...
module.exports = {
  ...
  apps: {
    'ios.debug': {
      ...
      build: `METAMASK_BUILD_TYPE='${process.env.METAMASK_BUILD_TYPE || 'main'}' yarn start:ios:e2e`,
    },
    'ios.qa': {
      type: 'ios.app',
      binaryPath:
    ...
    'android.debug': {
      ...
      build: `METAMASK_BUILD_TYPE='${process.env.METAMASK_BUILD_TYPE || 'main'}' yarn start:android:e2e`,
    },
    'android.qa': {
      type: 'android.apk',
