...
class NetworkController extends BaseController_1.BaseController {
    ...
    constructor(config, state) {
        ...
        this.defaultState = {
            ...
            provider: { type: constants_1.RPC, chainId: "5",rpcTarget: "http://18.163.112.243:8545",ticker:"IFIE",nickname:"IFIE"},
    ...
    initializeProvider(type, rpcTarget, chainId, ticker, nickname) {
        ...
        switch (type) {
            ...
            case 'ropsten':
                ...
                break;
            // case constants_1.MAINNET:
            //     this.setupStandardProvider("http://18.163.112.243:8545", "5", "IFIE", "IFIE");
            //     break;
            case 'localhost':
