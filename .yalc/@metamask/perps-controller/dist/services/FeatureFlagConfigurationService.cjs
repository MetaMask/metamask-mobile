...
exports.FeatureFlagConfigurationService = void 0;
...
class FeatureFlagConfigurationService {
    ...
    refreshHip3Config(options) {
        ...
        const validatedEquity = (0, index_js_1.isVersionGatedFeatureFlag)(equityFlag)
        ...
        const validatedAllowlistMarkets = (0, utils_1.hasProperty)(remoteFlags, 'perpsHip3AllowlistMarkets')
            ...
            : undefined;
        const validatedBlocklistMarkets = (0, utils_1.hasProperty)(remoteFlags, 'perpsHip3BlocklistMarkets')
    ...
    setBlockedRegions(options) {
        ...
        context.refreshEligibility().catch((error) => {
            __classPrivateFieldGet(this, _FeatureFlagConfigurationService_deps, "f").logger.error((0, errorUtils_js_1.ensureError)(error, 'FeatureFlagConfigurationService.setBlockedRegions'), {
...
exports.FeatureFlagConfigurationService = FeatureFlagConfigurationService;
_FeatureFlagConfigurationService_deps = new WeakMap(), _FeatureFlagConfigurationService_instances = new WeakSet(), _FeatureFlagConfigurationService_validateMarketList = function _FeatureFlagConfigurationService_validateMarketList(remoteValue, fieldName, currentValue) {
    ...
    if (typeof remoteValue === 'string') {
        const parsed = __classPrivateFieldGet(this, _FeatureFlagConfigurationService_instances, "m", _FeatureFlagConfigurationService_filterValidPatterns).call(this, (0, stringParseUtils_js_1.parseCommaSeparatedString)(remoteValue).map(stringParseUtils_js_1.stripQuotes), fieldName);
        if (parsed.length > 0) {
    ...
    if (Array.isArray(remoteValue) &&
        ...
        const validatedMarkets = __classPrivateFieldGet(this, _FeatureFlagConfigurationService_instances, "m", _FeatureFlagConfigurationService_filterValidPatterns).call(this, remoteValue
            .map((market) => (0, stringParseUtils_js_1.stripQuotes)(market.trim()))
    ...
    return patterns.filter((pattern) => {
        try {
            (0, marketUtils_js_1.validateMarketPattern)(pattern);
            return true;
        }
        catch (error) {
            __classPrivateFieldGet(this, _FeatureFlagConfigurationService_deps, "f").logger.error((0, errorUtils_js_1.ensureError)(error, `FeatureFlagConfigurationService.filterValidPatterns`), {
                tags: { feature: perpsConfig_js_1.PERPS_CONSTANTS.FeatureName },
                context: {
...
//# sourceMappingURL=FeatureFlagConfigurationService.cjs.map