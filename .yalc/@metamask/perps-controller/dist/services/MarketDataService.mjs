...
import { applyMarketFilters } from "../utils/marketUtils.mjs";
/**
 * MarketDataService
 *
...
export class MarketDataService {
    ...
    async getOrderFills(options) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _MarketDataService_deps, "f").logger.error(ensureError(error, 'MarketDataService.getOrderFills'), {
                tags: {
    ...
    async getOrders(options) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _MarketDataService_deps, "f").logger.error(ensureError(error, 'MarketDataService.getOrders'), {
                tags: {
                    feature: PERPS_CONSTANTS.FeatureName,
                    provider: context.tracingContext.provider,
                    network: context.tracingContext.isTestnet ? 'testnet' : 'mainnet',
    ...
    async getOpenOrders(options) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _MarketDataService_deps, "f").tracer.setMeasurement(PerpsMeasurementName.PerpsGetOpenOrdersOperation, completionDuration, 'millisecond');
            traceData = { success: true };
            return result;
        }
        catch (error) {
            __classPrivateFieldGet(this, _MarketDataService_deps, "f").logger.error(ensureError(error, 'MarketDataService.getOpenOrders'), {
                tags: {
                    feature: PERPS_CONSTANTS.FeatureName,
                    provider: context.tracingContext.provider,
                    network: context.tracingContext.isTestnet ? 'testnet' : 'mainnet',
    ...
    async getFunding(options) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _MarketDataService_deps, "f").logger.error(ensureError(error, 'MarketDataService.getFunding'), {
                tags: {
                    feature: PERPS_CONSTANTS.FeatureName,
                    provider: context.tracingContext.provider,
                    network: context.tracingContext.isTestnet ? 'testnet' : 'mainnet',
    ...
    async getAccountState(options) {
        ...
        try {
            ...
            if (!accountState) {
                ...
                __classPrivateFieldGet(this, _MarketDataService_deps, "f").logger.error(ensureError(error, 'MarketDataService.getAccountState'), {
                    tags: {
                        feature: PERPS_CONSTANTS.FeatureName,
                        provider: context.tracingContext.provider,
                        network: context.tracingContext.isTestnet ? 'testnet' : 'mainnet',
    ...
    async getHistoricalPortfolio(options) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _MarketDataService_deps, "f").logger.error(ensureError(error, 'MarketDataService.getHistoricalPortfolio'), {
                tags: {
                    feature: PERPS_CONSTANTS.FeatureName,
                    provider: context.tracingContext.provider,
                    network: context.tracingContext.isTestnet ? 'testnet' : 'mainnet',
    ...
    async getMarkets(options) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _MarketDataService_deps, "f").logger.error(ensureError(error, 'MarketDataService.getMarkets'), {
                tags: {
                    feature: PERPS_CONSTANTS.FeatureName,
                    provider: context.tracingContext.provider,
                    network: context.tracingContext.isTestnet ? 'testnet' : 'mainnet',
    ...
    async getMarketDataWithPrices(options) {
        ...
        try {
            ...
            const errorMessage = error instanceof Error
                ? error.message
                : PERPS_ERROR_CODES.MARKETS_FAILED;
            __classPrivateFieldGet(this, _MarketDataService_deps, "f").logger.error(ensureError(error, 'MarketDataService.getMarketDataWithPrices'), {
                tags: {
                    feature: PERPS_CONSTANTS.FeatureName,
                    provider: context.tracingContext.provider,
                    network: context.tracingContext.isTestnet ? 'testnet' : 'mainnet',
    ...
    async getAvailableDexs(options) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _MarketDataService_deps, "f").logger.error(ensureError(error, 'MarketDataService.getAvailableDexs'), {
                context: {
    ...
    async fetchHistoricalCandles(options) {
        ...
        try {
            ...
            if (!isAbortError(error)) {
                __classPrivateFieldGet(this, _MarketDataService_deps, "f").logger.error(ensureError(error, 'MarketDataService.fetchHistoricalCandles'), {
                    tags: {
                        feature: PERPS_CONSTANTS.FeatureName,
                        provider: context.tracingContext.provider,
                        network: context.tracingContext.isTestnet ? 'testnet' : 'mainnet',
    ...
    async calculateLiquidationPrice(options) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _MarketDataService_deps, "f").logger.error(ensureError(error, 'MarketDataService.calculateLiquidationPrice'), {
                context: {
    ...
    async calculateMaintenanceMargin(options) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _MarketDataService_deps, "f").logger.error(ensureError(error, 'MarketDataService.calculateMaintenanceMargin'), {
                context: {
    ...
    async getMaxLeverage(options) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _MarketDataService_deps, "f").logger.error(ensureError(error, 'MarketDataService.getMaxLeverage'), {
                context: {
    ...
    async calculateFees(options) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _MarketDataService_deps, "f").logger.error(ensureError(error, 'MarketDataService.calculateFees'), {
                context: {
    ...
    async validateOrder(options) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _MarketDataService_deps, "f").logger.error(ensureError(error, 'MarketDataService.validateOrder'), {
                context: {
    ...
    async validateClosePosition(options) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _MarketDataService_deps, "f").logger.error(ensureError(error, 'MarketDataService.validateClosePosition'), {
                context: {
...
//# sourceMappingURL=MarketDataService.mjs.map