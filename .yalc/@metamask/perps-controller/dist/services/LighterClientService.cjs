...
exports.LighterClientService = exports.LighterApiError = exports.convertKeysToCamelCase = void 0;
 ...
 */
class LighterApiError extends Error {
...
exports.LighterApiError = LighterApiError;
/**
 * REST client for the zkLighter API.
 */
class LighterClientService {
    constructor(deps, config) {
        ...
        _LighterClientService_request.set(this, async (path, init) => {
            ...
            const timeout = setTimeout(() => controller.abort(), lighterConfig_js_1.LIGHTER_HTTP_TIMEOUT_MS);
            try {
    ...
    get baseUrl() {
        return (0, lighterConfig_js_1.getLighterHttpEndpoint)(this.network);
    }
    /**
...
exports.LighterClientService = LighterClientService;
...
//# sourceMappingURL=LighterClientService.cjs.map