...
import { DATA_LAKE_API_CONFIG, PERPS_CONSTANTS } from "../constants/perpsConfig.mjs";
...
export class DataLakeService {
    ...
    async reportOrder(options) {
        ...
        try {
            ...
            const evmAccount = getSelectedEvmAccountFromMessenger(__classPrivateFieldGet(this, _DataLakeService_messenger, "f"));
            if (!evmAccount || !token) {
            ...
            // Record measurement
            __classPrivateFieldGet(this, _DataLakeService_deps, "f").tracer.setMeasurement(PerpsMeasurementName.PerpsDataLakeApiCall, apiCallDuration, 'millisecond');
            // Success logging
            ...
            __classPrivateFieldGet(this, _DataLakeService_deps, "f").logger.error(ensureError(error, 'DataLakeService.reportOrder'), {
            ...
            if (retryCount < MAX_RETRIES) {
                ...
                setTimeout(() => {
                    this.reportOrder({
                        ...
                        __classPrivateFieldGet(this, _DataLakeService_deps, "f").logger.error(ensureError(_retryError, 'DataLakeService.reportOrder'), {
                            tags: { feature: PERPS_CONSTANTS.FeatureName },
                            context: {
                                name: 'DataLakeService.reportOrder',
                                data: {
...
//# sourceMappingURL=DataLakeService.mjs.map