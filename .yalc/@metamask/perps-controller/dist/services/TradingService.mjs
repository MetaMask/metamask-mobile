...
import { isLimitExecutionOrderType } from "../utils/orderTypes.mjs";
/**
 * TradingService
 *
...
export class TradingService {
    ...
    async placeOrder(options) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _TradingService_instances, "m", _TradingService_trackSubmitted).call(this, PerpsAnalyticsEvent.TradeTransaction, {
            ...
            __classPrivateFieldGet(this, _TradingService_deps, "f").logger.error(ensureError(error, 'TradingService.placeOrder'), {
                tags: {
        ...
        try {
            ...
            if (result.success) {
                ...
                if (params.newOrder.price) {
                    editExecutedProps[PERPS_EVENT_PROPERTY.LIMIT_PRICE] = parseFloat(params.newOrder.price);
                }
                __classPrivateFieldGet(this, _TradingService_deps, "f").metrics.trackPerpsEvent(PerpsAnalyticsEvent.TradeTransaction, editExecutedProps);
                traceData = { success: true, orderId: result.orderId ?? '' };
            }
            else {
                // Track order edit failed
                __classPrivateFieldGet(this, _TradingService_deps, "f").metrics.trackPerpsEvent(PerpsAnalyticsEvent.TradeTransaction, {
            ...
            __classPrivateFieldGet(this, _TradingService_deps, "f").metrics.trackPerpsEvent(PerpsAnalyticsEvent.TradeTransaction, {
                ...
                [PERPS_EVENT_PROPERTY.ORDER_SIZE]: params.newOrder.size,
                [PERPS_EVENT_PROPERTY.COMPLETION_DURATION]: completionDuration,
                [PERPS_EVENT_PROPERTY.ERROR_MESSAGE]: error instanceof Error ? error.message : 'Unknown error',
            });
            __classPrivateFieldGet(this, _TradingService_deps, "f").logger.error(ensureError(error, 'TradingService.editOrder'), {
                tags: {
                    feature: PERPS_CONSTANTS.FeatureName,
                    provider: context.tracingContext.provider,
                    network: context.tracingContext.isTestnet ? 'testnet' : 'mainnet',
    ...
    async cancelOrder(options) {
        ...
        try {
            ...
            // Emit submitted event before the provider round-trip
            __classPrivateFieldGet(this, _TradingService_instances, "m", _TradingService_trackSubmitted).call(this, PerpsAnalyticsEvent.OrderCancelTransaction, {
                [PERPS_EVENT_PROPERTY.ASSET]: params.symbol,
                ...cancelExtraProps,
            });
            ...
            if (result.success) {
                ...
                __classPrivateFieldGet(this, _TradingService_deps, "f").metrics.trackPerpsEvent(PerpsAnalyticsEvent.OrderCancelTransaction, {
                    [PERPS_EVENT_PROPERTY.STATUS]: PERPS_EVENT_VALUE.STATUS.EXECUTED,
                    [PERPS_EVENT_PROPERTY.ASSET]: params.symbol,
                    [PERPS_EVENT_PROPERTY.COMPLETION_DURATION]: completionDuration,
                    ...cancelExtraProps,
                ...
                __classPrivateFieldGet(this, _TradingService_deps, "f").logger.error(ensureError(result.error, 'TradingService.cancelOrder'), __classPrivateFieldGet(this, _TradingService_instances, "m", _TradingService_getErrorContext).call(this, 'cancelOrder', {
                    symbol: params.symbol,
                    orderId: params.orderId,
            ...
            __classPrivateFieldGet(this, _TradingService_deps, "f").logger.error(ensureError(error, 'TradingService.cancelOrder'), __classPrivateFieldGet(this, _TradingService_instances, "m", _TradingService_getErrorContext).call(this, 'cancelOrder', { symbol: params.symbol }));
            traceData = {
                success: false,
                error: error instanceof Error ? error.message : 'Unknown error',
            };
        ...
        try {
            ...
            operationResult = await withStreamPause(async () => {
                ...
                if (params.cancelAll === true ||
                    ...
                    ordersToCancel = orders.filter((order) => !isTPSLOrder(order.detailedOrderType));
                }
            ...
            __classPrivateFieldGet(this, _TradingService_deps, "f").logger.error(ensureError(error, 'TradingService.cancelOrders'), __classPrivateFieldGet(this, _TradingService_instances, "m", _TradingService_getErrorContext).call(this, 'cancelOrders'));
            throw error;
        }
        finally {
            const completionDuration = __classPrivateFieldGet(this, _TradingService_deps, "f").performance.now() - startTime;
            ...
            const batchCancelProps = {
                [PERPS_EVENT_PROPERTY.STATUS]: operationResult?.success && operationResult.successCount > 0
            ...
            __classPrivateFieldGet(this, _TradingService_deps, "f").metrics.trackPerpsEvent(PerpsAnalyticsEvent.OrderCancelTransaction, batchCancelProps);
            __classPrivateFieldGet(this, _TradingService_deps, "f").tracer.endTrace({
                name: PerpsTraceNames.CancelOrder,
                id: traceId,
            });
    ...
    async closePosition(options) {
        ...
        try {
            ...
            // Emit submitted event before the provider round-trip
            __classPrivateFieldGet(this, _TradingService_instances, "m", _TradingService_trackSubmitted).call(this, PerpsAnalyticsEvent.PositionCloseTransaction, {
                [PERPS_EVENT_PROPERTY.ASSET]: params.symbol,
                [PERPS_EVENT_PROPERTY.ORDER_TYPE]: params.orderType ?? PERPS_EVENT_VALUE.ORDER_TYPE.MARKET,
                ...__classPrivateFieldGet(this, _TradingService_instances, "m", _TradingService_buildAttributionProperties).call(this, params.trackingData),
                ...(bulkActionId && {
                    [PERPS_EVENT_PROPERTY.BULK_ACTION_ID]: bulkActionId,
                }),
            ...
            if (result.success) {
                ...
                traceData = { success: false, error: result.error ?? 'Unknown error' };
                __classPrivateFieldGet(this, _TradingService_deps, "f").logger.error(ensureError(result.error, 'TradingService.closePosition'), __classPrivateFieldGet(this, _TradingService_instances, "m", _TradingService_getErrorContext).call(this, 'closePosition', {
                    symbol: params.symbol,
                    providerError: result.error ?? 'Unknown error',
                }));
            }
            ...
            __classPrivateFieldGet(this, _TradingService_deps, "f").logger.error(ensureError(error, 'TradingService.closePosition'), {
                tags: {
                    feature: PERPS_CONSTANTS.FeatureName,
                    provider: context.tracingContext.provider,
                    network: context.tracingContext.isTestnet ? 'testnet' : 'mainnet',
    ...
    async closePositions(options) {
        ...
        try {
            ...
            operationError =
                error instanceof Error ? error : new Error(String(error));
            __classPrivateFieldGet(this, _TradingService_deps, "f").logger.error(ensureError(error, 'TradingService.closePositions'), __classPrivateFieldGet(this, _TradingService_instances, "m", _TradingService_getErrorContext).call(this, 'closePositions', {
                symbols: params.symbols?.length ?? 0,
                closeAll: params.closeAll,
            }));
            throw error;
            ...
            const batchCloseProps = {
                ...
                [PERPS_EVENT_PROPERTY.COMPLETION_DURATION]: completionDuration,
                [PERPS_EVENT_PROPERTY.BULK_ACTION_ID]: bulkActionId,
                [PERPS_EVENT_PROPERTY.NUMBER_POSITIONS_CLOSED]: operationResult?.successCount ?? 0,
            };
            if (operationError) {
                batchCloseProps[PERPS_EVENT_PROPERTY.ERROR_MESSAGE] =
                    operationError.message;
            }
            __classPrivateFieldGet(this, _TradingService_deps, "f").metrics.trackPerpsEvent(PerpsAnalyticsEvent.PositionCloseTransaction, batchCloseProps);
    ...
    async updatePositionTPSL(options) {
        ...
        const source = params.trackingData?.source ?? PERPS_EVENT_VALUE.SOURCE.TP_SL_VIEW;
        ...
        try {
            ...
            // Emit submitted event before the provider round-trip
            __classPrivateFieldGet(this, _TradingService_instances, "m", _TradingService_trackSubmitted).call(this, PerpsAnalyticsEvent.RiskManagement, {
                [PERPS_EVENT_PROPERTY.ASSET]: params.symbol,
            ...
            traceData = { success: false, error: errorMessage };
            __classPrivateFieldGet(this, _TradingService_deps, "f").logger.error(ensureError(error, 'TradingService.updatePositionTPSL'), __classPrivateFieldGet(this, _TradingService_instances, "m", _TradingService_getErrorContext).call(this, 'updatePositionTPSL', {
                symbol: params.symbol,
            ...
            const eventProperties = {
                ...
                ...(direction && {
                    [PERPS_EVENT_PROPERTY.DIRECTION]: direction === 'long'
                        ? PERPS_EVENT_VALUE.DIRECTION.LONG
                        : PERPS_EVENT_VALUE.DIRECTION.SHORT,
                }),
                ...
                ...(params.takeProfitPrice && {
                    [PERPS_EVENT_PROPERTY.TAKE_PROFIT_PRICE]: parseFloat(params.takeProfitPrice),
                }),
                ...(params.stopLossPrice && {
                    [PERPS_EVENT_PROPERTY.STOP_LOSS_PRICE]: parseFloat(params.stopLossPrice),
                }),
            ...
            __classPrivateFieldGet(this, _TradingService_deps, "f").metrics.trackPerpsEvent(PerpsAnalyticsEvent.RiskManagement, eventProperties);
            __classPrivateFieldGet(this, _TradingService_deps, "f").tracer.endTrace({
                name: PerpsTraceNames.UpdateTpsl,
                id: traceId,
                data: traceData,
    ...
    async updateMargin(options) {
        ...
        try {
            ...
            if (result.success) {
                ...
                __classPrivateFieldGet(this, _TradingService_deps, "f").metrics.trackPerpsEvent(PerpsAnalyticsEvent.RiskManagement, {
                    [PERPS_EVENT_PROPERTY.STATUS]: PERPS_EVENT_VALUE.STATUS.EXECUTED,
                    [PERPS_EVENT_PROPERTY.ASSET]: symbol,
                    [PERPS_EVENT_PROPERTY.ACTION]: parseFloat(amount) > 0 ? 'add_margin' : 'remove_margin',
            ...
            __classPrivateFieldGet(this, _TradingService_deps, "f").logger.error(ensureError(error, 'TradingService.updateMargin'), __classPrivateFieldGet(this, _TradingService_instances, "m", _TradingService_getErrorContext).call(this, 'updateMargin', { symbol, amount }));
    ...
    async flipPosition(options) {
        ...
        try {
            ...
            const completionDuration = __classPrivateFieldGet(this, _TradingService_deps, "f").performance.now() - startTime;
            const errorMessage = error instanceof Error ? error.message : 'Unknown error';
            __classPrivateFieldGet(this, _TradingService_deps, "f").logger.error(ensureError(error, 'TradingService.flipPosition'), __classPrivateFieldGet(this, _TradingService_instances, "m", _TradingService_getErrorContext).call(this, 'flipPosition', { symbol: position.symbol }));
...
_TradingService_deps = new WeakMap(), _TradingService_controllerDeps = new WeakMap(), _TradingService_feeContextTail = new WeakMap(), _TradingService_instances = new WeakSet(), _TradingService_getErrorContext = function _TradingService_getErrorContext(method, additionalContext) {
    ...
    const properties = {
        ...
        [PERPS_EVENT_PROPERTY.ORDER_TYPE]: params.orderType,
        [PERPS_EVENT_PROPERTY.LEVERAGE]: parseFloat(String(params.leverage ?? 1)),
        [PERPS_EVENT_PROPERTY.ORDER_SIZE]: parseFloat(result?.filledSize ?? params.size),
    ...
    if (status === PERPS_EVENT_VALUE.STATUS.EXECUTED) {
        ...
        if (params.takeProfitPrice) {
            properties[PERPS_EVENT_PROPERTY.TAKE_PROFIT_PRICE] = parseFloat(params.takeProfitPrice);
        }
        if (params.stopLossPrice) {
            properties[PERPS_EVENT_PROPERTY.STOP_LOSS_PRICE] = parseFloat(params.stopLossPrice);
        }
    }
    else {
    ...
    if (result?.success === true &&
        ...
        __classPrivateFieldGet(this, _TradingService_deps, "f").metrics.trackPerpsEvent(PerpsAnalyticsEvent.TradeTransaction, {
            ...properties,
            [PERPS_EVENT_PROPERTY.STATUS]: PERPS_EVENT_VALUE.STATUS.PARTIALLY_FILLED,
    ...
    __classPrivateFieldGet(this, _TradingService_deps, "f").metrics.trackPerpsEvent(PerpsAnalyticsEvent.TradeTransaction, properties);
}, _TradingService_handleOrderSuccess = 
/**
...
async function _TradingService_handleOrderSuccess(options) {
    ...
    reportOrderToDataLake({
        ...
        __classPrivateFieldGet(this, _TradingService_deps, "f").logger.error(ensureError(error, 'TradingService.handleOrderSuccess'), {
            tags: {
                feature: PERPS_CONSTANTS.FeatureName,
                provider: context.tracingContext.provider,
                network: context.tracingContext.isTestnet ? 'testnet' : 'mainnet',
...
async function _TradingService_loadPositionData(options) {
    ...
    try {
        ...
        __classPrivateFieldGet(this, _TradingService_deps, "f").tracer.setMeasurement(PerpsMeasurementName.PerpsGetPositionsOperation, __classPrivateFieldGet(this, _TradingService_deps, "f").performance.now() - positionLoadStart, 'millisecond');
        return position;
    }
    catch (error) {
    ...
    const baseProperties = {
        ...
        [PERPS_EVENT_PROPERTY.OPEN_POSITION_SIZE]: Math.abs(parseFloat(position.size)),
        ...
        ...(position.returnOnEquity && {
            [PERPS_EVENT_PROPERTY.PNL_PERCENT]: parseFloat(position.returnOnEquity) * 100,
        }),
        ...
        ...(params.trackingData?.metamaskFeeRate !== undefined && {
            [PERPS_EVENT_PROPERTY.METAMASK_FEE_RATE]: params.trackingData.metamaskFeeRate,
        }),
        ...(params.trackingData?.feeDiscountPercentage !== undefined && {
            [PERPS_EVENT_PROPERTY.DISCOUNT_PERCENTAGE]: params.trackingData.feeDiscountPercentage,
        }),
        ...(params.trackingData?.estimatedPoints !== undefined && {
            [PERPS_EVENT_PROPERTY.ESTIMATED_REWARDS]: params.trackingData.estimatedPoints,
        }),
        ...
        ...(params.trackingData?.receivedAmount !== undefined && {
            [PERPS_EVENT_PROPERTY.RECEIVED_AMOUNT]: params.trackingData.receivedAmount,
        }),
    ...
    if (!position) {
        ...
        __classPrivateFieldGet(this, _TradingService_deps, "f").metrics.trackPerpsEvent(PerpsAnalyticsEvent.PositionCloseTransaction, {
            [PERPS_EVENT_PROPERTY.STATUS]: status,
            [PERPS_EVENT_PROPERTY.ASSET]: params.symbol,
            [PERPS_EVENT_PROPERTY.ORDER_TYPE]: params.orderType ?? PERPS_EVENT_VALUE.ORDER_TYPE.MARKET,
            [PERPS_EVENT_PROPERTY.COMPLETION_DURATION]: duration,
    ...
    if (result?.success && metrics.isPartiallyFilled) {
        const partialProperties = __classPrivateFieldGet(this, _TradingService_instances, "m", _TradingService_buildCloseEventProperties).call(this, position, params, metrics, result, PERPS_EVENT_VALUE.STATUS.PARTIALLY_FILLED);
        __classPrivateFieldGet(this, _TradingService_deps, "f").metrics.trackPerpsEvent(PerpsAnalyticsEvent.PositionCloseTransaction, {
            ...partialProperties,
            [PERPS_EVENT_PROPERTY.AMOUNT_FILLED]: metrics.filledSize,
            [PERPS_EVENT_PROPERTY.REMAINING_AMOUNT]: metrics.requestedSize - metrics.filledSize,
            [PERPS_EVENT_PROPERTY.COMPLETION_DURATION]: duration,
            ...bulkActionProps,
        });
    }
    ...
    reportOrderToDataLake({
        ...
        __classPrivateFieldGet(this, _TradingService_deps, "f").logger.error(ensureError(error, 'TradingService.handleDataLakeReporting'), {
            tags: {
                feature: PERPS_CONSTANTS.FeatureName,
                provider: context.tracingContext.provider,
                network: context.tracingContext.isTestnet ? 'testnet' : 'mainnet',
...
async function _TradingService_calculateFeeDiscountWithMeasurement() {
    ...
    // Record measurement
    __classPrivateFieldGet(this, _TradingService_deps, "f").tracer.setMeasurement(PerpsMeasurementName.PerpsRewardsOrderExecutionFeeDiscountApiCall, orderExecutionFeeDiscountDuration, 'millisecond');
...
//# sourceMappingURL=TradingService.mjs.map