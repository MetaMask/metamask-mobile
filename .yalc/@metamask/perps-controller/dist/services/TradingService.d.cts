import type { PerpsProvider, OrderParams, OrderResult, EditOrderParams, CancelOrderParams, CancelOrderResult, CancelOrdersParams, CancelOrdersResult, ClosePositionParams, ClosePositionsParams, ClosePositionsResult, Position, TrackingData, UpdatePositionTPSLParams, PerpsPlatformDependencies } from "../types/index.cjs";
import type { RewardsIntegrationService } from "./RewardsIntegrationService.cjs";
...
//# sourceMappingURL=TradingService.d.cts.map