...
const perpsConnectionAttemptContext_js_1 = require("../utils/perpsConnectionAttemptContext.cjs");
/**
...
Object.defineProperty(exports, "WebSocketConnectionState", { enumerable: true, get: function () { return index_js_2.WebSocketConnectionState; } });
/**
...
class HyperLiquidClientService {
    constructor(deps, options = {}) {
        ...
        _HyperLiquidClientService_connectionState.set(this, index_js_1.WebSocketConnectionState.Disconnected);
    ...
    async initialize(wallet) {
        ...
        const attemptContext = (0, perpsConnectionAttemptContext_js_1.getPerpsConnectionAttemptContext)();
        try {
            __classPrivateFieldGet(this, _HyperLiquidClientService_instances, "m", _HyperLiquidClientService_updateConnectionState).call(this, index_js_1.WebSocketConnectionState.Connecting);
            ...
            __classPrivateFieldGet(this, _HyperLiquidClientService_instances, "m", _HyperLiquidClientService_updateConnectionState).call(this, index_js_1.WebSocketConnectionState.Connected);
            ...
            const errorInstance = (0, errorUtils_js_1.ensureError)(error, 'HyperLiquidClientService.initialize');
            __classPrivateFieldGet(this, _HyperLiquidClientService_instances, "m", _HyperLiquidClientService_updateConnectionState).call(this, index_js_1.WebSocketConnectionState.Disconnected);
    ...
    async ensureSubscriptionClient(wallet) {
        if (!__classPrivateFieldGet(this, _HyperLiquidClientService_subscriptionClient, "f")) {
            ...
            if (__classPrivateFieldGet(this, _HyperLiquidClientService_walletParams, "f") &&
                __classPrivateFieldGet(this, _HyperLiquidClientService_connectionState, "f") === index_js_1.WebSocketConnectionState.Disconnected) {
    ...
    getExchangeClient() {
        if (!__classPrivateFieldGet(this, _HyperLiquidClientService_exchangeClient, "f")) {
            ...
            throw new Error(perpsErrorCodes_js_1.PERPS_ERROR_CODES.EXCHANGE_CLIENT_NOT_AVAILABLE);
        }
    ...
    getInfoClient(options) {
        if (options?.useHttp) {
            if (!__classPrivateFieldGet(this, _HyperLiquidClientService_infoClientHttp, "f")) {
                this.ensureInitialized();
                throw new Error(perpsErrorCodes_js_1.PERPS_ERROR_CODES.INFO_CLIENT_NOT_AVAILABLE);
            }
    ...
    async ensureTransportReady(options = {}) {
        ...
        try {
            ...
            throw (0, errorUtils_js_1.ensureError)(error, 'HyperLiquidClientService.ensureTransportReady');
        }
        finally {
    ...
    async fetchHistoricalCandles(options) {
        ...
        return (0, coalescePerpsRestRequest_js_1.coalescePerpsRestRequest)(cacheKey, () => __classPrivateFieldGet(this, _HyperLiquidClientService_instances, "m", _HyperLiquidClientService_runCandleSnapshotFetch).call(this, { symbol, interval, limit }), { ttlMs: perpsConfig_js_1.PERFORMANCE_CONFIG.PerpsCandleCoalesceTtlMs });
    }
    /**
    ...
    async fetchHistoricalOrders(userAddress, options) {
        ...
        return (0, coalescePerpsRestRequest_js_1.coalescePerpsRestRequest)(cacheKey, () => __classPrivateFieldGet(this, _HyperLiquidClientService_instances, "m", _HyperLiquidClientService_runHistoricalOrdersFetch).call(this, userAddress), { forceRefresh: options?.forceRefresh });
    }
    /**
    ...
    subscribeToCandles({ symbol, interval, duration, callback, onError, }) {
        ...
        const subscriptionClient = this.getSubscriptionClient();
        if (!subscriptionClient) {
            throw new Error(perpsErrorCodes_js_1.PERPS_ERROR_CODES.SUBSCRIPTION_CLIENT_NOT_AVAILABLE);
        }
        ...
        const initialLimit = duration
            ? Math.min((0, chartConfig_js_1.calculateCandleCount)(duration, interval), 500)
        ...
        const initAndSubscribe = async () => {
            try {
                ...
                try {
                    ...
                    const errorInstance = (0, errorUtils_js_1.ensureError)(error, 'HyperLiquidClientService.subscribeToCandles');
    ...
    async disconnect() {
        ...
        if (__classPrivateFieldGet(this, _HyperLiquidClientService_connectionState, "f") === index_js_1.WebSocketConnectionState.Disconnected) {
            return;
        }
     ...
     */
    isDisconnected() {
        return __classPrivateFieldGet(this, _HyperLiquidClientService_connectionState, "f") === index_js_1.WebSocketConnectionState.Disconnected;
    }
    /**
...
_HyperLiquidClientService_exchangeClient = new WeakMap(), _HyperLiquidClientService_infoClient = new WeakMap(), _HyperLiquidClientService_infoClientHttp = new WeakMap(), _HyperLiquidClientService_subscriptionClient = new WeakMap(), _HyperLiquidClientService_wsTransport = new WeakMap(), _HyperLiquidClientService_httpTransport = new WeakMap(), _HyperLiquidClientService_walletParams = new WeakMap(), _HyperLiquidClientService_isTestnet = new WeakMap(), _HyperLiquidClientService_connectionState = new WeakMap(), _HyperLiquidClientService_disconnectionPromise = new WeakMap(), _HyperLiquidClientService_onTerminateCallback = new WeakMap(), _HyperLiquidClientService_onReconnectCallback = new WeakMap(), _HyperLiquidClientService_reconnectionAttempt = new WeakMap(), _HyperLiquidClientService_connectionStateListeners = new WeakMap(), _HyperLiquidClientService_reconnectionRetryTimeout = new WeakMap(), _HyperLiquidClientService_deps = new WeakMap(), _HyperLiquidClientService_isReconnecting = new WeakMap(), _HyperLiquidClientService_instances = new WeakSet(), _HyperLiquidClientService_createTransports = function _HyperLiquidClientService_createTransports() {
    ...
    __classPrivateFieldSet(this, _HyperLiquidClientService_httpTransport, new hyperliquid_1.HttpTransport({
        isTestnet: __classPrivateFieldGet(this, _HyperLiquidClientService_isTestnet, "f"),
        timeout: hyperLiquidConfig_js_1.HYPERLIQUID_TRANSPORT_CONFIG.timeout,
    }), "f");
    ...
    try {
        ...
        const errorInstance = (0, errorUtils_js_1.ensureError)(error, 'HyperLiquidClientService.fetchHistoricalCandles');
    ...
    const intervalMap = {
        [chartConfig_js_1.CandlePeriod.OneMinute]: 1 * 60 * 1000,
        [chartConfig_js_1.CandlePeriod.ThreeMinutes]: 3 * 60 * 1000,
        [chartConfig_js_1.CandlePeriod.FiveMinutes]: 5 * 60 * 1000,
        [chartConfig_js_1.CandlePeriod.FifteenMinutes]: 15 * 60 * 1000,
        [chartConfig_js_1.CandlePeriod.ThirtyMinutes]: 30 * 60 * 1000,
        [chartConfig_js_1.CandlePeriod.OneHour]: 60 * 60 * 1000,
        [chartConfig_js_1.CandlePeriod.TwoHours]: 2 * 60 * 60 * 1000,
        [chartConfig_js_1.CandlePeriod.FourHours]: 4 * 60 * 60 * 1000,
        [chartConfig_js_1.CandlePeriod.EightHours]: 8 * 60 * 60 * 1000,
        [chartConfig_js_1.CandlePeriod.TwelveHours]: 12 * 60 * 60 * 1000,
        [chartConfig_js_1.CandlePeriod.OneDay]: 24 * 60 * 60 * 1000,
        [chartConfig_js_1.CandlePeriod.ThreeDays]: 3 * 24 * 60 * 60 * 1000,
        [chartConfig_js_1.CandlePeriod.OneWeek]: 7 * 24 * 60 * 60 * 1000,
        [chartConfig_js_1.CandlePeriod.OneMonth]: 30 * 24 * 60 * 60 * 1000, // Approximate
    };
    return intervalMap[interval];
}, _HyperLiquidClientService_performDisconnection = async function _HyperLiquidClientService_performDisconnection() {
    try {
        __classPrivateFieldGet(this, _HyperLiquidClientService_instances, "m", _HyperLiquidClientService_updateConnectionState).call(this, index_js_1.WebSocketConnectionState.Disconnecting);
        ...
        if (__classPrivateFieldGet(this, _HyperLiquidClientService_wsTransport, "f")) {
            try {
                ...
                __classPrivateFieldGet(this, _HyperLiquidClientService_deps, "f").logger.error((0, errorUtils_js_1.ensureError)(error, 'HyperLiquidClientService.performDisconnection'), {
    ...
    const isReconnectionAttempt = newState === index_js_1.WebSocketConnectionState.Connecting &&
    ...
    if (newState === index_js_1.WebSocketConnectionState.Connected) {
        __classPrivateFieldSet(this, _HyperLiquidClientService_reconnectionAttempt, 0, "f");
    }
...
async function _HyperLiquidClientService_handleConnectionDrop() {
    ...
    try {
        ...
        const newInfoClient = new hyperliquid_1.InfoClient({ transport: newWsTransport });
        const newSubscriptionClient = new hyperliquid_1.SubscriptionClient({
        ...
        __classPrivateFieldSet(this, _HyperLiquidClientService_reconnectionRetryTimeout, setTimeout(() => {
            ...
            if ((__classPrivateFieldGet(this, _HyperLiquidClientService_connectionState, "f") === index_js_1.WebSocketConnectionState.Connecting ||
                __classPrivateFieldGet(this, _HyperLiquidClientService_connectionState, "f") === index_js_1.WebSocketConnectionState.Disconnected) &&
        ...
        }, perpsConfig_js_1.PERPS_CONSTANTS.ReconnectionRetryDelayMs), "f");
    }
};
