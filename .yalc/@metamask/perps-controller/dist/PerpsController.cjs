...
exports.PerpsController = exports.getDefaultPerpsControllerState = exports.DEFAULT_PRO_LAYOUT_PREFERENCES = exports.DEFAULT_PERPS_MODE = exports.PerpsMode = exports.InitializationState = exports.PERPS_ERROR_CODES = exports.resolveMyxAuthConfig = exports.resolveWatchlistExchangeKey = exports.firstNonEmpty = void 0;
const base_controller_1 = require("@metamask/base-controller");
const controller_utils_1 = require("@metamask/controller-utils");
const uuid_1 = require("uuid");
const chartConfig_js_1 = require("./constants/chartConfig.cjs");
...
const AggregatedPerpsProvider_js_1 = require("./providers/AggregatedPerpsProvider.cjs");
const HyperLiquidProvider_js_1 = require("./providers/HyperLiquidProvider.cjs");
const AccountService_js_1 = require("./services/AccountService.cjs");
const DataLakeService_js_1 = require("./services/DataLakeService.cjs");
const DepositService_js_1 = require("./services/DepositService.cjs");
const EligibilityService_js_1 = require("./services/EligibilityService.cjs");
const FeatureFlagConfigurationService_js_1 = require("./services/FeatureFlagConfigurationService.cjs");
const MarketDataService_js_1 = require("./services/MarketDataService.cjs");
const RewardsIntegrationService_js_1 = require("./services/RewardsIntegrationService.cjs");
const TerminalMarketService_js_1 = require("./services/TerminalMarketService.cjs");
const TradingService_js_1 = require("./services/TradingService.cjs");
...
const perpsDiskPersistence_js_1 = require("./utils/perpsDiskPersistence.cjs");
const wait_js_1 = require("./utils/wait.cjs");
...
var perpsErrorCodes_js_2 = require("./perpsErrorCodes.cjs");
Object.defineProperty(exports, "PERPS_ERROR_CODES", { enumerable: true, get: function () { return perpsErrorCodes_js_2.PERPS_ERROR_CODES; } });
/**
...
var perpsConfig_js_2 = require("./constants/perpsConfig.cjs");
Object.defineProperty(exports, "PerpsMode", { enumerable: true, get: function () { return perpsConfig_js_2.PerpsMode; } });
Object.defineProperty(exports, "DEFAULT_PERPS_MODE", { enumerable: true, get: function () { return perpsConfig_js_2.DEFAULT_PERPS_MODE; } });
Object.defineProperty(exports, "DEFAULT_PRO_LAYOUT_PREFERENCES", { enumerable: true, get: function () { return perpsConfig_js_2.DEFAULT_PRO_LAYOUT_PREFERENCES; } });
/**
...
const getDefaultPerpsControllerState = () => ({
    ...
    proLayoutPreferences: { ...perpsConfig_js_1.DEFAULT_PRO_LAYOUT_PREFERENCES },
    mode: perpsConfig_js_1.DEFAULT_PERPS_MODE,
    hip3ConfigVersion: 0,
...
class PerpsController extends base_controller_1.BaseController {
    constructor({ messenger, state = {}, clientConfig = {}, infrastructure, deferEligibilityCheck = false, }) {
        ...
        __classPrivateFieldSet(this, _PerpsController_tradingService, new TradingService_js_1.TradingService(infrastructure), "f");
        __classPrivateFieldSet(this, _PerpsController_marketDataService, new MarketDataService_js_1.MarketDataService({
            ...infrastructure,
            terminalMarketService: infrastructure.terminalMarketService ??
                (infrastructure.terminalApi?.marketDataUrl ||
                    ...
                    ? new TerminalMarketService_js_1.TerminalMarketService(infrastructure)
                    : undefined),
        }), "f");
        __classPrivateFieldSet(this, _PerpsController_accountService, new AccountService_js_1.AccountService(infrastructure, messenger), "f");
        __classPrivateFieldSet(this, _PerpsController_eligibilityService, new EligibilityService_js_1.EligibilityService(infrastructure), "f");
        __classPrivateFieldSet(this, _PerpsController_dataLakeService, new DataLakeService_js_1.DataLakeService(infrastructure, messenger), "f");
        __classPrivateFieldSet(this, _PerpsController_depositService, new DepositService_js_1.DepositService(infrastructure, messenger), "f");
        __classPrivateFieldSet(this, _PerpsController_featureFlagConfigurationService, new FeatureFlagConfigurationService_js_1.FeatureFlagConfigurationService(infrastructure), "f");
        __classPrivateFieldSet(this, _PerpsController_rewardsIntegrationService, new RewardsIntegrationService_js_1.RewardsIntegrationService(infrastructure, messenger), "f");
        ...
        try {
            ...
            __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.constructor'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'constructor', {
    ...
    getCachedMarketDataForActiveProvider(options) {
        ...
        if (activeProvider === 'aggregated') {
            ...
            for (const providerId of __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getAggregatedCacheProviderIds).call(this, Object.keys(cache))) {
                const key = (0, perpsConfig_js_1.buildProviderCacheKey)(providerId, this.state.isTestnet);
                ...
                assembled.push(...(0, marketUtils_js_1.clonePerpsMarketData)(entry.data));
            }
        ...
        const key = (0, perpsConfig_js_1.buildProviderCacheKey)(activeProvider, this.state.isTestnet);
        const entry = cache[key];
        if (!entry || entry.data.length === 0) {
            return null;
        }
        ...
        return (0, marketUtils_js_1.clonePerpsMarketData)(entry.data);
    }
    /**
    ...
    getCachedUserDataForActiveProvider(options) {
        ...
        try {
            const evmAccount = (0, accountUtils_js_1.getSelectedEvmAccountFromMessenger)(this.messenger);
        ...
        if (activeProvider === 'aggregated') {
            ...
            for (const providerId of __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getAggregatedCacheProviderIds).call(this, Object.keys(cache))) {
                const providerNetworkKey = (0, perpsConfig_js_1.buildProviderCacheKey)(providerId, this.state.isTestnet);
        ...
        // Single provider mode
        const providerNetworkKey = (0, perpsConfig_js_1.buildProviderCacheKey)(activeProvider, this.state.isTestnet);
        const entry = cache[providerNetworkKey];
    ...
    async getUserDataSnapshot() {
        ...
        const isCurrent = () => {
            let currentAddress;
            try {
                currentAddress = (0, accountUtils_js_1.getSelectedEvmAccountFromMessenger)(this.messenger)?.address;
            }
            catch {
                return false;
            }
    ...
    registerLighterProvider(LighterProviderClass) {
        const lighterIsTestnet = perpsConfig_js_1.PROVIDER_CONFIG.LIGHTER_TESTNET_ONLY || this.state.isTestnet;
    ...
    getActiveProvider() {
        ...
        if (this.isCurrentlyReinitializing()) {
            this.update((state) => {
                state.lastError = perpsErrorCodes_js_1.PERPS_ERROR_CODES.CLIENT_REINITIALIZING;
                state.lastUpdateTimestamp = Date.now();
            });
            throw new Error(perpsErrorCodes_js_1.PERPS_ERROR_CODES.CLIENT_REINITIALIZING);
        }
        // Check if not initialized
        if (this.state.initializationState !== InitializationState.Initialized ||
            !this.isInitialized) {
            this.update((state) => {
                state.lastError = perpsErrorCodes_js_1.PERPS_ERROR_CODES.CLIENT_NOT_INITIALIZED;
                state.lastUpdateTimestamp = Date.now();
            });
            throw new Error(perpsErrorCodes_js_1.PERPS_ERROR_CODES.CLIENT_NOT_INITIALIZED);
        }
        // Return the active provider instance (set during initialization based on providerMode)
        if (!this.activeProviderInstance) {
            this.update((state) => {
                state.lastError = perpsErrorCodes_js_1.PERPS_ERROR_CODES.PROVIDER_NOT_AVAILABLE;
                state.lastUpdateTimestamp = Date.now();
            });
        ...
        try {
            ...
            if (!placeOrder) {
                ...
                result
                    ...
                    this.update((state) => {
                        ...
                        state.lastDepositResult = {
                            ...
                            txHash: actualTxHash,
                            amount: amount ?? '0',
                            asset: hyperLiquidConfig_js_1.USDC_SYMBOL, // Default asset for deposits
                            timestamp: Date.now(),
                            error: '',
                        };
                    ...
                    const errorMessage = (0, errorUtils_js_1.ensureError)(error, 'PerpsController.initiateDeposit').message;
                ...
                depositOrderResult
                    ...
                    .catch((error) => {
                    const errorMessage = (0, errorUtils_js_1.ensureError)(error, 'PerpsController.depositWithOrder').message;
    ...
    updateWithdrawalStatus(withdrawalId, status, txHash) {
        ...
        if (shouldTrack && withdrawalAmount !== undefined) {
            __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getMetrics).call(this).trackPerpsEvent(index_js_1.PerpsAnalyticsEvent.WithdrawalTransaction, {
                [eventNames_js_1.PERPS_EVENT_PROPERTY.STATUS]: status === 'completed'
                    ? eventNames_js_1.PERPS_EVENT_VALUE.STATUS.COMPLETED
                    : eventNames_js_1.PERPS_EVENT_VALUE.STATUS.FAILED,
                [eventNames_js_1.PERPS_EVENT_PROPERTY.WITHDRAWAL_AMOUNT]: Number.parseFloat(withdrawalAmount),
            });
        }
        if (found) {
    ...
    completeWithdrawalFromHistory(withdrawalRequestId, completedWithdrawal) {
        ...
        __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getMetrics).call(this).trackPerpsEvent(index_js_1.PerpsAnalyticsEvent.WithdrawalTransaction, {
            [eventNames_js_1.PERPS_EVENT_PROPERTY.STATUS]: eventNames_js_1.PERPS_EVENT_VALUE.STATUS.COMPLETED,
            [eventNames_js_1.PERPS_EVENT_PROPERTY.WITHDRAWAL_AMOUNT]: Number.parseFloat(completedWithdrawal.amount),
        });
    }
    /**
    ...
    getWithdrawalRoutes() {
        try {
            ...
            __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.getWithdrawalRoutes'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'getWithdrawalRoutes'));
    ...
    mergeAttributionContext(properties = {}) {
        ...
        if (context.utmSource !== undefined) {
            utm[eventNames_js_1.PERPS_EVENT_PROPERTY.UTM_SOURCE] = context.utmSource;
        }
        if (context.utmMedium !== undefined) {
            utm[eventNames_js_1.PERPS_EVENT_PROPERTY.UTM_MEDIUM] = context.utmMedium;
        }
        if (context.utmCampaign !== undefined) {
            utm[eventNames_js_1.PERPS_EVENT_PROPERTY.UTM_CAMPAIGN] = context.utmCampaign;
        }
        if (context.utmContent !== undefined) {
            utm[eventNames_js_1.PERPS_EVENT_PROPERTY.UTM_CONTENT] = context.utmContent;
        }
        if (context.utmTerm !== undefined) {
            utm[eventNames_js_1.PERPS_EVENT_PROPERTY.UTM_TERM] = context.utmTerm;
        }
    ...
    async toggleTestnet() {
        ...
        if (this.isCurrentlyReinitializing()) {
            ...
            return {
                ...
                error: perpsErrorCodes_js_1.PERPS_ERROR_CODES.CLIENT_REINITIALIZING,
            };
        }
        ...
        try {
            ...
            return {
                success: false,
                isTestnet: this.state.isTestnet,
                error: (0, errorUtils_js_1.ensureError)(error, 'PerpsController.toggleTestnet').message,
            };
        }
        finally {
    ...
    async switchProvider(providerId) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.switchProvider'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'switchProvider', { providerId }));
            ...
            try {
                ...
                __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(reinitError, 'PerpsController.switchProvider.rollback'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'switchProvider.rollback', {
                    previousProvider,
                }));
            }
            return {
     ...
     */
    getMarketCategories() {
        return index_js_1.MARKET_CATEGORIES;
    }
    /**
    ...
    async reconnect() {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.reconnect'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'reconnect', {
    ...
    subscribeToPrices(params) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.subscribeToPrices'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'subscribeToPrices', {
    ...
    subscribeToPositions(params) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.subscribeToPositions'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'subscribeToPositions', {
    ...
    subscribeToOrderFills(params) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.subscribeToOrderFills'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'subscribeToOrderFills', {
                accountId: params.accountId,
            }));
            return () => {
                // No-op
    ...
    subscribeToOrders(params) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.subscribeToOrders'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'subscribeToOrders', {
                accountId: params.accountId,
            }));
            return () => {
                // No-op
    ...
    subscribeToAccount(params) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.subscribeToAccount'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'subscribeToAccount', {
                accountId: params.accountId,
            }));
            return () => {
                // No-op
    ...
    subscribeToOrderBook(params) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.subscribeToOrderBook'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'subscribeToOrderBook', {
                symbol: params.symbol,
    ...
    subscribeToCandles(params) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.subscribeToCandles'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'subscribeToCandles', {
                symbol: params.symbol,
    ...
    subscribeToOICaps(params) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.subscribeToOICaps'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'subscribeToOICaps', {
                accountId: params.accountId,
            }));
            return () => {
                // No-op
    ...
    setLiveDataConfig(config) {
        try {
            ...
            __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.setLiveDataConfig'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'setLiveDataConfig'));
        }
    }
    /**
    ...
    async disconnect() {
        ...
        if (this.isInitialized && !this.isCurrentlyReinitializing()) {
            try {
                ...
                __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.disconnect'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'disconnect'));
            }
        }
    ...
    startEligibilityMonitoring() {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.startEligibilityMonitoring'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'startEligibilityMonitoring', {
                operation: 'readRemoteFeatureFlags',
            }));
        }
    }
    ...
    async refreshEligibility() {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.refreshEligibility'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'refreshEligibility'));
    ...
    setMaxSlippage(bps) {
        ...
        const clamped = Math.min(perpsConfig_js_1.MAX_SLIPPAGE_BOUNDS.MaxBps, Math.max(perpsConfig_js_1.MAX_SLIPPAGE_BOUNDS.MinBps, bps));
        const snapped = Math.round(clamped / perpsConfig_js_1.MAX_SLIPPAGE_BOUNDS.StepBps) *
            perpsConfig_js_1.MAX_SLIPPAGE_BOUNDS.StepBps;
        this.update((state) => {
    ...
    setSelectedPaymentToken(token) {
        let normalized = null;
        if (token !== null &&
            token.description !== perpsConfig_js_1.PERPS_CONSTANTS.PerpsBalanceTokenDescription) {
            normalized = token;
        }
        const current = this.state.selectedPaymentToken;
        const initialPaymentMethod = current === null ||
            current === undefined ||
            current?.description === perpsConfig_js_1.PERPS_CONSTANTS.PerpsBalanceTokenDescription
            ? 'perps_balance'
        ...
        if (initialPaymentMethod !== newPaymentMethod) {
            __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getMetrics).call(this).trackPerpsEvent(index_js_1.PerpsAnalyticsEvent.UiInteraction, {
                [eventNames_js_1.PERPS_EVENT_PROPERTY.INTERACTION_TYPE]: eventNames_js_1.PERPS_EVENT_VALUE.INTERACTION_TYPE.PAYMENT_METHOD_CHANGED,
                [eventNames_js_1.PERPS_EVENT_PROPERTY.INITIAL_PAYMENT_METHOD]: initialPaymentMethod,
                [eventNames_js_1.PERPS_EVENT_PROPERTY.NEW_PAYMENT_METHOD]: newPaymentMethod,
            });
        }
        let snapshot = null;
        if (normalized !== null) {
    ...
    async toggleWatchlistMarket(symbol) {
        ...
        __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getMetrics).call(this).trackPerpsEvent(index_js_1.PerpsAnalyticsEvent.UiInteraction, {
            [eventNames_js_1.PERPS_EVENT_PROPERTY.INTERACTION_TYPE]: eventNames_js_1.PERPS_EVENT_VALUE.INTERACTION_TYPE.FAVORITE_TOGGLED,
            [eventNames_js_1.PERPS_EVENT_PROPERTY.ASSET]: symbol,
            [eventNames_js_1.PERPS_EVENT_PROPERTY.ACTION_TYPE]: isWatchlisted
                ? eventNames_js_1.PERPS_EVENT_VALUE.ACTION_TYPE.UNFAVORITE_MARKET
                : eventNames_js_1.PERPS_EVENT_VALUE.ACTION_TYPE.FAVORITE_MARKET,
            [eventNames_js_1.PERPS_EVENT_PROPERTY.FAVORITES_COUNT]: this.state.watchlistMarkets[currentNetwork].length,
        });
        ...
        try {
            ...
            __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.toggleWatchlistMarket'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'toggleWatchlistMarket', {
                symbol,
                network: currentNetwork,
                action: isWatchlisted ? 'remove' : 'add',
            }));
...
_a = PerpsController, _PerpsController_initializationPromise = new WeakMap(), _PerpsController_isReinitializing = new WeakMap(), _PerpsController_myxRegistrationPromise = new WeakMap(), _PerpsController_lighterRegistrationPromise = new WeakMap(), _PerpsController_blockedRegionListVersion = new WeakMap(), _PerpsController_hip3Enabled = new WeakMap(), _PerpsController_hip3AllowlistMarkets = new WeakMap(), _PerpsController_hip3BlocklistMarkets = new WeakMap(), _PerpsController_hip3ConfigSource = new WeakMap(), _PerpsController_priceDeviationLimit = new WeakMap(), _PerpsController_attributionContext = new WeakMap(), _PerpsController_standaloneProvider = new WeakMap(), _PerpsController_handlersRegistered = new WeakMap(), _PerpsController_standaloneProviderIsTestnet = new WeakMap(), _PerpsController_standaloneProviderHip3Version = new WeakMap(), _PerpsController_standaloneProviderOperations = new WeakMap(), _PerpsController_eligibilityCheckDeferred = new WeakMap(), _PerpsController_ausQueue = new WeakMap(), _PerpsController_userDiskWrite = new WeakMap(), _PerpsController_options = new WeakMap(), _PerpsController_tradingService = new WeakMap(), _PerpsController_marketDataService = new WeakMap(), _PerpsController_accountService = new WeakMap(), _PerpsController_eligibilityService = new WeakMap(), _PerpsController_dataLakeService = new WeakMap(), _PerpsController_depositService = new WeakMap(), _PerpsController_featureFlagConfigurationService = new WeakMap(), _PerpsController_rewardsIntegrationService = new WeakMap(), _PerpsController_preloadTimer = new WeakMap(), _PerpsController_isPreloading = new WeakMap(), _PerpsController_marketPreloadQueued = new WeakMap(), _PerpsController_isPreloadingUserData = new WeakMap(), _PerpsController_userPreloadQueued = new WeakMap(), _PerpsController_userSnapshotRequests = new WeakMap(), _PerpsController_preloadStateUnsubscribe = new WeakMap(), _PerpsController_accountChangeUnsubscribe = new WeakMap(), _PerpsController_previousIsTestnet = new WeakMap(), _PerpsController_previousHip3ConfigVersion = new WeakMap(), _PerpsController_instances = new WeakSet(), _PerpsController_isMYXProviderEnabled = function _PerpsController_isMYXProviderEnabled() {
    ...
    try {
        ...
        if ((0, index_js_1.isVersionGatedFeatureFlag)(remoteFlag)) {
...
async function _PerpsController_awaitInitializationIfInProgress() {
    ...
    const providerNetworkKey = (0, perpsConfig_js_1.buildProviderCacheKey)('hyperliquid', isTestnet);
    this.update((state) => {
    ...
    __classPrivateFieldSet(this, _PerpsController_standaloneProvider, new HyperLiquidProvider_js_1.HyperLiquidProvider({
        isTestnet: currentIsTestnet,
...
async function _PerpsController_withStreamPause(operation, channels) {
    ...
    for (const channel of channels) {
        try {
            ...
            __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.withStreamPause'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'withStreamPause', {
                operation: 'pause',
...
async function _PerpsController_performInitialization() {
    ...
    for (let attempt = 1; attempt <= maxAttempts; attempt++) {
        try {
            ...
            await Promise.all([
                (0, wait_js_1.wait)(perpsConfig_js_1.PERPS_CONSTANTS.ReconnectionCleanupDelayMs),
            ...
            lastError = (0, errorUtils_js_1.ensureError)(error, 'PerpsController.performInitialization');
    ...
    const hyperLiquidProvider = new HyperLiquidProvider_js_1.HyperLiquidProvider({
        isTestnet: this.state.isTestnet,
        hip3Enabled: __classPrivateFieldGet(this, _PerpsController_hip3Enabled, "f"),
        allowlistMarkets: __classPrivateFieldGet(this, _PerpsController_hip3AllowlistMarkets, "f"),
        blocklistMarkets: __classPrivateFieldGet(this, _PerpsController_hip3BlocklistMarkets, "f"),
    ...
    if (activeProvider === 'aggregated') {
        this.activeProviderInstance = new AggregatedPerpsProvider_js_1.AggregatedPerpsProvider({
    ...
    return (symbol) => {
        ...
        return (0, marketUtils_js_1.shouldIncludeMarket)(symbol, dex, hip3Enabled, compiledAllowlist, compiledBlocklist);
    };
...
async function _PerpsController_getActiveProviderWhenReady() {
    ...
    if (this.state.isTestnet) {
        return hyperLiquidConfig_js_1.TESTNET_HIP3_CONFIG.AutoDiscoverAll
            ? undefined
            : (0, hyperLiquidConfig_js_1.canonicalizeHyperLiquidDexes)(hyperLiquidConfig_js_1.TESTNET_HIP3_CONFIG.EnabledDexs);
    }
    if (hyperLiquidConfig_js_1.MAINNET_HIP3_CONFIG.AutoDiscoverAll) {
        return undefined;
    }
    const dexes = new Set();
    ...
    return (0, hyperLiquidConfig_js_1.canonicalizeHyperLiquidDexes)(dexes);
}, _PerpsController_hydrateCacheFromDiskSync = function _PerpsController_hydrateCacheFromDiskSync() {
    const { marketUpdates, userUpdates, stats } = (0, perpsDiskPersistence_js_1.hydrateFromDiskSync)(__classPrivateFieldGet(this, _PerpsController_options, "f").infrastructure.diskCache, this.state.cachedMarketDataByProvider, this.state.cachedUserDataByProvider, __classPrivateFieldGet(_a, _a, "f", _PerpsController_preloadGuardMs));
    ...
    __classPrivateFieldSet(this, _PerpsController_userDiskWrite, __classPrivateFieldGet(this, _PerpsController_userDiskWrite, "f")
        .then(() => (0, perpsDiskPersistence_js_1.persistUserEntriesToDisk)(__classPrivateFieldGet(this, _PerpsController_options, "f").infrastructure.diskCache, entries))
        .catch(() => {
...
async function _PerpsController_performMarketDataPreload() {
    ...
    const actualProviderId = this.activeProviderInstance
        ...
        : 'hyperliquid';
    const cacheKey = (0, perpsConfig_js_1.buildProviderCacheKey)(actualProviderId, this.state.isTestnet);
    ...
    try {
        __classPrivateFieldGet(this, _PerpsController_options, "f").infrastructure.tracer.trace({
            name: index_js_1.PerpsTraceNames.MarketDataPreload,
            id: traceId,
        ...
        if (this.state.activeProvider === 'aggregated' &&
            ...
            this.update((state) => {
                for (const [pid, slice] of byProvider) {
                    const key = (0, perpsConfig_js_1.buildProviderCacheKey)(pid, this.state.isTestnet);
        ...
        (0, perpsDiskPersistence_js_1.persistMarketEntriesToDisk)(__classPrivateFieldGet(this, _PerpsController_options, "f").infrastructure.diskCache, marketDiskEntries);
        ...
        __classPrivateFieldGet(this, _PerpsController_options, "f").infrastructure.tracer.setMeasurement(performanceMetrics_js_1.PerpsMeasurementName.PerpsMarketDataPreload, performance.now() - preloadStart, 'millisecond');
    }
    catch (error) {
        traceData = {
            success: false,
            error: (0, errorUtils_js_1.ensureError)(error, 'PerpsController.performMarketDataPreload')
                .message,
        };
        __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.performMarketDataPreload'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'performMarketDataPreload', {
...
async function _PerpsController_performUserDataPreload() {
    ...
    const actualProviderId = activeProviderInstance
        ...
        : 'hyperliquid';
    const providerNetworkKey = (0, perpsConfig_js_1.buildProviderCacheKey)(actualProviderId, isTestnet);
    ...
    if (hasMatchingCache &&
        this.getWebSocketConnectionState() === index_js_1.WebSocketConnectionState.Connected) {
        return;
    }
    ...
    try {
        __classPrivateFieldGet(this, _PerpsController_options, "f").infrastructure.tracer.trace({
            name: index_js_1.PerpsTraceNames.UserDataPreload,
            id: traceId,
            op: index_js_1.PerpsTraceOperations.Operation,
            tags: {
        ...
        if (activeProvider === 'hyperliquid') {
            ...
            __classPrivateFieldGet(this, _PerpsController_options, "f").infrastructure.tracer.setMeasurement(performanceMetrics_js_1.PerpsMeasurementName.PerpsUserDataPreload, performance.now() - preloadStart, 'millisecond');
            return;
        }
        ...
        if (activeProvider === 'aggregated' && activeProviderInstance) {
            ...
            this.update((state) => {
                for (const [pid, data] of byProvider) {
                    const key = (0, perpsConfig_js_1.buildProviderCacheKey)(pid, isTestnet);
        ...
        traceData = {
            success: false,
            error: (0, errorUtils_js_1.ensureError)(error, 'PerpsController.performUserDataPreload')
                .message,
        };
        __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.performUserDataPreload'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'performUserDataPreload', {
...
async function _PerpsController_syncWatchlistFromRemote() {
    ...
    try {
        ...
        __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_logError).call(this, (0, errorUtils_js_1.ensureError)(error, 'PerpsController.syncWatchlistFromRemote'), __classPrivateFieldGet(this, _PerpsController_instances, "m", _PerpsController_getErrorContext).call(this, 'syncWatchlistFromRemote'));
    }
};
// ============================================================================
