...
import { SubscriptionMultiplexer } from "../aggregation/SubscriptionMultiplexer.mjs";
import { ProviderRouter } from "../routing/ProviderRouter.mjs";
 ...
 * ```
 */
export class AggregatedPerpsProvider {
    constructor(config) {
        ...
        __classPrivateFieldSet(this, _AggregatedPerpsProvider_router, new ProviderRouter({
        ...
        __classPrivateFieldSet(this, _AggregatedPerpsProvider_subscriptionMux, new SubscriptionMultiplexer({
...
//# sourceMappingURL=AggregatedPerpsProvider.mjs.map