...
import { BASIS_POINTS_DIVISOR, BUILDER_FEE_CONFIG, canonicalizeHyperLiquidDexes, FEE_RATES, getBridgeInfo, getChainId, HIP3_ASSET_MARKET_TYPES, HIP3_FEE_CONFIG, HIP3_MARGIN_CONFIG, HYPERLIQUID_ASSET_NAMES, HYPERLIQUID_CONFIG, HYPERLIQUID_WITHDRAWAL_MINUTES, REFERRAL_CONFIG, TRADING_DEFAULTS, USDC_DECIMALS, USDC_SYMBOL } from "../constants/hyperLiquidConfig.mjs";
import { CHASE_ORDER_CONFIG, HYPERLIQUID_TWAP_LIMITS, ORDER_SLIPPAGE_CONFIG, PERFORMANCE_CONFIG, PERPS_CONSTANTS, TP_SL_CONFIG, WITHDRAWAL_CONSTANTS } from "../constants/perpsConfig.mjs";
...
import { DexDiscoveryCacheManager } from "../services/DexDiscoveryCacheManager.mjs";
import { HyperLiquidClientService, WebSocketConnectionState } from "../services/HyperLiquidClientService.mjs";
...
import { generatePerpsId } from "../utils/idUtils.mjs";
...
import { buildOrdersArray, calculateFinalPositionSize, calculateOrderPriceAndSize, computeChaseQuotePrice, computeScalePriceLadder, floorToSizeDecimals, formatPartialTpslSize, splitScaleSizes, validateOrderPrecision } from "../utils/orderCalculations.mjs";
import { getTriggerExecution, isLimitExecutionOrderType, isStrategyOrderType, isTriggerOrderType, toSDKTimeInForce } from "../utils/orderTypes.mjs";
...
export class HyperLiquidProvider {
    constructor(options) {
        ...
        _HyperLiquidProvider_errorMappings.set(this, {
            'isolated position does not have sufficient margin available to decrease leverage': PERPS_ERROR_CODES.ORDER_LEVERAGE_REDUCTION_FAILED,
        ...
        __classPrivateFieldSet(this, _HyperLiquidProvider_priceDeviationLimit, options.priceDeviationLimit ??
            HYPERLIQUID_CONFIG.OraclePriceDeviationLimit, "f");
        ...
        __classPrivateFieldSet(this, _HyperLiquidProvider_dexDiscoveryCache, new DexDiscoveryCacheManager({
        ...
        __classPrivateFieldSet(this, _HyperLiquidProvider_walletService, new HyperLiquidWalletService(__classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f"), __classPrivateFieldGet(this, _HyperLiquidProvider_messenger, "f"), {
            isTestnet,
        }), "f");
        __classPrivateFieldSet(this, _HyperLiquidProvider_subscriptionService, new HyperLiquidSubscriptionService(__classPrivateFieldGet(this, _HyperLiquidProvider_clientService, "f"), __classPrivateFieldGet(this, _HyperLiquidProvider_walletService, "f"), __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f"), __classPrivateFieldGet(this, _HyperLiquidProvider_hip3Enabled, "f"), [], // enabledDexs - will be populated after DEX discovery in buildAssetMapping
    ...
    async editOrder(params) {
        try {
            ...
            __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.editOrder'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'editOrder', {
    ...
    async cancelOrder(params) {
        ...
        try {
            ...
            await __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_ensureReady).call(this);
            const coinValidation = validateCoinExists(params.symbol, __classPrivateFieldGet(this, _HyperLiquidProvider_symbolToAssetId, "f"));
            ...
            return createErrorResult(__classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_mapError).call(this, new Error(rawError)), {
                success: false,
                orderId: params.orderId,
            });
        }
    ...
    async closePositions(params) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.closePositions'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'closePositions', {
        ...
        try {
            ...
            if (position) {
                ...
                try {
                    ...
                    __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.updatePositionTPSL'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'updatePositionTPSL > getPositions', {
                        symbol,
                    }));
                    throw error;
                }
            ...
            __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.updatePositionTPSL'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'updatePositionTPSL', {
                symbol: params.symbol,
    ...
    async closePosition(params) {
        try {
            ...
            __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.closePosition'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'closePosition', {
                coin: params.symbol,
                orderType: params.orderType,
            }));
            return createErrorResult(error, { success: false });
    ...
    async getUserDataSnapshot(params) {
        ...
        const orders = rawOrders.map((order) => adaptOrderFromSDK(order, positionsBySymbol.get(order.coin)));
        const dexAccountStates = clearinghouseStates.map((state) => adaptAccountStateFromSDK(state));
        const accountState = addSpotBalanceToAccountState(aggregateAccountStates(dexAccountStates), spotState, { foldIntoCollateral: hyperLiquidModeFoldsSpot(abstractionMode) });
    ...
    async getPositions(params) {
        try {
            ...
            if (params?.standalone && params.userAddress) {
                ...
                const results = await queryStandaloneClearinghouseStates(standaloneInfoClient, userAddress, dexs);
    ...
    async getOpenOrders(params) {
        try {
            ...
            if (params?.standalone && params.userAddress) {
                ...
                const dexs = await __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getStandaloneValidatedDexs).call(this);
                const orderResults = await queryStandaloneOpenOrders(standaloneInfoClient, userAddress, dexs);
                // Combine all orders from all DEXs and adapt (without position context in standalone mode)
                const orders = orderResults.flatMap((dexOrders) => dexOrders.map((order) => adaptOrderFromSDK(order, undefined)));
    ...
    async getUserNonFundingLedgerUpdates(params) {
        try {
            ...
            __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.getUserNonFundingLedgerUpdates'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'getUserNonFundingLedgerUpdates', params));
            return [];
        }
    }
    /**
    ...
    async getUserHistory(params) {
        try {
            ...
            __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.getUserHistory'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'getUserHistory'));
            return [];
        }
    }
        ...
        try {
            ...
            const perpsResponse = perpsStateResult.status === 'fulfilled'
                ...
                : {
                    ...
                    failedDexs: [
                        {
                            dex: null,
                            error: ensureError(perpsStateResult.reason, 'HyperLiquidProvider.getAccountState.perps'),
                        },
                    ],
                };
            ...
            if (spotStateResult.status === 'rejected') {
                __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").debugLogger.log('Spot state fetch failed during account state aggregation', {
                    error: ensureError(spotStateResult.reason, 'HyperLiquidProvider.getAccountState.spot').message,
                });
            }
            ...
            if (perpsStateResults.length === 0) {
                ...
                const spotErrorMessage = spotStateResult.status === 'rejected'
                    ? ensureError(spotStateResult.reason, 'HyperLiquidProvider.getAccountState.spot').message
                    : undefined;
            ...
            __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.getAccountState'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'getAccountState', {
    ...
    async getMarkets(params) {
        try {
                ...
                if (dexsToQuery.length > 1) {
                    ...
                    const marketArrays = await Promise.all(dexsToQuery.map(async (dex) => {
                        try {
                            ...
                            __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.getMarkets'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'getMarkets.multiDex', {
                                dex: dex ?? 'main',
                            }));
            ...
            __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.getMarkets'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'getMarkets', {
                dex: params?.dex,
                symbolCount: params?.symbols?.length,
            }));
            return [];
    ...
    async getAvailableHip3Dexs() {
        try {
            ...
            __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.getAvailableHip3Dexs'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'getAvailableHip3Dexs'));
            return [];
        }
    }
    /**
    ...
    async getMarketDataWithPrices() {
        ...
        const dexDataResults = await Promise.all(enabledDexs.map(async (dex) => {
            ...
            if (assetCtxs.length !== metaForDex.universe.length) {
                try {
                    ...
                    return {
                        ...
                        success: false,
                        failedStep: 'metaAndAssetCtxs',
                        errorMessage: ensureError(error, 'HyperLiquidProvider.getMarketDataWithPrices.metaAndAssetCtxs').message,
                    };
                }
            }
            let dexAllMids = {};
            try {
                ...
                failedStep = 'allMids';
                errorMessage = ensureError(error, 'HyperLiquidProvider.getMarketDataWithPrices.allMids').message;
            }
            return {
                dex,
                meta: metaForDex,
        ...
        }, __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").marketDataFormatters, HIP3_ASSET_MARKET_TYPES, HYPERLIQUID_ASSET_NAMES);
    ...
    async withdraw(params) {
        try {
            ...
            const safeError = ensureError(error, 'HyperLiquidProvider.initiateWithdrawal');
    ...
    async transferBetweenDexs(params) {
        try {
            ...
            const safeError = ensureError(error, 'HyperLiquidProvider.transferToSpot');
    ...
    subscribeToPrices(params) {
        ...
        __classPrivateFieldGet(this, _HyperLiquidProvider_subscriptionService, "f")
            ...
            .catch((error) => {
            __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.subscribeToPrices'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'subscribeToPrices', {
    ...
    async initialize() {
        try {
            ...
            return {
                success: true,
                chainId: getChainId(__classPrivateFieldGet(this, _HyperLiquidProvider_clientService, "f").isTestnetMode()),
            };
        }
        catch (error) {
            return createErrorResult(error, { success: false });
    ...
    async calculateLiquidationPrice(params) {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.calculateLiquidationPrice'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'calculateLiquidationPrice', {
                asset: params.asset,
    ...
    async getMaxLeverage(asset) {
        try {
            ...
            __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.getMaxLeverage'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'getMaxLeverage', {
                asset,
            }));
            return PERPS_CONSTANTS.DefaultMaxLeverage;
        }
    ...
    async calculateFees(params) {
        ...
        try {
            ...
            const safeError = ensureError(error, 'HyperLiquidProvider.getFeeSchedule');
        ...
        if (__classPrivateFieldGet(this, _HyperLiquidProvider_userFeeDiscountBips, "f") !== undefined) {
            const discount = __classPrivateFieldGet(this, _HyperLiquidProvider_userFeeDiscountBips, "f") / BASIS_POINTS_DIVISOR; // Convert basis points to decimal
        ...
        __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").debugLogger.log('Final Fee Calculation Result', {
            ...
            usingFallbackRates: protocolFeeRate === FEE_RATES.taker ||
    ...
    async getAvailableDexs(_params) {
        try {
            ...
            __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.getAvailableDexs'), {
                context: {
...
_HyperLiquidProvider_deps = new WeakMap(), _HyperLiquidProvider_clientService = new WeakMap(), _HyperLiquidProvider_walletService = new WeakMap(), _HyperLiquidProvider_subscriptionService = new WeakMap(), _HyperLiquidProvider_symbolToAssetId = new WeakMap(), _HyperLiquidProvider_userFeeCache = new WeakMap(), _HyperLiquidProvider_maxLeverageCache = new WeakMap(), _HyperLiquidProvider_cachedMetaByDex = new WeakMap(), _HyperLiquidProvider_cachedMarketDataWithPrices = new WeakMap(), _HyperLiquidProvider_cachedSpotMeta = new WeakMap(), _HyperLiquidProvider_dexDiscoveryCache = new WeakMap(), _HyperLiquidProvider_referralCheckCache = new WeakMap(), _HyperLiquidProvider_builderFeeCheckCache = new WeakMap(), _HyperLiquidProvider_ensureReadyPromise = new WeakMap(), _HyperLiquidProvider_pendingBuilderFeeApprovals = new WeakMap(), _HyperLiquidProvider_subscriptionBuilderApprovalEpoch = new WeakMap(), _HyperLiquidProvider_approvedBuilderAddresses = new WeakMap(), _HyperLiquidProvider_compiledAllowlistPatterns = new WeakMap(), _HyperLiquidProvider_compiledBlocklistPatterns = new WeakMap(), _HyperLiquidProvider_userFeeDiscountBips = new WeakMap(), _HyperLiquidProvider_userFeeResolution = new WeakMap(), _HyperLiquidProvider_hip3Enabled = new WeakMap(), _HyperLiquidProvider_allowlistMarkets = new WeakMap(), _HyperLiquidProvider_blocklistMarkets = new WeakMap(), _HyperLiquidProvider_useUnifiedAccount = new WeakMap(), _HyperLiquidProvider_dexDiscoveryComplete = new WeakMap(), _HyperLiquidProvider_unifiedAccountSetupNeedsRetry = new WeakMap(), _HyperLiquidProvider_pendingValidatedDexsPromise = new WeakMap(), _HyperLiquidProvider_cachedUsdcTokenId = new WeakMap(), _HyperLiquidProvider_errorMappings = new WeakMap(), _HyperLiquidProvider_scaleOrderGroups = new WeakMap(), _HyperLiquidProvider_chaseSessions = new WeakMap(), _HyperLiquidProvider_chasePlacementsInFlight = new WeakMap(), _HyperLiquidProvider_chaseGeneration = new WeakMap(), _HyperLiquidProvider_clientsInitialized = new WeakMap(), _HyperLiquidProvider_initializationPromise = new WeakMap(), _HyperLiquidProvider_messenger = new WeakMap(), _HyperLiquidProvider_builderAddressTestnet = new WeakMap(), _HyperLiquidProvider_builderAddressMainnet = new WeakMap(), _HyperLiquidProvider_subscriptionBuilderAddressTestnet = new WeakMap(), _HyperLiquidProvider_subscriptionBuilderAddressMainnet = new WeakMap(), _HyperLiquidProvider_priceDeviationLimit = new WeakMap(), _HyperLiquidProvider_tradingSetupPromise = new WeakMap(), _HyperLiquidProvider_tradingSetupComplete = new WeakMap(), _HyperLiquidProvider_instances = new WeakSet(), _HyperLiquidProvider_compilePatternsSafely = function _HyperLiquidProvider_compilePatternsSafely(patterns, listName) {
    ...
    for (const pattern of patterns) {
        try {
            ...
            __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, `HyperLiquidProvider.compilePatternsSafely`), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'compilePatternsSafely', { listName, pattern }));
        }
    }
    return compiled;
...
async function _HyperLiquidProvider_isHyperliquidMultiSigAccount(userAddress) {
    try {
        ...
        __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").debugLogger.log('[isHyperliquidMultiSigAccount] Probe failed, assuming single-signer', {
            user: userAddress,
            error: ensureError(error, 'HyperLiquidProvider.isHyperliquidMultiSigAccount').message,
        });
        return false;
    }
}, _HyperLiquidProvider_ensureUnifiedAccountEnabled = 
...
async function _HyperLiquidProvider_getAllAvailableDexs() {
    ...
    try {
        ...
        __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.getAllAvailableDexs'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'getAllAvailableDexs'));
        return [null]; // Fallback to main DEX only
    }
    ...
    if (!__classPrivateFieldGet(this, _HyperLiquidProvider_dexDiscoveryCache, "f").state) {
        try {
            ...
            __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").debugLogger.log('[backfillAssetMapForDex] Unable to refresh validated DEXs before rebuilding asset map', {
                dex: dex ?? 'main',
                error: ensureError(error, 'HyperLiquidProvider.backfillAssetMapForDex').message,
            });
        }
    }
...
async function _HyperLiquidProvider_fetchMarketsForDex(params) {
    ...
    const filteredMarkets = skipFilters || dex === null
        ? markets
        : markets.filter((market) => shouldIncludeMarket(market.name, dex, __classPrivateFieldGet(this, _HyperLiquidProvider_hip3Enabled, "f"), __classPrivateFieldGet(this, _HyperLiquidProvider_compiledAllowlistPatterns, "f"), __classPrivateFieldGet(this, _HyperLiquidProvider_compiledBlocklistPatterns, "f")));
...
async function _HyperLiquidProvider_queryUserDataAcrossDexs(baseParams, queryFn) {
    ...
    settledResults.forEach((result, index) => {
        ...
        failedDexs.push({
            dex,
            error: ensureError(result.reason, 'HyperLiquidProvider.queryUserDataAcrossDexs'),
        });
    });
    ...
    return (error.message === PERPS_ERROR_CODES.EXCHANGE_MULTI_SIG_REQUIRED ||
...
async function _HyperLiquidProvider_ensureBuilderFeeApproval() {
    ...
    // Check if another provider instance is currently attempting this operation
    const inFlightPromise = PerpsSigningCache.isInFlight('builderFee', network, userAddress);
    if (inFlightPromise) {
    ...
    const completeInFlight = PerpsSigningCache.setInFlight('builderFee', network, userAddress);
    try {
        // Re-check cache after acquiring lock
        const recheckCache = PerpsSigningCache.getBuilderFee(network, userAddress);
        ...
        __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").debugLogger.log('[ensureBuilderFeeApproval] Failed, will retry on next trading operation', {
            network,
            error: ensureError(error, 'HyperLiquidProvider.ensureBuilderFeeApproval').message,
        });
        completeInFlight();
        throw error;
    }
...
async function _HyperLiquidProvider_autoTransferForHip3Order(params) {
    ...
    // Execute transfer
    const transferAmount = Math.min(shortfall, source.available).toFixed(USDC_DECIMALS);
    ...
    try {
        ...
        if (excessAmount > minimumTransferThreshold) {
            try {
                ...
                __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(rebalanceError, 'HyperLiquidProvider.placeOrder:autoRebalance'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'placeOrder:autoRebalance', {
                    dex: dexName,
                    excessAmount: excessAmount.toFixed(2),
        ...
        __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(balanceCheckError, 'HyperLiquidProvider.placeOrder:postOrderBalanceCheck'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'placeOrder:postOrderBalanceCheck', {
            dex: dexName,
...
async function _HyperLiquidProvider_handleHip3OrderRollback(params) {
    ...
    try {
        ...
        __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(rollbackError, 'HyperLiquidProvider.placeOrder:rollback'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'placeOrder:rollback:exception', {
            dex: dexName,
            amount: transferInfo.amount.toFixed(USDC_DECIMALS),
...
async function _HyperLiquidProvider_handleHip3PreOrder(params) {
    ...
    if (!isUsdcDex) {
        ...
        throw new Error(PERPS_ERROR_CODES.UNSUPPORTED_COLLATERAL);
    }
    if (__classPrivateFieldGet(this, _HyperLiquidProvider_useUnifiedAccount, "f")) {
...
async function _HyperLiquidProvider_startChaseSession(params, context, generation) {
    ...
    const intervalMs = params.chaseIntervalMs ?? CHASE_ORDER_CONFIG.DefaultIntervalMs;
    ...
    const session = {
        ...
        maxRepricings: params.chaseMaxRepricings ?? CHASE_ORDER_CONFIG.DefaultMaxRepricings,
        repricings: 0,
        timer: null,
        active: true,
    };
    ...
    if (generation !== __classPrivateFieldGet(this, _HyperLiquidProvider_chaseGeneration, "f")) {
        ...
        return createErrorResult(new Error(PERPS_ERROR_CODES.ORDER_CHASE_ABANDONED), {
            success: false,
...
async function _HyperLiquidProvider_cancelScaleOrder(params) {
    ...
    return createErrorResult(new Error(PERPS_ERROR_CODES.ORDER_STRATEGY_CANCEL_INCOMPLETE), { success: false, orderId: params.orderId });
...
async function _HyperLiquidProvider_cancelChaseOrder(params) {
    ...
    return Math.floor(BUILDER_FEE_CONFIG.MaxFeeTenthsBps *
        (1 - __classPrivateFieldGet(this, _HyperLiquidProvider_userFeeDiscountBips, "f") / BASIS_POINTS_DIVISOR));
...
async function _HyperLiquidProvider_getAllMids(infoClient, dexParam) {
    ...
    try {
        ...
        allMidsErrorMessage = ensureError(error, 'HyperLiquidProvider.getMarketDataWithPrices.allMids').message;
    }
    if (meta?.universe) {
...
async function _HyperLiquidProvider_excludeNonUsdcCollateralResults(results) {
    return Promise.all(results.map(async (result) => {
        ...
        try {
            ...
            __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").debugLogger.log('HyperLiquidProvider: Failed to check collateral type for HIP-3 DEX; excluding from market data', {
                dex: result.dex,
                error: ensureError(error, 'HyperLiquidProvider.excludeNonUsdcCollateralResults').message,
            });
            isUsdcDex = false;
        }
        if (isUsdcDex) {
    ...
    results.forEach((result) => {
        if (result.success && result.meta?.universe) {
            ...
            const filteredMarkets = result.dex === null
                ? marketsFromDex
                : marketsFromDex.filter((asset) => shouldIncludeMarket(asset.name, result.dex, __classPrivateFieldGet(this, _HyperLiquidProvider_hip3Enabled, "f"), __classPrivateFieldGet(this, _HyperLiquidProvider_compiledAllowlistPatterns, "f"), __classPrivateFieldGet(this, _HyperLiquidProvider_compiledBlocklistPatterns, "f")));
    ...
    if (isTestnet) {
        ...
        return __classPrivateFieldGet(this, _HyperLiquidProvider_builderAddressTestnet, "f") || BUILDER_FEE_CONFIG.TestnetBuilder;
    }
    // eslint-disable-next-line @typescript-eslint/prefer-nullish-coalescing
    return __classPrivateFieldGet(this, _HyperLiquidProvider_builderAddressMainnet, "f") || BUILDER_FEE_CONFIG.MainnetBuilder;
...
async function _HyperLiquidProvider_ensureReferralSet() {
    ...
    const inFlightPromise = PerpsSigningCache.isInFlight('referral', network, userAddress);
    if (inFlightPromise) {
    ...
    // Set global in-flight lock
    const completeInFlight = PerpsSigningCache.setInFlight('referral', network, userAddress);
    try {
        // Re-check cache after acquiring lock
        ...
        __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.ensureReferralSet'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'ensureReferralSet', {
...
async function _HyperLiquidProvider_isReferralCodeReady() {
    try {
        ...
        __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.isReferralCodeReady'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'isReferralCodeReady', {
...
async function _HyperLiquidProvider_checkReferralSet() {
    try {
        ...
        __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.checkReferralSet'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'checkReferralSet', {
...
async function _HyperLiquidProvider_setReferralCode() {
    try {
        ...
        __classPrivateFieldGet(this, _HyperLiquidProvider_deps, "f").logger.error(ensureError(error, 'HyperLiquidProvider.setReferralCode'), __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getErrorContext).call(this, 'setReferralCode', {
            code: __classPrivateFieldGet(this, _HyperLiquidProvider_instances, "m", _HyperLiquidProvider_getReferralCode).call(this, __classPrivateFieldGet(this, _HyperLiquidProvider_clientService, "f").isTestnetMode()),
        }));
...
//# sourceMappingURL=HyperLiquidProvider.mjs.map