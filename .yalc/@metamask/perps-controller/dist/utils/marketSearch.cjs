...
exports.rankMarketsByQuery = exports.getMarketMatchRank = exports.MarketMatchRank = void 0;
/**
...
})(MarketMatchRank || (exports.MarketMatchRank = MarketMatchRank = {}));
/**
 ...
 * is empty/whitespace).
 */
function getMarketMatchRank(market, searchQuery) {
    if (!searchQuery?.trim()) {
        return null;
    }
...
exports.getMarketMatchRank = getMarketMatchRank;
/**
 ...
 */
function rankMarketsByQuery(markets, searchQuery) {
    if (!searchQuery?.trim()) {
        return markets;
    }
    const query = searchQuery.toLowerCase().trim();
...
exports.rankMarketsByQuery = rankMarketsByQuery;
//# sourceMappingURL=marketSearch.cjs.map