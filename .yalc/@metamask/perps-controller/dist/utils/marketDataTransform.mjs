...
import { HYPERLIQUID_CONFIG, getHyperLiquidAssetName } from "../constants/hyperLiquidConfig.mjs";
 ...
 */
export function calculateOpenInterestUSD(openInterest, currentPrice) {
...
function extractFundingData(params) {
    const { predictedFundings, symbol, exchangeName = HYPERLIQUID_CONFIG.ExchangeName, } = params;
    const result = {};
 ...
 */
export function transformMarketData(hyperLiquidData, formatters, assetMarketTypes, assetNames) {
 ...
 */
export function formatChange(change, formatters) {
...
//# sourceMappingURL=marketDataTransform.mjs.map