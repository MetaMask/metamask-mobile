 ...
 */
function addSpotBalanceToAccountState(accountState, spotState, options) {
...
function aggregateAccountStates(states) {
    const fallback = {
        spendableBalance: perpsConfig_js_1.PERPS_CONSTANTS.FallbackDataDisplay,
        withdrawableBalance: perpsConfig_js_1.PERPS_CONSTANTS.FallbackDataDisplay,
        totalBalance: perpsConfig_js_1.PERPS_CONSTANTS.FallbackDataDisplay,
        marginUsed: perpsConfig_js_1.PERPS_CONSTANTS.FallbackDataDisplay,
        unrealizedPnl: perpsConfig_js_1.PERPS_CONSTANTS.FallbackDataDisplay,
        returnOnEquity: perpsConfig_js_1.PERPS_CONSTANTS.FallbackDataDisplay,
    };
    if (states.length === 0) {
        return fallback;
    }
