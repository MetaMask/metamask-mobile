...
import { ensureError } from "./errorUtils.mjs";
/**
 ...
 * ```
 */
export const formatAccountToCaipAccountId = (address, chainId, logger) => {
    try {
 ...
 */
export const isCaipAccountId = (value) => {
 ...
 */
export const handleRewardsError = (error, logger, context) => {
...
//# sourceMappingURL=rewardsUtils.mjs.map