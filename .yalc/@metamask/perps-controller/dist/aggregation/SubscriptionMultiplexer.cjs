    ...
    subscribeToPrices(params) {
        ...
        for (const [providerId, provider] of providers) {
            try {
                ...
                __classPrivateFieldGet(this, _SubscriptionMultiplexer_logger, "f")?.error((0, errorUtils_js_1.ensureError)(error, 'SubscriptionMultiplexer.subscribeToPrices'), {
                    tags: {
    ...
    subscribeToPositions(params) {
        ...
        for (const [providerId, provider] of providers) {
            try {
                ...
                __classPrivateFieldGet(this, _SubscriptionMultiplexer_logger, "f")?.error((0, errorUtils_js_1.ensureError)(error, 'SubscriptionMultiplexer.subscribeToPositions'), {
                    tags: {
                        feature: perpsConfig_js_1.PERPS_CONSTANTS.FeatureName,
                        provider: providerId,
    ...
    subscribeToOrderFills(params) {
        ...
        for (const [providerId, provider] of providers) {
            try {
                ...
                __classPrivateFieldGet(this, _SubscriptionMultiplexer_logger, "f")?.error((0, errorUtils_js_1.ensureError)(error, 'SubscriptionMultiplexer.subscribeToOrderFills'), {
                    tags: {
                        feature: perpsConfig_js_1.PERPS_CONSTANTS.FeatureName,
                        provider: providerId,
    ...
    subscribeToOrders(params) {
        ...
        for (const [providerId, provider] of providers) {
            try {
                ...
                __classPrivateFieldGet(this, _SubscriptionMultiplexer_logger, "f")?.error((0, errorUtils_js_1.ensureError)(error, 'SubscriptionMultiplexer.subscribeToOrders'), {
                    tags: {
                        feature: perpsConfig_js_1.PERPS_CONSTANTS.FeatureName,
                        provider: providerId,
    ...
    subscribeToAccount(params) {
        ...
        for (const [providerId, provider] of providers) {
            try {
                ...
                __classPrivateFieldGet(this, _SubscriptionMultiplexer_logger, "f")?.error((0, errorUtils_js_1.ensureError)(error, 'SubscriptionMultiplexer.subscribeToAccount'), {
                    tags: {
                        feature: perpsConfig_js_1.PERPS_CONSTANTS.FeatureName,
                        provider: providerId,
