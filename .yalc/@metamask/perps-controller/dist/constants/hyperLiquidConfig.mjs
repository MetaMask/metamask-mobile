 ...
 */
export function canonicalizeHyperLiquidDexes(dexes) {
 ...
 */
export const HYPERLIQUID_ASSET_NAMES = {
 ...
 */
export function getHyperLiquidAssetName(symbol, names = HYPERLIQUID_ASSET_NAMES) {
