 ...
 */
export function getMYXHttpEndpoint(network) {
 ...
 * @returns Standard decimal number
 */
export function fromMYXSize(myxSize) {
 ...
 */
export function toMYXSize(size) {
    try {
 ...
 * @returns Standard decimal number
 */
export function fromMYXCollateral(myxCollateral) {
