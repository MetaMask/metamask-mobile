 ...
 */
export const getCandlePeriodsForDuration = (duration) => {
    const periods = DURATION_CANDLE_PERIODS[duration]?.periods || [];
    return periods;
};
/**
 ...
 */
export const getDefaultCandlePeriodForDuration = (duration) => DURATION_CANDLE_PERIODS[duration]?.default ||
 ...
 */
export const calculateCandleCount = (duration, candlePeriod) => {
...
//# sourceMappingURL=chartConfig.mjs.map