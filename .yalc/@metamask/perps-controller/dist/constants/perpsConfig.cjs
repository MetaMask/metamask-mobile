...
exports.buildProviderCacheKey = exports.getProviderNetworkKey = exports.ABSTRACTION_MODE_REFRESH_THROTTLE_MS = exports.PERPS_DISK_CACHE_THROTTLE_MS = exports.PERPS_DISK_CACHE_USER_DATA = exports.PERPS_DISK_CACHE_MARKETS = exports.PROVIDER_CONFIG = exports.FUNDING_RATE_CONFIG = exports.DEFAULT_PERPS_MODE = exports.DEFAULT_PRO_LAYOUT_PREFERENCES = exports.PerpsMode = exports.MARKET_SORTING_CONFIG = exports.DECIMAL_PRECISION_CONFIG = exports.TERMINAL_API_CONFIG = exports.SUBSCRIPTION_BENEFITS_CACHE = exports.DATA_LAKE_API_CONFIG = exports.MARGIN_ADJUSTMENT_CONFIG = exports.CLOSE_POSITION_CONFIG = exports.HYPERLIQUID_ORDER_LIMITS = exports.HYPERLIQUID_TWAP_LIMITS = exports.TP_SL_CONFIG = exports.PERFORMANCE_CONFIG = exports.MAX_ORDER_MARGIN_BUFFER = exports.MAX_SLIPPAGE_BOUNDS = exports.CHASE_ORDER_CONFIG = exports.ORDER_SLIPPAGE_CONFIG = exports.VALIDATION_THRESHOLDS = exports.WITHDRAWAL_CONSTANTS = exports.PERPS_CONSTANTS = exports.ZERO_BALANCE = exports.ZERO_ADDRESS = void 0;
/**
 ...
 */
exports.MAX_ORDER_MARGIN_BUFFER = 0.005; // 0.5%
/**
 ...
 */
exports.HYPERLIQUID_TWAP_LIMITS = {
 ...
 */
exports.SUBSCRIPTION_BENEFITS_CACHE = {
...
(function (PerpsMode) {
    PerpsMode["Lite"] = "lite";
    PerpsMode["Pro"] = "pro";
})(PerpsMode || (exports.PerpsMode = PerpsMode = {}));
/**
 ...
 */
exports.DEFAULT_PERPS_MODE = PerpsMode.Lite;
/**
 ...
 */
function getProviderNetworkKey(state) {
    return `${state.activeProvider ?? exports.PROVIDER_CONFIG.DefaultProvider}:${state.isTestnet ? 'testnet' : 'mainnet'}`;
}
exports.getProviderNetworkKey = getProviderNetworkKey;
/**
 ...
 * @returns Cache key in the format "provider:mainnet" or "provider:testnet".
 */
function buildProviderCacheKey(providerId, isTestnet) {
    let effectiveTestnet = isTestnet;
    if (providerId === 'myx') {
        effectiveTestnet = exports.PROVIDER_CONFIG.MYX_TESTNET_ONLY || isTestnet;
    }
    else if (providerId === 'lighter') {
        effectiveTestnet = exports.PROVIDER_CONFIG.LIGHTER_TESTNET_ONLY || isTestnet;
    }
    return `${providerId}:${effectiveTestnet ? 'testnet' : 'mainnet'}`;
}
exports.buildProviderCacheKey = buildProviderCacheKey;
