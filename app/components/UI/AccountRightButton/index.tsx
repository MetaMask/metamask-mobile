 ...
 */
const AccountRightButton = React.memo(
  ({ selectedAddress, onPress }: AccountRightButtonProps) => {
    ...
    const route =
      useRoute<RouteProp<Record<string, { url: string }>, string>>();
...
AccountRightButton.displayName = 'AccountRightButton';
