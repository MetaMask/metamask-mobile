export const MOCK_POOLED_STAKING_VAULT_DAILY_APYS = [
  {
    id: 30811,
    chain_id: 1,
    vault_address: '0xabc',
...
export const MOCK_POOLED_STAKING_VAULT_APYS_ONE_WEEK =
  MOCK_POOLED_STAKING_VAULT_DAILY_APYS.slice(-7);

export const MOCK_POOLED_STAKING_VAULT_APYS_ONE_MONTH =
  MOCK_POOLED_STAKING_VAULT_DAILY_APYS.slice(-30);

export const MOCK_POOLED_STAKING_VAULT_APYS_SIX_MONTHS =
  MOCK_POOLED_STAKING_VAULT_DAILY_APYS.slice(-90);

export const MOCK_POOLED_STAKING_VAULT_APYS_ONE_YEAR =
  MOCK_POOLED_STAKING_VAULT_DAILY_APYS.slice(-365);

export const MOCK_POOLED_STAKING_VAULT_APY_AVERAGES = {
