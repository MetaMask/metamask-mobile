...
import BenefitPreviewCard from './BenefitPreviewCard';
...
describe('BenefitPreviewCard', () => {
  ...
  describe('rendering', () => {
    it('renders title and description text', () => {
      ...
      const { getByText } = render(<BenefitPreviewCard benefit={benefit} />);
    ...
    it('renders the company name in the remaining-time row', () => {
      ...
      const { getByTestId } = render(<BenefitPreviewCard benefit={benefit} />);
      const footer = within(
        getByTestId(
    ...
    it('does not render an empty company label when companyName is null', () => {
      ...
      const { queryByText } = render(<BenefitPreviewCard benefit={benefit} />);
    ...
    it('uses a unique image testID per benefit id', () => {
      ...
      const { getByTestId } = render(
        <>
          <BenefitPreviewCard benefit={firstBenefit} />
          <BenefitPreviewCard benefit={secondBenefit} />
        </>,
      );
    ...
    it('sizes the card so the next one peeks in the carousel', () => {
      const benefit = createBenefit();
      render(<BenefitPreviewCard benefit={benefit} />);
  ...
  describe('interaction', () => {
    ...
    it('uses expected touchable activeOpacity', () => {
      ...
      const { UNSAFE_getByType } = render(
        <BenefitPreviewCard benefit={benefit} />,
      );
