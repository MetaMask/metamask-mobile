...
/**
 * Gap between consecutive bars, so the four rows read as a single
 * top-to-bottom wave rather than four bars filling at once. Same cadence as
 * the Money sheet entrance wave.
 */
