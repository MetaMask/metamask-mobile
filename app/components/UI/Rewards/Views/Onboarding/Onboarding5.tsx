    ...
    <SafeAreaView style={tw.style('flex-1 bg-default')}>
      ...
      <Box alignItems={BoxAlignItems.Center} twClassName="flex-1 px-4 mt-2">
        ...
        <Text variant={TextVariant.HeadingLg} twClassName="text-center mb-6">
          {strings('rewards.onboarding.unlocked_points')}
        </Text>
          ...
          >
            ...
            >
              <Text variant={TextVariant.BodyMd} twClassName="text-alternative">
                {strings('rewards.onboarding.signup_bonus')}
              </Text>
              <Box
                flexDirection={BoxFlexDirection.Row}
                alignItems={BoxAlignItems.Center}
              ...
              >
                <Text variant={TextVariant.BodyMd} twClassName="font-bold">
                  {strings('rewards.onboarding.points_amount')}
                </Text>
              </Box>
            </Box>
            {referralCodeIsValid && (
              ...
              >
                ...
                >
                  {strings('rewards.onboarding.referral_bonus')}
                </Text>
                <Box
                  flexDirection={BoxFlexDirection.Row}
                  alignItems={BoxAlignItems.Center}
      ...
      <Box twClassName="p-4">
        ...
        >
          {strings('rewards.onboarding.claim_points')}
        </Button>
        <Text
          variant={TextVariant.BodySm}
          twClassName="text-alternative text-center mt-3"
        >
          {strings('rewards.onboarding.join_disclaimer')}{' '}
          <Text variant={TextVariant.BodySm} twClassName="text-primary-default">
            {strings('rewards.onboarding.learn_more')}
          </Text>
        </Text>
      </Box>
    </SafeAreaView>
