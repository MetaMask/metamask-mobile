...
describe('OndoCampaignStatsView', () => {
  ...
  it('shows the winner banner and navigates to the winning view when the user is a top-5 qualifier', () => {
  ...
  it('uses the route campaign name on the winner banner when the campaign is not in the store', () => {
    mockRewardsState.campaigns = [];
    globalThis.__ONDO_CAMPAIGN_STATS_TEST_ROUTE__ = {
      campaignId: 'campaign-ondo-123',
