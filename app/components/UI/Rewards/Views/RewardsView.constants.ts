...
export const REWARDS_VIEW_SELECTORS = {
  ...
  // Drops
  TAB_CONTENT_DROPS: 'rewards-view-tab-content-drops',
  DROPS_SECTION: 'rewards-view-drops-section',
  DROPS_ACTIVE_SECTION: 'rewards-view-drops-active-section',
  DROPS_UPCOMING_SECTION: 'rewards-view-drops-upcoming-section',
  DROPS_PREVIOUS_SECTION: 'rewards-view-drops-previous-section',
} as const;
