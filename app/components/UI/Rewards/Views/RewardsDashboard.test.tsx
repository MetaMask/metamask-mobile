...
jest.mock('../hooks/useRewardsSyncWithEngine', () => ({
  useRewardsSyncWithEngine: () => mockUseRewardsSyncWithEngine(),
}));
...
describe('RewardsView', () => {
  ...
  it('should handle referral button press', () => {
    const { getByTestId } = renderComponent();

    const referralButton = getByTestId(REWARDS_VIEW_SELECTORS.REFERRAL_BUTTON);
    fireEvent.press(referralButton);

    expect(mockNavigate).toHaveBeenCalledWith('ReferralRewardsView');
  });
