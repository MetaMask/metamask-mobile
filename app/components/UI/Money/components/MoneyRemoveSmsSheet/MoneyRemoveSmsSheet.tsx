...
const MoneyRemoveSmsSheet = () => {
  ...
  return (
    <BottomSheet
      ...
      testID={MoneyRemoveSmsSheetTestIds.CONTAINER}
    >
      <Box style={styles.content}>
        ...
        <Box alignItems={BoxAlignItems.Center} twClassName="px-2 pt-6 gap-4">
          ...
          >
            {strings(
              canRemove
                ? 'money.sms_details.remove_title'
                : 'money.sms_details.cannot_remove_title',
            )}
          </Text>
          <Text
          ...
          >
            {strings(
              canRemove
                ? 'money.sms_details.remove_description'
                : 'money.sms_details.cannot_remove_description',
            )}
          </Text>
        </Box>
        ...
        {canRemove ? (
          <Box gap={3} twClassName="mt-6">
            <Button
              ...
              testID={MoneyRemoveSmsSheetTestIds.CONFIRM_BUTTON}
            ...
            >
              ...
              >
                {strings('money.sms_details.confirm_remove')}
              </Text>
            </Button>
            <Button
              ...
              isFullWidth
              onPress={closeSheet}
              testID={MoneyRemoveSmsSheetTestIds.CANCEL_BUTTON}
...
export default MoneyRemoveSmsSheet;
