...
const MoneySecurityVerificationView = () => {
  const navigation = useNavigation<AppNavigationProp>();
  const route =
    useRoute<
      RouteProp<MoneyNavigationParamList, 'MoneySecurityVerification'>
    >();
  ...
  const handleBack = useCallback(() => {
    ...
    navigation.goBack();
  }, [availableMethods.length, navigation, selectedMethod]);
  ...
  const handlePasskeyVerification = useCallback(() => {
  ...
  useEffect(() => {
    if (selectedMethod === 'passkey' || !selectedMethod || code.length !== 6) {
      return undefined;
    }
  ...
  const codeDescription =
    selectedMethod === 'sms'
      ? strings('money.security.sms_code_description')
      : strings('money.security.authenticator_code_description');

  return (
    <Box
      style={[styles.root, { paddingTop: insets.top }]}
      twClassName="bg-default"
      testID={MoneySecurityVerificationViewTestIds.CONTAINER}
    >
      <Box
        flexDirection={BoxFlexDirection.Row}
        alignItems={BoxAlignItems.Center}
      ...
      >
        ...
        >
          {!selectedMethod ? (
              ...
              <Box twClassName="mt-6 gap-3">
                {availableMethods.includes('passkey') && (
                  <MethodButton
                    ...
                    testID={MoneySecurityVerificationViewTestIds.PASSKEY_METHOD}
                  />
                )}
                {availableMethods.includes('authenticator') && (
                  <MethodButton
                    ...
                    testID={
                      MoneySecurityVerificationViewTestIds.AUTHENTICATOR_METHOD
                    }
                  />
                )}
                {availableMethods.includes('sms') && (
                  <MethodButton
                    ...
                    testID={MoneySecurityVerificationViewTestIds.SMS_METHOD}
                  />
                )}
              </Box>
            </>
            ...
            <>
              <Box alignItems={BoxAlignItems.Center} twClassName="mt-8 gap-4">
                <Icon
              ...
              <Button
                ...
                onPress={handlePasskeyVerification}
                testID={
                  MoneySecurityVerificationViewTestIds.PASSKEY_VERIFY_BUTTON
                }
                twClassName="mt-8"
              >
            ...
            <>
              ...
              >
                ...
                <TextInput
                  ...
                  autoFocus
                  caretHidden
                  testID={MoneySecurityVerificationViewTestIds.CODE_INPUT}
...
export default MoneySecurityVerificationView;
