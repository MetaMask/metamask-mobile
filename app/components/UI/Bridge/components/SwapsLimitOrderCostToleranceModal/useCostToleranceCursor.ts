...
interface UseCostToleranceCursorParams {
  value: string;
...
interface UseCostToleranceCursorResult {
  selection?: {
    start: number;
    end: number;
  };
...
export const useCostToleranceCursor = ({
  value,
  inputMaxDecimals,
  maxAmount,
  onValueChange,
  onAttemptExceedMaxChange,
}: UseCostToleranceCursorParams): UseCostToleranceCursorResult => {
