export const OpenLimitOrderDetailsModalSelectorsIDs = {
  SHEET: 'open-order-details-modal',
  CLOSE_BUTTON: 'open-order-details-modal-close',
  STATUS: 'open-order-details-modal-status',
