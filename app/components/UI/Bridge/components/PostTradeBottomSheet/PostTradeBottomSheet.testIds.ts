export const PostTradeBottomSheetTestIds = {
  SHEET: 'post-trade-bottom-sheet',
  CLOSE_BUTTON: 'post-trade-bottom-sheet-close-button',
  STATUS_ICON: 'post-trade-bottom-sheet-status-icon',
  TITLE: 'post-trade-bottom-sheet-title',
  SUBTITLE: 'post-trade-bottom-sheet-subtitle',
