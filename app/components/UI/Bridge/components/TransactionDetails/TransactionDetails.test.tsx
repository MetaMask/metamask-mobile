...
describe('BridgeTransactionDetails', () => {
  ...
  it('renders the layout (You sent/received, Transaction ID, explorer, do-it-again)', () => {
  ...
  it('copies the transaction id via the shared copy control', () => {
    ...
    // Reuses the shared ActivityDetailsTransactionId copy control.
