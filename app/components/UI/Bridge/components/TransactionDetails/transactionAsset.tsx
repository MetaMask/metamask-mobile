...
const TransactionAsset = ({ token, tokenAmount, chainId }: TransactionAssetProps) => {
  const styles = createStyles();
  const networkName = NETWORK_TO_SHORT_NETWORK_NAME_MAP[chainId as AllowedBridgeChainIds];
