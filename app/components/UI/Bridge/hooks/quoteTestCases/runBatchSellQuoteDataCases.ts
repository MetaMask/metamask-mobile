...
export const uniToken: BridgeToken = {
...
export const runBatchSellQuoteDataCases = (
  render: () => {
    result: { current: ReturnType<typeof useBatchSellQuoteData> };
    ...
    it(
      ...
      () => {
        ...
        expect(
          ...
          [mockBatchSellQuotes.recommendedQuotes[0]],
          false,
        );
        expect(result.current.tokenData[uniAssetId]).toEqual(
          expect.objectContaining({
