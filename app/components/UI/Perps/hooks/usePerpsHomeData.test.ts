...
const createMockOrderFill = (overrides: Partial<OrderFill> = {}): OrderFill => ({
    orderId: 'fill-123',
    symbol: 'ETH',
    side: 'buy',
    price: '3000',
...
describe('usePerpsHomeData', () => {
    ...
    beforeEach(() => {
        ...
        mockMarkets = [
            createMockMarket({ symbol: 'BTC', name: 'Bitcoin', volume: '$1.2B', volumeNumber: 1200000000 }),
            createMockMarket({ symbol: 'ETH', name: 'Ethereum', volume: '$900M', volumeNumber: 900000000 }),
            createMockMarket({ symbol: 'SOL', name: 'Solana', volume: '$500M', volumeNumber: 500000000 }),
        ];
        ...
        mockUsePerpsLiveFills.mockReturnValue(mockFills);
    ...
    describe('Initial state and data loading', () => {
        it('returns initial data from all sources', () => {
            ...
            expect(result.current.trendingMarkets).toEqual(mockMarkets);
        ...
        it('applies default limits to data', () => {
            ...
            mockUsePerpsLiveOrders.mockReturnValue(manyOrders);
            mockUsePerpsLiveFills.mockReturnValue(manyFills);
    ...
    describe('Trending markets sorting', () => {
        ...
        it('applies trendingLimit to sorted markets', () => {
            ...
            expect(result.current.trendingMarkets).toHaveLength(3);
        });
    ...
    describe('Search filtering', () => {
        ...
        it('searches all markets when search query present', () => {
            ...
            expect(result.current.trendingMarkets).toHaveLength(1);
            expect(result.current.trendingMarkets[0].symbol).toBe('DOGE');
        });
        ...
        it('shows top trending markets when search query is empty', () => {
            ...
            expect(result.current.trendingMarkets).toHaveLength(2);
        });
    ...
    describe('Edge cases', () => {
        ...
        it('handles empty markets array', () => {
            ...
            expect(result.current.trendingMarkets).toEqual([]);
            expect(result.current.watchlistMarkets).toEqual([]);
        });
    ...
    describe('Data reactivity', () => {
        ...
        it('updates when orders change', () => {
            ...
            mockUsePerpsLiveOrders.mockReturnValue(newOrders);
        ...
        it('updates when markets change', () => {
            ...
            expect(result.current.trendingMarkets).toEqual(newMarkets);
        });
    ...
    describe('Combined scenarios', () => {
        ...
        it('handles all parameters together', () => {
            ...
            expect(result.current.trendingMarkets.length).toBeLessThanOrEqual(1);
