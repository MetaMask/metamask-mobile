...
describe('usePerpsOrderFees - Maker/Taker Determination', () => {
  ...
  describe('Edge Cases - Stale Price', () => {
    it('defaults to taker when price data is older than 5 seconds', async () => {
      const mockTakerFeeResult: FeeCalculationResult = {
        feeRate: 0.00045,
        feeAmount: 45,
        protocolFeeRate: 0.00045,
    ...
    it('uses normal maker logic when price is within 5 seconds', async () => {
      const mockMakerFeeResult: FeeCalculationResult = {
        feeRate: 0.00015,
        feeAmount: 15,
        protocolFeeRate: 0.00015,
    ...
    it('uses normal maker logic when no timestamp provided', async () => {
      const mockMakerFeeResult: FeeCalculationResult = {
        feeRate: 0.00015,
        feeAmount: 15,
        protocolFeeRate: 0.00015,
