...
const transakPhoneRegisteredError = {
  errorCode: '2020',
  apiMessage: 'Phone registered with t***@test.com',
  message:
    'Fetching \'https://api.transak.com/user\' failed with status \'400\': {"error":{"errorCode":2020,"message":"Phone registered with t***@test.com"}}',
};
