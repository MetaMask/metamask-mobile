...
export const TRANSAK_TERMS_URL = 'https://www.transak.com/terms-of-use';
export const CONSENSYS_PRIVACY_POLICY_URL =
  'https://consensys.net/privacy-policy';

export const TRANSAK_TERMS_URL_US = 'https://www.transak.com/terms-of-service-us';
export const TRANSAK_TERMS_URL_WORLD = 'https://www.transak.com/terms-of-service';
