...
export const DEPOSIT_DEV_PREVIEW_SCREENS: DepositDevPreviewScreen[] = [
  ...
  {
    label: 'Bank details',
    description: 'Seeds a CREATED deposit order in Redux.',
  ...
  },
  {
    ...
    description: 'Seeds a PENDING deposit order in Redux.',
  ...
  },
  {
    ...
    description: 'Seeds a COMPLETED deposit order in Redux.',
