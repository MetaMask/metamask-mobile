...
import OrderProcessing from './Deposit/Views/OrderProcessing/OrderProcessing';
import KycProcessing from './Deposit/Views/KycProcessing/KycProcessing';
import BasicInfo from './Deposit/Views/BasicInfo/BasicInfo';
import VerifyIdentity from './Deposit/Views/VerifyIdentity/VerifyIdentity';
import BankDetails from './Deposit/Views/BankDetails/BankDetails';
import AdditionalVerification from './Deposit/Views/AdditionalVerification/AdditionalVerification';
...
const MainRoutes = () => (
  ...
  >
    ...
    <Stack.Screen name={Routes.RAMP.ORDER_PROCESSING} component={OrderProcessing} />
    <Stack.Screen name={Routes.RAMP.KYC_PROCESSING} component={KycProcessing} />
    <Stack.Screen name={Routes.RAMP.BASIC_INFO} component={BasicInfo} />
    <Stack.Screen name={Routes.RAMP.VERIFY_IDENTITY} component={VerifyIdentity} />
    <Stack.Screen name={Routes.RAMP.BANK_DETAILS} component={BankDetails} />
    <Stack.Screen name={Routes.RAMP.ADDITIONAL_VERIFICATION} component={AdditionalVerification} />
    <Stack.Screen
