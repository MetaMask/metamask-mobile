...
jest.mock('../../../../../component-library/components/BottomSheets/BottomSheet/BottomSheet', () => {
  ...
  return {
    ...
    default: ReactMock.forwardRef(({ children, onClose }: any, ref: any) => {
      ...
      return ReactMock.createElement(View, { testID: 'mock-bottom-sheet' }, children);
    }),
  };
});
...
jest.mock('../../../../../component-library/components/BottomSheets/BottomSheetHeader/BottomSheetHeader', () => {
  ...
  return {
    ...
    default: ({ children, onClose, ...props }: any) =>
      ReactMock.createElement(View, { testID: 'header', ...props },
        children,
        ReactMock.createElement(View, { testID: 'header-close', onPress: onClose }),
      ),
  };
});

jest.mock('../../../../../component-library/components/BottomSheets/BottomSheetFooter/BottomSheetFooter', () => {
  const ReactMock = require('react');
  ...
  return {
    ...
    default: ({ onPress, buttonLabel, buttonPropsArray, ...props }: any) => {
      ...
      return ReactMock.createElement(View, { testID: 'bottomsheetfooter', ...props },
        ReactMock.createElement(TouchableOpacity, { testID: 'bottomsheetfooter-button', onPress: handlePress },
