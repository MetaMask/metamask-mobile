...
describe('usePredictPositions', () => {
  ...
  describe('optimistic position auto-refresh', () => {
    it('enables auto-refresh when optimistic position is detected', async () => {
      ...
      mockGetPositions.mockResolvedValue([optimisticPosition]);
    ...
    it('disables auto-refresh when optimistic positions are resolved', async () => {
      const optimisticPosition = {
        providerId: 'p1',
        marketId: 'm1',
        outcomeId: 'o1',
      ...
      const resolvedPosition = { ...optimisticPosition, optimistic: false };
      mockGetPositions.mockResolvedValueOnce([optimisticPosition]);
      ...
      mockGetPositions.mockResolvedValueOnce([resolvedPosition]);
      mockGetPositions.mockClear();
    ...
    it('does not enable auto-refresh for optimistic positions when user has set timeout', async () => {
      const optimisticPosition = {
        providerId: 'p1',
        marketId: 'm1',
        outcomeId: 'o1',
    ...
    it('does not disable auto-refresh when user has set timeout even without optimistic positions', async () => {
      const position = {
        providerId: 'p1',
        marketId: 'm1',
        outcomeId: 'o1',
    ...
    it('does not enable auto-refresh for claimable positions with optimistic flag', async () => {
      const optimisticPosition = {
        providerId: 'p1',
        marketId: 'm1',
        outcomeId: 'o1',
    ...
    it('maintains auto-refresh when optimistic position remains present', async () => {
      const optimisticPosition = {
        providerId: 'p1',
        marketId: 'm1',
        outcomeId: 'o1',
    ...
    it('enables auto-refresh when at least one position is optimistic among multiple positions', async () => {
      const positions = [
        {
          providerId: 'p1',
          marketId: 'm1',
