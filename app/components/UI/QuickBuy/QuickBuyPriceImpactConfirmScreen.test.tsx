...
jest.mock('../Bridge/components/PriceImpactModal/PriceImpactHeader', () => ({
...
jest.mock('../Bridge/components/PriceImpactModal/PriceImpactFooter', () => ({
...
jest.mock('../Bridge/hooks/usePriceImpactFiat', () => ({
...
describe('QuickBuyPriceImpactConfirmScreen', () => {
  ...
  it('passes loading=true to the footer while handleConfirm is in-flight', async () => {
    ...
    const { PriceImpactFooter } = jest.requireMock(
      '../Bridge/components/PriceImpactModal/PriceImpactFooter',
