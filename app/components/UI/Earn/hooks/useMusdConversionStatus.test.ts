  ...
  describe('non-mUSD conversion transactions', () => {
    it('ignores transaction when type is not mUSD conversion', () => {
      ...
      const transactionMeta = createTransactionMeta(
        TransactionStatus.submitted,
        'test-transaction-5',
        'contractInteraction' as typeof EVM_TOKEN_CONVERSION_TRANSACTION_TYPE,
      );
    ...
    it('ignores transaction when type is swap', () => {
      ...
      const transactionMeta = createTransactionMeta(
        TransactionStatus.confirmed,
        'test-transaction-6',
        'swap' as typeof EVM_TOKEN_CONVERSION_TRANSACTION_TYPE,
      );
    ...
    it('ignores transaction when type is simpleSend', () => {
      ...
      const transactionMeta = createTransactionMeta(
        TransactionStatus.failed,
        'test-transaction-7',
        'simpleSend' as typeof EVM_TOKEN_CONVERSION_TRANSACTION_TYPE,
      );
