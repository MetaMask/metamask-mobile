...
import MultichainAccountsConnectedList from '../../Views/AccountConnect/AccountsConnectedList/MultichainAccountsConnectedList';
...
const MultichainPermissionsSummary = ({
  ...
  const getAccountLabel = useCallback(() => {
    ...
    return strings('permissions.requesting_for_accounts', {
      numberOfAccounts: accountGroups.length,
    });
  }, [accountGroups, isAlreadyConnected]);
  ...
  const renderAccountsConnectedList = useCallback(
    ...
    [accountGroups, privacyMode, networkAvatars, handleEditAccountsButtonPress],
  );
