...
export interface TransactionActivityEmptyStateProps
  extends TabEmptyStateProps {}

export const TransactionActivityEmptyState: React.FC<
  TransactionActivityEmptyStateProps
> = (props) => {
  const activityImage = useAssetFromTheme(
    emptyStateActivityLight,
    emptyStateActivityDark,
  );
