...
/**
 * Reactive subscription to the raw stored watchlist asset IDs. Optimistic
 * add/remove mutations update the shared blob cache, so the returned list
 * reflects changes immediately. Returns `[]` until the blob has loaded.
 */
