...
const AccountGroupBalance = ({
  ...
  // Deriving the array from the joined key keeps the memo body dependent only on
  // `popularChainIdsKey`, so it stays content-stable without suppressing react-hooks/exhaustive-deps.
