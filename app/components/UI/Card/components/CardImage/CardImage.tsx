...
const VirtualCardImage = (props: SvgProps & { address?: string | null }) => (
...
const MetalCardImage = (props: SvgProps & { address?: string | null }) => (
  <View style={{ aspectRatio: cardImageAspectRatio }}>
    <Svg
      fill="none"
      width="100%"
...
const CardImage = (props: CardImageProps) => {
  ...
  const address = rawAddress ? truncateAddress(rawAddress) : null;
