...
import type { CardSensitiveDetails } from '../../../../../core/Engine/controllers/card-controller/provider-types';

export interface CardSecureDetailsViewProps {
  isLoading?: boolean;
...
export default CardSecureDetailsView;
