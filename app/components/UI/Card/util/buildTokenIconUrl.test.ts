...
describe('buildTokenIconUrl', () => {
  ...
  it('should work with BSC mainnet', () => {
    ...
    const expected = `https://static.cx.metamask.io/api/v2/tokenIcons/assets/eip155/56/erc20/${address}.png`;
  ...
  it('should work with Arbitrum One', () => {
    ...
    const expected = `https://static.cx.metamask.io/api/v2/tokenIcons/assets/eip155/42161/erc20/${address}.png`;
