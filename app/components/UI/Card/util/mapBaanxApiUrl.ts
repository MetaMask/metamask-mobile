 ...
 * When not Bitrise and not E2E (GitHub Actions / local), uses process.env.BAANX_API_URL (set by builds.yml).
 * When Bitrise or E2E, uses AppConstants.BAANX_API_URL per METAMASK_ENVIRONMENT.
 */
