...
import { AlignItems, Display, FlexDirection, JustifyContent, TextAlign } from '../SnapUIRenderer/utils';
  ...
  extra,
    ...
    >
      ...
      >
        ...
        {extra && (
          <Text color={TextColor.Alternative} numberOfLines={1} ellipsizeMode="tail">
            {extra}
          </Text>
        )}
      </Box>
