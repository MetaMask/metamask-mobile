...
import styleSheet from './VerifyIdentityLoading.styles';
...
export const createVerifyIdentityLoadingNavDetails = createNavigationDetails(
  Routes.DEPOSIT.VERIFY_IDENTITY,
);

const VerifyIdentityLoading = () => {
    ...
    <ScreenLayout>
      <ScreenLayout.Body>
        <ScreenLayout.Content grow>
          <DepositProgressBar steps={4} currentStep={4} />
...
export default VerifyIdentityLoading;
