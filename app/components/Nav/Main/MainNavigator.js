...
import AddBookmark from '@components/Views/AddBookmark';
import SimpleWebview from '@components/Views/SimpleWebview';
import Settings from '@components/Views/Settings';
import GeneralSettings from '@components/Views/Settings/GeneralSettings';
import AdvancedSettings from '@components/Views/Settings/AdvancedSettings';
import SecuritySettings from '@components/Views/Settings/SecuritySettings';
import ExperimentalSettings from '@components/Views/Settings/ExperimentalSettings';
import NetworksSettings from '@components/Views/Settings/NetworksSettings';
import NotificationsSettings from '@components/Views/Settings/NotificationsSettings';
import NotificationsView from '@components/Views/Notifications';
import NotificationsDetails from '@components/Views/Notifications/Details';
import OptIn from '@components/Views/Notifications/OptIn';
import AppInformation from '@components/Views/Settings/AppInformation';
import DeveloperOptions from '@components/Views/Settings/DeveloperOptions';
import Contacts from '@components/Views/Settings/Contacts';
...
import Collectible from '@components/Views/Collectible';
import Send from '@components/Views/confirmations/Send';
import SendTo from '@components/Views/confirmations/SendFlow/SendTo';
import { RevealPrivateCredential } from '@components/Views/RevealPrivateCredential';
import WalletConnectSessions from '@components/Views/WalletConnectSessions';
import OfflineMode from '@components/Views/OfflineMode';
import QRTabSwitcher from '@components/Views/QRTabSwitcher';
import EnterPasswordSimple from '@components/Views/EnterPasswordSimple';
...
import PaymentRequest from '@components/UI/PaymentRequest';
import PaymentRequestSuccess from '@components/UI/PaymentRequestSuccess';
import Amount from '@components/Views/confirmations/SendFlow/Amount';
import Confirm from '@components/Views/confirmations/SendFlow/Confirm';
import ContactForm from '@components/Views/Settings/Contacts/ContactForm';
import ActivityView from '@components/Views/ActivityView';
import SwapsAmountView from '@components/UI/Swaps';
import SwapsQuotesView from '@components/UI/Swaps/QuotesView';
import CollectiblesDetails from '@components/UI/CollectibleModal';
import OptinMetrics from '@components/UI/OptinMetrics';
import Drawer from '@components/UI/Drawer';

import RampRoutes from '@components/UI/Ramp/routes';
import { RampType } from '@components/UI/Ramp/types';
import RampSettings from '@components/UI/Ramp/Views/Settings';
import RampActivationKeyForm from '@components/UI/Ramp/Views/Settings/ActivationKeyForm';

import { colors as importedColors } from '@styles/common';
import OrderDetails from '@components/UI/Ramp/Views/OrderDetails';
import SendTransaction from '@components/UI/Ramp/Views/SendTransaction';
import TabBar from '@component-library/components/Navigation/TabBar';
import BrowserUrlModal from '@components/Views/BrowserUrlModal';
///: BEGIN:ONLY_INCLUDE_IF(external-snaps)
import { SnapsSettingsList } from '@components/Views/Snaps/SnapsSettingsList';
import { SnapSettings } from '@components/Views/Snaps/SnapSettings';
///: END:ONLY_INCLUDE_IF
...
import SDKSessionsManager from '@components/Views/SDK/SDKSessionsManager/SDKSessionsManager';
import PermissionsManager from '@components/Views/Settings/PermissionsSettings/PermissionsManager';
import URL from 'url-parse';
import Logger from '@util/Logger';
import { getDecimalChainId } from '@util/networks';
import { useMetrics } from '@components/hooks/useMetrics';
import DeprecatedNetworkDetails from '@components/UI/DeprecatedNetworkModal';
import ConfirmAddAsset from '@components/UI/ConfirmAddAsset';
import { AesCryptoTestForm } from '@components/Views/AesCryptoTestForm';
import { isTest } from '@util/test/utils';
import { selectPermissionControllerState } from '@selectors/snaps/permissionController';
import NftDetails from '@components/Views/NftDetails';
import NftDetailsFullImage from '@components/Views/NftDetails/NFtDetailsFullImage';
import AccountPermissions from '@components/Views/AccountPermissions';
import { AccountPermissionsScreens } from '@components/Views/AccountPermissions/AccountPermissions.types';
import { StakeModalStack, StakeScreenStack } from '@components/UI/Stake/routes';
