...
import InstallSnapConnectionRequest from '@components/Approvals/InstallSnapApproval/components/InstallSnapConnectionRequest/InstallSnapConnectionRequest';
import {
  SNAP_INSTALL_CANCEL,
