...
describe('prepareEVMTransaction', () => {
  ...
  it('prepares transaction for ERC1155 NFT token', () => {
    expect(
      ...
      data: '',
      from: '0x123',
      to: '0x123',
      value: '0x0',
    });
