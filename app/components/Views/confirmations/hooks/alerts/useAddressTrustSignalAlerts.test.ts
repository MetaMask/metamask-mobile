...
describe('useAddressTrustSignalAlerts', () => {
  ...
  it('scans multiple addresses (recipient and spender) for approval transactions', () => {
    // ERC20 approve function selector (0x095ea7b3) + spender address + amount
    const approveData =
  ...
  it('returns multiple alerts when multiple addresses are malicious', () => {
    const approveData =
      '0x095ea7b3000000000000000000000000abcdef1234567890abcdef1234567890abcdef12ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff';
