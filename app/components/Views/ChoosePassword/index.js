...
class ChoosePassword extends PureComponent {
  ...
  onPressCreate = async () => {
    ...
    metrics.trackEvent(MetaMetricsEvents.WALLET_CREATION_ATTEMPTED);
    ...
    try {
      ...
      metrics.trackEvent(MetaMetricsEvents.WALLET_CREATED, {
        biometrics_enabled: Boolean(this.state.biometryType),
      });
      metrics.trackEvent(MetaMetricsEvents.WALLET_SETUP_COMPLETED, {
      ...
      metrics.trackEvent(MetaMetricsEvents.WALLET_SETUP_FAILURE, {
        wallet_setup_type: 'new',
