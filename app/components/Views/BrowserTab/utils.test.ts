...
describe('BrowserTab utils', () => {
  ...
  describe('resolveCommittedDocumentUrl', () => {
    ...
    it('returns the native WebView URL when the page reports a URL with a disallowed explicit port', () => {
      const nativeUrl = 'https://attacker.example/poc';
      const pageReportedUrl = 'https://metamask.io:8443';
    ...
    it('returns the native WebView URL when the page-reported URL uses userinfo to impersonate another host', () => {
      const nativeUrl = 'https://attacker.example/poc';
      const pageReportedUrl = 'https://attacker.example@metamask.io/';
    ...
    it('returns null when the native WebView URL has a disallowed explicit port', () => {
      const nativeUrl = 'https://metamask.io:8443';
      const pageReportedUrl = 'https://metamask.io:8443';
    ...
    it('returns null when origin mismatches and the native WebView URL has a disallowed explicit port', () => {
      const nativeUrl = 'https://metamask.io:8443';
      const pageReportedUrl = 'https://attacker.example/poc';
