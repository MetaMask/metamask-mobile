 ...
 */
const BrowserTabPure: React.FC<BrowserTabProps> = ({
  id: tabId,
  ...
  useEffect(() => {
    ...
    const getEntryScriptWeb3 = async () => {
      ...
      setEntryScriptWeb3(
        entryScriptWeb3Fetched + SPA_urlChangeListener + SCROLL_TRACKER_SCRIPT,
      );
    };
...
export const BrowserTab = React.memo(BrowserTabPure);
