...
const renderSRPQuiz = (
  ...
  (useRoute as jest.Mock).mockReturnValue({ params: { keyringId } });
...
describe('SRPQuiz', () => {
  ...
  it('navigates to the learn more article of social login when the learn more button is pressed', async () => {
    const keyringId = '123';
