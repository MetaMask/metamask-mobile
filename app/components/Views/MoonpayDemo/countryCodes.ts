 ...
 *
 * The `GeolocationController` returns ISO 3166-2 codes whose leading segment
 * is an alpha-2 country code (e.g. "US", "US-NY"). The MoonPay Identity API
 * (disclaimers, kyc-required, identities) expects alpha-3 codes (e.g. "USA").
