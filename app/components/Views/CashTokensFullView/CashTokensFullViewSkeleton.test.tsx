...
describe('CashTokensFullViewSkeleton', () => {
  ...
  it('renders a single token row skeleton when user has mUSD on one chain', () => {
    render(<CashTokensFullViewSkeleton numChainsWithMusdBalance={1} />);
