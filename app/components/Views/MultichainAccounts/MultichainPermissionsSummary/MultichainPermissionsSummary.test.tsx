...
describe('MultichainPermissionsSummary', () => {
  ...
  it('filters out network avatars without imageSource', () => {
    const networkAvatarsWithMissingImages = [
      {
        name: 'Ethereum Mainnet',
        imageSource: { uri: 'test-network-avatar.png' },
        size: AvatarSize.Xs,
    ...
    const { getByTestId } = renderMultichainPermissionsSummary({
      networkAvatars: networkAvatarsWithMissingImages,
    });
  ...
  it('renders without errors when all network avatars are missing imageSource', () => {
    const networkAvatarsWithoutImages = [
      {
        name: 'Ethereum Mainnet',
        imageSource: undefined,
        size: AvatarSize.Xs,
    ...
    const { getByTestId } = renderMultichainPermissionsSummary({
      networkAvatars: networkAvatarsWithoutImages,
    });
  ...
  it('renders network avatars when all have valid imageSource', () => {
    const networkAvatarsWithImages = [
      {
        name: 'Ethereum Mainnet',
        imageSource: { uri: 'test-ethereum.png' },
        size: AvatarSize.Xs,
        variant: AvatarVariant.Network,
        caipChainId: 'eip155:1' as CaipChainId,
      },
      {
        name: 'Polygon',
        imageSource: { uri: 'test-polygon.png' },
        size: AvatarSize.Xs,
        variant: AvatarVariant.Network,
        caipChainId: 'eip155:137' as CaipChainId,
      },
      {
        name: 'Arbitrum',
        imageSource: { uri: 'test-arbitrum.png' },
        size: AvatarSize.Xs,
        variant: AvatarVariant.Network,
        caipChainId: 'eip155:42161' as CaipChainId,
      },
    ...
    const { getByTestId } = renderMultichainPermissionsSummary({
      networkAvatars: networkAvatarsWithImages,
    });
