...
export const WalletViewSelectorsIDs = {
  ...
  WALLET_DISCOVERY_TAB_PORTFOLIO: 'wallet-discovery-tab-portfolio',
  WALLET_DISCOVERY_TAB_PERPS: 'wallet-discovery-tab-perps',
  WALLET_DISCOVERY_TAB_PREDICTIONS: 'wallet-discovery-tab-predictions',
