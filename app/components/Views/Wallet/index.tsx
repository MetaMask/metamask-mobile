...
import { debugCaptureSnapshot } from '../../../util/analytics/appInstallEvent';
import {
    ...
    <View style={debugStyles.container}>
      <Text style={debugStyles.text}>
        {[
          ...
          '',
          'captureSnapshot (this session):',
          JSON.stringify(debugCaptureSnapshot, null, 2),
          '',
          'getLatestReferringParams (now):',
          latestParams,
          '',
          'getFirstReferringParams (now):',
          firstParams,
        ].join('\n')}
      </Text>
    </View>
