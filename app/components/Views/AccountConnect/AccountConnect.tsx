...
const AccountConnect = (props: AccountConnectProps) => {
  ...
  const defaultSelectedChainIds = useMemo(() => {
    // For EIP-1193 requests (injected Ethereum provider requests) or WalletConnect,
    // we only want to show EIP-155 (Ethereum) compatible chains
    if (isEip1193Request || isOriginWalletConnect) {
  ...
  }, [isEip1193Request, allNetworksList, supportedRequestedCaipChainIds, isOriginWalletConnect]);
