...
describe('Asset', () => {
  ...
  describe('musdClaim Transaction Filtering', () => {
    const mockMusdClaimTransaction = {
      id: 'musd-claim-tx-1',
      txParams: {
        from: '0xC4966c0D659D99699BFD7EB54D8fafEE40e4a756',
    ...
    const createMudsClaimTestState = (
      transactions = [mockMusdClaimTransaction],
    ) => ({
      ...mockInitialState,
      engine: {
        ...mockInitialState.engine,
          ...
          NetworkController: {
            ...
            networkConfigurationsByChainId: {
              ...
              '0xe708': {
                chainId: '0xe708',
                name: 'Linea Mainnet',
                rpcEndpoints: [{ networkClientId: 'lineaClient' }],
                defaultRpcEndpointIndex: 0,
              },
            },
          },
    ...
    it('shows musdClaim transactions when viewing mUSD token by address', () => {
      const state = createMudsClaimTestState();
    ...
    it('shows musdClaim transactions when viewing mUSD token by symbol', () => {
      const state = createMudsClaimTestState();
        ...
        <Asset
          ...
          route={{
            params: {
              ...
              address: MUSD_TOKEN_ADDRESS,
              isETH: false,
              chainId: '0x1', // Even when on a different chain
            },
          }}
        />,
        { state },
    ...
    it('does NOT show musdClaim transactions when viewing a different token', () => {
      const state = createMudsClaimTestState();
    ...
    it('does NOT show unapproved musdClaim transactions', () => {
      const unapprovedMusdClaimTx = {
        ...mockMusdClaimTransaction,
        status: 'unapproved',
      };
      const state = createMudsClaimTestState([unapprovedMusdClaimTx]);
