...
import SocialLoginSuccess from './index';
...
describe('SocialLoginSuccess', () => {
  ...
  it('should render correctly', () => {
    const { toJSON } = render(<SocialLoginSuccess />);
    expect(toJSON()).toMatchSnapshot();
  });

  it('should display the success title', () => {
    const { getByText } = render(<SocialLoginSuccess />);
  ...
  it('should render without crashing when all props are provided', () => {
    expect(() => render(<SocialLoginSuccess />)).not.toThrow();
  });
