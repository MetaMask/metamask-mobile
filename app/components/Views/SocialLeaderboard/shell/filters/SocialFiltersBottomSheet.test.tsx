...
describe('SocialFiltersBottomSheet', () => {
  ...
  it('shows the Time frame section on For you and Leaderboard', () => {
  ...
  it('shows the Following cohort chip on For you and Live trades but not Leaderboard', () => {
    const { rerender } = render(
      <SocialFiltersBottomSheet
        tab="forYou"
        draft={baseDraft}
  ...
  it('renders market cap and 24h volume sliders on For you and Live trades', () => {
    const { rerender } = render(
      <SocialFiltersBottomSheet
        tab="forYou"
        draft={baseDraft}
