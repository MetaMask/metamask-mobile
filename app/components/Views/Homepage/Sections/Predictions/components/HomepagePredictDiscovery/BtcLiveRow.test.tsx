...
describe('BtcLiveRow', () => {
  ...
  it('queries the supplied series definition', () => {
    ...
    render(<BtcLiveRow series={series} onPress={jest.fn()} isSectionVisible />);
  ...
  it('disables live market data when the homepage section is off-screen', () => {
    const series = BTC_UP_OR_DOWN_5M_SERIES;
