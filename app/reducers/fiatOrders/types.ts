...
export enum ACTIONS {
  ...
  // aggregator actions
  FIAT_SET_REGION_AGG,
  FIAT_SET_PAYMENT_METHOD_AGG,
  FIAT_SET_GETSTARTED_AGG,
  FIAT_ADD_CUSTOM_ID_DATA,
  FIAT_UPDATE_CUSTOM_ID_DATA,
  FIAT_REMOVE_CUSTOM_ID_DATA,
  FIAT_ADD_AUTHENTICATION_URL,
  FIAT_REMOVE_AUTHENTICATION_URL,
}
