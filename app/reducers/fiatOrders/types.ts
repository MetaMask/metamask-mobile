...
export interface FiatOrdersState {
  ...
  rampRegionSupport: RampRegionSupport;
...
export const ACTIONS = {
  ...
  FIAT_SET_RAMP_REGION_SUPPORT: 'FIAT_SET_RAMP_REGION_SUPPORT',
...
export type Action =
  ...
  | ReturnType<typeof setRampRegionSupport>
