import { selectRewardsFirstPredictOnUsEnabled } from './index';
...
describe('selectRewardsFirstPredictOnUsEnabled', () => {
  ...
  it('returns true when remote flag is enabled and version requirement is met', () => {
    const result = selectRewardsFirstPredictOnUsEnabled.resultFunc({
