import { selectRewardsMoneyControllerEnabled } from './index';
...
describe('selectRewardsMoneyControllerEnabled', () => {
  ...
  it('returns true when remote flag is enabled and version requirement is met', () => {
    const result = selectRewardsMoneyControllerEnabled.resultFunc({
