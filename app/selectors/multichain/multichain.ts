...
export const selectNonEvmTransactions = createDeepEqualSelector(
  ...
  (
    ...
    const accountTransactions = {
      ...
      "transactions": [
          {
              "id": "5dn9hKr3US2XAPkR262FbzVoqi7F7fNmMDKepNyuuu9NnT1BuNMmLgayV1D8AP5oPJN2eBeDukWLjwVUvGz7PTpJ",
              "account": "26e1d5cb-099d-419d-8f81-5e312d6c9d70",
              "timestamp": 1758274413,
              ...
              "to": [
                  {
                      "address": "9iWxPhaTyvUckBA3GqBaa8zfqeyT6UKokJs2MfimYgkr",
                      "asset": {
                          "fungible": true,
                          "type": "solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp/slip44:501",
                          "unit": "SOL",
          ...
          {
              "id": "4Cgnag3Kk2UpHzHQxtSQM8MPpgWycbARt5btDhfpLVPqJMxCA3EnhigeTWXSWMtt35bdWvMAYbBK5dfLnEjTE7Ge",
              "account": "26e1d5cb-099d-419d-8f81-5e312d6c9d70",
              "timestamp": 1758268553,
              "chain": "solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp",
              "status": "confirmed",
              "type": "send",
              "from": [
              ...
              "to": [
                  {
                      "address": "7zN9GRPirpyRrjmYzpGcAb2iEWBWQcft2iWwDu3Ny6t6",
                      "asset": {
                          "fungible": true,
                          "type": "solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp/token:EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v",
                          "unit": "USDC",
                  ...
                  {
                      "address": "Hs9AVnNsteJtzxnpxxVKyiym65zZ7rjM7i2dZiUmixYv",
                      "asset": {
                          "fungible": true,
                          "type": "solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp/slip44:501",
                          "unit": "SOL",
          ...
          },
          {
              ...
              "id": "2ypfTofNo2s2LU6srSaUuHsNL3Q1XPmpRnCDLoAU8mqh1M7ZHM9MinWBz8NkoJMdtLUkbGa5o82XYMuu6fRScpwe",
              "status": "confirmed",
              "timestamp": 1758204716,
              "to": [
                  {
      ...
      "next": null,
      "lastUpdated": 1758280952890
    },
    "solana:EtWTRABZaYq6iMfeYKouRu166VU2xqa1": {
        "lastUpdated": 1758012073006,
        "next": null,
        "transactions": [
            {
                "account": "26e1d5cb-099d-419d-8f81-5e312d6c9d70",
                ...
                "id": "3ZGE1mFGJu4SPynfDSwuwFEb2zt8KALsp4y2wEF3Yv9NuAFsMjT79amXGFNHnr93XMCUw7U3fLUTdiRDwHVCgh63",
                "status": "confirmed",
                "timestamp": 1756739470,
                "to": [
                    {
                        "address": "6TookiHFpbxvKhU37bKH2AsGCzB2kouVMV9Wfmp1wQjc",
                        "asset": {
                            "amount": "0.00089088",
                            "fungible": true,
                            "type": "solana:EtWTRABZaYq6iMfeYKouRu166VU2xqa1/slip44:501",
            ...
            },
            {
                ...
                "id": "4KhT9NEcnkKmKhaxjrw9BD7sf9mUFZzifNpCSEo5coXSdtt7Sz4v1um1gDX5eFZbP2z36GR1BznzVSRPdjE16zez",
                "status": "confirmed",
                "timestamp": 1756739448,
                "to": [
                    {
                        "address": "JCp15hm4zQoghYFK277XE7xBBKVxmq4NBHU6TGV29Kqt",
                        "asset": {
                            "amount": "0.00089088",
                            "fungible": true,
                            "type": "solana:EtWTRABZaYq6iMfeYKouRu166VU2xqa1/slip44:501",
            ...
            },
            {
                ...
                "id": "iig26WQKGyCRWyYxAPTBkfFm7hUpqSS5otenc6VRqqhhAJXU5P5BEcc682U94TxJpyo2GJh6L5G1ZPziZkFo2iq",
                "status": "confirmed",
                "timestamp": 1751531488,
                "to": [
                    {
            ...
            },
            {
                ...
                "id": "3VbnuvghcGWfux6Xog9GuLLkuTyPQWmDCxnLciaRHQMSLtqTc4g7jiwTHRxoaSKfKMSXV1UNdRh7aiCwHpuVxwC",
                "status": "confirmed",
                "timestamp": 1751467149,
                "to": [
                    {
            ...
            },
            {
                ...
                "id": "5NewKmm7jvRwSBq5NfVwLXC6mD4ddCea7Zys2c9cMqGN9uJtYKjGA9UaLqVWdhk8QwFExVhY46QcgAAoJBqm8jB1",
                "status": "confirmed",
                "timestamp": 1751466664,
                "to": [
                    {
    ...
    return (
      (accountTransactions as Record<string, NonEvmTransactionStateEntry>)[selectedNonEvmNetworkChainId] ??
