 ...
 *
 * @param {{ features: import('./remove-fenced-code.js').Features }} config - Configuration required for validation.
 ...
 * @param {import('./remove-fenced-code.js').Features} features - Features that are currently active.
