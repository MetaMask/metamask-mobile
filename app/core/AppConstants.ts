...
export default {
  ...
  SEEDLESS_ONBOARDING: {
    ...
    ANDROID_APPLE_REDIRECT_URI: process.env.ANDROID_APPLE_REDIRECT_URI,
    IOS_GOOGLE_REDIRECT_URI: process.env.IOS_GOOGLE_REDIRECT_URI,

    ANDROID_APPLE_AUTH_CONNECTION_ID: process.env.ANDROID_APPLE_AUTH_CONNECTION_ID,
    ANDROID_GOOGLE_AUTH_CONNECTION_ID: process.env.ANDROID_GOOGLE_AUTH_CONNECTION_ID,
    IOS_APPLE_AUTH_CONNECTION_ID: process.env.IOS_APPLE_AUTH_CONNECTION_ID,
    IOS_GOOGLE_AUTH_CONNECTION_ID: process.env.IOS_GOOGLE_AUTH_CONNECTION_ID,

    APPLE_GROUPED_AUTH_CONNECTION_ID: process.env.APPLE_GROUPED_AUTH_CONNECTION_ID,
    GOOGLE_GROUPED_AUTH_CONNECTION_ID: process.env.GOOGLE_GROUPED_AUTH_CONNECTION_ID,
