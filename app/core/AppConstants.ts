...
export default {
  ...
  SEEDLESS_ONBOARDING: {
    ...
    ANDROID_GOOGLE_SERVER_CLIENT_ID: process.env.ANDROID_GOOGLE_SERVER_CLIENT_ID,
    ...
    APPLE_AUTH_CONNECTION_ID: process.env.APPLE_AUTH_CONNECTION_ID,
    GOOGLE_AUTH_CONNECTION_ID: process.env.GOOGLE_AUTH_CONNECTION_ID,
