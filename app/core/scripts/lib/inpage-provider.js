...
function MetamaskInpageProvider(connectionStream) {
	...
	pump(mux.createStream('publicConfig'), asStream(self.publicConfigStore), err =>
		logStreamDisconnectWarning('MetaMask PublicConfigStore', err)
	);
	...
	pump(streamMiddleware.stream, mux.createStream('provider'), streamMiddleware.stream, err =>
		logStreamDisconnectWarning('MetaMask RpcProvider', err)
	);
