...
export class RewardsDataService {
  ...
  /**
   * Get VIP fee configuration for the authenticated subscription.
   * @param subscriptionId - The subscription ID to use for authentication.
   * @returns The VIP fees response DTO.
   */
