...
enum EVENT_NAME {
  ...
  OFFRAMP_REGION_SELECTED = 'Off-ramp Region Selected',
  ...
  OFFRAMP_REGION_RESET = 'Off-ramp Region Reset',
...
const events = {
  ...
  OFFRAMP_REGION_SELECTED: generateOpt(EVENT_NAME.OFFRAMP_REGION_SELECTED),
  ...
  OFFRAMP_REGION_RESET: generateOpt(EVENT_NAME.OFFRAMP_REGION_RESET),
