...
enum EVENT_NAME {
  ...
  PERPS_MARKET_SELECTED = 'Perps Market Selected',
  PERPS_LEVERAGE_ADJUSTED = 'Perps Leverage Adjusted',
  ...
  PERPS_POSITION_OPENED = 'Perps Position Opened',
  PERPS_POSITION_CLOSED = 'Perps Position Closed',
  PERPS_ORDER_FAILED = 'Perps Order Failed',
  PERPS_DEPOSIT_STARTED = 'Perps Deposit Started',
  PERPS_DEPOSIT_COMPLETED = 'Perps Deposit Completed',
  PERPS_DEPOSIT_FAILED = 'Perps Deposit Failed',
  PERPS_WITHDRAW_STARTED = 'Perps Withdraw Started',
  PERPS_WITHDRAW_COMPLETED = 'Perps Withdraw Completed',
  PERPS_WITHDRAW_FAILED = 'Perps Withdraw Failed',
  PERPS_POSITION_DETAILS_VIEWED = 'Perps Position Details Viewed',
  PERPS_MODIFY_POSITION_INITIATED = 'Perps Modify Position Initiated',
  PERPS_STOP_LOSS_SET = 'Perps Stop Loss Set',
  PERPS_TAKE_PROFIT_SET = 'Perps Take Profit Set',
  PERPS_COLLATERAL_ADJUSTMENT_STARTED = 'Perps Collateral Adjustment Started',
  PERPS_COLLATERAL_ADDED_SUCCESSFULLY = 'Perps Collateral Added Successfully',
  PERPS_ORDER_CANCELED = 'Perps Order Canceled',
  PERPS_MARKET_DATA_LOADED = 'Perps Market Data Loaded',
  PERPS_WEBSOCKET_CONNECTED = 'Perps WebSocket Connected',
  PERPS_WEBSOCKET_DISCONNECTED = 'Perps WebSocket Disconnected',
  PERPS_PRICE_FEED_UPDATE = 'Perps Price Feed Update',
  PERPS_ORDER_VALIDATION_FAILED = 'Perps Order Validation Failed',
  PERPS_PAYMENT_TOKEN_SELECTED = 'Perps Payment Token Selected',
  PERPS_TP_SL_SET = 'Perps TP/SL Set',
...
const events = {
  ...
  PERPS_MARKET_SELECTED: generateOpt(EVENT_NAME.PERPS_MARKET_SELECTED),
  PERPS_LEVERAGE_ADJUSTED: generateOpt(EVENT_NAME.PERPS_LEVERAGE_ADJUSTED),
  ...
  PERPS_POSITION_OPENED: generateOpt(EVENT_NAME.PERPS_POSITION_OPENED),
  PERPS_POSITION_CLOSED: generateOpt(EVENT_NAME.PERPS_POSITION_CLOSED),
  PERPS_ORDER_FAILED: generateOpt(EVENT_NAME.PERPS_ORDER_FAILED),
  PERPS_DEPOSIT_STARTED: generateOpt(EVENT_NAME.PERPS_DEPOSIT_STARTED),
  PERPS_DEPOSIT_COMPLETED: generateOpt(EVENT_NAME.PERPS_DEPOSIT_COMPLETED),
  PERPS_DEPOSIT_FAILED: generateOpt(EVENT_NAME.PERPS_DEPOSIT_FAILED),
  PERPS_WITHDRAW_STARTED: generateOpt(EVENT_NAME.PERPS_WITHDRAW_STARTED),
  PERPS_WITHDRAW_COMPLETED: generateOpt(EVENT_NAME.PERPS_WITHDRAW_COMPLETED),
  PERPS_WITHDRAW_FAILED: generateOpt(EVENT_NAME.PERPS_WITHDRAW_FAILED),
  PERPS_POSITION_DETAILS_VIEWED: generateOpt(
    EVENT_NAME.PERPS_POSITION_DETAILS_VIEWED,
  ),
  PERPS_MODIFY_POSITION_INITIATED: generateOpt(
    EVENT_NAME.PERPS_MODIFY_POSITION_INITIATED,
  ),
  ...
  PERPS_COLLATERAL_ADJUSTMENT_STARTED: generateOpt(
    EVENT_NAME.PERPS_COLLATERAL_ADJUSTMENT_STARTED,
  ),
  PERPS_COLLATERAL_ADDED_SUCCESSFULLY: generateOpt(
    EVENT_NAME.PERPS_COLLATERAL_ADDED_SUCCESSFULLY,
  ),
  PERPS_ORDER_CANCELED: generateOpt(EVENT_NAME.PERPS_ORDER_CANCELED),
  PERPS_MARKET_DATA_LOADED: generateOpt(EVENT_NAME.PERPS_MARKET_DATA_LOADED),
  PERPS_WEBSOCKET_CONNECTED: generateOpt(EVENT_NAME.PERPS_WEBSOCKET_CONNECTED),
  PERPS_WEBSOCKET_DISCONNECTED: generateOpt(
    EVENT_NAME.PERPS_WEBSOCKET_DISCONNECTED,
  ),
  PERPS_PRICE_FEED_UPDATE: generateOpt(EVENT_NAME.PERPS_PRICE_FEED_UPDATE),
  PERPS_ORDER_VALIDATION_FAILED: generateOpt(
    EVENT_NAME.PERPS_ORDER_VALIDATION_FAILED,
  ),
  PERPS_PAYMENT_TOKEN_SELECTED: generateOpt(
    EVENT_NAME.PERPS_PAYMENT_TOKEN_SELECTED,
  ),
  PERPS_TP_SL_SET: generateOpt(EVENT_NAME.PERPS_TP_SL_SET),
