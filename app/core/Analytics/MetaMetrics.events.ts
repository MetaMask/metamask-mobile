...
enum EVENT_NAME {
  ...
  // Solana New Feature Content
  SOLANA_NEW_FEATURE_CONTENT_IMPORT_ACCOUNT_CLICKED = 'Solana New Feature Content Import Account Clicked',
  SOLANA_NEW_FEATURE_CONTENT_LEARN_MORE_CLICKED = 'Solana New Feature Content Learn More Clicked',
  SOLANA_NEW_FEATURE_CONTENT_NOT_NOW_CLICKED = 'Solana New Feature Content Not Now Clicked',
}
...
const events = {
  ...
  SOLANA_NEW_FEATURE_CONTENT_IMPORT_ACCOUNT_CLICKED: generateOpt(
    EVENT_NAME.SOLANA_NEW_FEATURE_CONTENT_IMPORT_ACCOUNT_CLICKED,
  ),
  SOLANA_NEW_FEATURE_CONTENT_LEARN_MORE_CLICKED: generateOpt(
    EVENT_NAME.SOLANA_NEW_FEATURE_CONTENT_LEARN_MORE_CLICKED,
  ),
  SOLANA_NEW_FEATURE_CONTENT_NOT_NOW_CLICKED: generateOpt(
    EVENT_NAME.SOLANA_NEW_FEATURE_CONTENT_NOT_NOW_CLICKED,
  ),
