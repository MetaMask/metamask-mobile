...
const events = {
  ...
  CARD_WELCOME_VIEWED: generateOpt(EVENT_NAME.CARD_WELCOME_VIEWED),
  CARD_VERIFY_ACCOUNT_BUTTON_CLICKED: generateOpt(
    EVENT_NAME.CARD_VERIFY_ACCOUNT_BUTTON_CLICKED,
  ),
  CARD_AUTHENTICATION_VIEWED: generateOpt(
    EVENT_NAME.CARD_AUTHENTICATION_VIEWED,
  ),
  CARD_OTP_AUTHENTICATION_VIEWED: generateOpt(
    EVENT_NAME.CARD_OTP_AUTHENTICATION_VIEWED,
  ),
  CARD_AUTHENTICATION_LOGIN_BUTTON_CLICKED: generateOpt(
    EVENT_NAME.CARD_AUTHENTICATION_LOGIN_BUTTON_CLICKED,
  ),
  CARD_OTP_AUTHENTICATION_CONFIRM_BUTTON_CLICKED: generateOpt(
    EVENT_NAME.CARD_OTP_AUTHENTICATION_CONFIRM_BUTTON_CLICKED,
  ),
  // Rewards
