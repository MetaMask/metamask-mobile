...
enum EVENT_NAME {
  ...
  WHATS_HAPPENING_OPENED = 'Whats Happening Opened',
  WHATS_HAPPENING_VIEWED = 'Whats Happening Viewed',
  WHATS_HAPPENING_INTERACTION = 'Whats Happening Interaction',
  WHATS_HAPPENING_CLOSED = 'Whats Happening Closed',
...
const events = {
  ...
  WHATS_HAPPENING_OPENED: generateOpt(EVENT_NAME.WHATS_HAPPENING_OPENED),
  WHATS_HAPPENING_VIEWED: generateOpt(EVENT_NAME.WHATS_HAPPENING_VIEWED),
  WHATS_HAPPENING_INTERACTION: generateOpt(
    EVENT_NAME.WHATS_HAPPENING_INTERACTION,
  ),
  WHATS_HAPPENING_CLOSED: generateOpt(EVENT_NAME.WHATS_HAPPENING_CLOSED),
  // Card
