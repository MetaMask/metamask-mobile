...
const events = {
  ...
  // Mpc Wallet
  ADD_MPC_WALLET: generateOpt(EVENT_NAME.ADD_MPC_WALLET),
  JOIN_MPC_WALLET: generateOpt(EVENT_NAME.JOIN_MPC_WALLET),
  CREATE_MPC_WALLET: generateOpt(EVENT_NAME.CREATE_MPC_WALLET),
