...
enum EVENT_NAME {
  ...
  CONTACTS_SYNC_UPDATED = 'Contacts Sync Updated',
  CONTACTS_SYNC_DELETED = 'Contacts Sync Deleted',
...
const events = {
  ...
  CONTACTS_SYNC_UPDATED: generateOpt(EVENT_NAME.CONTACTS_SYNC_UPDATED),
  CONTACTS_SYNC_DELETED: generateOpt(EVENT_NAME.CONTACTS_SYNC_DELETED),
  ACCOUNTS_SYNC_ERRONEOUS_SITUATION: generateOpt(
    EVENT_NAME.ACCOUNTS_SYNC_ERRONEOUS_SITUATION,
  ),
  CONTACTS_SYNC_ERRONEOUS_SITUATION: generateOpt(
    EVENT_NAME.CONTACTS_SYNC_ERRONEOUS_SITUATION,
  ),
  // Connection
