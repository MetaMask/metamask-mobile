...
enum EVENT_NAME {
  ...
  // Balance Breakdown
  BALANCE_BREAKDOWN_OPENED = 'Balance Breakdown Opened',
  BALANCE_BREAKDOWN_SLICE_TAPPED = 'Balance Breakdown Slice Tapped',
  BALANCE_BREAKDOWN_DRILLDOWN_CTA_TAPPED = 'Balance Breakdown Drilldown CTA Tapped',
...
const events = {
  ...
  // Balance Breakdown
  BALANCE_BREAKDOWN_OPENED: generateOpt(EVENT_NAME.BALANCE_BREAKDOWN_OPENED),
  BALANCE_BREAKDOWN_SLICE_TAPPED: generateOpt(
    EVENT_NAME.BALANCE_BREAKDOWN_SLICE_TAPPED,
  ),
  BALANCE_BREAKDOWN_DRILLDOWN_CTA_TAPPED: generateOpt(
    EVENT_NAME.BALANCE_BREAKDOWN_DRILLDOWN_CTA_TAPPED,
  ),
