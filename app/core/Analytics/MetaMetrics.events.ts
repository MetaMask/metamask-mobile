...
enum EVENT_NAME {
  ...
  // SLOW RPC MONITORING
  SLOW_RPC_MONITORING_BANNER_SHOWN = 'Slow RPC Monitoring Banner Shown',
  SLOW_RPC_MONITORING_BANNER_EDIT_RPC_CLICKED = 'Slow RPC Monitoring Banner Edit RPC Clicked',
...
const events = {
  ...
  // SLOW RPC MONITORING
  SLOW_RPC_MONITORING_BANNER_SHOWN: generateOpt(
    EVENT_NAME.SLOW_RPC_MONITORING_BANNER_SHOWN,
  ),
  SLOW_RPC_MONITORING_BANNER_EDIT_RPC_CLICKED: generateOpt(
    EVENT_NAME.SLOW_RPC_MONITORING_BANNER_EDIT_RPC_CLICKED,
  ),
