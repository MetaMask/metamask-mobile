...
enum EVENT_NAME {
  ...
  SOCIAL_LOGIN_STARTED = 'Social Login Started',
  SOCIAL_LOGIN_BACKGROUNDED = 'Social Login Backgrounded',
  SOCIAL_LOGIN_RESUMED = 'Social Login Resumed',
  SOCIAL_LOGIN_ABANDONED = 'Social Login Abandoned',
...
const events = {
  ...
  SOCIAL_LOGIN_STARTED: generateOpt(EVENT_NAME.SOCIAL_LOGIN_STARTED),
  SOCIAL_LOGIN_BACKGROUNDED: generateOpt(EVENT_NAME.SOCIAL_LOGIN_BACKGROUNDED),
  SOCIAL_LOGIN_RESUMED: generateOpt(EVENT_NAME.SOCIAL_LOGIN_RESUMED),
  SOCIAL_LOGIN_ABANDONED: generateOpt(EVENT_NAME.SOCIAL_LOGIN_ABANDONED),
