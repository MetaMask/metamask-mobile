...
enum EVENT_NAME {
  ...
  // Intercom - Surveys
  INTERCOM_SURVEY_VIEWED = 'Intercom Survey Viewed',
  INTERCOM_SURVEY_STARTED = 'Intercom Survey Started',
  INTERCOM_SURVEY_COMPLETED = 'Intercom Survey Completed',
  INTERCOM_SURVEY_DISMISSED = 'Intercom Survey Dismissed',
  INTERCOM_SURVEY_OPT_IN = 'Intercom Survey Opt In',
  INTERCOM_SURVEY_OPT_OUT = 'Intercom Survey Opt Out',

  // Intercom - Support
  INTERCOM_SUPPORT_OPENED = 'Intercom Support Opened',
  INTERCOM_SUPPORT_CLOSED = 'Intercom Support Closed',
  INTERCOM_SUPPORT_MESSAGE_SENT = 'Intercom Support Message Sent',
  INTERCOM_SUPPORT_FALLBACK_USED = 'Intercom Support Fallback Used',
  INTERCOM_SUPPORT_ERROR = 'Intercom Support Error',

  // Intercom - SDK
  INTERCOM_SDK_INITIALIZED = 'Intercom SDK Initialized',
  INTERCOM_SDK_ERROR = 'Intercom SDK Error',
}
...
enum ACTIONS {
  ...
  // Intercom
  INTERCOM_SURVEY = 'Intercom Survey',
...
const events = {
  ...
  // Intercom - Surveys
  INTERCOM_SURVEY_VIEWED: generateOpt(
    EVENT_NAME.INTERCOM_SURVEY_VIEWED,
    ACTIONS.INTERCOM_SURVEY,
  ),
  INTERCOM_SURVEY_STARTED: generateOpt(
    EVENT_NAME.INTERCOM_SURVEY_STARTED,
    ACTIONS.INTERCOM_SURVEY,
  ),
  INTERCOM_SURVEY_COMPLETED: generateOpt(
    EVENT_NAME.INTERCOM_SURVEY_COMPLETED,
    ACTIONS.INTERCOM_SURVEY,
  ),
  INTERCOM_SURVEY_DISMISSED: generateOpt(
    EVENT_NAME.INTERCOM_SURVEY_DISMISSED,
    ACTIONS.INTERCOM_SURVEY,
  ),
  INTERCOM_SURVEY_OPT_IN: generateOpt(
    EVENT_NAME.INTERCOM_SURVEY_OPT_IN,
    ACTIONS.INTERCOM_SURVEY,
  ),
  INTERCOM_SURVEY_OPT_OUT: generateOpt(
    EVENT_NAME.INTERCOM_SURVEY_OPT_OUT,
    ACTIONS.INTERCOM_SURVEY,
  ),

  // Intercom - Support
  INTERCOM_SUPPORT_OPENED: generateOpt(
    EVENT_NAME.INTERCOM_SUPPORT_OPENED,
    ACTIONS.INTERCOM_SUPPORT,
  ),
  INTERCOM_SUPPORT_CLOSED: generateOpt(
    EVENT_NAME.INTERCOM_SUPPORT_CLOSED,
    ACTIONS.INTERCOM_SUPPORT,
  ),
  INTERCOM_SUPPORT_MESSAGE_SENT: generateOpt(
    EVENT_NAME.INTERCOM_SUPPORT_MESSAGE_SENT,
    ACTIONS.INTERCOM_SUPPORT,
  ),
  INTERCOM_SUPPORT_FALLBACK_USED: generateOpt(
    EVENT_NAME.INTERCOM_SUPPORT_FALLBACK_USED,
    ACTIONS.INTERCOM_SUPPORT,
  ),
  INTERCOM_SUPPORT_ERROR: generateOpt(
    EVENT_NAME.INTERCOM_SUPPORT_ERROR,
    ACTIONS.INTERCOM_SUPPORT,
  ),

  // Intercom - SDK
  INTERCOM_SDK_INITIALIZED: generateOpt(EVENT_NAME.INTERCOM_SDK_INITIALIZED),
  INTERCOM_SDK_ERROR: generateOpt(EVENT_NAME.INTERCOM_SDK_ERROR),
};
