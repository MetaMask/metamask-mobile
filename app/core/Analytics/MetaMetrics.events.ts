...
enum EVENT_NAME {
  ...
  PUSH_PRE_PROMPT_VIEWED = 'Push Pre-Prompt Viewed',
  PUSH_PRE_PROMPT_DISMISSED = 'Push Pre-Prompt Dismissed',
  PUSH_PRE_PROMPT_BUTTON_CLICKED = 'Push Pre-Prompt Button Clicked',
  PUSH_OS_PROMPT_SHOWN = 'Push OS Prompt Shown',
  PUSH_OS_PROMPT_RESPONSE = 'Push OS Prompt Response',
  ...
  SOCIAL_FOLLOW_TRADE_NOTIFICATION_CLICKED = 'Follow Trade Notification Clicked',
  // Activity
...
const events = {
  ...
  PUSH_PRE_PROMPT_VIEWED: generateOpt(EVENT_NAME.PUSH_PRE_PROMPT_VIEWED),
  PUSH_PRE_PROMPT_DISMISSED: generateOpt(EVENT_NAME.PUSH_PRE_PROMPT_DISMISSED),
  PUSH_PRE_PROMPT_BUTTON_CLICKED: generateOpt(
    EVENT_NAME.PUSH_PRE_PROMPT_BUTTON_CLICKED,
  ),
  PUSH_OS_PROMPT_SHOWN: generateOpt(EVENT_NAME.PUSH_OS_PROMPT_SHOWN),
  PUSH_OS_PROMPT_RESPONSE: generateOpt(EVENT_NAME.PUSH_OS_PROMPT_RESPONSE),
  ...
  SOCIAL_FOLLOW_TRADE_NOTIFICATION_CLICKED: generateOpt(
    EVENT_NAME.SOCIAL_FOLLOW_TRADE_NOTIFICATION_CLICKED,
  ),
