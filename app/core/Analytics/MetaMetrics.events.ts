...
enum EVENT_NAME {
  ...
  SOCIAL_FOLLOW_TRADING_TOKEN_BUY_CLICKED = 'Follow Trading Token Buy Clicked',
  ...
  SOCIAL_LEADERBOARD_ONBOARDING_SCREEN_VIEWED = 'Social Leaderboard Onboarding Screen Viewed',
  SOCIAL_LEADERBOARD_ONBOARDING_COMPLETED = 'Social Leaderboard Onboarding Completed',
  SOCIAL_LEADERBOARD_ONBOARDING_DISMISSED = 'Social Leaderboard Onboarding Dismissed',
...
const events = {
  ...
  SOCIAL_FOLLOW_TRADING_TOKEN_BUY_CLICKED: generateOpt(
    EVENT_NAME.SOCIAL_FOLLOW_TRADING_TOKEN_BUY_CLICKED,
  ),
  ...
  SOCIAL_LEADERBOARD_ONBOARDING_SCREEN_VIEWED: generateOpt(
    EVENT_NAME.SOCIAL_LEADERBOARD_ONBOARDING_SCREEN_VIEWED,
  ),
  SOCIAL_LEADERBOARD_ONBOARDING_COMPLETED: generateOpt(
    EVENT_NAME.SOCIAL_LEADERBOARD_ONBOARDING_COMPLETED,
  ),
  SOCIAL_LEADERBOARD_ONBOARDING_DISMISSED: generateOpt(
    EVENT_NAME.SOCIAL_LEADERBOARD_ONBOARDING_DISMISSED,
  ),
