...
enum EVENT_NAME {
  ...
  // Social Leaderboard
  LEADERBOARD_SCREEN_VIEWED = 'Leaderboard Screen Viewed',
  TRADER_FOLLOW_CLICKED = 'Trader Follow Clicked',
  TRADER_UNFOLLOW_CLICKED = 'Trader Unfollow Clicked',
  TRADER_PROFILE_SCREEN_VIEWED = 'Trader Profile Screen Viewed',
  FOLLOW_TRADE_NOTIFICATION_CLICKED = 'Follow Trade Notification Clicked',
...
const events = {
  ...
  // Social Leaderboard
  LEADERBOARD_SCREEN_VIEWED: generateOpt(EVENT_NAME.LEADERBOARD_SCREEN_VIEWED),
  TRADER_FOLLOW_CLICKED: generateOpt(EVENT_NAME.TRADER_FOLLOW_CLICKED),
  TRADER_UNFOLLOW_CLICKED: generateOpt(EVENT_NAME.TRADER_UNFOLLOW_CLICKED),
  TRADER_PROFILE_SCREEN_VIEWED: generateOpt(
    EVENT_NAME.TRADER_PROFILE_SCREEN_VIEWED,
  ),
  FOLLOW_TRADE_NOTIFICATION_CLICKED: generateOpt(
    EVENT_NAME.FOLLOW_TRADE_NOTIFICATION_CLICKED,
  ),
