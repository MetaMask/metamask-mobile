...
enum EVENT_NAME {
  ...
  SLOW_RPC_UPDATE_RPC_CLICKED = 'Slow RPC Update RPC Clicked',
  UNAVAILABLE_RPC_UPDATE_RPC_CLICKED = 'Unavailable RPC Update RPC Clicked',
...
const events = {
  ...
  SLOW_RPC_UPDATE_RPC_CLICKED: generateOpt(
    EVENT_NAME.SLOW_RPC_UPDATE_RPC_CLICKED,
  ),
  UNAVAILABLE_RPC_UPDATE_RPC_CLICKED: generateOpt(
    EVENT_NAME.UNAVAILABLE_RPC_UPDATE_RPC_CLICKED,
  ),
