...
enum EVENT_NAME {
  ...
  HARDWARE_WALLET_RECOVERY_PRIMARY_BUTTON_CLICKED = 'Hardware Wallet Recovery Primary Button Clicked',
...
const events = {
  ...
  HARDWARE_WALLET_RECOVERY_PRIMARY_BUTTON_CLICKED: generateOpt(
    EVENT_NAME.HARDWARE_WALLET_RECOVERY_PRIMARY_BUTTON_CLICKED,
  ),
