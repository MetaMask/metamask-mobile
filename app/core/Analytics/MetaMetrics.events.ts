...
enum EVENT_NAME {
  ...
  SOCIAL_FOLLOW_TRADING_TAB_CHANGED = 'Follow Trading Tab Changed',
  SOCIAL_TRADER_FEED_AUDIENCE_FILTER_CHANGED = 'Trader Feed Audience Filter Changed',
  SOCIAL_TRADER_FEED_TYPE_FILTER_CHANGED = 'Trader Feed Type Filter Changed',
...
const events = {
  ...
  SOCIAL_FOLLOW_TRADING_TAB_CHANGED: generateOpt(
    EVENT_NAME.SOCIAL_FOLLOW_TRADING_TAB_CHANGED,
  ),
  SOCIAL_TRADER_FEED_AUDIENCE_FILTER_CHANGED: generateOpt(
    EVENT_NAME.SOCIAL_TRADER_FEED_AUDIENCE_FILTER_CHANGED,
  ),
  SOCIAL_TRADER_FEED_TYPE_FILTER_CHANGED: generateOpt(
    EVENT_NAME.SOCIAL_TRADER_FEED_TYPE_FILTER_CHANGED,
  ),
