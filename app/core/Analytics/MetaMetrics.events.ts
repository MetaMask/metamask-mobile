...
enum EVENT_NAME {
  ...
  // Onboarding Crypto Experience Questionnaire
  ONBOARDING_CRYPTO_EXPERIENCE_QUESTION_VIEWED = 'Onboarding Crypto Experience Question Viewed',
  ONBOARDING_CRYPTO_EXPERIENCE_QUESTION_SUBMITTED = 'Onboarding Crypto Experience Question Submitted',
...
const events = {
  ...
  ONBOARDING_CRYPTO_EXPERIENCE_QUESTION_VIEWED: generateOpt(
    EVENT_NAME.ONBOARDING_CRYPTO_EXPERIENCE_QUESTION_VIEWED,
  ),
  ONBOARDING_CRYPTO_EXPERIENCE_QUESTION_SUBMITTED: generateOpt(
    EVENT_NAME.ONBOARDING_CRYPTO_EXPERIENCE_QUESTION_SUBMITTED,
  ),
