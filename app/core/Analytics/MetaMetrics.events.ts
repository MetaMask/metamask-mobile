...
enum EVENT_NAME {
  ...
  FIRST_PREDICT_ON_US_SPLASH_SHOWN = 'First Predict On Us Splash Shown',
  FIRST_PREDICT_ON_US_SPLASH_SKIPPED = 'First Predict On Us Splash Skipped',
...
const events = {
  ...
  FIRST_PREDICT_ON_US_SPLASH_SHOWN: generateOpt(
    EVENT_NAME.FIRST_PREDICT_ON_US_SPLASH_SHOWN,
  ),
  FIRST_PREDICT_ON_US_SPLASH_SKIPPED: generateOpt(
    EVENT_NAME.FIRST_PREDICT_ON_US_SPLASH_SKIPPED,
  ),
  // Predict
