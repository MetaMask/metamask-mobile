...
enum EVENT_NAME {
  ...
  SCREENSHOT_WARNING = 'screenshot_warning_displayed',
  SCREENSHOT_LEARN_MORE = 'clicked_screenshot_warning_learn_more',
  SCREENSHOT_OK = 'clicked_screenshot_warning_okay',
}
