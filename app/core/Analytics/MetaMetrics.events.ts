...
enum EVENT_NAME {
  ...
  SOCIAL_FOLLOW_TRADING_TOKEN_TRADE_CLICKED = 'Follow Trading Token Trade Clicked',
...
const events = {
  ...
  SOCIAL_FOLLOW_TRADING_TOKEN_TRADE_CLICKED: generateOpt(
    EVENT_NAME.SOCIAL_FOLLOW_TRADING_TOKEN_TRADE_CLICKED,
  ),
