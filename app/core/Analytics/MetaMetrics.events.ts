...
enum EVENT_NAME {
  ...
  RAMPS_CHECKOUT_URL_CHANGE = 'Ramps Checkout Url Change',
  RAMPS_CHECKOUT_LOAD_COMPLETE = 'Ramps Checkout Load Complete',
  RAMPS_CHECKOUT_HTTP_ERROR = 'Ramps Checkout Http Error',
...
const events = {
  ...
  RAMPS_CHECKOUT_URL_CHANGE: generateOpt(EVENT_NAME.RAMPS_CHECKOUT_URL_CHANGE),
  RAMPS_CHECKOUT_LOAD_COMPLETE: generateOpt(
    EVENT_NAME.RAMPS_CHECKOUT_LOAD_COMPLETE,
  ),
  RAMPS_CHECKOUT_HTTP_ERROR: generateOpt(EVENT_NAME.RAMPS_CHECKOUT_HTTP_ERROR),
