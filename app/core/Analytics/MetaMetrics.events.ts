...
enum EVENT_NAME {
  ...
  PRICE_ALERT_CREATION_INITIATED = 'Price Alert Creation Initiated',
...
const events = {
  ...
  // Price Alerts
  PRICE_ALERT_CREATED: generateOpt(EVENT_NAME.PRICE_ALERT_CREATED),
  PRICE_ALERT_DELETED: generateOpt(EVENT_NAME.PRICE_ALERT_DELETED),
  PRICE_ALERT_UPDATED: generateOpt(EVENT_NAME.PRICE_ALERT_UPDATED),
  PRICE_ALERT_NOTIFICATION_OPENED: generateOpt(
    EVENT_NAME.PRICE_ALERT_NOTIFICATION_OPENED,
  ),
  PRICE_ALERT_CREATION_INITIATED: generateOpt(
    EVENT_NAME.PRICE_ALERT_CREATION_INITIATED,
  ),
