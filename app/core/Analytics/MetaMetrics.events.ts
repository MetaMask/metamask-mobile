...
enum EVENT_NAME {
  ...
  MUSD_FULLSCREEN_ANNOUNCEMENT_VIEWED = 'mUSD Fullscreen Announcement Viewed',
  MUSD_FULLSCREEN_ANNOUNCEMENT_PRIMARY_ACTION_CLICKED = 'mUSD Fullscreen Announcement Primary Action Clicked',
  MUSD_FULLSCREEN_ANNOUNCEMENT_SECONDARY_ACTION_CLICKED = 'mUSD Fullscreen Announcement Secondary Action Clicked',
}
...
const events = {
  ...
  MUSD_FULLSCREEN_ANNOUNCEMENT_VIEWED: generateOpt(
    EVENT_NAME.MUSD_FULLSCREEN_ANNOUNCEMENT_VIEWED,
  ),
  MUSD_FULLSCREEN_ANNOUNCEMENT_PRIMARY_ACTION_CLICKED: generateOpt(
    EVENT_NAME.MUSD_FULLSCREEN_ANNOUNCEMENT_PRIMARY_ACTION_CLICKED,
  ),
  MUSD_FULLSCREEN_ANNOUNCEMENT_SECONDARY_ACTION_CLICKED: generateOpt(
    EVENT_NAME.MUSD_FULLSCREEN_ANNOUNCEMENT_SECONDARY_ACTION_CLICKED,
  ),
};
