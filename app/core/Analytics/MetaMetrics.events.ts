...
enum EVENT_NAME {
  ...
  REWARDS_MONEY_REFERRAL_OFFER_INTERACTED = 'Rewards Money Referral Offer Interacted',
...
const events = {
  ...
  REWARDS_MONEY_REFERRAL_OFFER_INTERACTED: generateOpt(
    EVENT_NAME.REWARDS_MONEY_REFERRAL_OFFER_INTERACTED,
  ),
