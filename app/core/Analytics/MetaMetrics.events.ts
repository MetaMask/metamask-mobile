...
enum EVENT_NAME {
  ...
  SOCIAL_LEADERBOARD_WEEKLY_NOTIFICATION_CLICKED = 'Weekly Leaderboard Notification Clicked',
...
const events = {
  ...
  SOCIAL_LEADERBOARD_WEEKLY_NOTIFICATION_CLICKED: generateOpt(
    EVENT_NAME.SOCIAL_LEADERBOARD_WEEKLY_NOTIFICATION_CLICKED,
  ),
