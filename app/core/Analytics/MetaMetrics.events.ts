...
enum EVENT_NAME {
  ...
  // Vault Corruption
  SEEDLESS_ONBOARDING_LEGACY_DATA_VAULT_DECRYPTED = 'Seedless Onboarding Legacy Data Vault Decrypted',
...
const events = {
  ...
  // Vault corruption
  SEEDLESS_ONBOARDING_LEGACY_DATA_VAULT_DECRYPTED: generateOpt(
    EVENT_NAME.SEEDLESS_ONBOARDING_LEGACY_DATA_VAULT_DECRYPTED,
  ),
