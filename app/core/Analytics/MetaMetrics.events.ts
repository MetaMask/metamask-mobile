...
enum EVENT_NAME {
  ...
  SOCIAL_LOGIN_IOS_INTERSTITIAL_VIEWED = 'Social Login iOS Interstitial Viewed',
  SOCIAL_LOGIN_IOS_INTERSTITIAL_CTA_CLICKED = 'Social Login iOS Interstitial CTA Clicked',
...
const events = {
  ...
  SOCIAL_LOGIN_IOS_INTERSTITIAL_VIEWED: generateOpt(
    EVENT_NAME.SOCIAL_LOGIN_IOS_INTERSTITIAL_VIEWED,
  ),
  SOCIAL_LOGIN_IOS_INTERSTITIAL_CTA_CLICKED: generateOpt(
    EVENT_NAME.SOCIAL_LOGIN_IOS_INTERSTITIAL_CTA_CLICKED,
  ),
