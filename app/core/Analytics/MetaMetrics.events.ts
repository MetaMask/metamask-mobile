...
enum EVENT_NAME {
  ...
  // Rewards
  REWARDS_OPTED_IN = 'Rewards Opted In',
  REWARDS_OPT_OUT = 'Rewards Opt-Out',
  REWARDS_ONBOARDING = 'Rewards Onboarding',
  REWARDS_ACTIVE_BOOST_CLICKED = 'Rewards Active Boost Clicked',
  REWARDS_SWAP_BUTTON_CLICKED = 'Rewards Swap Button Clicked',
  REWARDS_PERPS_BUTTON_CLICKED = 'Rewards Perps Button Clicked',
  REWARDS_REWARD_CLAIMED = 'Rewards Reward Claimed',
  REWARDS_REFERRAL_CODE_COPIED = 'Rewards Referral Code Copied',
  REWARDS_REFERRAL_LINK_COPIED = 'Rewards Referral Link Copied',
  REWARDS_REFERRAL_SHARE_CLICKED = 'Rewards Referral Share Clicked',
  REWARDS_ACCOUNT_LINKING = 'Rewards Account Linking',
}
...
const events = {
  ...
  // Rewards
  REWARDS_OPTED_IN: generateOpt(EVENT_NAME.REWARDS_OPTED_IN),
  REWARDS_OPT_OUT: generateOpt(EVENT_NAME.REWARDS_OPT_OUT),
  REWARDS_ONBOARDING: generateOpt(EVENT_NAME.REWARDS_ONBOARDING),
  REWARDS_ACTIVE_BOOST_CLICKED: generateOpt(
    EVENT_NAME.REWARDS_ACTIVE_BOOST_CLICKED,
  ),
  REWARDS_SWAP_BUTTON_CLICKED: generateOpt(
    EVENT_NAME.REWARDS_SWAP_BUTTON_CLICKED,
  ),
  REWARDS_PERPS_BUTTON_CLICKED: generateOpt(
    EVENT_NAME.REWARDS_PERPS_BUTTON_CLICKED,
  ),
  REWARDS_REWARD_CLAIMED: generateOpt(EVENT_NAME.REWARDS_REWARD_CLAIMED),
  REWARDS_REFERRAL_CODE_COPIED: generateOpt(
    EVENT_NAME.REWARDS_REFERRAL_CODE_COPIED,
  ),
  REWARDS_REFERRAL_LINK_COPIED: generateOpt(
    EVENT_NAME.REWARDS_REFERRAL_LINK_COPIED,
  ),
  REWARDS_REFERRAL_SHARE_CLICKED: generateOpt(
    EVENT_NAME.REWARDS_REFERRAL_SHARE_CLICKED,
  ),
  REWARDS_ACCOUNT_LINKING: generateOpt(EVENT_NAME.REWARDS_ACCOUNT_LINKING),
};
