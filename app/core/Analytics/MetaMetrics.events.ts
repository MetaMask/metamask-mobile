...
enum EVENT_NAME {
  ...
  PREDICT_WORLD_CUP_SCREEN_VIEWED = 'Predict World Cup Screen Viewed',
  PREDICT_WORLD_CUP_SCREEN_TAB_CHANGED = 'Predict World Cup Screen Tab Changed',
  PREDICT_WORLD_CUP_BANNER_VIEWED = 'Predict World Cup Banner Viewed',
  PREDICT_WORLD_CUP_BANNER_CLICKED = 'Predict World Cup Banner Clicked',
...
const events = {
  ...
  PREDICT_WORLD_CUP_SCREEN_VIEWED: generateOpt(
    EVENT_NAME.PREDICT_WORLD_CUP_SCREEN_VIEWED,
  ),
  PREDICT_WORLD_CUP_SCREEN_TAB_CHANGED: generateOpt(
    EVENT_NAME.PREDICT_WORLD_CUP_SCREEN_TAB_CHANGED,
  ),
  PREDICT_WORLD_CUP_BANNER_VIEWED: generateOpt(
    EVENT_NAME.PREDICT_WORLD_CUP_BANNER_VIEWED,
  ),
  PREDICT_WORLD_CUP_BANNER_CLICKED: generateOpt(
    EVENT_NAME.PREDICT_WORLD_CUP_BANNER_CLICKED,
  ),
