...
enum EVENT_NAME {
  ...
  SLOW_RPC_BANNER_EDIT_RPC_CLICKED = 'Slow RPC Banner Edit RPC Clicked',
...
const events = {
  ...
  SLOW_RPC_BANNER_EDIT_RPC_CLICKED: generateOpt(
    EVENT_NAME.SLOW_RPC_BANNER_EDIT_RPC_CLICKED,
  ),
