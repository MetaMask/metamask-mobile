...
- `hasOverrides` - End-to-end testing mode
...
2. **Events Not Appearing in Analytics**: If `HAS_OVERRIDES=true` environment variable is set, the Segment client is replaced with a mock that does nothing - check your environment variables
