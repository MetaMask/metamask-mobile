...
export const w3aAuthServerUrl = CURRENT_OAUTH_CONFIG.W3A_AUTH_SERVER;
...
export const AppleServerRedirectUri = `${CURRENT_OAUTH_CONFIG.W3A_AUTH_SERVER}/api/v1/oauth/callback`;
