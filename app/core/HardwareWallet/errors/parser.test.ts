...
describe('parseErrorByType', () => {
  ...
  describe('DMK _tag-based error translation', () => {
    it('parses DeviceSessionNotFound _tag as device disconnected', () => {
      const error = { _tag: 'DeviceSessionNotFound', message: 'Session not found' };
    ...
    it('parses ConnectionOpeningError _tag as bluetooth connection failed', () => {
      const error = { _tag: 'ConnectionOpeningError', message: 'Failed to open connection' };
    ...
    it('parses DeviceDisconnectedWhileSendingError _tag as device disconnected', () => {
      const error = { _tag: 'DeviceDisconnectedWhileSendingError', message: 'Disconnected' };
    ...
    it('prefers name over _tag when both present', () => {
      const error = { name: 'TransportStatusError', statusCode: 0x6985, _tag: 'Ignored' };
