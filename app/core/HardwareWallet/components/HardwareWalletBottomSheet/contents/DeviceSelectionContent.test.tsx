...
const mockDevices: BluetoothDevice[] = [
  { id: 'device-1', name: 'Nano X 1234', rssi: -45 },
  { id: 'device-2', name: 'Nano X 5678', rssi: -60 },
  { id: 'device-3', name: 'Nano S Plus', rssi: -75 },
];
...
describe('DeviceSelectionContent', () => {
  ...
  it('hides rescan button when scanning', () => {
    const { queryByText } = renderWithProvider(
      <DeviceSelectionContent {...defaultProps} isScanning={true} />,
      { state: mockInitialState },
    );
