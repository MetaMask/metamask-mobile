...
describe('SuccessContent', () => {
  ...
  it('should render default message', () => {
    ...
    expect(
      getByText('hardware_wallet.success.operation_complete'),
    ).toBeTruthy();
  });

  it('should render custom message', () => {
    const { getByText } = render(<SuccessContent message="Custom success!" />);

    expect(getByText('Custom success!')).toBeTruthy();
  });
