 ...
 * @returns
 */
var ethAccountsHandler = function (_req, res, _next, end, _c) {
    var getAccounts = _c.getAccounts;
 ...
 */
var handlerExport = {
    methodNames: [constants_2.RestrictedMethods.eth_accounts],
    implementation: ethAccountsHandler,
    hookNames: {
        getAccounts: true
    }
};
exports["default"] = handlerExport;
