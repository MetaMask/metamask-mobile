...
import { createMultichainMethodMiddleware } from '.';
...
jest.mock('../handlers', () => ({
  multichainLocalHandlers: [getHandler()],
}));

describe('createMultichainMethodMiddleware', () => {
  ...
  it('should return a function', () => {
    const middleware = createMultichainMethodMiddleware(getDefaultHooks());
  ...
  it('should throw an error if a required hook is missing', () => {
    ...
    expect(() => createMultichainMethodMiddleware(hooks)).toThrow(
