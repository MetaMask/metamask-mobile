...
import { KeyPair } from '@metamask/mobile-wallet-protocol-core';
...
export class KeyManager implements IKeyManager {
	generateKeyPair(): KeyPair {
		...
		return { privateKey: Uint8Array.from(privateKey.secret), publicKey: Uint8Array.from(privateKey.publicKey.compressed) };
	}
