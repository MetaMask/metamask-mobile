...
exports.createSanitizationMiddleware = exports.permittedKeys = void 0;
 ...
 */
function sanitizeRpcParameter(parameter) {
    return exports.permittedKeys.reduce(function (copy, permitted) {
        if (permitted in parameter) {
            var value = parameter[permitted];
...
function sanitize(value) {
    if (typeof value === 'string' &&
        ...
        return (0, ethereumjs_util_1.addHexPrefix)(value.toLowerCase());
    }
    return value;
}
/**
