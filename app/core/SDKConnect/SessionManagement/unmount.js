...
function unmount(instance) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            Logger_1["default"].log("SDKConnect::unmount()");
            try {
                (_c = instance.state.appStateListener) === null || _c === void 0 ? void 0 : _c.remove();
            }
            catch (err) {
                // Ignore if already removed
            }
            for (id in instance.state.connected) {
                instance.state.connected[id].disconnect({
                    terminate: false,
                    context: 'unmount'
                });
            }
            if (device_1["default"].isAndroid()) {
            ...
            if (instance.state.initTimeout)
                clearTimeout(instance.state.initTimeout);
