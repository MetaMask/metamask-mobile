...
export default {
  ...
  FIAT_ORDERS: {
    ...
    SARDINE_API_URL_PRODUCTION:
      'https://stoplight.io/mocks/sardineai/crypto-on-ramp/45224227/', // TODO: change to sardine base api (prod)
    SARDINE_API_URL_STAGING:
      'https://stoplight.io/mocks/sardineai/crypto-on-ramp/45224227/', // TODO: change to sardine base api (dev)
