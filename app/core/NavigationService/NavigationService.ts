...
class NavigationService {
  static #navigation: TypedNavigationContainerRef;
   ...
   */
  static #assertNavigationRefType(navRef: TypedNavigationContainerRef) {
   ...
   * @param navRef
   */
  static set navigation(navRef: TypedNavigationContainerRef) {
