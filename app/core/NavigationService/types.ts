...
import type { OnboardingFundWalletRouteParams } from '../../components/Views/OnboardingFundWallet/OnboardingFundWallet.types.ts';
...
export type RootStackParamList = {
  ...
  OnboardingFundWallet: OnboardingFundWalletRouteParams;
