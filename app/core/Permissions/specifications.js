...
exports.unrestrictedMethods =
    exports.getPermissionSpecifications =
        exports.getCaveatSpecifications =
            void 0;
...
var CaveatFactories = Object.freeze(((_a = {}),
    (_a[constants_1.CaveatTypes.restrictReturnedAccounts] = function (accounts) {
        return {
...
var getCaveatSpecifications = function (_a) {
    ...
    return __assign(__assign(((_b = {}),
        (_b[constants_1.CaveatTypes.restrictReturnedAccounts] = {
            type: constants_1.CaveatTypes.restrictReturnedAccounts,
            decorator: function (method, caveat) {
    ...
    return ((_b = {}),
        (_b[PermissionKeys.eth_accounts] = {
            ...
            factory: function (permissionOptions, requestData) {
                ...
                return (0, permission_controller_1.constructPermission)(__assign(__assign({ id: (0, uuid_1.v1)() }, permissionOptions), {
                    caveats: [
                        CaveatFactories[constants_1.CaveatTypes.restrictReturnedAccounts](requestData.approvedAccounts),
                    ]
                }));
            },
            methodImplementation: function (_args) {
                return __awaiter(void 0, void 0, void 0, function () {
                    var accounts, internalAccounts;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                return [4 /*yield*/, getAllAccounts()];
                            case 1:
                                accounts = _a.sent();
                                internalAccounts = getInternalAccounts();
                                return [
                                    2 /*return*/,
                                    accounts.sort(function (firstAddress, secondAddress) {
                                        var lowerCaseFirstAddress = firstAddress.toLowerCase();
                                        var firstAccount = internalAccounts.find(function (internalAccount) {
                                            return (internalAccount.address.toLowerCase() ===
                                                lowerCaseFirstAddress);
                                        });
...
function validateCaveatAccounts(accounts, getInternalAccounts) {
    ...
    accounts.forEach(function (address) {
        if (!address || typeof address !== 'string') {
            throw new Error(''
                .concat(PermissionKeys.eth_accounts, ' error: Expected an array of objects that contains an Ethereum addresses. Received: "')
                .concat(address, '".'));
        }
        ...
        if (!internalAccounts.some(function (internalAccount) {
            ...
            throw new Error(''
                .concat(PermissionKeys.eth_accounts, ' error: Received unrecognized address: "')
                .concat(address, '".'));
        }
    });
}
