...
/**
 * Gets the sorted permitted caip account IDs for the specified origin. Returns an empty
 * array if no accounts are permitted.
 *
 * @param {string} origin - The origin whose exposed accounts to retrieve.
 * @returns {CaipAccountId[]} The origin's permitted accounts, or an empty
 * array.
 */
export const getPermittedCaipAccountIds = (
  origin: string,
) => {
