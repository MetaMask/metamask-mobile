...
export const SampleFeatureSelectorsText = {
  SAMPLE_FEATURE_TITLE: enContent.sample_feature.title,
  SAMPLE_FEATURE_DESCRIPTION: enContent.sample_feature.description,
} as const;
