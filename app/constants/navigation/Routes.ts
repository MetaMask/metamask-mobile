const Routes = {
  ...
  ONBOARDING: {
    ...
    RECOVERY_PROTOTYPE: 'WalletRecoveryPrototype',
  ...
  MONEY: {
    ...
    AUTHENTICATOR_DETAILS: 'MoneyAuthenticatorDetails',
    SMS_SETUP: 'MoneySmsSetup',
    SMS_DETAILS: 'MoneySmsDetails',
    SOCIAL_DETAILS: 'MoneySocialDetails',
    ...
    MODALS: {
      ...
      FINISH_SETUP_SHEET: 'MoneyFinishSetupSheet',
      PROTECT_WALLET_SHEET: 'MoneyProtectWalletSheet',
      ADD_PASSKEY_SHEET: 'MoneyAddPasskeySheet',
      SECURITY_VERIFICATION_SHEET: 'MoneySecurityVerificationSheet',
      SECURITY_INFO_SHEET: 'MoneySecurityInfoSheet',
      DELETE_PASSKEY_SHEET: 'MoneyDeletePasskeySheet',
      REMOVE_AUTHENTICATOR_SHEET: 'MoneyRemoveAuthenticatorSheet',
      AUTHENTICATOR_KEY_SHEET: 'MoneyAuthenticatorKeySheet',
      REMOVE_SMS_SHEET: 'MoneyRemoveSmsSheet',
      ADD_SOCIAL_SHEET: 'MoneyAddSocialSheet',
      REMOVE_SOCIAL_SHEET: 'MoneyRemoveSocialSheet',
