 ...
 * OTA hotfix branches are `release/X.Y.Z-ota` (e.g. `release/8.4.1-ota`); CI detects OTA
 ...
 * bare v-prefixed semver (e.g. `v8.4.1`). Runway always increments the patch past any
 ...
 */
export const OTA_VERSION: string = 'v8.4.3';
