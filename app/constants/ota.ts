 ...
 * OTA hotfix branches are `release/X.Y.Z-ota` (e.g. `release/7.81.1-ota`); CI detects OTA
 ...
 * bare v-prefixed semver (e.g. `v7.81.1`). Runway always increments the patch past any
 ...
 */
export const OTA_VERSION: string = 'v7.81.1';
