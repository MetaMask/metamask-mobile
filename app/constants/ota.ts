 ...
 * OTA hotfix branches are `release/X.Y.Z-ota` (e.g. `release/8.4.2-ota`); CI detects OTA
 ...
 * bare v-prefixed semver (e.g. `v8.4.2`). Runway always increments the patch past any
