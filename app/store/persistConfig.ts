...
const createPersistConfig = ({
  ...
  transforms,
  stateReconciler: customStateReconcilier ?? autoMergeLevel2, // see "Merge Process" section for details.
  migrate,
  timeout,
  writeFailHandler,
});
...
export const rootPersistConfig = createPersistConfig({
  ...
  customStateReconcilier: (inboundState: any, originalState: any) =>
