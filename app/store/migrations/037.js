...
function migrate(stateAsync) {
    return __awaiter(this, void 0, void 0, function () {
        var state, keyringControllerState, networkControllerState;
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    if (!(0, utils_1.isObject)(state)) {
                        (0, react_native_1.captureException)(new Error("Migration 37: Invalid state error: '".concat(typeof state, "'")));
                        return [2 /*return*/, state];
                    }
                    if (!(0, utils_1.isObject)(state.engine)) {
                        (0, react_native_1.captureException)(new Error("Migration 37: Invalid engine state error: '".concat(typeof state.engine, "'")));
                        return [2 /*return*/, state];
                    }
                    if (!(0, utils_1.isObject)(state.engine.backgroundState)) {
                        (0, react_native_1.captureException)(new Error("Migration 37: Invalid engine backgroundState error: '".concat(typeof state
                            .engine.backgroundState, "'")));
                        return [2 /*return*/, state];
                    }
                    keyringControllerState = state.engine.backgroundState.KeyringController;
                    if (!(0, utils_1.isObject)(keyringControllerState)) {
                        (0, react_native_1.captureException)(new Error("Migration 37: Invalid vault in KeyringController: '".concat(typeof keyringControllerState, "'")));
                    }
                    networkControllerState = state.engine.backgroundState.NetworkController;
                    if (!(0, utils_1.isObject)(networkControllerState)) {
                        (0, react_native_1.captureException)(new Error("Migration 37: Invalid NetworkController state error: '".concat(typeof networkControllerState, "'")));
                        return [2 /*return*/, state];
                    }
