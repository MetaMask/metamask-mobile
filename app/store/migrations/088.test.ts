...
describe('Migration #88 - Replace BSC Network RPC URL', () => {
  ...
  const invalidStates = [
    {
      state: null,
      errorMessage: "FATAL ERROR: Migration 88: Invalid state error: 'object'",
    ...
    },
    {
      ...
      errorMessage:
        "FATAL ERROR: Migration 88: Invalid engine state error: 'object'",
    ...
    },
    {
      ...
      errorMessage:
        "FATAL ERROR: Migration 88: Invalid engine backgroundState error: 'object'",
