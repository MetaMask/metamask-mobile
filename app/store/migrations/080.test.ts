  ...
  it.each([
    {
      ...
      expectedError:
        "FATAL ERROR: Migration 80: Invalid TokenBalancesController state error: 'string'",
    },
    {
      state: {
        engine: {
      ...
      expectedError:
        "FATAL ERROR: Migration 80: Invalid TokenBalancesController state error: 'object'",
    },
    {
      state: {
        engine: {
      ...
      expectedError:
        "FATAL ERROR: Migration 80: Invalid TokensController state error: 'string'",
    },
    {
      state: {
        engine: {
      ...
      expectedError:
        "FATAL ERROR: Migration 80: Invalid TokensController state error: 'object'",
    },
    {
      state: {
        engine: {
    ...
    },
    {
      ...
      expectedError:
        "FATAL ERROR: Migration 80: Invalid AccountsController state error: 'string'",
    },
    {
      state: {
        engine: {
      ...
      expectedError:
        "FATAL ERROR: Migration 80: Invalid AccountsController state error: 'object'",
    },
  ])(
