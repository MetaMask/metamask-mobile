...
describe(`Migration ${migrationVersion}: Derive osAuthEnabled from legacy storage flags`, () => {
  beforeEach(() => {
    jest.resetAllMocks();
  });
  ...
  it('captures exception and returns state when security object does not exist', async () => {
