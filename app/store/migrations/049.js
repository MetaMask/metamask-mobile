...
function migrate(state) {
    return __awaiter(this, void 0, void 0, function () {
        var keys, _i, keys_1, key, value, error_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, async_storage_1["default"].getAllKeys()];
                case 1:
                    keys = _c.sent();
                    _i = 0, keys_1 = keys;
                    _c.label = 2;
                case 2:
                    if (!(_i < keys_1.length)) return [3 /*break*/, 8];
                    key = keys_1[_i];
                    _c.label = 3;
                case 3:
                    _c.trys.push([3, 6, , 7]);
                ...
                case 6:
                    error_1 = _c.sent();
                    (0, react_native_1.captureException)("Failed to migrate key \"".concat(key, "\" from AsyncStorage to MMKV! Error: ").concat(error_1));
                    return [3 /*break*/, 7];
                case 7:
                    _i++;
                    return [3 /*break*/, 2];
