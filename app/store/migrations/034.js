...
function migrate(stateAsync) {
    return __awaiter(this, void 0, void 0, function () {
        var state, networkControllerState, newNetworkControllerState;
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    if (!(0, utils_1.isObject)(state)) {
                        (0, react_native_1.captureException)(new Error("Migration 34: Invalid root state: '".concat(typeof state, "'")));
                        return [2 /*return*/, state];
                    }
                    if (!(0, utils_1.isObject)(state.engine)) {
                        (0, react_native_1.captureException)(new Error("Migration 34: Invalid root engine state: '".concat(typeof state.engine, "'")));
                        return [2 /*return*/, state];
                    }
                    if (!(0, utils_1.isObject)(state.engine.backgroundState)) {
                        (0, react_native_1.captureException)(new Error("Migration 34: Invalid root engine backgroundState: '".concat(typeof state
                    ...
                    if (!(0, utils_1.isObject)(networkControllerState)) {
                        (0, react_native_1.captureException)(new Error("Migration 34: Invalid NetworkController state: '".concat(typeof networkControllerState, "'")));
                        return [2 /*return*/, state];
                    }
                    if (!(0, utils_1.hasProperty)(networkControllerState, 'providerConfig') ||
                        !(0, utils_1.isObject)(networkControllerState.providerConfig)) {
                        (0, react_native_1.captureException)(new Error("Migration 34: Invalid NetworkController providerConfig: '".concat(typeof networkControllerState.providerConfig, "'")));
                        return [2 /*return*/, state];
                    }
