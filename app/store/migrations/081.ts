...
const migration = (state: unknown): unknown => {
  ...
  if (
    ...
    captureException(
      new Error(
        `FATAL ERROR: Migration 81: Invalid TokenBalancesController state error: '${typeof tokenBalancesControllerState}'`,
      ),
    );
    return state;
  }
  ...
  if (
    ...
    captureException(
      new Error(
        `FATAL ERROR: Migration 81: Invalid TokensController state error: '${typeof tokensControllerState}'`,
      ),
    );
    return state;
  }
  ...
  if (
    ...
    captureException(
      new Error(
        `FATAL ERROR: Migration 81: Invalid AccountsController state error: '${typeof accountsControllerState}'`,
      ),
    );
    return state;
  }
