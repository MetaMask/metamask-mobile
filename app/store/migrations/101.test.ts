...
describe('Migration 101: Delete old and unused UserStorageController properties', () => {
  beforeEach(() => {
    jest.resetAllMocks();
  });
  ...
  it.each([
    {
      ...
      expectedError:
        "FATAL ERROR: Migration 101: Invalid UserStorageController state error: 'string'",
    },
    {
      state: {
        engine: {
      ...
      test: 'invalid UserStorageController state',
      expectedError:
        "FATAL ERROR: Migration 101: Invalid UserStorageController state error: 'undefined'",
    },
  ])(
