...
export default async function migrate(stateAsync: unknown) {
  ...
  if (!isObject(tokenListControllerState)) {
    captureException(
      new Error(
        `Migration 33: Invalid TokenListController state: '${JSON.stringify(
  ...
  if (
    ...
    captureException(
      new Error(
        `Migration 33: Invalid tokenListControllerState tokensChainsCache: '${JSON.stringify(
  ...
  if (!isObject(tokenRatesControllerState)) {
    captureException(
      new Error(
        `Migration 33: Invalid TokenRatesController state: '${JSON.stringify(
  ...
  if (!isObject(tokensControllerState)) {
    captureException(
      new Error(
        `Migration 33: Invalid TokensController state: '${JSON.stringify(
  ...
  if (
    ...
    captureException(
      new Error(
        `Migration 33: Invalid TokensController allTokens: '${JSON.stringify(
  ...
  if (
    ...
    captureException(
      new Error(
        `Migration 33: Invalid TokensController allIgnoredTokens: '${JSON.stringify(
  ...
  if (
    ...
    captureException(
      new Error(
        `Migration 33: Invalid TokensController allDetectedTokens: '${JSON.stringify(
