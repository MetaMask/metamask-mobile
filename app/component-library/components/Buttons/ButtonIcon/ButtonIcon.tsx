 ...
 * @see {@link https://github.com/MetaMask/metamask-design-system/blob/v34.0.0/packages/design-system-react-native/MIGRATION.md#buttonicon-component Migration docs}
 */
const ButtonIcon = ({
  iconName,
  onPress,
