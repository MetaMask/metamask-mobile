...
AccountAvatarOnNetwork is a component that renders an avatar based on the users account address. This component is based on the [BaseAvatar](../BaseAvatar/BaseAvatar.tsx) component.
