...
import { NotificationsActionsTypes } from '../../../../../../components/Views/Settings/NotificationsSettings/NotificationsSettings.constants';
...
export const TEST_NOTIFICATIONS_ACTION = NotificationsActionsTypes.SENT;
