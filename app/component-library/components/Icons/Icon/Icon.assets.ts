...
import arrow2uprightSVG from './assets/arrow-2-upright.svg';
...
import chart2SVG from './assets/chart-2.svg';
import chartSVG from './assets/chart.svg';
import checkboldSVG from './assets/check-bold.svg';
import checkboxoffSVG from './assets/check-box-off.svg';
import checkboxonSVG from './assets/check-box-on.svg';
import checkcircleoffSVG from './assets/check-circle-off.svg';
...
import userminusSVG from './assets/user-minus.svg';
import userremoveSVG from './assets/user-remove.svg';
import usersearchSVG from './assets/user-search.svg';
import usertickSVG from './assets/user-tick.svg';
...
export const assetByIconName: AssetByIconName = {
  ...
  [IconName.Chart2]: chart2SVG,
  [IconName.Chart]: chartSVG,
  [IconName.CheckBold]: checkboldSVG,
  [IconName.CheckBoxOff]: checkboxoffSVG,
  [IconName.CheckBoxOn]: checkboxonSVG,
  [IconName.CheckCircleOff]: checkcircleoffSVG,
  ...
  [IconName.Usb]: usbSVG,
  [IconName.UserAdd]: useraddSVG,
  [IconName.UserCheck]: usercheckSVG,
  [IconName.UserCircleAdd]: usercircleaddSVG,
  [IconName.UserCircle]: usercircleSVG,
  [IconName.UserMinus]: userminusSVG,
  [IconName.UserRemove]: userremoveSVG,
  [IconName.UserSearch]: usersearchSVG,
  [IconName.UserTick]: usertickSVG,
