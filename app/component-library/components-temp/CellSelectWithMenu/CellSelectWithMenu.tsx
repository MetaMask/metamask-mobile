...
import {
  DEFAULT_CELLSELECT_WITH_BUTTON_SECONDARYTEXT_TEXTVARIANT,
  DEFAULT_CELLSELECT_WITH_BUTTON_AVATAR_SIZE,
  DEFAULT_CELLSELECT_WITH_BUTTON_TITLE_TEXTVARIANT,
} from './CellSelectWithMenu.constants';
    ...
    >
      <View style={styles.cellBase}>
        ...
        <Avatar
          ...
          size={DEFAULT_CELLSELECT_WITH_BUTTON_AVATAR_SIZE}
          {...avatarProps}
        />
        <View style={styles.cellBaseInfo}>
          <Text
            numberOfLines={1}
            variant={DEFAULT_CELLSELECT_WITH_BUTTON_TITLE_TEXTVARIANT}
