...
/**
 * Props for the HeaderCollapsible component.
 */
export interface HeaderCollapsibleProps extends HeaderBaseProps {
   ...
   * This content is displayed when the header is expanded and collapses as the user scrolls.
   */
...
/**
 * Options for the useHeaderCollapsible hook.
 */
export interface UseHeaderCollapsibleOptions {
  /**
...
/**
 * Return type for the useHeaderCollapsible hook.
 */
export interface UseHeaderCollapsibleReturn {
  /**
   ...
   * Pass this to HeaderCollapsible's onExpandedHeightChange prop.
   */
