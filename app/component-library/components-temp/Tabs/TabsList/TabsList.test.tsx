...
describe('TabsList', () => {
  ...
  describe('Auto Height Mode', () => {
    ...
    it('disables height measurement when autoHeight is false', () => {
      const { getByTestId } = render(
        <TabsList autoHeight={false} testID="tabs-list">
    ...
    it('measures and sets tab height when autoHeight is true', async () => {
      const { rerender } = render(
        <TabsList autoHeight testID="tabs-list">
          <View {...({ tabLabel: 'Tab 1' } as TabViewProps)}>
            <Text>Content 1</Text>
          </View>
        </TabsList>,
    ...
    it('clears height when autoHeight is disabled', () => {
      const { rerender } = render(
        <TabsList autoHeight testID="tabs-list">
          <View {...({ tabLabel: 'Tab 1' } as TabViewProps)}>
            <Text>Content 1</Text>
    ...
    it('updates height when switching tabs in autoHeight mode', async () => {
      const { getAllByText } = render(
        <TabsList autoHeight initialActiveIndex={0}>
          <View {...({ tabLabel: 'Tab 1' } as TabViewProps)}>
    ...
    it('ignores height changes below threshold', () => {
      render(
        <TabsList autoHeight testID="tabs-list">
          <View {...({ tabLabel: 'Tab 1' } as TabViewProps)}>
            <Text>Content</Text>
  ...
  describe('Tab Loading and Cleanup', () => {
    beforeEach(() => {
      jest.useFakeTimers();
    });
    ...
    it('loads tab when navigating via tab press', async () => {
      const { getAllByText, getByText } = render(
        <TabsList initialActiveIndex={0}>
          <View {...({ tabLabel: 'Tab 1' } as TabViewProps)}>
            <Text>Content 1</Text>
  ...
  describe('Tab Height Cleanup', () => {
    it('removes heights for tabs that no longer exist', () => {
      const { rerender } = render(
        <TabsList>
          <View key="tab1" {...({ tabLabel: 'Tab 1' } as TabViewProps)}>
            <Text>Content 1</Text>
    ...
    it('cleans up measurement timers for removed tabs', () => {
      const { rerender } = render(
        <TabsList autoHeight>
          <View key="tab1" {...({ tabLabel: 'Tab 1' } as TabViewProps)}>
            <Text>Content 1</Text>
    ...
    it('preserves heights for tabs that still exist', () => {
  ...
  describe('Programmatic Scroll Handling', () => {
    beforeEach(() => {
      jest.useFakeTimers();
    });
    ...
    it('sets programmatic scroll flag when navigating via goToTabIndex', () => {
      const ref = React.createRef<TabsListRef>();
      render(
        <TabsList ref={ref} initialActiveIndex={0}>
          <View {...({ tabLabel: 'Tab 1' } as TabViewProps)}>
    ...
    it('clears programmatic scroll flag after delay', () => {
      const ref = React.createRef<TabsListRef>();
      render(
        <TabsList ref={ref} initialActiveIndex={0}>
          <View {...({ tabLabel: 'Tab 1' } as TabViewProps)}>
    ...
    it('handles rapid programmatic navigation', () => {
      const ref = React.createRef<TabsListRef>();
      render(
        <TabsList ref={ref} initialActiveIndex={0}>
          <View {...({ tabLabel: 'Tab 1' } as TabViewProps)}>
  ...
  describe('Scroll Event Timing', () => {
    ...
    it('defers tab loading until scroll ends', async () => {
      const { getByTestId } = render(
    ...
    it('clears pending scroll timeout on new scroll', () => {
      const { getByTestId } = render(
        <TabsList testID="tabs-container">
          <View {...({ tabLabel: 'Tab 1' } as TabViewProps)}>
            <Text>Content 1</Text>
    ...
    it('measures height after scroll settles in autoHeight mode', async () => {
      const { getByTestId } = render(
  ...
  describe('Edge Cases for New Code', () => {
    it('handles tab with zero height measurement', () => {
      render(
        <TabsList autoHeight>
          <View {...({ tabLabel: 'Tab 1' } as TabViewProps)}>
            <View testID="empty-content" />
          </View>
        </TabsList>,
      );
    });

    it('handles missing tab content ref during measurement', () => {
      const { rerender } = render(
        <TabsList autoHeight>
          <View {...({ tabLabel: 'Tab 1' } as TabViewProps)}>
            <Text>Content 1</Text>
    ...
    it('handles activeIndex out of bounds in autoHeight mode', () => {
      const { rerender } = render(
        <TabsList autoHeight initialActiveIndex={0}>
          <View {...({ tabLabel: 'Tab 1' } as TabViewProps)}>
            <Text>Content 1</Text>
      ...
      rerender(
        <TabsList autoHeight initialActiveIndex={5}>
          <View {...({ tabLabel: 'Tab 1' } as TabViewProps)}>
            <Text>Content 1</Text>
          </View>
        </TabsList>,
    ...
    it('handles invalid activeTab in height effect', () => {
      render(
        <TabsList autoHeight initialActiveIndex={-1}>
          <View {...({ tabLabel: 'Tab 1' } as TabViewProps)}>
            <Text>Content 1</Text>
          </View>
        </TabsList>,
