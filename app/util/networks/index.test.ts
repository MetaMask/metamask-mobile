...
describe('network-utils', () => {
  ...
  describe('fetchEstimatedMultiLayerL1Fee', () => {
    it('returns a non-0x prefixed hex string', async () => {
      const txMeta = {
        chainId: '0xa',
        txParams: {
          data: '',
  ...
  describe('findBlockExplorerForNonEvmAccount', () => {
    it('returns the correct block explorer URL for a Solana account', () => {
      const url = findBlockExplorerForNonEvmAccount(MOCK_SOLANA_ACCOUNT);
      expect(url).toBe(
        `https://explorer.solana.com/address/${MOCK_SOLANA_ACCOUNT.address}`,
      );
    });

    it('returns the correct block explorer URL for a Bitcoin account', () => {
      const url = findBlockExplorerForNonEvmAccount(MOCK_ACCOUNT_BIP122_P2WPKH);
      expect(url).toBe(
