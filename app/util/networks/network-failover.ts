...
const QUICKNODE_URL_GETTERS_BY_CHAIN_ID = new Map<
  ...
  () => string | undefined
>([
  [ChainId.mainnet, () => process.env.QUICKNODE_MAINNET_URL],
  [ChainId['linea-mainnet'], () => process.env.QUICKNODE_LINEA_MAINNET_URL],
  [ChainId['arbitrum-mainnet'], () => process.env.QUICKNODE_ARBITRUM_URL],
  [ChainId['avalanche-mainnet'], () => process.env.QUICKNODE_AVALANCHE_URL],
  [ChainId['optimism-mainnet'], () => process.env.QUICKNODE_OPTIMISM_URL],
  [ChainId['polygon-mainnet'], () => process.env.QUICKNODE_POLYGON_URL],
  [ChainId['base-mainnet'], () => process.env.QUICKNODE_BASE_URL],
  [ChainId['bsc-mainnet'], () => process.env.QUICKNODE_BSC_URL],
  [ChainId['zksync-mainnet'], () => process.env.QUICKNODE_ZKSYNC_URL],
  [ChainId['megaeth-mainnet'], () => process.env.QUICKNODE_MEGAETH_URL],
  [ChainId['sei-mainnet'], () => process.env.QUICKNODE_SEI_URL],
  [ChainId['monad-mainnet'], () => process.env.QUICKNODE_MONAD_URL],
  // HyperEVM, Arc and Robinhood are not part of the `ChainId` enum.
  [toHex(999), () => process.env.QUICKNODE_HYPEREVM_URL],
  [toHex(5042), () => process.env.QUICKNODE_ARC_URL],
  [toHex(4663), () => process.env.QUICKNODE_ROBINHOOD_URL],
]);
...
/**
 * Determines whether the given RPC endpoint URL matches a known QuickNode
 * failover URL.
 *
