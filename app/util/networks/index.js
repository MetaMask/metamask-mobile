...
import {
  ...
  LINEA_GOERLI,
  LINEA_MAINNET,
  NETWORKS_CHAIN_ID_DECIMAL_STRING,
...
export const BLOCKAID_SUPPORTED_CHAIN_IDS = [
  NETWORKS_CHAIN_ID_DECIMAL_STRING.MAINNET,
  NETWORKS_CHAIN_ID_DECIMAL_STRING.BSC,
  NETWORKS_CHAIN_ID_DECIMAL_STRING.POLYGON,
  NETWORKS_CHAIN_ID_DECIMAL_STRING.ARBITRUM,
  NETWORKS_CHAIN_ID_DECIMAL_STRING.OPTIMISM,
  NETWORKS_CHAIN_ID_DECIMAL_STRING.AVAXCCHAIN,
  NETWORKS_CHAIN_ID_DECIMAL_STRING.LINEA_MAINNET,
];
