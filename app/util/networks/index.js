...
export const BLOCKAID_SUPPORTED_CHAIN_IDS = [
  NETWORKS_CHAIN_ID_DECIMAL.MAINNET,
  NETWORKS_CHAIN_ID_DECIMAL.BSC,
  NETWORKS_CHAIN_ID_DECIMAL.POLYGON,
  NETWORKS_CHAIN_ID_DECIMAL.ARBITRUM,
  NETWORKS_CHAIN_ID_DECIMAL.OPTIMISM,
  NETWORKS_CHAIN_ID_DECIMAL.AVAXCCHAIN,
  NETWORKS_CHAIN_ID_DECIMAL.LINEA_MAINNET,
];
