...
export const ANALYTICS_EVENT_OPTS = {
	...
	// Swaps
	SWAPS_OPENED: generateOpt(CATEGORIES.SWAPS, ACTIONS.SWAP, NAMES.SWAPS_OPENED),
	QUOTES_REQUESTED: generateOpt(CATEGORIES.SWAPS, ACTIONS.QUOTE, NAMES.QUOTES_REQUESTED),
	QUOTES_RECEIVED: generateOpt(CATEGORIES.SWAPS, ACTIONS.QUOTE, NAMES.QUOTES_RECEIVED),
	QUOTES_REQUEST_CANCELLED: generateOpt(CATEGORIES.SWAPS, ACTIONS.QUOTE, NAMES.QUOTES_REQUEST_CANCELLED),
	ALL_AVAILABLE_QUOTES_OPENED: generateOpt(CATEGORIES.SWAPS, ACTIONS.QUOTE, NAMES.ALL_AVAILABLE_QUOTES_OPENED),
	SWAP_STARTED: generateOpt(CATEGORIES.SWAPS, ACTIONS.SWAP, NAMES.SWAP_STARTED),
	SWAP_COMPLETED: generateOpt(CATEGORIES.SWAPS, ACTIONS.SWAP, NAMES.SWAP_COMPLETED),
	SWAP_FAILED: generateOpt(CATEGORIES.SWAPS, ACTIONS.SWAP, NAMES.SWAP_FAILED),
	SWAP_TRACKING_FAILED: generateOpt(CATEGORIES.SWAPS, ACTIONS.SWAP, NAMES.SWAP_TRACKING_FAILED),
	QUOTES_TIMED_OUT: generateOpt(CATEGORIES.SWAPS, ACTIONS.QUOTE, NAMES.QUOTES_TIMED_OUT),
	NO_QUOTES_AVAILABLE: generateOpt(CATEGORIES.SWAPS, ACTIONS.QUOTE, NAMES.NO_QUOTES_AVAILABLE),
	GAS_FEES_CHANGED: generateOpt(CATEGORIES.SWAPS, ACTIONS.QUOTE, NAMES.GAS_FEES_CHANGED),
	EDIT_SPEND_LIMIT_OPENED: generateOpt(CATEGORIES.SWAPS, ACTIONS.QUOTE, NAMES.EDIT_SPEND_LIMIT_OPENED)
};
