...
// Mock @react-navigation/native to provide required functions
jest.mock('@react-navigation/native', () => {
  ...
  return {
    ...actualNavigation,
    createNavigatorFactory: jest.fn((routeConfig) => {
      return (options) => {
        return {
          Navigator: ({ children }) =>
...
// Mock @react-navigation/stack to provide createStackNavigator
jest.mock('@react-navigation/stack', () => {
  ...
  return {
    createStackNavigator: jest.fn(() => ({
      Navigator: ({ children }) =>
        React.createElement(React.Fragment, null, children),
      Screen: ({ children, component, ...props }) => {
        if (component) {
