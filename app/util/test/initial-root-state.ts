...
import { initialState as initialNetworkConnectionBannersState } from '../../reducers/networkConnectionBanners';
...
const initialRootState: RootState = {
  ...
  networkConnectionBanners: initialNetworkConnectionBannersState,
};
