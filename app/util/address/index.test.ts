...
describe('renderSlightlyLongAddress', () => {
	...
	it('should return 5 characters before ellipsis and 4 final characters of the address after the ellipsis', () => {
		expect(renderSlightlyLongAddress('0xC4955C0d639D99699Bfd7Ec54d9FaFEe40e4D272').split('.')[0].length).toBe(24);
		expect(renderSlightlyLongAddress('0xC4955C0d639D99699Bfd7Ec54d9FaFEe40e4D272').split('.')[3].length).toBe(4);
	});
	it('should return 0xC4955 before ellipsis and 4D272 after the ellipsis', () => {
		expect(renderSlightlyLongAddress('0xC4955C0d639D99699Bfd7Ec54d9FaFEe40e4D272', 5, 2).split('.')[0]).toBe(
			'0xC4955'
		);
		expect(renderSlightlyLongAddress('0xC4955C0d639D99699Bfd7Ec54d9FaFEe40e4D272', 5, 0).split('.')[3]).toBe(
			'4D272'
		);
	});
});
