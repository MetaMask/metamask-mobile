...
describe('isDefaultAccountName', () => {
	...
	it('should match RegEx if name "Account 1" have default pattern', () => {
		expect(isDefaultAccountName(accountNameDefaultOne)).toEqual(true);
	});
	const accountNameDefaultTwo = 'Account 99999';
	it('should match RegEx if name "Account 99999" have default pattern', () => {
	...
	it('should not match RegEx if name does not have default pattern', () => {
