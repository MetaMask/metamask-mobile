...
describe('formatDisplayAmount', () => {
  ...
  it('rounds number to 2 decimals by default -- down if less than 5', () => {
    expect(formatDisplayAmount(5.454)).toBe('5.45');
    expect(formatDisplayAmount('5.454')).toBe('5.45');
    expect(formatDisplayAmount(new bn(5.454))).toBe('5.45');
  });
  it('rounds number to 2 decimals by default -- up if greater than 5', () => {
    expect(formatDisplayAmount(5.455)).toBe('5.46');
    expect(formatDisplayAmount('5.455')).toBe('5.46');
    expect(formatDisplayAmount(new bn(5.455))).toBe('5.46');
  });
  it('rounds number to 4 decimals with second arg', () => {
    expect(formatDisplayAmount(5.45446, 4)).toBe('5.4545');
    expect(formatDisplayAmount('5.45446', 4)).toBe('5.4545');
    expect(formatDisplayAmount(new bn(5.45446), 4)).toBe('5.4545');
  });
  it('displays minimum amount of decimals', () => {
    expect(formatDisplayAmount('5.40000')).toBe('5.4');
  });
});
...
describe('formatCountdown', () => {
  it('displays correctly for 0 seconds', () => {
    const countdown = formatCountdown(0);
    expect(countdown).toBe('00:00');
  });

  it('displays correctly for 1 second', () => {
    const countdown = formatCountdown(1);
    expect(countdown).toBe('00:01');
  });

  it('displays correctly for 60 seconds', () => {
    const countdown = formatCountdown(60);
    expect(countdown).toBe('01:00');
  });

  it('displays correctly for 61 seconds', () => {
    const countdown = formatCountdown(61);
    expect(countdown).toBe('01:01');
  });
});

// Left some TODO tests because the approach seemed validated and there were already a lot of tests
describe('formatPercent', () => {
  ...
  it.todo('converts basis points provided as a string to a formatted decimal');
  it.todo(
    'converts basis points provided as a number to a formatted decimal with a fixed number of decimals',
  );
  it.todo(
    'converts basis points provided as a string to a formatted decimal with a fixed number of decimals',
  );
  ...
  it.todo('converts decimals provided as a string to a formatted decimal');
  it.todo(
    'converts decimals provided as a number to a formatted decimal with a fixed number of decimals',
  );
  it.todo(
    'converts decimals provided as a string to a formatted decimal with a fixed number of decimals',
  );
  ...
  it.todo(
    'converts basis points provided as a number to a formatted percentage',
  );
  it.todo(
    'converts basis points provided as a string to a formatted percentage',
  );
  it.todo(
    'converts basis points provided as a number to a formatted percentage with a fixed number of decimals',
  );
  it.todo(
    'converts basis points provided as a string to a formatted percentage with a fixed number of decimals',
  );

  it.todo('converts decimals provided as a number to a formatted percentage');
  it.todo('converts decimals provided as a string to a formatted percentage');
  it.todo(
    'converts decimals provided as a number to a formatted percentage with a fixed number of decimals',
  );
  it.todo(
    'converts decimals provided as a string to a formatted percentage with a fixed number of decimals',
  );
