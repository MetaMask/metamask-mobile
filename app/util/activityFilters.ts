import type { ActivityKind } from './activity-adapters';
...
export function isActivityTypeFilter(
  value: unknown,
): value is ActivityTypeFilter {
  return (
    typeof value === 'string' &&
    Object.values(ActivityTypeFilter).includes(value as ActivityTypeFilter)
  );
}
