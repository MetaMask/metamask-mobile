...
Skipping `yarn skills` is fine — it only affects agent tooling, not the app build. To opt into best-effort regeneration during install/setup, set `SKILLS_AUTO_UPDATE=1`.
