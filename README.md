...
- _Non-MetaMask Only:_  Fill `MM_SENTRY_DSN` in `.js.env` if you want the app to emit logs to your own Sentry project. For Sentry properties, you can either place the `sentry.properties` file in the root directory or as instructed from the Sentry [docs](https://docs.sentry.io/platforms/react-native/).
