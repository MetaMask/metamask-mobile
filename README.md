...
-   Install the shared [React Native dependencies](https://reactnative.dev/docs/0.65/environment-setup#installing-dependencies) (`React Native CLI`, _not_ `Expo Go`)
    ...
    -   But [Node](https://nodejs.org) v14 where mentioned _make sure it is Node 12 or newer_
        ...
        -   If you are using [nvm](https://github.com/creationix/nvm#installation) (recommended) running `nvm install` then `nvm use` will automatically use the right node version from [.nvmrc](https://github.com/MetaMask/metamask-mobile/blob/f7e44adc7b61b71fdf6794b0fcad2531561c2f95/.nvmrc#L1)
