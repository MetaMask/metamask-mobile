...
## Current Main Branch
- [#7551](https://github.com/MetaMask/metamask-mobile/pull/7551): 7.10.0
- [#7698](https://github.com/MetaMask/metamask-mobile/pull/7698): refactor(readme): node version 18
- [#7652](https://github.com/MetaMask/metamask-mobile/pull/7652): feat: 7.9.1
...
- [#7672](https://github.com/MetaMask/metamask-mobile/pull/7672): [E2e] Removed duplicate tests in quarantine
...
- [#7618](https://github.com/MetaMask/metamask-mobile/pull/7618): Show message on UI when blockaid validation fails
...
- [#7363](https://github.com/MetaMask/metamask-mobile/pull/7363): Integrating ppom update tool into mobile build
