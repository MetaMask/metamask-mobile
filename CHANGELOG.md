...
- Added new network client megaeth-testnet-v2 Removed network client megaeth-testnet (#23961)
- Updated mUSD conversion card design with new copy and close button styling (#24491)
- Updated header and footer styling across account management screens to align with new design system (#24306)
- Token insights modal (#24298)
- chore: sync stable to main for version 7.62.0 (#23505)
- Bump assets controllers to v95.1.0 (#24316)
- Added support for `download-extension` deeplink action to enable direct navigation to extension download flow (#24255)
- Updated headers and footers in import token and NFT flows to use design system components (#24304)
- Add MSU network and native token logos. Add Etherlink network and native token logos. (#24109)
- chore: refine import account screen (#24301)
- Fixed inconsistent header and footer spacing in swap and bridge modals (#24273)
- Add BOB network and native token logos. Add Rootstock network and native token logos. (#24243)
- Fixed gas fees sponsored tooltip message (#24321)
- chore: QR share bottom sheet UI refinements (#24276)
- Flip logical order of buttons on last screen of perps onboarding (#24269)
- Updated network fee tooltip for gas fees sponsored case (#24258)
- Bump @metamask/tron-wallet-snap to 1.17.0 (#24185)
- Removes dead state code from PerpsController (#24251)
- Added RC and Production EAS certificates (#24220)
- chore: move network icon to the left in network filter in send flow (#24202)
- Added disclaimer to Predict market details About tab informing users to check Polymarket for full market rules (#24265)
- Optimize PerpsSelectors in PerpsMarketBalanceActions (#24124)
- chore: merge release to main (#24226)
- Improve developer docs related to deeplinking (#24037)
- Stop re-rendering 'trending' when navigating back to it (#24141)
- Bump `@metamask/notification-services-controller` to `^21.0.0` (#24164)
- Fixed mUSD CTA incorrectly appearing on unsupported chains like BSC (#24048)
- Improved recent trades loading performance in Perps (#24122)
- Improve code quality on tokens list and remove deprecated code (#24074)
- Add Perps Learn More CTA to Perps onboarding flow (#24036)
- chore: extract revealprivatecredential (#24088)
- Refined network picker user interface (#23992)
- Refine Custom Network button and avatar styles (#23581)
- Update region selector (#23876)
- Reduce API calls to chains.json (#24016)
- Fix jumpy asset details graph (#23681)
- Refine DeFi details spacing and avatar size (#23578)
- Bump assets controllers to v94.1.0 (#24005)
- Remove announcement settings sparkle icon (#23932)
- Adds metrics for trending feature (#23674)
- Improve Snaps registry verification speed. (#23769)
- chore: update selected item state background color (#23894)
- Fixes intermittent font rendering issues on first load of the app or import of SRP (#23517)
- Update ENS snap (#23871)
- Update card onboarding flow according to new design (#23706)
- Fix new hip3 asset logos not rendering (#23729)
- Fixed inconsistent vertical padding in Add Funds modal to improve visual consistency (#23556)
- Updated Activity page filter buttons to use design system components with consistent styling (#21236)
- Fixed security issue where external deep links could bypass user consent modals. Signed links from in-app sources (carousel, (#23692)
  notifications, QR scanner) now bypass the redirect modal, while external
  links always show appropriate warnings.
- Bump assets controllers to v93 (#23606)
- Adds 2 missing properties for transaction events (#23539)
- Fix to account specific pending perps withdraws (#23497)
- Updated Swap network names (#23541)
- Added the network and token icons for X Layer (#23540)
- Added URLs originating from within app to whitelist to bypass the interstitial modal (#23564)
- Bump assets controllers to v92 (#23411)
- Trending bug fixes and improvements (#23359)
...
[7.63.0]: https://github.com/MetaMask/metamask-mobile/compare/v7.61.6...v7.63.0
