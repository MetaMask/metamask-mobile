...
- test: add performance tests for the market details page ([#22034](https://github.com/MetaMask/metamask-mobile/pull/22034))
- feat(ramps): adds ramps token selector clicked event ([#22121](https://github.com/MetaMask/metamask-mobile/pull/22121))
- feat(perps): use price updates to compute live positions ([#22100](https://github.com/MetaMask/metamask-mobile/pull/22100))
- fix(perps): Incorrect overlay in Close Position bottom sheet ([#22138](https://github.com/MetaMask/metamask-mobile/pull/22138))
- fix(card): add temporary fix for crashing KYC webview on Android ([#22200](https://github.com/MetaMask/metamask-mobile/pull/22200))
- feat(predict): add consent sheet ([#22071](https://github.com/MetaMask/metamask-mobile/pull/22071))
- fix(perps): update drag value in tap handler ([#21608](https://github.com/MetaMask/metamask-mobile/pull/21608))
- fix(perps): resolve CLIENT_NOT_INITIALIZED race condition during initialization ([#22178](https://github.com/MetaMask/metamask-mobile/pull/22178))
- feat(ramps): creates a smart routing hook with redux state ([#22111](https://github.com/MetaMask/metamask-mobile/pull/22111))
- feat(predict): disable geo-blocking for withdraw ([#22176](https://github.com/MetaMask/metamask-mobile/pull/22176))
- fix(card): Onboarding UI issues ([#22140](https://github.com/MetaMask/metamask-mobile/pull/22140))
- chore(INFRA-3081): add branch name validation step for changelog refresh ([#21853](https://github.com/MetaMask/metamask-mobile/pull/21853))
- fix(perps): missing referral code inpnl card tat-1981 ([#22175](https://github.com/MetaMask/metamask-mobile/pull/22175))
- fix(perps): invalid decimals in pnl card ([#22174](https://github.com/MetaMask/metamask-mobile/pull/22174))
- fix(perps): TAT-1966 close all positions not including discount ([#22112](https://github.com/MetaMask/metamask-mobile/pull/22112))
- feat(perps): Add market-level allowlist/blocklist filtering for HIP-3 ([#22086](https://github.com/MetaMask/metamask-mobile/pull/22086))
- feat(perps): design alignment for open-interest cap reached banner ([#22107](https://github.com/MetaMask/metamask-mobile/pull/22107))
- feat(ramps): Update ramp tracking calls to include readable token info ([#22078](https://github.com/MetaMask/metamask-mobile/pull/22078))
- chore: remove ppom local fallback ([#21474](https://github.com/MetaMask/metamask-mobile/pull/21474))
- feat(predict): optimistic balances & invalidate query cache ([#22144](https://github.com/MetaMask/metamask-mobile/pull/22144))
- chore: fix market details header, market feed header and avatars ([#22152](https://github.com/MetaMask/metamask-mobile/pull/22152))
- test: disable predictions e2e ([#22161](https://github.com/MetaMask/metamask-mobile/pull/22161))
- chore(predict): Visual tweaks from (visual) bug bash ([#22157](https://github.com/MetaMask/metamask-mobile/pull/22157))
- chore: Improved error catching block to know when feature flag update fails cp-7.58.0 ([#22142](https://github.com/MetaMask/metamask-mobile/pull/22142))
- chore: Consolidate link types and implement normalizer (Phase 1 - PR 1) ([#21869](https://github.com/MetaMask/metamask-mobile/pull/21869))
- feat(ramp): add buy unified button (no nav) ([#22122](https://github.com/MetaMask/metamask-mobile/pull/22122))
- test: increases timeout and removes sync enable step ([#22145](https://github.com/MetaMask/metamask-mobile/pull/22145))
- feat(ramps): request data incrementally in buildquote ([#21775](https://github.com/MetaMask/metamask-mobile/pull/21775))
- chore(perps): remove dead code and document architecture ([#22101](https://github.com/MetaMask/metamask-mobile/pull/22101))
- feat(predict): optimistic updates for sold/claimed positions ([#21987](https://github.com/MetaMask/metamask-mobile/pull/21987))
- feat(ramps): adds event for tracking when user details are fetched ([#22000](https://github.com/MetaMask/metamask-mobile/pull/22000))
- test: fixed flakiness ([#22129](https://github.com/MetaMask/metamask-mobile/pull/22129))
- test: disables the send native token tests ([#22134](https://github.com/MetaMask/metamask-mobile/pull/22134))
- test: unskip test ([#22099](https://github.com/MetaMask/metamask-mobile/pull/22099))
- chore: Update keyboard height to 48px to improve usability ([#21875](https://github.com/MetaMask/metamask-mobile/pull/21875))
- chore: upgrade auto-changelog v4 to v5 ([#22123](https://github.com/MetaMask/metamask-mobile/pull/22123))
- chore: fetch currencyRates with price api ([#21523](https://github.com/MetaMask/metamask-mobile/pull/21523))
- ci: Prevent XCode cache from expanding ([#22008](https://github.com/MetaMask/metamask-mobile/pull/22008))
- ci: Skip Gradle cache restoration for repack runs ([#22004](https://github.com/MetaMask/metamask-mobile/pull/22004))
- test: cleans the test resource approach and helper functions ([#21997](https://github.com/MetaMask/metamask-mobile/pull/21997))
- chore: bump `@metamask/multichain-account-service` to `^2.1.0` ([#22092](https://github.com/MetaMask/metamask-mobile/pull/22092))
- refactor: migrate away from Ramps ([#22010](https://github.com/MetaMask/metamask-mobile/pull/22010))
- chore(predict): Reduces auto-refresh timeout for buy/sell previews ([#22085](https://github.com/MetaMask/metamask-mobile/pull/22085))
- feat(predict): Adds pull-down-to-refresh on market details view ([#22088](https://github.com/MetaMask/metamask-mobile/pull/22088))
- feat(perps): HIP-3 upgrade with webData3 migration and performance improvements ([#22041](https://github.com/MetaMask/metamask-mobile/pull/22041))
- fix(card): delegation issues ([#22058](https://github.com/MetaMask/metamask-mobile/pull/22058))
- test: add assertions to claim activity view ([#22075](https://github.com/MetaMask/metamask-mobile/pull/22075))
- feat(ramp): add ramps unified v1 feature flag selectors + hook ([#22062](https://github.com/MetaMask/metamask-mobile/pull/22062))
- chore: improve quote streaming UX and prevent premature tx submission ([#21685](https://github.com/MetaMask/metamask-mobile/pull/21685))
- chore: bump cross-spawn wdio dep ([#21314](https://github.com/MetaMask/metamask-mobile/pull/21314))
- chore: sync stable to main for version 7.57.1 ([#21899](https://github.com/MetaMask/metamask-mobile/pull/21899))
- test(ramp): add unified ff mock ([#22069](https://github.com/MetaMask/metamask-mobile/pull/22069))
- test: adds function handling for fixture ([#21883](https://github.com/MetaMask/metamask-mobile/pull/21883))
- test: fixes for some tests that were failing ([#22059](https://github.com/MetaMask/metamask-mobile/pull/22059))
- fix(card): cp-7.58.0 fix non-gated feature flag ([#22057](https://github.com/MetaMask/metamask-mobile/pull/22057))
- test: add intial predictions claim e2e test ([#21546](https://github.com/MetaMask/metamask-mobile/pull/21546))
- test: Add waitForElementToDisappear option for confirm button ([#22055](https://github.com/MetaMask/metamask-mobile/pull/22055))
- fix(UnifiedTransactionsView): missing blockexplorer links ([#21921](https://github.com/MetaMask/metamask-mobile/pull/21921))
- fix(perps): price caching performance issues cp-7.58.0 ([#22038](https://github.com/MetaMask/metamask-mobile/pull/22038))
- New Crowdin translations by Github Action cp-7.58.0 ([#21920](https://github.com/MetaMask/metamask-mobile/pull/21920))
- chore: remove PORTFOLIO_VIEW feature flag ([#21806](https://github.com/MetaMask/metamask-mobile/pull/21806))
- fix(predict): Improves handling of markets with some resolved outcomes ([#21984](https://github.com/MetaMask/metamask-mobile/pull/21984))
- chore: Default Perps local and production builds to mainnet ([#21650](https://github.com/MetaMask/metamask-mobile/pull/21650))
- chore: Consolidate E2E commands and enable dynamic debug/release configuration for Android ([#21530](https://github.com/MetaMask/metamask-mobile/pull/21530))
- test: first test in smoke perps ([#21953](https://github.com/MetaMask/metamask-mobile/pull/21953))
- fix(perps): remove hardcoded color in RefreshControl ([#21916](https://github.com/MetaMask/metamask-mobile/pull/21916))
- feat(stx-controller): bump @metamask/smart-transaction-controller to 20.1.0 ([#21977](https://github.com/MetaMask/metamask-mobile/pull/21977))
- ci: Prevent Gradle cache size from expanding ([#21954](https://github.com/MetaMask/metamask-mobile/pull/21954))
- chore: cache generation implementation ([#21956](https://github.com/MetaMask/metamask-mobile/pull/21956))
- chore: Remove unused option ([#21929](https://github.com/MetaMask/metamask-mobile/pull/21929))
- test: change where perf builds are created ([#21979](https://github.com/MetaMask/metamask-mobile/pull/21979))
- test: add mock for batch transactions ([#21962](https://github.com/MetaMask/metamask-mobile/pull/21962))
- ci: remove concurrency group for inner test workflow ([#21939](https://github.com/MetaMask/metamask-mobile/pull/21939))
- chore(predict): change input screen action button ([#21935](https://github.com/MetaMask/metamask-mobile/pull/21935))
- feat(perps): handle hip-3 token icon ([#21928](https://github.com/MetaMask/metamask-mobile/pull/21928))
- chore(predict): update deposit toast text and fix addding funds ui ([#21969](https://github.com/MetaMask/metamask-mobile/pull/21969))
- chore(predict): rename metric amount to usdAmount ([#21958](https://github.com/MetaMask/metamask-mobile/pull/21958))
- chore: Revert "test: removes e2e references from bitrise.yml" ([#21968](https://github.com/MetaMask/metamask-mobile/pull/21968))
- feat(ramp): add detected region to ramp button events ([#21878](https://github.com/MetaMask/metamask-mobile/pull/21878))
- chore: cleanup asset events ([#21858](https://github.com/MetaMask/metamask-mobile/pull/21858))
- feat(card): cp-7.58.0 add card experimental deeplink ([#21955](https://github.com/MetaMask/metamask-mobile/pull/21955))
- fix(perps): invalid controller state on withdrawal ([#21925](https://github.com/MetaMask/metamask-mobile/pull/21925))
- test: Added e2e test validate balance for polymarket account ([#21930](https://github.com/MetaMask/metamask-mobile/pull/21930))
- feat(predict): Visual tweaks to market detail view ([#21936](https://github.com/MetaMask/metamask-mobile/pull/21936))
- chore: update default bridge slippage to 2% ([#21882](https://github.com/MetaMask/metamask-mobile/pull/21882))
- chore: Remove migration validation ([#21937](https://github.com/MetaMask/metamask-mobile/pull/21937))
- Remove broken link from documentation ([#21915](https://github.com/MetaMask/metamask-mobile/pull/21915))
- feat(perps): core infrastructure for hip-3 and batch methods ([#21799](https://github.com/MetaMask/metamask-mobile/pull/21799))
- feat(predict): Adds images for empty state in predict positions ([#21891](https://github.com/MetaMask/metamask-mobile/pull/21891))
- feat(predict): Visual tweaks / Default tab on market details ([#21857](https://github.com/MetaMask/metamask-mobile/pull/21857))
- chore(predict): move error codes and add string logic ([#21872](https://github.com/MetaMask/metamask-mobile/pull/21872))
- chore(predict): bug bash 3 ([#21873](https://github.com/MetaMask/metamask-mobile/pull/21873))
- chore(predict): fix deposit error toast ([#21931](https://github.com/MetaMask/metamask-mobile/pull/21931))
- test: Added cash out geo-restriction ([#21835](https://github.com/MetaMask/metamask-mobile/pull/21835))
- ci: Allow concurrent runs on `main` ([#21893](https://github.com/MetaMask/metamask-mobile/pull/21893))
- chore: New Crowdin translations by Github Action cp-7.58.0 ([#21902](https://github.com/MetaMask/metamask-mobile/pull/21902))
- test: fix regression android builds ([#21876](https://github.com/MetaMask/metamask-mobile/pull/21876))
- test: removes e2e references from bitrise.yml ([#21684](https://github.com/MetaMask/metamask-mobile/pull/21684))
- chore(predict): bump slippage to 1.5% ([#21879](https://github.com/MetaMask/metamask-mobile/pull/21879))
- ci: Fix merge queue checks ([#21892](https://github.com/MetaMask/metamask-mobile/pull/21892))
- chore: Fix format errors ([#21888](https://github.com/MetaMask/metamask-mobile/pull/21888))
- chore(predict): remove and change predict states ([#21827](https://github.com/MetaMask/metamask-mobile/pull/21827))
- fix(deposit): allow user to proceed with order creation when limits fetch fails cp-7.58.0 ([#21877](https://github.com/MetaMask/metamask-mobile/pull/21877))
- fix(predict): resolves feed jumping back to top when fast scrolling ([#21859](https://github.com/MetaMask/metamask-mobile/pull/21859))
- ci: enhance format check to block unformatted code in PRs ([#21801](https://github.com/MetaMask/metamask-mobile/pull/21801))
- chore: Run `yarn format` on all files ([#21866](https://github.com/MetaMask/metamask-mobile/pull/21866))
- feat(predict): Visual tweaks to Predict Positions ([#21863](https://github.com/MetaMask/metamask-mobile/pull/21863))
- feat(ramp): add state for detected geolocation ([#21856](https://github.com/MetaMask/metamask-mobile/pull/21856))
- refactor: migrate controllers to `@metamask/messenger` ([#21581](https://github.com/MetaMask/metamask-mobile/pull/21581))
- feat(card): cp-7.58.0 delegation flow ([#21667](https://github.com/MetaMask/metamask-mobile/pull/21667))
- chore: add energy and bandwidth toggle ([#21575](https://github.com/MetaMask/metamask-mobile/pull/21575))
- chore: remove deprecated network selector from settings ([#21614](https://github.com/MetaMask/metamask-mobile/pull/21614))
- chore: fix typo in isPortfolioViewEnabled property name ([#21808](https://github.com/MetaMask/metamask-mobile/pull/21808))
- fix(perps): cp-7.58.0 invalid tpsl behavior ([#21759](https://github.com/MetaMask/metamask-mobile/pull/21759))
- docs: improve Infura setup instructions in README and .js.env.example ([#21651](https://github.com/MetaMask/metamask-mobile/pull/21651))
- chore: cp-7.58.0 Add legal links and checkboxes to card onboarding ([#21814](https://github.com/MetaMask/metamask-mobile/pull/21814))
- test: add predictions ci workflows ([#21795](https://github.com/MetaMask/metamask-mobile/pull/21795))
- chore: update balance empty state to use primary button and buy flow ([#21817](https://github.com/MetaMask/metamask-mobile/pull/21817))
- chore: Remove TokenListFooter component in favor of balance empty state ([#21490](https://github.com/MetaMask/metamask-mobile/pull/21490))
- chore: Use universal link handler for metamask:// protocol ([#21005](https://github.com/MetaMask/metamask-mobile/pull/21005))
- chore(predict): add loading state to place order screen and remove toasts ([#21818](https://github.com/MetaMask/metamask-mobile/pull/21818))
- feat(card): cp-7.58.0 add delegation translations ([#21816](https://github.com/MetaMask/metamask-mobile/pull/21816))
- fix(predict): ensure polygon network exists ([#21813](https://github.com/MetaMask/metamask-mobile/pull/21813))
- chore(predict): change keypad to remove unnecessary props and show decimal dot ([#21810](https://github.com/MetaMask/metamask-mobile/pull/21810))
- chore: Incrementally add Perps Home screen V2 components ([#21804](https://github.com/MetaMask/metamask-mobile/pull/21804))
- feat(predict): cache balances at controller level ([#21756](https://github.com/MetaMask/metamask-mobile/pull/21756))
- feat(card): add authentication + onboarding metrics ([#21528](https://github.com/MetaMask/metamask-mobile/pull/21528))
- docs: update component library readme for storybook ([#21802](https://github.com/MetaMask/metamask-mobile/pull/21802))
- fix(snaps): Only trigger `onActive` and `onInactive` when client is unlocked ([#21664](https://github.com/MetaMask/metamask-mobile/pull/21664))
- chore(pipeline): Add BUGBOT rules to inc unit test guidelines ([#21760](https://github.com/MetaMask/metamask-mobile/pull/21760))
- refactor: update alignment in PerpsMarketListView ([#21793](https://github.com/MetaMask/metamask-mobile/pull/21793))
- chore: align opt design with authentication ([#21745](https://github.com/MetaMask/metamask-mobile/pull/21745))
- chore(predict): add error handling for predict actions ([#21590](https://github.com/MetaMask/metamask-mobile/pull/21590))
- feat(deposit): allow phone region to differ from KYC region ([#21002](https://github.com/MetaMask/metamask-mobile/pull/21002))
- chore: upgrade build-version action ([#21687](https://github.com/MetaMask/metamask-mobile/pull/21687))
- feat(multichain): update multichain accounts intro modal logic and tests ([#21762](https://github.com/MetaMask/metamask-mobile/pull/21762))
- test: Add e2e rewards feature ([#21767](https://github.com/MetaMask/metamask-mobile/pull/21767))
- docs: fix broken link ([#21404](https://github.com/MetaMask/metamask-mobile/pull/21404))
- fix(predict): fix error toast for claim and withdraw ([#21740](https://github.com/MetaMask/metamask-mobile/pull/21740))
- chore(predict): ui bug bash 2 ([#21683](https://github.com/MetaMask/metamask-mobile/pull/21683))
- fix(INFRA-3066): path based rebuilds ([#21747](https://github.com/MetaMask/metamask-mobile/pull/21747))
- chore: revert hardcoded fingerprint ([#21617](https://github.com/MetaMask/metamask-mobile/pull/21617))
- test(predict): add cash out position e2e ([#21545](https://github.com/MetaMask/metamask-mobile/pull/21545))
- refactor(predict): various visual tweaks (on card, feed, feed tabs) ([#21742](https://github.com/MetaMask/metamask-mobile/pull/21742))
- chore: Persist preferred candle period ([#21593](https://github.com/MetaMask/metamask-mobile/pull/21593))
- chore: cp-7.58.0 set MM_PERPS_ENABLED build flag to true ([#21734](https://github.com/MetaMask/metamask-mobile/pull/21734))
- test: e2e test for predict geo restriction ([#21435](https://github.com/MetaMask/metamask-mobile/pull/21435))
- chore(predict): remove dummy transactions from withdraw/deposit ([#21649](https://github.com/MetaMask/metamask-mobile/pull/21649))
- fix(predict): add funds modal redirect ([#21675](https://github.com/MetaMask/metamask-mobile/pull/21675))
- feat(INFRA-2576): Added new gh workflow to update changelog on cherrypicks to release ([#21434](https://github.com/MetaMask/metamask-mobile/pull/21434))
- feat(rewards|perps): support batch points estimation for perps ([#21658](https://github.com/MetaMask/metamask-mobile/pull/21658))
- test: updates the hash for setup e2e ([#21661](https://github.com/MetaMask/metamask-mobile/pull/21661))
- chore: move confirmation scenarios from regression to smoke E2E suite ([#21660](https://github.com/MetaMask/metamask-mobile/pull/21660))
- chore: adds TrxMethod to selectCanSignTransactions ([#21618](https://github.com/MetaMask/metamask-mobile/pull/21618))
- chore: show staked tron element in the Trx detail page ([#21413](https://github.com/MetaMask/metamask-mobile/pull/21413))
- chore: update reducer typing for signature request, legal notices, and accounts ([#21013](https://github.com/MetaMask/metamask-mobile/pull/21013))
- feat(card): general onboarding fixes ([#21652](https://github.com/MetaMask/metamask-mobile/pull/21652))
- chore: fix card KYC webview ([#21598](https://github.com/MetaMask/metamask-mobile/pull/21598))
- chore: update to 2 buttons when max leverage is 3 ([#21645](https://github.com/MetaMask/metamask-mobile/pull/21645))
- chore(predict): fix unit tests as per guidelines ([#21638](https://github.com/MetaMask/metamask-mobile/pull/21638))
- fix(ramps): cp-7.58.0 do not throw when user details fetch is 401 ([#21633](https://github.com/MetaMask/metamask-mobile/pull/21633))
- feat(card): Update onboarding images + metrics ([#21597](https://github.com/MetaMask/metamask-mobile/pull/21597))
- feat(card): Card Onboarding edge cases and Onboarding token management ([#21594](https://github.com/MetaMask/metamask-mobile/pull/21594))
- chore(predict): Improves predict market details tab order and visibility ([#21630](https://github.com/MetaMask/metamask-mobile/pull/21630))
- feat(predict): add predict withdraw ([#21495](https://github.com/MetaMask/metamask-mobile/pull/21495))
- chore: sync stable to main for version 7.57.0 ([#21538](https://github.com/MetaMask/metamask-mobile/pull/21538))
- feat(predict): sticky tabs in predict feed ([#21600](https://github.com/MetaMask/metamask-mobile/pull/21600))
- fix(predict): missing geoblock in certain actions ([#21588](https://github.com/MetaMask/metamask-mobile/pull/21588))
- test: changing the timer location to not count the GTM modals ([#21611](https://github.com/MetaMask/metamask-mobile/pull/21611))
- test: Adds CommandQueueServer to framework ([#21601](https://github.com/MetaMask/metamask-mobile/pull/21601))
- chore: Add `@metamask-previews/*` to NPM age gate exceptions ([#21610](https://github.com/MetaMask/metamask-mobile/pull/21610))
- feat(perps): swipable tabs in perps market details ([#21561](https://github.com/MetaMask/metamask-mobile/pull/21561))
- chore: Configure NPM age gate ([#21566](https://github.com/MetaMask/metamask-mobile/pull/21566))
- chore(perps): address sonarcloud issues in hooks ([#21516](https://github.com/MetaMask/metamask-mobile/pull/21516))
- chore: adjust orders tab in tx history to make labels easier to read ([#21596](https://github.com/MetaMask/metamask-mobile/pull/21596))
- feat(sentry): add searchable tags and context to Logger.error ([#21512](https://github.com/MetaMask/metamask-mobile/pull/21512))
- chore: move user from redux store to card sdk context ([#21582](https://github.com/MetaMask/metamask-mobile/pull/21582))
- feat(predict): Adds PredictPositionDetail component / correctly shows multiple positions in predict details ([#21591](https://github.com/MetaMask/metamask-mobile/pull/21591))
- chore: switch rewards controller to new season discovery/metadata endpoints ([#21559](https://github.com/MetaMask/metamask-mobile/pull/21559))
- chore(predict): rate limit buy orders ([#21540](https://github.com/MetaMask/metamask-mobile/pull/21540))
- chore(core-backend): bump to 3.0.0 ([#21564](https://github.com/MetaMask/metamask-mobile/pull/21564))
- test: wrap async refresh handlers in act() to prevent flaky tests ([#21563](https://github.com/MetaMask/metamask-mobile/pull/21563))
- chore: New Crowdin translations by Github Action cp-7.58 ([#21441](https://github.com/MetaMask/metamask-mobile/pull/21441))
- chore: improve add token screen experience ([#21472](https://github.com/MetaMask/metamask-mobile/pull/21472))
- chore: Tron energy and bandwidth UI ([#21089](https://github.com/MetaMask/metamask-mobile/pull/21089))
- chore: move bitcoin to main build ([#21537](https://github.com/MetaMask/metamask-mobile/pull/21537))
- feat(perps): enable hyperliquid HIP-3 support ([#21323](https://github.com/MetaMask/metamask-mobile/pull/21323))
- fix(predict): navigation stack ([#21544](https://github.com/MetaMask/metamask-mobile/pull/21544))
- feat(predict): Updates market details view to use sticky tabs ([#21541](https://github.com/MetaMask/metamask-mobile/pull/21541))
- chore: Update `sample-controllers` from v0.1.0 to v2 ([#21542](https://github.com/MetaMask/metamask-mobile/pull/21542))
- docs: sample feature for tutorials ([#14158](https://github.com/MetaMask/metamask-mobile/pull/14158))
- chore: bump bridge controllers ([#21392](https://github.com/MetaMask/metamask-mobile/pull/21392))
- test: add market feed mocks ([#21508](https://github.com/MetaMask/metamask-mobile/pull/21508))
- chore: create feature flag for homepage redesign v1 ([#21526](https://github.com/MetaMask/metamask-mobile/pull/21526))
- test: add mock responses for predict ([#21505](https://github.com/MetaMask/metamask-mobile/pull/21505))
- chore: rename E2E json report ([#21524](https://github.com/MetaMask/metamask-mobile/pull/21524))
- feat(card): add card FREEZE, BLOCKED warnings and card provisioning flow ([#21489](https://github.com/MetaMask/metamask-mobile/pull/21489))
- chore: remove token selector from deposit/earn view ([#21514](https://github.com/MetaMask/metamask-mobile/pull/21514))
- test(e2e): Use fixture for Snap lifecycle test ([#21513](https://github.com/MetaMask/metamask-mobile/pull/21513))
- chore: bump `@metamask/base-controller` from `^8.3.0` to `^8.4.2` ([#21521](https://github.com/MetaMask/metamask-mobile/pull/21521))
- chore: bump `@metamask/token-search-discovery-controller` to `^3.5.0` ([#21195](https://github.com/MetaMask/metamask-mobile/pull/21195))
- chore: move bitcoin to experimental ([#21511](https://github.com/MetaMask/metamask-mobile/pull/21511))
- release: Bump main version to 7.59.0 ([#21504](https://github.com/MetaMask/metamask-mobile/pull/21504))
- chore: updated cron job to 4am UTC ([#21501](https://github.com/MetaMask/metamask-mobile/pull/21501))
...
- fix: cp-7.59.0 remove dex prefix for hip3 asset display ([#22461](https://github.com/MetaMask/metamask-mobile/pull/22461))
...
[7.60.0]: https://github.com/MetaMask/metamask-mobile/compare/v7.58.2...v7.60.0
