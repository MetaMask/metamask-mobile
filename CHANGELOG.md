...
### Added
- [#12314](https://github.com/MetaMask/metamask-mobile/pull/12314): feat: v7.36.0 (#12314)
...
- [#12510](https://github.com/MetaMask/metamask-mobile/pull/12510): chore(runway): cherry-pick feat: implement remote feature flag controller (#12510)
...
### Other
- [#12338](https://github.com/MetaMask/metamask-mobile/pull/12338): New Crowdin translations by Github Action (#12338)
- [#12645](https://github.com/MetaMask/metamask-mobile/pull/12645): build: Add --device flag to yarn start:android (#12645)
- [#12600](https://github.com/MetaMask/metamask-mobile/pull/12600): chore: cherry-pick #12540 (#12600)
- [#12564](https://github.com/MetaMask/metamask-mobile/pull/12564): chore(runway): cherry-pick fix: Move `AssetPollingProvider` from Root to Nav/Main/index.js (#12564)
- [#Jyoti Puri](Jyoti Puri): "feat: adding basic page for typed signatures V3
...
- [#cryptodev-2s](cryptodev-2s): "chore: bump {profile-sync
- [#selected-network](selected-network): "chore: bump {gas-fee
- [#cryptodev-2s](cryptodev-2s): "chore: bump `@metamask/{preferences
- [#10441](https://github.com/MetaMask/metamask-mobile/pull/10441): chore(deps): Bump `@metamask/composable-controller` from `^3.0.0` to `^10.0.0` (#10441)
- [#12348](https://github.com/MetaMask/metamask-mobile/pull/12348): "fix: Remove stateless ""non-controllers"" from background engine state (#12348)"
- [# duplicates in Engine types `Global{Actions]( duplicates in Engine types `Global{Actions): "fix: Resolve errors
- [#tommasini](tommasini): "fix: circular deps between engine
- [#12553](https://github.com/MetaMask/metamask-mobile/pull/12553): chore: bump react-native-linear-gradient library (#12553)
- [#12573](https://github.com/MetaMask/metamask-mobile/pull/12573): chore(runway): cherry-pick fix(12527): sdk connection with unknown url causes a bug (#12573)
