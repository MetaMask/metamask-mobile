...
- Merge branch 'release/7.47.0' of https://github.com/MetaMask/metamask-mobile into release/7.47.0
...
- fix(bridge): update quote details card toggle to handle same chain swaps and improve slippage button layout ([#15153](https://github.com/MetaMask/metamask-mobile/pull/15153))
...
- feat(bridge): cp-7.46.0 implement quote expiration handling in Bridge feature ([#14872](https://github.com/MetaMask/metamask-mobile/pull/14872))
- feat(bridge): cp-7.46.0 implement bridge controller metrics ([#14846](https://github.com/MetaMask/metamask-mobile/pull/14846))
- fix(bridge): cp-7.46.0 keyboard not appearing when error banner is displayed ([#14862](https://github.com/MetaMask/metamask-mobile/pull/14862))
...
- chore: Improve `mock-server` ([#14836](https://github.com/MetaMask/metamask-mobile/pull/14836))
...
- chore: Bump `@metamask/snaps-controllers` to `^11.2.2` ([#14799](https://github.com/MetaMask/metamask-mobile/pull/14799))
- feat(ramps): auto-select ramp region ([#14780](https://github.com/MetaMask/metamask-mobile/pull/14780))
- fix(14140): add DisconnectedDevice case to custome error handler ([#14678](https://github.com/MetaMask/metamask-mobile/pull/14678))
- fix(4071): increase touchable area for account picker ([#14762](https://github.com/MetaMask/metamask-mobile/pull/14762))
...
- chore: upgrade assets-controllers v58 and bump solana wallet snap ([#14768](https://github.com/MetaMask/metamask-mobile/pull/14768))
- chore: Ignore ses advisory GHSA-h9w6-f932-gq62 ([#14779](https://github.com/MetaMask/metamask-mobile/pull/14779))
- chore: Bump Snaps packages ([#14769](https://github.com/MetaMask/metamask-mobile/pull/14769))
- chore: upgrade assets-controllers-v56 ([#14723](https://github.com/MetaMask/metamask-mobile/pull/14723))
- chore: Add baseline metrics ([#14732](https://github.com/MetaMask/metamask-mobile/pull/14732))
- ci: optimize bitrise e2e runs ([#14634](https://github.com/MetaMask/metamask-mobile/pull/14634))
...
- chore: bump `@metamask/signature-controller` to `^27.1.0` ([#14698](https://github.com/MetaMask/metamask-mobile/pull/14698))
- INFRA-2406:Created issue automated RCA gh action workflow ([#14592](https://github.com/MetaMask/metamask-mobile/pull/14592))
- chore: handle bridge routing for Swaps/Bridge and Solana ([#14614](https://github.com/MetaMask/metamask-mobile/pull/14614))
- ci: download release apk for e2e app upgrade ([#13613](https://github.com/MetaMask/metamask-mobile/pull/13613))
- refactor: Apply Confirmations folder structure ([#14695](https://github.com/MetaMask/metamask-mobile/pull/14695))
- chore(deps): bump @metamask/message-signing-snap to v1.1.1 ([#14653](https://github.com/MetaMask/metamask-mobile/pull/14653))
- refactor: Apply modular init approach to `SignatureController` ([#14670](https://github.com/MetaMask/metamask-mobile/pull/14670))
- chore: allow fixtures to be used with appium and BrowserStack ([#14684](https://github.com/MetaMask/metamask-mobile/pull/14684))
- test: Enable Segment/MetaMetrics for E2E tests ([#14641](https://github.com/MetaMask/metamask-mobile/pull/14641))
- chore: bump profile-sync-controller to `^12.0.0` and notification-services-controller to `^6.0.0` ([#14675](https://github.com/MetaMask/metamask-mobile/pull/14675))
...
- Integrate App Metadata Controller ([#14513](https://github.com/MetaMask/metamask-mobile/pull/14513))
- fix(ramp,test): switch network assertion ([#14624](https://github.com/MetaMask/metamask-mobile/pull/14624))
- chore: stable sync 7.44.0 to main ([#14620](https://github.com/MetaMask/metamask-mobile/pull/14620))
- chore: update changelog-check workflow ([#14612](https://github.com/MetaMask/metamask-mobile/pull/14612))
- chore: updates the auto-detected NFT check ([#14608](https://github.com/MetaMask/metamask-mobile/pull/14608))
- ci: address lockfile issue with detox ([#14600](https://github.com/MetaMask/metamask-mobile/pull/14600))
...
- feat: use dynamic slippage for solana swaps ([#14805](https://github.com/MetaMask/metamask-mobile/pull/14805))
- feat: add metrics for bridge/swap button_clicked and page_viewed ([#14777](https://github.com/MetaMask/metamask-mobile/pull/14777))
- feat: match short address truncation to match extension ([#14744](https://github.com/MetaMask/metamask-mobile/pull/14744))
- feat: Token search and discovery with swaps ([#13328](https://github.com/MetaMask/metamask-mobile/pull/13328))
- feat: Implement advanced details component ([#14606](https://github.com/MetaMask/metamask-mobile/pull/14606))
- feat: keyring selection during multichain account ([#14644](https://github.com/MetaMask/metamask-mobile/pull/14644))
- feat: renamed staking team to @MetaMask/metamask-earn in codeowners ([#14561](https://github.com/MetaMask/metamask-mobile/pull/14561))
- feat: real time dapp scanning BrowserTab ([#14515](https://github.com/MetaMask/metamask-mobile/pull/14515))
- feat: Solana + EVM bridge status controller tx submission ([#14708](https://github.com/MetaMask/metamask-mobile/pull/14708))
- feat: Add L2 support to mobile native gas fee component ([#14681](https://github.com/MetaMask/metamask-mobile/pull/14681))
- feat: bridge solana pumpfun fetch ([#14699](https://github.com/MetaMask/metamask-mobile/pull/14699))
- feat: add e2e tests for multisrp ([#14583](https://github.com/MetaMask/metamask-mobile/pull/14583))
- feat: bridge tx history ([#14334](https://github.com/MetaMask/metamask-mobile/pull/14334))
- feat: update ramp data flow to fetch cryptos before payment methods ([#14437](https://github.com/MetaMask/metamask-mobile/pull/14437))
- feat: track snap account metrics ([#14686](https://github.com/MetaMask/metamask-mobile/pull/14686))
- feat: Add `AddressInput` component ([#14571](https://github.com/MetaMask/metamask-mobile/pull/14571))
- feat: Create contract interaction entry point component ([#14350](https://github.com/MetaMask/metamask-mobile/pull/14350))
- feat: Implement insufficient balance alert into redesigned confirmations ([#14652](https://github.com/MetaMask/metamask-mobile/pull/14652))
- feat: bridge destination address picker ([#14656](https://github.com/MetaMask/metamask-mobile/pull/14656))
- feat: Multichain account list balance ([#14278](https://github.com/MetaMask/metamask-mobile/pull/14278))
- feat: multichain manual import ([#14400](https://github.com/MetaMask/metamask-mobile/pull/14400))
- feat: bridge solana assets ([#14365](https://github.com/MetaMask/metamask-mobile/pull/14365))
...
- fix: bridge switch tokens network change ([#14812](https://github.com/MetaMask/metamask-mobile/pull/14812))
- fix: should not poll token detection when non evm account is selected ([#14816](https://github.com/MetaMask/metamask-mobile/pull/14816))
- fix: blockaid metrics to properly merge into the `ui_customizations` ([#14764](https://github.com/MetaMask/metamask-mobile/pull/14764))
- fix: cp-7.45.0 WC automatically update network permissions when switching chains ([#14782](https://github.com/MetaMask/metamask-mobile/pull/14782))
- fix: not showing fiat value of inputted Solana assets in bridge token… ([#14807](https://github.com/MetaMask/metamask-mobile/pull/14807))
- fix: Disable 'Check Changelog' workflow for now ([#14740](https://github.com/MetaMask/metamask-mobile/pull/14740))
- fix: prevent multiple banner display tracking events ([#14785](https://github.com/MetaMask/metamask-mobile/pull/14785))
- fix: fix remove nft multichain ([#14790](https://github.com/MetaMask/metamask-mobile/pull/14790))
- fix: Row Variant support in mobile ([#14717](https://github.com/MetaMask/metamask-mobile/pull/14717))
- fix: EVM and Solana bridge tx history ([#14759](https://github.com/MetaMask/metamask-mobile/pull/14759))
- fix: re-enable basic functionality onPersistComplete ([#14761](https://github.com/MetaMask/metamask-mobile/pull/14761))
- fix: Switch chains when sending NFT on different chain ([#14749](https://github.com/MetaMask/metamask-mobile/pull/14749))
- fix: fix signature confirm button for ledger signature. ([#14752](https://github.com/MetaMask/metamask-mobile/pull/14752))
- fix: Remove temporary `Confirm` export ([#14766](https://github.com/MetaMask/metamask-mobile/pull/14766))
- fix: Use max in send flow ([#14519](https://github.com/MetaMask/metamask-mobile/pull/14519))
- fix: Fix selecting `chainId` from `NetworkController` state in send flow ([#14696](https://github.com/MetaMask/metamask-mobile/pull/14696))
- fix: cp-7.45.0 STAKE-1010: fix missing staking data if app loads with non-Ethereum mainnet network selected ([#14709](https://github.com/MetaMask/metamask-mobile/pull/14709))
- fix: fix solana key in asset list ([#14738](https://github.com/MetaMask/metamask-mobile/pull/14738))
- fix: not switching networks when selecting source token ([#14712](https://github.com/MetaMask/metamask-mobile/pull/14712))
- fix: cp-7.45.0 Update @keystonehq packages and Ledger library to solve QR wallet and Ledger Sign transaction issue. ([#14555](https://github.com/MetaMask/metamask-mobile/pull/14555))
- fix: update error logic for address input ([#14706](https://github.com/MetaMask/metamask-mobile/pull/14706))
- fix: Add NFT detection event ([#14659](https://github.com/MetaMask/metamask-mobile/pull/14659))
- fix: SnapUILink alignment and colour inheritance issue ([#14478](https://github.com/MetaMask/metamask-mobile/pull/14478))
- fix: disable run_ios_app_launch_times_appium_test workflow ([#14275](https://github.com/MetaMask/metamask-mobile/pull/14275))
- fix: check for empty rpc urls ([#14650](https://github.com/MetaMask/metamask-mobile/pull/14650))
- fix: adds the color property ([#14664](https://github.com/MetaMask/metamask-mobile/pull/14664))
- fix: pass correct disabled prop in `SnapUInput` ([#14642](https://github.com/MetaMask/metamask-mobile/pull/14642))
- fix: Fix/deploy bitrise ipa path ([#14639](https://github.com/MetaMask/metamask-mobile/pull/14639))
- fix: Re-introduce bitrise ipa path ([#14619](https://github.com/MetaMask/metamask-mobile/pull/14619))
- fix: cp-7.44.0 Correct `SnapUIImage` border radius and sizing logic ([#14578](https://github.com/MetaMask/metamask-mobile/pull/14578))
- fix: use last selected account's srp index ([#14352](https://github.com/MetaMask/metamask-mobile/pull/14352))
- fix: Update `TransactionController` to latest ([#14574](https://github.com/MetaMask/metamask-mobile/pull/14574))
- fix: Add delay in checkPermissions for iOS to prevent UI crash ([#14602](https://github.com/MetaMask/metamask-mobile/pull/14602))
- fix: styles for `AccountAction` and `AddAccountActions` ([#14582](https://github.com/MetaMask/metamask-mobile/pull/14582))
...
[7.47.0]: https://github.com/MetaMask/metamask-mobile/compare/v7.45.2...v7.47.0
