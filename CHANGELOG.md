...
- bump semvar version to 7.49.0 && build version to 1962
- fix formating of changelog
- Merge branch 'release/7.49.0' of https://github.com/MetaMask/metamask-mobile into release/7.49.0
- bump semvar version to 7.49.0 && build version to 1961
- bump semvar version to 7.49.0 && build version to 1960
- remove changelog unReleased temporarily ([#16252](https://github.com/MetaMask/metamask-mobile/pull/16252))
- bump semvar version to 7.49.0 && build version to 1959
- chore(runway): cherry-pick fix: cp-7.49.0 Make `confirmation_redesign` feature flags work as true kill-switch ([#16240](https://github.com/MetaMask/metamask-mobile/pull/16240))
- chore(runway): cherry-pick fix: cp-7.49.0 Fix fiat values for non-test networks ([#16230](https://github.com/MetaMask/metamask-mobile/pull/16230))
- Cherry-pick `aa1ba84` in to `7.49.0` ([#16126](https://github.com/MetaMask/metamask-mobile/pull/16126))
...
[Unreleased]: https://github.com/MetaMask/metamask-mobile/compare/v7.49.0...HEAD
[7.49.0]: https://github.com/MetaMask/metamask-mobile/compare/v7.46.2...v7.49.0
