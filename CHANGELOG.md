...
- chore: improve e2e performance error when failing ([#17769](https://github.com/MetaMask/metamask-mobile/pull/17769))
- chore(INFRA-2792): enable jest testing results ([#17693](https://github.com/MetaMask/metamask-mobile/pull/17693))
...
- chore: bump @metamask/profile-sync-controller to ^23.0.0 ([#17760](https://github.com/MetaMask/metamask-mobile/pull/17760))
- Fix/qa bugs ([#17750](https://github.com/MetaMask/metamask-mobile/pull/17750))
- chore: add warning logs for all requests to live server ([#17703](https://github.com/MetaMask/metamask-mobile/pull/17703))
- bump(deps): Bitcoin 0.18.0 ([#17755](https://github.com/MetaMask/metamask-mobile/pull/17755))
- build: upgrade asset controllers to @73.0.1 ([#17758](https://github.com/MetaMask/metamask-mobile/pull/17758))
...
- test: Adding e2e coverage tests for multichain import feature ([#15867](https://github.com/MetaMask/metamask-mobile/pull/15867))
- ci: fix env mapping in workflow ([#17759](https://github.com/MetaMask/metamask-mobile/pull/17759))
- New Crowdin translations by Github Action ([#17353](https://github.com/MetaMask/metamask-mobile/pull/17353))
- chore: Enable quality gate in smoke e2e pipelines for account listing ([#17747](https://github.com/MetaMask/metamask-mobile/pull/17747))
...
- chore: update config to get test file name in failure results ([#17744](https://github.com/MetaMask/metamask-mobile/pull/17744))
...
- chore: stable main 7.51.1 sync ([#17715](https://github.com/MetaMask/metamask-mobile/pull/17715))
- test: Fix Snaps E2E tests ([#17651](https://github.com/MetaMask/metamask-mobile/pull/17651))
- refactor: Remove password strength tracking from wallet events ([#17725](https://github.com/MetaMask/metamask-mobile/pull/17725))
- chore: removing broken storybook files ([#17711](https://github.com/MetaMask/metamask-mobile/pull/17711))
- feat(deposit): adds a modal for unsupported states ([#17514](https://github.com/MetaMask/metamask-mobile/pull/17514))
- chore: Add AssetDetailsActions to Wallet Home ([#17437](https://github.com/MetaMask/metamask-mobile/pull/17437))
- ci: use specific commit hash for browserstack github action ([#17707](https://github.com/MetaMask/metamask-mobile/pull/17707))
- chore: Update `@MetaMask/snaps-devs` codeowners to `@MetaMask/core-platform` ([#17662](https://github.com/MetaMask/metamask-mobile/pull/17662))
- perf: Stop using hashes for Snaps UI React keys ([#17660](https://github.com/MetaMask/metamask-mobile/pull/17660))
- refactor(deposit): remove sdk from settings ([#17675](https://github.com/MetaMask/metamask-mobile/pull/17675))
- chore(deposit): remove helper ([#17672](https://github.com/MetaMask/metamask-mobile/pull/17672))
...
- test(deposit): refactor unsupported region ([#17663](https://github.com/MetaMask/metamask-mobile/pull/17663))
- test(deposit): refactor additional verification ([#17669](https://github.com/MetaMask/metamask-mobile/pull/17669))
- test(deposit): refactor bank details ([#17668](https://github.com/MetaMask/metamask-mobile/pull/17668))
- test(deposit): refactor kyc processing ([#17665](https://github.com/MetaMask/metamask-mobile/pull/17665))
- test(deposit): refactor enter address ([#17667](https://github.com/MetaMask/metamask-mobile/pull/17667))
- test(deposit): refactor enter email ([#17666](https://github.com/MetaMask/metamask-mobile/pull/17666))
- chore: add CODEOWNERS for QA Team - E2E Framework ([#17640](https://github.com/MetaMask/metamask-mobile/pull/17640))
- test: Add preinstalled example Snap ([#17643](https://github.com/MetaMask/metamask-mobile/pull/17643))
- chore: PR removes an unused Plist property ([#17391](https://github.com/MetaMask/metamask-mobile/pull/17391))
- ci: add GitHub workflow to trigger performance e2e on browserstack ([#17582](https://github.com/MetaMask/metamask-mobile/pull/17582))
- chore: refactor keypad to typescript ([#17462](https://github.com/MetaMask/metamask-mobile/pull/17462))
- feat(deposit): adds modal for SSN description ([#17627](https://github.com/MetaMask/metamask-mobile/pull/17627))
- refactor: update all page object imports to use new utils and add lint rules ([#17607](https://github.com/MetaMask/metamask-mobile/pull/17607))
...
- refactor: use account-api + new account-tree-controller types ([#17536](https://github.com/MetaMask/metamask-mobile/pull/17536))
...
- chore: update pipelines for beta and prod builds ([#17570](https://github.com/MetaMask/metamask-mobile/pull/17570))
- chore: fixing casing view on ([#17470](https://github.com/MetaMask/metamask-mobile/pull/17470))
- perf: Enable react-freeze ([#17373](https://github.com/MetaMask/metamask-mobile/pull/17373))
- chore: enforce lint in pre commit hook ([#16816](https://github.com/MetaMask/metamask-mobile/pull/16816))
- refactor: use framework utils and helpers for analytics tests ([#17560](https://github.com/MetaMask/metamask-mobile/pull/17560))
- refactor(deposit): token and region selector heights ([#17531](https://github.com/MetaMask/metamask-mobile/pull/17531))
- feat(deposit): add more tokens support conditionally on balance ([#17513](https://github.com/MetaMask/metamask-mobile/pull/17513))
- chore: cp-7.52.0 match extension implementation of validation/simulation error details ([#17518](https://github.com/MetaMask/metamask-mobile/pull/17518))
- chore(deps): bump `@metamask/{keyring*-api,eth-snap-keyring}` dependencies ([#17539](https://github.com/MetaMask/metamask-mobile/pull/17539))
- chore: create Flask specific detox config ([#17544](https://github.com/MetaMask/metamask-mobile/pull/17544))
- test: e2e fix for seedless oauth flow cp-7.52.0 ([#16782](https://github.com/MetaMask/metamask-mobile/pull/16782))
- refactor: bundle size ([#17530](https://github.com/MetaMask/metamask-mobile/pull/17530))
- chore: adding cursor rule for ui development ([#17520](https://github.com/MetaMask/metamask-mobile/pull/17520))
...
- test: cp-7.52.0 handle multichain account rename flows ([#17494](https://github.com/MetaMask/metamask-mobile/pull/17494))
- chore: test loading multi accounts ([#16732](https://github.com/MetaMask/metamask-mobile/pull/16732))
...
- chore: adding keypad story and allowing stories from other folders ([#17427](https://github.com/MetaMask/metamask-mobile/pull/17427))
- chore: adding twrnc/tailwind css docs ([#17424](https://github.com/MetaMask/metamask-mobile/pull/17424))
- chore: adding taiwlind intellisense and linting ([#17349](https://github.com/MetaMask/metamask-mobile/pull/17349))
- chore: cp-7.52.0 hardcode solana swaps liveness ([#17419](https://github.com/MetaMask/metamask-mobile/pull/17419))
- chore: cp-7.51.0 faster address checksum (#16926) ([#16926](https://github.com/MetaMask/metamask-mobile/pull/16926))
- chore: cp-7.52.0 assets controllers patch and bump form-data dependency ([#17444](https://github.com/MetaMask/metamask-mobile/pull/17444))
...
- chore: Adding e2e for switch acount action ([#17119](https://github.com/MetaMask/metamask-mobile/pull/17119))
- chore: update metamask-earn codeowners ([#17263](https://github.com/MetaMask/metamask-mobile/pull/17263))
- ci: add cache check stage for fix regression pipeline ([#17413](https://github.com/MetaMask/metamask-mobile/pull/17413))
- refactor(deposit): reorder payment methods ([#17394](https://github.com/MetaMask/metamask-mobile/pull/17394))
- feat(deposit): transactions analytics ([#17339](https://github.com/MetaMask/metamask-mobile/pull/17339))
- chore: upgrade design tokens to v8.1 ([#17392](https://github.com/MetaMask/metamask-mobile/pull/17392))
- docs: add expo e2e testing docs ([#17383](https://github.com/MetaMask/metamask-mobile/pull/17383))
- style: fix import token button search list filling screen ([#17375](https://github.com/MetaMask/metamask-mobile/pull/17375))
- chore: bump @metamask/profile-sync-controller to ^21.0.0 ([#16876](https://github.com/MetaMask/metamask-mobile/pull/16876))
- feat(deposit): adds basic info kyc analytics events ([#17337](https://github.com/MetaMask/metamask-mobile/pull/17337))
- chore: Updated tabs in permissions ([#17342](https://github.com/MetaMask/metamask-mobile/pull/17342))
- chore: Updated tabs in Reveal Private Credentials ([#17343](https://github.com/MetaMask/metamask-mobile/pull/17343))
- chore: Updated Tabs in Import Tokens flow ([#17352](https://github.com/MetaMask/metamask-mobile/pull/17352))
- refactor: secure keychain typescript ([#17348](https://github.com/MetaMask/metamask-mobile/pull/17348))
- chore: Updated Tabs in Notifications ([#17338](https://github.com/MetaMask/metamask-mobile/pull/17338))
- New Crowdin translations by Github Action ([#16522](https://github.com/MetaMask/metamask-mobile/pull/16522))
...
- chore: Updated Wallet to use TabBar ([#17251](https://github.com/MetaMask/metamask-mobile/pull/17251))
- chore: Updated Tabs in network settings ([#17344](https://github.com/MetaMask/metamask-mobile/pull/17344))
- test: add new ramps account switching test case ([#17315](https://github.com/MetaMask/metamask-mobile/pull/17315))
- feat(deposit): copy and design parity ([#17324](https://github.com/MetaMask/metamask-mobile/pull/17324))
- chore: run tests without delays ([#17218](https://github.com/MetaMask/metamask-mobile/pull/17218))
- refactor: migrate AES crypto test form related tests to new framework ([#17297](https://github.com/MetaMask/metamask-mobile/pull/17297))
...
- test: exclude quarantine files from end-to-end test suite ([#17310](https://github.com/MetaMask/metamask-mobile/pull/17310))
- test: quarantine end-to-end tests for max transfer and wallet initiated transfer scenarios ([#17306](https://github.com/MetaMask/metamask-mobile/pull/17306))
...
- bug: clear MMKV on fresh install ([#15244](https://github.com/MetaMask/metamask-mobile/pull/15244))
...
- chore: Revert "feat(TAT-575): add fixture to import random generated account… ([#17260](https://github.com/MetaMask/metamask-mobile/pull/17260))
- refactor: create wallet account tests and related methods ([#17273](https://github.com/MetaMask/metamask-mobile/pull/17273))
- chore: add staking transaction confirmed traces ([#17207](https://github.com/MetaMask/metamask-mobile/pull/17207))
- chore: Move polyfills to shim file ([#17189](https://github.com/MetaMask/metamask-mobile/pull/17189))
...
- chore: stable sync 7.50 & 7.50.1 ([#17186](https://github.com/MetaMask/metamask-mobile/pull/17186))
- style: cp-7.51.0 fix padding issues with asset detail buttons ([#17233](https://github.com/MetaMask/metamask-mobile/pull/17233))
- feat(TAT-575): add fixture to import random generated accounts ([#17205](https://github.com/MetaMask/metamask-mobile/pull/17205))
- cp-7.51.0 fix: TAT-1271 fix crash when lending historic apy chart datapoints have null netSupplyRate ([#17182](https://github.com/MetaMask/metamask-mobile/pull/17182))
- chore: add card team on CODEOWNERS file ([#17249](https://github.com/MetaMask/metamask-mobile/pull/17249))
...
- chore: Added TabBar component to the components-temp folder ([#17193](https://github.com/MetaMask/metamask-mobile/pull/17193))
...
- chore: add a CI step to check prettier ([#17136](https://github.com/MetaMask/metamask-mobile/pull/17136))
- chore: swaps token button style ([#17170](https://github.com/MetaMask/metamask-mobile/pull/17170))
- chore: adding design system libraries ([#17083](https://github.com/MetaMask/metamask-mobile/pull/17083))
- cp-7.51.0 fix: TAT-1263 fix staking data refresh issue when switching accounts with unsupported pooled staking chain ([#17171](https://github.com/MetaMask/metamask-mobile/pull/17171))
- chore: faster random values (#16957) ([#16957](https://github.com/MetaMask/metamask-mobile/pull/16957))
- test: backup and sync (accounts) after reset wallet flow ([#17148](https://github.com/MetaMask/metamask-mobile/pull/17148))
...
- feat(deposit): widget theme ([#17128](https://github.com/MetaMask/metamask-mobile/pull/17128))
- chore: get react-native-acm from registry ([#17166](https://github.com/MetaMask/metamask-mobile/pull/17166))
- refactor(deposit): refactor date picker, add formatter cache ([#17140](https://github.com/MetaMask/metamask-mobile/pull/17140))
- refactor(deposit): use all network names in token modal ([#17159](https://github.com/MetaMask/metamask-mobile/pull/17159))
- test: improve reliability of decrypt button interaction on small screens ([#17133](https://github.com/MetaMask/metamask-mobile/pull/17133))
- ci: avoid yarn race condition ([#17152](https://github.com/MetaMask/metamask-mobile/pull/17152))
- feat(card): add card sdk ([#17156](https://github.com/MetaMask/metamask-mobile/pull/17156))
- chore: update solana welcome modal/view ([#16578](https://github.com/MetaMask/metamask-mobile/pull/16578))
- chore: faster blockies avatars ([#16954](https://github.com/MetaMask/metamask-mobile/pull/16954))
- fix(ramp): cp-7.51.0 payment method selector label ([#17125](https://github.com/MetaMask/metamask-mobile/pull/17125))
- chore: update metrics to reflect unified swap/bridge ([#16777](https://github.com/MetaMask/metamask-mobile/pull/16777))
- feat(deposit): add payment method filtering ([#17085](https://github.com/MetaMask/metamask-mobile/pull/17085))
- refactor(deposit): buildquote spacing, remove logo as property ([#17077](https://github.com/MetaMask/metamask-mobile/pull/17077))
- refactor(deposit): remove order external link ([#17087](https://github.com/MetaMask/metamask-mobile/pull/17087))
- chore: Removed portfolio and import tokens from wallet page ([#16800](https://github.com/MetaMask/metamask-mobile/pull/16800))
- refactor(deposit): KYC form UX updates ([#17039](https://github.com/MetaMask/metamask-mobile/pull/17039))
- chore: prepopulate dest swap token ([#17064](https://github.com/MetaMask/metamask-mobile/pull/17064))
- refactor(ramp): remove filter border ([#17079](https://github.com/MetaMask/metamask-mobile/pull/17079))
- chore: enable hermes on iOS ([#16943](https://github.com/MetaMask/metamask-mobile/pull/16943))
- test: Solana Multichain API E2E - signIn method ([#16323](https://github.com/MetaMask/metamask-mobile/pull/16323))
- test: fix flaky test balance privacy toggle ([#16882](https://github.com/MetaMask/metamask-mobile/pull/16882))
- chore: Updated Token List Item for Wallet ([#16801](https://github.com/MetaMask/metamask-mobile/pull/16801))
- chore: updated background color for the homepage carousel ([#17050](https://github.com/MetaMask/metamask-mobile/pull/17050))
- chore: add performance traces for earn deposit and withdrawal flows ([#17025](https://github.com/MetaMask/metamask-mobile/pull/17025))
- chore: Bump Snaps packages ([#17051](https://github.com/MetaMask/metamask-mobile/pull/17051))
- test: add back notification e2e tests ([#16975](https://github.com/MetaMask/metamask-mobile/pull/16975))
- test: fix encrypt password synchronization ([#17048](https://github.com/MetaMask/metamask-mobile/pull/17048))
- feat(deposit): webview modal component ([#17036](https://github.com/MetaMask/metamask-mobile/pull/17036))
- refactor(deposit): verify otp uses throws method ([#17043](https://github.com/MetaMask/metamask-mobile/pull/17043))
- chore: updated homepage filters ([#16799](https://github.com/MetaMask/metamask-mobile/pull/16799))
- chore: faster sentry + use native polyfills (#16025) ([#16025](https://github.com/MetaMask/metamask-mobile/pull/16025))
- chore: Add `@MetaMask/perps` codeowners to CODEOWNERS file ([#17041](https://github.com/MetaMask/metamask-mobile/pull/17041))
- chore: Updated tabs styling in wallet ([#16802](https://github.com/MetaMask/metamask-mobile/pull/16802))
- chore: Add DisplayLG variant to Text component and updated homepage balance to use DisplayLG variant ([#17038](https://github.com/MetaMask/metamask-mobile/pull/17038))
- feat(deposit): error view ([#16947](https://github.com/MetaMask/metamask-mobile/pull/16947))
- refactor(deposit): copy provider order id ([#17026](https://github.com/MetaMask/metamask-mobile/pull/17026))
- refactor(deposit): only restrict created orders from new orders ([#17032](https://github.com/MetaMask/metamask-mobile/pull/17032))
- chore: updates deposit region list ([#16887](https://github.com/MetaMask/metamask-mobile/pull/16887))
- refactor(deposit): send email throws true method ([#17034](https://github.com/MetaMask/metamask-mobile/pull/17034))
- feat(deposit): fix android dob input; improve autofill UX ([#17001](https://github.com/MetaMask/metamask-mobile/pull/17001))
- chore: stable sync 7.47.3 & 747.2 ([#17030](https://github.com/MetaMask/metamask-mobile/pull/17030))
- refactor(deposit): routing method calls ([#17004](https://github.com/MetaMask/metamask-mobile/pull/17004))
- test: fix encrypt decrypt with password ([#17006](https://github.com/MetaMask/metamask-mobile/pull/17006))
...
- chore: add a note for devs who need to re-run a partial e2e run ([#16430](https://github.com/MetaMask/metamask-mobile/pull/16430))
- release: add CHANGELOG to pull-request-template.md ([#16992](https://github.com/MetaMask/metamask-mobile/pull/16992))
- chore: Chore/16093 experimental environment ([#16647](https://github.com/MetaMask/metamask-mobile/pull/16647))
- test: refactor payment request e2e test ([#16959](https://github.com/MetaMask/metamask-mobile/pull/16959))
- update: Update primary and secondary button styles ([#16641](https://github.com/MetaMask/metamask-mobile/pull/16641))
- feat(deposit): update kyc processing copy and cta ([#16961](https://github.com/MetaMask/metamask-mobile/pull/16961))
- refactor: use Promise.all to avoid race condition in checkAndCollect … ([#16841](https://github.com/MetaMask/metamask-mobile/pull/16841))
...
- test: quarantine swap token chart test and fix transaction e2e ([#16571](https://github.com/MetaMask/metamask-mobile/pull/16571))
- chore(snaps): Bump Snaps dependencies ([#16911](https://github.com/MetaMask/metamask-mobile/pull/16911))
- chore: cp-7.50.0 bump controller utils to version 11.11.0 ([#16968](https://github.com/MetaMask/metamask-mobile/pull/16968))
- chore: bump `@metamask/profile-sync-controller` to `^20.0.0` ([#16938](https://github.com/MetaMask/metamask-mobile/pull/16938))
...
- refactor(deposit): dismiss flow button ([#16948](https://github.com/MetaMask/metamask-mobile/pull/16948))
...
- test(deposit): refactor root ([#16944](https://github.com/MetaMask/metamask-mobile/pull/16944))
- chore: cp-7.51.0 update transaction controller version 58.1.1 ([#16668](https://github.com/MetaMask/metamask-mobile/pull/16668))
- chore: cp-7.50.0 bump and deduplicate metamask/utils to 11.4.2 ([#16916](https://github.com/MetaMask/metamask-mobile/pull/16916))
- test: Add analytics checks to onboarding events ([#16883](https://github.com/MetaMask/metamask-mobile/pull/16883))
- ci: workflows for identity ([#16930](https://github.com/MetaMask/metamask-mobile/pull/16930))
- refactor: new test utils assertion methods and add unit tests for retry utility ([#16921](https://github.com/MetaMask/metamask-mobile/pull/16921))
- feat(deposit): Unsupported region modal copy & design update ([#16819](https://github.com/MetaMask/metamask-mobile/pull/16819))
- test: disable flaking bridge test ([#16925](https://github.com/MetaMask/metamask-mobile/pull/16925))
- chore: moves notifications tests into quarantine ([#16922](https://github.com/MetaMask/metamask-mobile/pull/16922))
- chore: add performance tracing for earn experiences ([#16698](https://github.com/MetaMask/metamask-mobile/pull/16698))
