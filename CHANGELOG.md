...
- bump semvar version to 9.99.92 && build version to 12352
- bump semvar version to 9.99.92 && build version to 12351
- bump semvar version to 9.99.92 && build version to 12350
- bump semvar version to 9.99.92 && build version to 12349
- bump semvar version to 9.99.92 && build version to 12348
- bump semvar version to 9.99.92 && build version to 12347
- bump semvar version to 9.99.92 && build version to 12346
- bump semvar version to 9.99.92 && build version to 12345
- testing rls-sheet automation
- rlstesting
- rls-testing
- rls-testing
- updates
...
[Unreleased]: https://github.com/MetaMask/metamask-mobile/compare/v9.99.92...HEAD
[9.99.92]: https://github.com/MetaMask/metamask-mobile/compare/v7.39.0...v9.99.92
