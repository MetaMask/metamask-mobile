...
- chore: update changelog 7.51.0 ([#17000](https://github.com/MetaMask/metamask-mobile/pull/17000))
- bump semvar version to 7.51.0 && build version to 2072
- feat(deposit): add powered by transak logo ([#16894](https://github.com/MetaMask/metamask-mobile/pull/16894))
- chore: update native ramps sdk to v1.0.9 ([#16875](https://github.com/MetaMask/metamask-mobile/pull/16875))
...
- chore: updated debug keystore to enable gcp configuration ([#15637](https://github.com/MetaMask/metamask-mobile/pull/15637))
- chore: Add e2e tests for `approve` confirmations ([#16874](https://github.com/MetaMask/metamask-mobile/pull/16874))
- chore: Bump `react-native-quick-crypto` ([#16837](https://github.com/MetaMask/metamask-mobile/pull/16837))
- test: fix regression tests failing related to new UI for change password and delete wallet ([#16566](https://github.com/MetaMask/metamask-mobile/pull/16566))
- chore: Update default font from CentraNo1 to Geist ([#16609](https://github.com/MetaMask/metamask-mobile/pull/16609))
- test: Add Ethereum provider Snap test ([#16672](https://github.com/MetaMask/metamask-mobile/pull/16672))
- chore: Remove duplicate label ([#16852](https://github.com/MetaMask/metamask-mobile/pull/16852))
- perf: Migrate AccountSelectorList to FlashList cp-7.50.0 ([#16775](https://github.com/MetaMask/metamask-mobile/pull/16775))
- test: fix selector for app launch times e2e ([#16850](https://github.com/MetaMask/metamask-mobile/pull/16850))
- perf(swaps): optimize token processing selectors ([#16733](https://github.com/MetaMask/metamask-mobile/pull/16733))
...
- chore: Added MainActionButton component to temp components ([#16798](https://github.com/MetaMask/metamask-mobile/pull/16798))
- feat(deposit): adds interfaces for deposit analytics events ([#16820](https://github.com/MetaMask/metamask-mobile/pull/16820))
- test: convert multiple dapp connect e2e files to typescript ([#16821](https://github.com/MetaMask/metamask-mobile/pull/16821))
...
- chore: cp-7.50.0 update solana 1.34.0 ([#16790](https://github.com/MetaMask/metamask-mobile/pull/16790))
- chore: bump @metamask/multichain-api-client to version 0.6.4 ([#16755](https://github.com/MetaMask/metamask-mobile/pull/16755))
- perf: make `EvmAccountSelectorList.renderItem` faster - cp-7.50.0 ([#16739](https://github.com/MetaMask/metamask-mobile/pull/16739))
- chore: replaced HeadingSMRegular with BodyMD ([#16491](https://github.com/MetaMask/metamask-mobile/pull/16491))
- feat(deposit): adds unsupported region modal ([#16772](https://github.com/MetaMask/metamask-mobile/pull/16772))
- refactor(identity): contact-syncing e2e helpers and waitUntilSyncedElementsNumberEquals ([#16760](https://github.com/MetaMask/metamask-mobile/pull/16760))
- test: Add network access Snap E2E test ([#16656](https://github.com/MetaMask/metamask-mobile/pull/16656))
...
- chore: add unit testing guidelines to the project ([#16088](https://github.com/MetaMask/metamask-mobile/pull/16088))
- test: Added test for balance privacy toggle ([#16687](https://github.com/MetaMask/metamask-mobile/pull/16687))
...
- test: adds event checking coverage to the existing on-ramp and off-ramp flows ([#15868](https://github.com/MetaMask/metamask-mobile/pull/15868))
- feat(deposit): adds payment method selector modal ([#16725](https://github.com/MetaMask/metamask-mobile/pull/16725))
- test: fix notification mock server clashing ports ([#16724](https://github.com/MetaMask/metamask-mobile/pull/16724))
- test: fix multichain account test. ([#16446](https://github.com/MetaMask/metamask-mobile/pull/16446))
- test: convert Portfolio dapp e2e files to typescript ([#16731](https://github.com/MetaMask/metamask-mobile/pull/16731))
- chore: improve tx history for unified swaps and bridge ([#16730](https://github.com/MetaMask/metamask-mobile/pull/16730))
- refactor: tag-base text props partial ([#16721](https://github.com/MetaMask/metamask-mobile/pull/16721))
- chore: add redux field for bridge view mode ([#16716](https://github.com/MetaMask/metamask-mobile/pull/16716))
- test: enable single test run on bitrise ([#16720](https://github.com/MetaMask/metamask-mobile/pull/16720))
- chore: add QA team ownership for e2e and wdio directories ([#16719](https://github.com/MetaMask/metamask-mobile/pull/16719))
...
- chore: bump `@metamask/preferences-controller` to `18.2.0` ([#16623](https://github.com/MetaMask/metamask-mobile/pull/16623))
- chore: make UserStorageMockttpControllerEvents object instead of enum ([#16634](https://github.com/MetaMask/metamask-mobile/pull/16634))
- refactor: combine AccountsController listMultichainAccounts and listAccounts usage where appropriate ([#16362](https://github.com/MetaMask/metamask-mobile/pull/16362))
- feat(deposit): adds modals and token selector ([#16688](https://github.com/MetaMask/metamask-mobile/pull/16688))
- feat(deposit): adds resend otp feature ([#16112](https://github.com/MetaMask/metamask-mobile/pull/16112))
- refactor(deposit): use assetId for rates ([#16644](https://github.com/MetaMask/metamask-mobile/pull/16644))
- feat(deposit): Deposit feature analytics config ([#16564](https://github.com/MetaMask/metamask-mobile/pull/16564))
- chore: fix typo and clarify ios stuff ([#16676](https://github.com/MetaMask/metamask-mobile/pull/16676))
- chore: cp-7.50.0 passing discovered accounts data to the metrics event ([#16667](https://github.com/MetaMask/metamask-mobile/pull/16667))
- test: convert TestDApp page object and selectors to typescript ([#16494](https://github.com/MetaMask/metamask-mobile/pull/16494))
- refactor: cp-7.50.0 switch from SectionList to FlatList in EvmAccountSelectorList ([#16575](https://github.com/MetaMask/metamask-mobile/pull/16575))
- build: cp-7.50.0 bump`@metamask/solana-wallet-snap` to `^1.33.3` ([#16658](https://github.com/MetaMask/metamask-mobile/pull/16658))
- test: Add BIP-32 example Snap test ([#16583](https://github.com/MetaMask/metamask-mobile/pull/16583))
- chore: added abstract's network logo ([#16586](https://github.com/MetaMask/metamask-mobile/pull/16586))
- feat(deposit): order details ([#16606](https://github.com/MetaMask/metamask-mobile/pull/16606))
- test: fix notification e2e test delays ([#16632](https://github.com/MetaMask/metamask-mobile/pull/16632))
- test: Fix Swap e2e test flakiness ([#16637](https://github.com/MetaMask/metamask-mobile/pull/16637))
- chore: stable 7.47.0 7.47.1 sync ([#16633](https://github.com/MetaMask/metamask-mobile/pull/16633))
- refactor: Apply modular init approach to `ApprovalController` ([#16411](https://github.com/MetaMask/metamask-mobile/pull/16411))
- test: adds coverage for bridge events ([#15797](https://github.com/MetaMask/metamask-mobile/pull/15797))
- chore: bump pbkdf ([#16616](https://github.com/MetaMask/metamask-mobile/pull/16616))
- feat(deposit): adds date picker keyboard to basic info form ([#15906](https://github.com/MetaMask/metamask-mobile/pull/15906))
- chore: Enable new architecture ([#15363](https://github.com/MetaMask/metamask-mobile/pull/15363))
- test: snap mobile e2e implementation ([#16223](https://github.com/MetaMask/metamask-mobile/pull/16223))
- chore: log feature flag fetch failure as sentry breadcrumbs ([#16080](https://github.com/MetaMask/metamask-mobile/pull/16080))
- chore(dev): Upgrade network-controller to v24, error-reporting-service to v2 ([#16307](https://github.com/MetaMask/metamask-mobile/pull/16307))
- feat(perf): accounts performance/sentry tracing ([#15439](https://github.com/MetaMask/metamask-mobile/pull/15439))
- chore: Bump Snaps packages ([#16497](https://github.com/MetaMask/metamask-mobile/pull/16497))
- chore: update transaction controller 57.4.0 ([#16458](https://github.com/MetaMask/metamask-mobile/pull/16458))
...
[7.51.0]: https://github.com/MetaMask/metamask-mobile/compare/v7.47.1...v7.51.0
