...
- bump semvar version to 7.45.0 && build version to 1680
- chore(cleanup): Remove crowdin actions for workflow that was never put into place ([#14589](https://github.com/MetaMask/metamask-mobile/pull/14589))
- New Crowdin translations by Github Action ([#14572](https://github.com/MetaMask/metamask-mobile/pull/14572))
- chore: Add Soneium network and native img ([#14538](https://github.com/MetaMask/metamask-mobile/pull/14538))
- refactor(walletconnect): migrate to WalletKit and implement multi-chain support ([#13515](https://github.com/MetaMask/metamask-mobile/pull/13515))
- test: reduce flakiness with notification e2e mocks ([#14580](https://github.com/MetaMask/metamask-mobile/pull/14580))
- build: enable notifications ([#14507](https://github.com/MetaMask/metamask-mobile/pull/14507))
- chore: Add small bottom padding to Browser 5-tab max toast ([#14306](https://github.com/MetaMask/metamask-mobile/pull/14306))
- chore: added a new script in the setup help onboard engineers to EXPO ([#14424](https://github.com/MetaMask/metamask-mobile/pull/14424))
- chore: apply all teams to remaining files in CODEOWNERs ([#14212](https://github.com/MetaMask/metamask-mobile/pull/14212))
- Fix/swaps usdc usdt slippage ([#14525](https://github.com/MetaMask/metamask-mobile/pull/14525))
- chore: Add XRPEVM logo ([#14536](https://github.com/MetaMask/metamask-mobile/pull/14536))
- chore: fix merge queue failures ([#14544](https://github.com/MetaMask/metamask-mobile/pull/14544))
- refactor: Apply modular init approach to `GasFeeController` ([#14464](https://github.com/MetaMask/metamask-mobile/pull/14464))
- chore: bump transaction-controller to 52.3.0 ([#14326](https://github.com/MetaMask/metamask-mobile/pull/14326))
- chore: Update code ownesrhip of deep link manager ([#14537](https://github.com/MetaMask/metamask-mobile/pull/14537))
- feat(ramp): erc20 gas and balance checks for off-ramp ([#12526](https://github.com/MetaMask/metamask-mobile/pull/12526))
- chore: revert update solana ([#14517](https://github.com/MetaMask/metamask-mobile/pull/14517))
- refactor: fix type strictness and improve tests on notifications ([#14510](https://github.com/MetaMask/metamask-mobile/pull/14510))
- chore: Add asset multichain network logo ([#14453](https://github.com/MetaMask/metamask-mobile/pull/14453))
- test: add back `@testing-library/react-native` concurrentRoot in tests. ([#14454](https://github.com/MetaMask/metamask-mobile/pull/14454))
- chore: update solana ([#14485](https://github.com/MetaMask/metamask-mobile/pull/14485))
- test: new e2e case for offramps cashout destination ([#14419](https://github.com/MetaMask/metamask-mobile/pull/14419))
- test: notification e2e tests ([#14431](https://github.com/MetaMask/metamask-mobile/pull/14431))
- test: new test cases for off-ramp token amounts ([#14415](https://github.com/MetaMask/metamask-mobile/pull/14415))
- Feat/redesign phishing screen ([#14390](https://github.com/MetaMask/metamask-mobile/pull/14390))
- build: add resolution for metro/image-size ([#14482](https://github.com/MetaMask/metamask-mobile/pull/14482))
- chore: updates the support url to use the internal-beta-testing ([#14435](https://github.com/MetaMask/metamask-mobile/pull/14435))
- test: move limits ramps test to quarantine ([#14436](https://github.com/MetaMask/metamask-mobile/pull/14436))
- chore: bump multichain controllers ([#14320](https://github.com/MetaMask/metamask-mobile/pull/14320))
- chore: bump preferences-controller to 17.0.0 ([#14322](https://github.com/MetaMask/metamask-mobile/pull/14322))
- chore: bump accounts-controller to 27.0.0 ([#14317](https://github.com/MetaMask/metamask-mobile/pull/14317))
- chore: bump selected-network-controller to 22.0.0 ([#14324](https://github.com/MetaMask/metamask-mobile/pull/14324))
- chore: bump approval-controller to 7.1.3 ([#14315](https://github.com/MetaMask/metamask-mobile/pull/14315))
- feat(ramp): paymentMethods refactor for sdk evolution ([#13464](https://github.com/MetaMask/metamask-mobile/pull/13464))
- chore: bump bridge controllers ([#14316](https://github.com/MetaMask/metamask-mobile/pull/14316))
- chore: bump profile-sync-controller to 11.0.0 ([#14323](https://github.com/MetaMask/metamask-mobile/pull/14323))
- chore: bump phishing-controller to 12.4.1 ([#14321](https://github.com/MetaMask/metamask-mobile/pull/14321))
- chore: bump signature-controller to 25.0.0 ([#14325](https://github.com/MetaMask/metamask-mobile/pull/14325))
- chore: bump json-rpc-middleware-stream to 8.0.7 ([#14319](https://github.com/MetaMask/metamask-mobile/pull/14319))
- chore: bump gas-fee-controller to 23.0.0 ([#14318](https://github.com/MetaMask/metamask-mobile/pull/14318))
...
- chore: bump `@metamask/keyring-controller` to `^21.0.1` ([#14304](https://github.com/MetaMask/metamask-mobile/pull/14304))
- chore: Bump network-controller to 23.2.0, controller-utils to 11.7.0 ([#14408](https://github.com/MetaMask/metamask-mobile/pull/14408))
- test: Fix swap smoke tests ([#14388](https://github.com/MetaMask/metamask-mobile/pull/14388))
- Updated default font to Centra No 1 ([#14349](https://github.com/MetaMask/metamask-mobile/pull/14349))
- chore: Updated CODEOWNER for snap files ([#14380](https://github.com/MetaMask/metamask-mobile/pull/14380))
- test: update ramp used token text ([#14383](https://github.com/MetaMask/metamask-mobile/pull/14383))
- test: update token used in ramps test ([#14363](https://github.com/MetaMask/metamask-mobile/pull/14363))
- chore: patch detox default lockfile sync timeout ([#14358](https://github.com/MetaMask/metamask-mobile/pull/14358))
- chore: Revert "fix: anonymous props that's not moved to sensitive props (#12… ([#14362](https://github.com/MetaMask/metamask-mobile/pull/14362))
- ci: Fix Android expodev build ([#14359](https://github.com/MetaMask/metamask-mobile/pull/14359))
- test: update token selection function for flaky test ([#14337](https://github.com/MetaMask/metamask-mobile/pull/14337))
- chore: bump @metamask/controller-utils to v11.6.0 ([#14156](https://github.com/MetaMask/metamask-mobile/pull/14156))
- chore: bump assets controllers v55.0.1 ([#14201](https://github.com/MetaMask/metamask-mobile/pull/14201))
- refactor: create a new earn input screen that works with evm tokens ([#14237](https://github.com/MetaMask/metamask-mobile/pull/14237))
- test: temporary skipping flaking e2e test ([#14335](https://github.com/MetaMask/metamask-mobile/pull/14335))
- chore: Enable e2e testing for flask builds in ci ([#14283](https://github.com/MetaMask/metamask-mobile/pull/14283))
- chore: Bump Snaps dependencies ([#14328](https://github.com/MetaMask/metamask-mobile/pull/14328))
- chore: 7.43.0 stable main sync ([#14279](https://github.com/MetaMask/metamask-mobile/pull/14279))
- fix(14255): invalid url on account list ([#14259](https://github.com/MetaMask/metamask-mobile/pull/14259))
- chore: New Crowdin translations by Github Action ([#13263](https://github.com/MetaMask/metamask-mobile/pull/13263))
- chore: organize files into folders ([#14249](https://github.com/MetaMask/metamask-mobile/pull/14249))
- chore: add beta to the pipelines ([#13952](https://github.com/MetaMask/metamask-mobile/pull/13952))
- fix(snaps): Update snap footer buttons ([#13953](https://github.com/MetaMask/metamask-mobile/pull/13953))
- chore: added earn team as codeowners for earn directories ([#14271](https://github.com/MetaMask/metamask-mobile/pull/14271))
- chore: update value checks for multichain tx detail modal ([#14252](https://github.com/MetaMask/metamask-mobile/pull/14252))
- test: add alert system E2E tests ([#14001](https://github.com/MetaMask/metamask-mobile/pull/14001))
- chore: Update solana snap ([#14251](https://github.com/MetaMask/metamask-mobile/pull/14251))
- chore: Silence unhandled ENS URL ([#14256](https://github.com/MetaMask/metamask-mobile/pull/14256))
- chore: codeowner snapshots updates ([#14250](https://github.com/MetaMask/metamask-mobile/pull/14250))
- chore: improvements to files and UI ([#14224](https://github.com/MetaMask/metamask-mobile/pull/14224))
- chore: removing unused deprecated sheet bottom code component ([#14216](https://github.com/MetaMask/metamask-mobile/pull/14216))
- chore: enable QA Flask builds for BrowserStack ([#14214](https://github.com/MetaMask/metamask-mobile/pull/14214))
- docs: fix typo in Expo development section of README ([#14227](https://github.com/MetaMask/metamask-mobile/pull/14227))
- feat(ramp): add backpress handler to expanded quotes view ([#14210](https://github.com/MetaMask/metamask-mobile/pull/14210))
- chore: adds the multichain transaction view ([#14029](https://github.com/MetaMask/metamask-mobile/pull/14029))
- chore: Bump `@metamask/key-tree` to `^10.1.1` ([#14209](https://github.com/MetaMask/metamask-mobile/pull/14209))
- Mms 1882 bridge network selector 2 ([#14167](https://github.com/MetaMask/metamask-mobile/pull/14167))
- debounce writting in storage ([#14193](https://github.com/MetaMask/metamask-mobile/pull/14193))
- chore: add code fencing file to CODEOWNERS ([#14192](https://github.com/MetaMask/metamask-mobile/pull/14192))
- chore: 7.42.1 stable-main sync ([#14208](https://github.com/MetaMask/metamask-mobile/pull/14208))
- test: Fix Swap smoke tests ([#14186](https://github.com/MetaMask/metamask-mobile/pull/14186))
...
- chore: removing unused storybook folder ([#14068](https://github.com/MetaMask/metamask-mobile/pull/14068))
- feat(4213-2) update network icons ([#14069](https://github.com/MetaMask/metamask-mobile/pull/14069))
- strip only in release ([#14168](https://github.com/MetaMask/metamask-mobile/pull/14168))
- refactor: `Tokens` business logic isolation ([#14104](https://github.com/MetaMask/metamask-mobile/pull/14104))
- chore: bump @metamask/profile-sync-controller to ^10.1.0 ([#14114](https://github.com/MetaMask/metamask-mobile/pull/14114))
- chore: remove e2e merge commit filter ([#14132](https://github.com/MetaMask/metamask-mobile/pull/14132))
- chore: Migrate confirmation files from TypeScript to JavaScript ([#14116](https://github.com/MetaMask/metamask-mobile/pull/14116))
- chore: 7.42.0 stable sync ([#14093](https://github.com/MetaMask/metamask-mobile/pull/14093))
- test: disable ramps iOS workflow ([#14087](https://github.com/MetaMask/metamask-mobile/pull/14087))
- chore: Bump Snaps packages ([#14000](https://github.com/MetaMask/metamask-mobile/pull/14000))
- ci: cp-7.43.0 add trigger to kick off qa builds after release is published ([#14092](https://github.com/MetaMask/metamask-mobile/pull/14092))
- refactor: Consolidate `Token` screen asset selectors ([#13985](https://github.com/MetaMask/metamask-mobile/pull/13985))
- chore: Add performance instrumentation for create Snap account ([#14002](https://github.com/MetaMask/metamask-mobile/pull/14002))
- feat(ramp): add non evm balance ([#13948](https://github.com/MetaMask/metamask-mobile/pull/13948))
- test: update bitrise yml to include iOS ramps tests ([#13691](https://github.com/MetaMask/metamask-mobile/pull/13691))
- chore: refactors metametrics to common function ([#13963](https://github.com/MetaMask/metamask-mobile/pull/13963))
- chore: update latest shared workflows ([#14015](https://github.com/MetaMask/metamask-mobile/pull/14015))
...
- fix: cp-7.43.0 correctly fetch token rates during onboarding ([#14207](https://github.com/MetaMask/metamask-mobile/pull/14207))
...
- fix: cp-7.43.0 QR hardware signature requests not showing result after signing ([#14117](https://github.com/MetaMask/metamask-mobile/pull/14117))
...
- fix: cp-7.43.0 useInterval deps ([#14105](https://github.com/MetaMask/metamask-mobile/pull/14105))
...
- fix: cp-7.43.0 bell icon colour and styles ([#14084](https://github.com/MetaMask/metamask-mobile/pull/14084))
...
- fix: cp-7.43.0 Updated ThemeProvider to no longer have wrapping View ([#14056](https://github.com/MetaMask/metamask-mobile/pull/14056))
- fix: cp-7.43.0 remove network fee section in notification details ([#14050](https://github.com/MetaMask/metamask-mobile/pull/14050))
- fix: cp-7.43.0 updated root to use themeprovider ([#14040](https://github.com/MetaMask/metamask-mobile/pull/14040))
- fix: cp-7.43.0 add remote feature flag for notifications ([#14028](https://github.com/MetaMask/metamask-mobile/pull/14028))
...
- fix: cp-7.43.0 - Temporarily disable notifications ([#14036](https://github.com/MetaMask/metamask-mobile/pull/14036))
...
- fix: cp-7.42.0 Refactor AddNickname with missing data ([#14008](https://github.com/MetaMask/metamask-mobile/pull/14008))
...
[7.45.0]: https://github.com/MetaMask/metamask-mobile/compare/v7.43.0...v7.45.0
