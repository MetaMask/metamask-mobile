...
## Current Main Branch
- build number bump
- temporary ignores vunlerability issues (GHSA-mrgp-mrhc-5jrq, GHSA-2j79-8pqc-r7x6)
- Revert "Fixes vulnerable package dependency"
- Fixes vulnerable package dependency
- version and build bump
- Merge branch 'release/5.8.0' into feature/improve-dapp-connection
- Bump version
...
- Fix lock event
- Merge branch 'main' into feature/improve-dapp-connection
- Bump version
- Update comm layer
- Fix unlock state
...
- Fix small issues
- Formatting
- Merge branch 'feature/improve-dapp-connection' of https://github.com/MetaMask/metamask-mobile into feature/improve-dapp-connection
- Minor changes
- Merge branch 'main' into feature/improve-dapp-connection
- starts with
...
- Merge branch 'main' into feature/improve-dapp-connection
- Typescript
- Merge branch 'feature/dapps-analytics' into feature/improve-dapp-connection
- dapp connect analytics
- Merge commit 'cecdfc5a854c6ede44fb18e0a99213d18531da39' into feature/improve-dapp-connection
...
- Remove audit
- Bump versions
- Merge commit 'e2e548080446cc9de2dac7150a92894b29742334' into feature/improve-dapp-connection
- Remove yarn audit
- Pause connection
- Update CHANGELOG
- Bump version
...
- [#4409](https://github.com/MetaMask/metamask-mobile/pull/4409): Remove Harmony from supported networks
- [#4408](https://github.com/MetaMask/metamask-mobile/pull/4408): Fix wrong analytics event
- Bump build number
- [#4387](https://github.com/MetaMask/metamask-mobile/pull/4387): Fix provider support string
...
- [#4364](https://github.com/MetaMask/metamask-mobile/pull/4364): Fix overriding network and account for orders being processed
- [#4366](https://github.com/MetaMask/metamask-mobile/pull/4366): Fix order id retrieve in checkout
...
- [#4376](https://github.com/MetaMask/metamask-mobile/pull/4376): [5.2.0][FIX] M3 - Warning on legit address
- [#4369](https://github.com/MetaMask/metamask-mobile/pull/4369): [5.2.0][FIX] Secret Recovery Phrase text alignment
- [#4363](https://github.com/MetaMask/metamask-mobile/pull/4363): [5.2.0][FIX] Alignment of check icon with option on select component
- Bump version
...
- bitcode
- Merge branch 'feature/improve-dapp-connection' of https://github.com/MetaMask/metamask-mobile into feature/improve-dapp-connection
- updates version and build number for release testing
...
- Working on android
- Merge branch 'main' into feature/prepare-sdk
- SDK Working
- Merge branch 'main' into feature/prepare-sdk
