...
- chore(runway): cherry-pick fix: cp-7.57.0 rive asset state machine name ([#20762](https://github.com/MetaMask/metamask-mobile/pull/20762))
- chore(runway): cherry-pick fix: cp-7.57.0 rive asset state machine name ([#20758](https://github.com/MetaMask/metamask-mobile/pull/20758))
- chore(runway): cherry-pick fix: cp-7.57.0 prevent duplicate points events api calls ([#20805](https://github.com/MetaMask/metamask-mobile/pull/20805))
- chore(runway): cherry-pick fix: cp-7.57.0 prevent duplicate points events api calls ([#20802](https://github.com/MetaMask/metamask-mobile/pull/20802))
- chore(runway): cherry-pick chore: set BIP-44 as default cp-7.57.0 ([#20737](https://github.com/MetaMask/metamask-mobile/pull/20737))
- refactor: add test env to feature flag mock ([#20721](https://github.com/MetaMask/metamask-mobile/pull/20721))
- chore(runway): cherry-pick chore: set BIP-44 as default cp-13.5.0 ([#20250](https://github.com/MetaMask/metamask-mobile/pull/20250))
- chore(runway): cherry-pick fix: cp-7.57.0 update rewards event type for take profit and stop loss ([#20879](https://github.com/MetaMask/metamask-mobile/pull/20879))
- chore(runway): cherry-pick fix: cp-7.57.0 update rewards event type for take profit and stop loss ([#20869](https://github.com/MetaMask/metamask-mobile/pull/20869))
- chore(runway): cherry-pick chore: New Crowdin translations by Github Action ([#20882](https://github.com/MetaMask/metamask-mobile/pull/20882))
- [skip ci] Bump version number to 2666
- chore(runway): cherry-pick fix: cp-7.57.0 handle session expiration for rewards module ([#20750](https://github.com/MetaMask/metamask-mobile/pull/20750))
- [skip ci] Bump version number to 2663
- chore(runway): cherry-pick fix: cp-7.57.0 make sure rewards session token exists when importing SRP that h… ([#20751](https://github.com/MetaMask/metamask-mobile/pull/20751))
- [skip ci] Bump version number to 2662
- chore(runway): cherry-pick fix: align connection logic with extension cp-7.57.0 ([#20780](https://github.com/MetaMask/metamask-mobile/pull/20780))
- Merge branch 'release/7.57.0' into runway-cherry-pick-7.57.0-1759504626
- [skip ci] Bump version number to 2656
- chore(runway): cherry-pick fix: cp-7.57.0 side effect opt in default account in srp ([#20756](https://github.com/MetaMask/metamask-mobile/pull/20756))
- chore(runway): cherry-pick chore: New Crowdin translations by Github Action ([#20670](https://github.com/MetaMask/metamask-mobile/pull/20670))
- [skip ci] Bump version number to 2643
- chore(runway): cherry-pick fix: cp-7.57.0 side effect opt in default account in srp ([#20747](https://github.com/MetaMask/metamask-mobile/pull/20747))
- chore(runway): cherry-pick fix: cp-7.57.0 handle session expiration for rewards module ([#20690](https://github.com/MetaMask/metamask-mobile/pull/20690))
- [skip ci] Bump version number to 2629
- [skip ci] Bump version number to 2628
...
[7.57.0]: https://github.com/MetaMask/metamask-mobile/compare/v7.55.1...v7.57.0
