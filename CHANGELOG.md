...
- chore: bump {gas-fee,network,selected-network,notification-services,profile-sync,signature}-controller ([#12577](https://github.com/MetaMask/metamask-mobile/pull/12577))
...
[7.37.0]: https://github.com/MetaMask/metamask-mobile/releases/tag/v7.37.0
