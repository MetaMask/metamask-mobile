...
- test: Improve `Engine` unit test isolation ([#21469](https://github.com/MetaMask/metamask-mobile/pull/21469))
- refactor: migrate sentry trace.js to ts ([#21074](https://github.com/MetaMask/metamask-mobile/pull/21074))
...
- test: removes old framework and organizes the framework ([#21359](https://github.com/MetaMask/metamask-mobile/pull/21359))
- fix(perps): balance display without full decimals cp-7.58.0 ([#21355](https://github.com/MetaMask/metamask-mobile/pull/21355))
- test: Improve `RewardsController` unit test isolation ([#21452](https://github.com/MetaMask/metamask-mobile/pull/21452))
- chore: adds TRX Staking feature flag ([#21458](https://github.com/MetaMask/metamask-mobile/pull/21458))
- refactor: Simplify NPM fetching logic ([#21412](https://github.com/MetaMask/metamask-mobile/pull/21412))
...
- refactor(perps): migrate tpsl bottomsheet to fullscreen view ([#21344](https://github.com/MetaMask/metamask-mobile/pull/21344))
- chore(predict): adds initial logic to handle a resolved market ([#21382](https://github.com/MetaMask/metamask-mobile/pull/21382))
- refactor(MultichainAccountSelectorList): remove initialScrollIndex from FlashList cp-7.57.0 ([#21332](https://github.com/MetaMask/metamask-mobile/pull/21332))
...
- test: mock infura requests to unblock e2e ([#21438](https://github.com/MetaMask/metamask-mobile/pull/21438))
...
- New Crowdin translations by Github Action ([#21397](https://github.com/MetaMask/metamask-mobile/pull/21397))
- test: Add more predict e2e locators ([#21418](https://github.com/MetaMask/metamask-mobile/pull/21418))
...
- Fix changelog for create release PR workflow ([#21360](https://github.com/MetaMask/metamask-mobile/pull/21360))
...
- perf: Increase Snap timeouts slightly ([#21405](https://github.com/MetaMask/metamask-mobile/pull/21405))
...
- refactor: Refactor remaining controllers to use modular init pattern ([#21201](https://github.com/MetaMask/metamask-mobile/pull/21201))
...
- docs: update cursor rules and commands for unit testing ([#20597](https://github.com/MetaMask/metamask-mobile/pull/20597))
...
- docs: fix broken links ([#20749](https://github.com/MetaMask/metamask-mobile/pull/20749))
- refactor(perps): migrate to latest hyperliquid sdk ([#21128](https://github.com/MetaMask/metamask-mobile/pull/21128))
- refactor(predict): preview/place order logic ([#21316](https://github.com/MetaMask/metamask-mobile/pull/21316))
...
- ci: remove unused bitrise workflow ([#21296](https://github.com/MetaMask/metamask-mobile/pull/21296))
...
- test: aligns the e2e MetaMask environment through builds and test runs ([#20862](https://github.com/MetaMask/metamask-mobile/pull/20862))
...
- refactor: Align add/switch chain logic with Extension (Fix addEthereumChain unneeded switch approval) ([#20649](https://github.com/MetaMask/metamask-mobile/pull/20649))
- test: addresses flakiness in network expansion solana tests ([#21275](https://github.com/MetaMask/metamask-mobile/pull/21275))
- chore: remove self hosted runners ([#21289](https://github.com/MetaMask/metamask-mobile/pull/21289))
- refactor: Refactor PPOM controller to use modular init pattern ([#21188](https://github.com/MetaMask/metamask-mobile/pull/21188))
...
- test: removed unnecessary scroll that made the test flaky ([#21270](https://github.com/MetaMask/metamask-mobile/pull/21270))
- refactor: Refactor remote feature flag controller to use modular init pattern ([#21213](https://github.com/MetaMask/metamask-mobile/pull/21213))
- test: move smoke confirmations test to regression confirmations and r… ([#21134](https://github.com/MetaMask/metamask-mobile/pull/21134))
...
- refactor: Refactor DeFi-related controllers to use modular init pattern ([#21135](https://github.com/MetaMask/metamask-mobile/pull/21135))
- docs(perps): update metametrics references ([#21210](https://github.com/MetaMask/metamask-mobile/pull/21210))
...
- New Crowdin translations by Github Action ([#21018](https://github.com/MetaMask/metamask-mobile/pull/21018))
...
- refactor: Refactor profile sync controllers to use modular init pattern ([#21102](https://github.com/MetaMask/metamask-mobile/pull/21102))
- feat(INFRA-3009): ios only in GHA ([#20944](https://github.com/MetaMask/metamask-mobile/pull/20944))
- ci(merge queue): Add merge group to workflow trigger ([#21109](https://github.com/MetaMask/metamask-mobile/pull/21109))
...
- test: app readiness check in login process ([#21120](https://github.com/MetaMask/metamask-mobile/pull/21120))
...
- refactor: Refactor smart transactions controller to use modular init pattern ([#21088](https://github.com/MetaMask/metamask-mobile/pull/21088))
...
- refactor: Refactor remaining assets controllers to use modular init pattern ([#21036](https://github.com/MetaMask/metamask-mobile/pull/21036))
- refactor: Refactor token controllers to use modular init pattern ([#21029](https://github.com/MetaMask/metamask-mobile/pull/21029))
- test: skip filtering tokens by selected network from enabled popular networks ([#21095](https://github.com/MetaMask/metamask-mobile/pull/21095))
...
- test: changed value for in-build SRP ([#20617](https://github.com/MetaMask/metamask-mobile/pull/20617))
- MCRM-8: Updated add-team-label worklow to use topology.json ([#21003](https://github.com/MetaMask/metamask-mobile/pull/21003))
- chore: add environment to the state logs ([#20783](https://github.com/MetaMask/metamask-mobile/pull/20783))
- perf: add `SnapKeyring.setSelectedAccounts` support - cp-7.57.0 ([#20952](https://github.com/MetaMask/metamask-mobile/pull/20952))
...
- test: self heal performance e2e ([#21006](https://github.com/MetaMask/metamask-mobile/pull/21006))
- test: remove app launch times test, rename to expo_dev_pipeline ([#21008](https://github.com/MetaMask/metamask-mobile/pull/21008))
- New Crowdin translations by Github Action ([#20943](https://github.com/MetaMask/metamask-mobile/pull/20943))
- feat(predict): new buy/sell logic without on-chain tx ([#20665](https://github.com/MetaMask/metamask-mobile/pull/20665))
- test: add predict e2e infrastructure ([#20965](https://github.com/MetaMask/metamask-mobile/pull/20965))
- fix(predict): market details tabs ([#20970](https://github.com/MetaMask/metamask-mobile/pull/20970))
- test: build android ([#20975](https://github.com/MetaMask/metamask-mobile/pull/20975))
...
- test: Increase memory and cores in Detox configuration for CI stability ([#20974](https://github.com/MetaMask/metamask-mobile/pull/20974))
- chore: Adding e2e test case for new send flow ([#20512](https://github.com/MetaMask/metamask-mobile/pull/20512))
- test: Add first musd test ([#20815](https://github.com/MetaMask/metamask-mobile/pull/20815))
...
- chore: sync stable to main for version 7.58.0 ([#20788](https://github.com/MetaMask/metamask-mobile/pull/20788))
...
- refactor: use extended thinking and tools for agentic e2e selection ([#20893](https://github.com/MetaMask/metamask-mobile/pull/20893))
- test: quarantines ramps tests that were disabled, reduces trade shards ([#20945](https://github.com/MetaMask/metamask-mobile/pull/20945))
...
- refactor: custom amount confirmation ([#20599](https://github.com/MetaMask/metamask-mobile/pull/20599))
- test: adds a guard to the flask test report to be skipped when it should ([#20858](https://github.com/MetaMask/metamask-mobile/pull/20858))
...
- ci: add build step for ios regression e2e ([#20897](https://github.com/MetaMask/metamask-mobile/pull/20897))
- chore: disable RC auto generation ([#20896](https://github.com/MetaMask/metamask-mobile/pull/20896))
- INFRA-2999-Fix create release PR workflow changelog issue for mobile ([#20894](https://github.com/MetaMask/metamask-mobile/pull/20894))
...
- New Crowdin translations by Github Action ([#20794](https://github.com/MetaMask/metamask-mobile/pull/20794))
- refactor: use bumped notification controller config cleanup ([#20860](https://github.com/MetaMask/metamask-mobile/pull/20860))
- test: fixes schedule builds outputs ([#20867](https://github.com/MetaMask/metamask-mobile/pull/20867))
...
- ci: remove identity ios regression e2e on bitrise ([#20864](https://github.com/MetaMask/metamask-mobile/pull/20864))
...
- test: add pred page objects ([#20823](https://github.com/MetaMask/metamask-mobile/pull/20823))
...
- refactor: Refactor network controller to use messenger and init pattern ([#20741](https://github.com/MetaMask/metamask-mobile/pull/20741))
- feat(ramp): add activation keys to all non-prod envs ([#20781](https://github.com/MetaMask/metamask-mobile/pull/20781))
- test: regression tests reporting ([#20648](https://github.com/MetaMask/metamask-mobile/pull/20648))
- chore: Bump Snaps packages ([#20834](https://github.com/MetaMask/metamask-mobile/pull/20834))
- refactor: Refactor keyring controller to use modular init pattern ([#20732](https://github.com/MetaMask/metamask-mobile/pull/20732))
- test: add job to run Flask Smoke E2E in GHA ([#19977](https://github.com/MetaMask/metamask-mobile/pull/19977))
...
- INFRA-2999-FixAutoCreateReleasePR ([#20744](https://github.com/MetaMask/metamask-mobile/pull/20744))
...
- test: quarantine ramp test ([#20724](https://github.com/MetaMask/metamask-mobile/pull/20724))
...
- test: skip dorny on scheduled runs ([#20678](https://github.com/MetaMask/metamask-mobile/pull/20678))
- refactor: add test env to feature flag mock ([#20721](https://github.com/MetaMask/metamask-mobile/pull/20721))
...
- revert: "feat: introduce native utils margelo" ([#20710](https://github.com/MetaMask/metamask-mobile/pull/20710))
- test: fixed test `e2e/specs/assets/multichain/asset-list.spec.ts` ([#20671](https://github.com/MetaMask/metamask-mobile/pull/20671))
- fix(card): card home viewed metric returning NaN error ([#20707](https://github.com/MetaMask/metamask-mobile/pull/20707))
- perf: speed up overlay animation duration to 150ms ([#20695](https://github.com/MetaMask/metamask-mobile/pull/20695))
- test: Removed test scenario due to functionality change ([#20702](https://github.com/MetaMask/metamask-mobile/pull/20702))
...
- INFRA-2999-Fixes for create release workflows ([#20653](https://github.com/MetaMask/metamask-mobile/pull/20653))
- refactor: Refactor preferences controller to use modular init pattern ([#20683](https://github.com/MetaMask/metamask-mobile/pull/20683))
...
- refactor: Refactor subject metadata controller to use modular init pattern ([#20688](https://github.com/MetaMask/metamask-mobile/pull/20688))
...
- refactor: Refactor permission controller to use modular init ([#20510](https://github.com/MetaMask/metamask-mobile/pull/20510))
...
- test: fix numberKey.waitFor is not a function ([#20667](https://github.com/MetaMask/metamask-mobile/pull/20667))
- refactor: tab empty state cleanup ([#20652](https://github.com/MetaMask/metamask-mobile/pull/20652))
- test: Account regression and smoke e2e tests ([#20273](https://github.com/MetaMask/metamask-mobile/pull/20273))
- New Crowdin translations by Github Action ([#20608](https://github.com/MetaMask/metamask-mobile/pull/20608))
- refactor(ramp): aggregator region UX update ([#20613](https://github.com/MetaMask/metamask-mobile/pull/20613))
...
- refactor: ramp payment modal bottom sheet ([#20562](https://github.com/MetaMask/metamask-mobile/pull/20562))
- feat(rewards): add deeplink support for rewards ([#20508](https://github.com/MetaMask/metamask-mobile/pull/20508))
- refactor(deposit): use sdk env according MetaMask env ([#20520](https://github.com/MetaMask/metamask-mobile/pull/20520))
...
- refactor(ramp): use sdk env according MetaMask env ([#20588](https://github.com/MetaMask/metamask-mobile/pull/20588))
...
- test: Fixed the test `e2e/specs/assets/nft-detection-modal.spec.ts` ([#20631](https://github.com/MetaMask/metamask-mobile/pull/20631))
- chore: dedicated github runners for android e2e ([#20463](https://github.com/MetaMask/metamask-mobile/pull/20463))
- revert: "chore: Prioritize target and environment values from js env for build.sh" ([#20621](https://github.com/MetaMask/metamask-mobile/pull/20621))
...
- test: refactors needs-builds step ([#20538](https://github.com/MetaMask/metamask-mobile/pull/20538))
...
- test: convert appwright selectors to .ts ([#20580](https://github.com/MetaMask/metamask-mobile/pull/20580))
- Chore: New Crowdin translations by Github Action cp-7.56.1 ([#20494](https://github.com/MetaMask/metamask-mobile/pull/20494))
...
- test: fixed test `e2e/specs/assets/defi/view-defi-tab.spec.ts` ([#20582](https://github.com/MetaMask/metamask-mobile/pull/20582))
- fix(perps): invalid candle interval button styles ([#20447](https://github.com/MetaMask/metamask-mobile/pull/20447))
- refactor: add common pattern for RewardsController caching & add pointsEvents caching ([#20471](https://github.com/MetaMask/metamask-mobile/pull/20471))
- refactor(ramp): use avatar token icon ([#20587](https://github.com/MetaMask/metamask-mobile/pull/20587))
...
- test: fix keyboard issue on import flow on iOS ([#20584](https://github.com/MetaMask/metamask-mobile/pull/20584))
- chore: bump `@metamask/multichain-account-service` to `^1.4.0` ([#20572](https://github.com/MetaMask/metamask-mobile/pull/20572))
- test: fix assets view and send flow ([#20519](https://github.com/MetaMask/metamask-mobile/pull/20519))
...
- refactor: Refactor selected network controller to use modular init pattern ([#20516](https://github.com/MetaMask/metamask-mobile/pull/20516))
...
- test: Migrate appwright gestures to e2e/framework folder ([#20489](https://github.com/MetaMask/metamask-mobile/pull/20489))
- chore: add segment error tracking to vault issues ([#19425](https://github.com/MetaMask/metamask-mobile/pull/19425))
- ci: change performance run frequency ([#20553](https://github.com/MetaMask/metamask-mobile/pull/20553))
...
- test: add unit tests on SegmentPersistor ([#20518](https://github.com/MetaMask/metamask-mobile/pull/20518))
- test: fixes the scheduled main smoke e2e runs ([#20515](https://github.com/MetaMask/metamask-mobile/pull/20515))
...
- New Crowdin translations by Github Action ([#20473](https://github.com/MetaMask/metamask-mobile/pull/20473))
...
- Rewards rwds 495 hardware wallet settings exclusion v2 ([#20464](https://github.com/MetaMask/metamask-mobile/pull/20464))
...
- test: fix flaky test `e2e/specs/assets/import-tokens-via-asset-watcher.spec.ts` ([#20409](https://github.com/MetaMask/metamask-mobile/pull/20409))
...
- test: fix build state machine ([#20441](https://github.com/MetaMask/metamask-mobile/pull/20441))
- ci: fix ios e2e in bitrise ([#20435](https://github.com/MetaMask/metamask-mobile/pull/20435))
- chore: update network names ([#19745](https://github.com/MetaMask/metamask-mobile/pull/19745))
- ci: fix performance workflow ([#20416](https://github.com/MetaMask/metamask-mobile/pull/20416))
- test: fix yarn setup in performance workflow ([#20397](https://github.com/MetaMask/metamask-mobile/pull/20397))
- chore: bump multichain accounts deps ([#20255](https://github.com/MetaMask/metamask-mobile/pull/20255))
- Fix broken type reference links in ButtonLink README ([#16509](https://github.com/MetaMask/metamask-mobile/pull/16509))
...
- test: add binary to anvil startup ([#20374](https://github.com/MetaMask/metamask-mobile/pull/20374))
- test: add launch times tests to performance suite ([#20283](https://github.com/MetaMask/metamask-mobile/pull/20283))
...
[7.58.0]: https://github.com/MetaMask/metamask-mobile/compare/v7.56.5...v7.58.0
