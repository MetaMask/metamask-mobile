...
- Revert "fix: bump axios to 1.15.0 to resolve critical SSRF vulnerability (#28620)
...
- Unify USD amount range bucketing for balance tracking (#28914)
- Bump assets controller v5.0.0 (#28569)
- Update CSS layout spacing for legacy and advanced charts (#28920)
- Removed geo-restrictions for RWA tokens in the Stocks view (#28872)
- Fix showing outline pill on advanced charts on old history when chart head is visible. (#28837)
- Consolidates chart events (#28902)
- Fallback to legacy chart if new ohlcv api returns empty result (#28728)
- Update badge color and position (#28857)
- Rewards campaign emit events (#28794)
- No-changelog (#28859)
- Remove token details v2 flag (#28823)
...
- Ondo campaign rewards - stats page (#28734)
- chore(release): sync stable to main for version 7.74.0 (#28727)
- Remove usage of tokensChainsCache from useMusdConversionStatus (#28644)
- Remove tokensChainsCache usage from usePerpsPaymentTokens (#28639)
- Remove usage of tokensChainsCache from OndoPortfolio (#28646)
- Remove unused tokensChainsCache usage in useWithdrawTokens (#28601)
...
- Stopped using the token list cache for asset overview token details; decimals, aggregators, and market data now come from the (#28533)
...
- chore: Revert "chore: Sync 7.57.1 with stable" (#21840)
- chore: Sync 7.57.1 with stable (#21836)
- chore(runway): bump version to 7.57.1 (#21548)
- chore: revert 21221 (#21341)
- chore: revert pr 15706 from 7.49.0 (#16304)
- chore: revert 15665 from 7.49.0 (#16306)
- chore: revert 15669 from 7.49.0 (#16305)
- revert a3e434083a05b64756736aeb196c48e42660c122 (#12134)
- chore: cherry pick 12074 (#12082)
- bump build number to 1468 for v7.34.0 - RC-3 (#12053)
- Chore/merge main in release 7.33.0 (#11999)
- chore: update attribution (#11998)
- chore: 7.33.0 merge fix (#11970)
...
- Chore: bump to 1450 (#11665)
- Bump build to 1449 (#11654)
- chore: Chore/7.31.1 bump rc2 (#11645)
- chore: Cherry/cherry pick audit ignore (#11644)
- chore: bump to 1444 (#11604)
- chore: bump to 1443 (#11584)
- chore: cherry pick #11524 (#11571)
- chore: Chore/7.32.0 bump to 1442 (#11560)
- chore: bump build to 1441 (#11541)
- Cherry pick e5de779 to 7.32.0 (#11516)
- chore: bump to 1439 (#11463)
- chore: bump to 1432 (#11298)
- chore: bump build to 1429 (#11268)
- chore: bump build 1427 (#11211)
- chore: cherry pick sync hot fixes 7.29.1 & 7.29.2 (#11016)
- chore: cherry pick swaps PR (#11010)
- chore: bump version to 1409 RC-2 (#11008)
- chore: Cherry pick 5849444 (#11007)
- chore: Cherry pick reCaptcha fix (#10908)
- chore: cherry pick d98a1c9 fix(notifications): hide profile sync toggle (#10951)
- chore: updated bitrise build version (#10957)
- Chore: Bump version 1401 RC3 (#10838)
- chore: cherry pick 10533 (#10823)
- chore: bump version 1399 RC 2 (#10822)
- chore: bump verions number 1397 for RC 5 (#10737)
- chore: version bump 1393 rc4 (#10713)
- chore: cherry pick d147d8f (#10453) (#10453)
- chore: cherry picked and fixed conflicts 7.28.1 release (#10702)
- chore: cherry pick fix for aggregated balance calculation (#10638)
- chore: cherry pick 2df9eb5 (#10669)
- chore: Cherry pick 3285220 (#10659)
- chore: Cherry pick 340e5ed (#10660)
- chore: Cherry pick new terms of use (#10609)
- chore: bump version 1378 RC 2 (#10581)
- chore: revert 10266 (#10525)
- chore: bump version 1372 (#10526)
- chore: bump RC3 version to 1370 (#10459)
- chore: Cherry pick #10387 (#10443)
- chore: bump version 1367 7.28.0 (#10370)
- chore: 7.27.0 version bump 1364 (#10343)
- chore: 7.27.0 RC 2 (#10305)
- chore: 7.26.0 bump 1359 rc 4 (#10255)
- chore: bump version RC 3 1358 (#10211)
- chore: sync 7.24.4 main (#10117)
- chore: bump build for 7.26.0 - RC2 (#10105)
- chore: resolve conflicts for ws audit (#10097)
...
- Revert "fix: synchronize accounts name" (#10003)
- bump build number to 1333 (#9769)
- chore: bump RC 4 1332 (#9738)
- chore: fix cherry conflict while merging JSON fix. (#9716)
- chore: version bump 1331 (#9691)
- chore: Merge main changes into release/7.22.0 (#9607)
- chore: merge main 7.22.0 (#9591)
- chore: RC - 3 bump version 1325 (#9557)
- Cherry pick revert linea goerli network (#9534)
- chore: bump build to 1323 (#9518)
- chore: Chore/cherry pick #9436 (#9449)
- chore: 7.21.0 main sync (#9409)
- Revert "chore: Merge main into 7.20.0 (#9230)
- chore: Merge main into 7.20.0 (#9230)
- chore: Bump 7 20 0 rc3 (#9209)
- chore: Bump 7.20.0 1303 (#9179)
- chore: fix ses crash resolution (#9098)
- Bump build from 1288 to 1289 (#9089)
- chore: Version bump to 1288 (#9064)
- chore: sync with main 7.18.0 (#8978)
- chore: Merge main into 7.17.1 (#8962)
- chore: Bump release 7.18.0 RC 3 version to 1281 (#8947)
- bump to RC3 (#8939)
- chore: v7.18.0 RC 2 version bump to 1279 (#8924)
- Bump version to 1273 (#8878)
- Bump version to 1272 (#8876)
- chore: bump version 1267 (#8779)
- chore: cherry pick 8615 (#8640)
...
- chore: revert engine slice PR (#8540)
- bumped up build to 1249 (#8505)
- chore: cherry pick 8373 (#8477)
- chore: build version bump to 1245 (#8458)
- chore: cherry pick 8421 (#8456)
- chore: build bump 1244 (#8419)
- chore: cherry pick spinner fix (#8417)
- chore: merge main into 7.14.0 - resolve conflicts (#8339)
- chore: bump to build 1243 (#8314)
- chore: cherry pick QR & migrations hotfixes into 7.15.0 (#8297)
- chore: build version bump to 1240 (#8296)
- chore: fix: scanning dapp QR code does not open in-app browser and navigate … (#8294)
- chore: merge 7.14.0 (#8258)
- chore: bump build 1237 (#8236)
- chore: Bump up build to 1136 (#8214)
- chore: cherry pick to lower case fix into 7.14.0 (#8208)
- bump up build to 1234 (#8188)
- chore: cherry pick 7.12.4 into 7.14.0 (#8164)
- chore: build bump to 1233 (#8178)
- chore: 7.12.3 merge 7.14.0 (#8153)
- chore: 7.12.2 merge 7.14.0 (#8152)
- chore: fix: prevent bad svg urls in react-native-svg (#8102) (#8102)
- chore: bump build 7.13.0 (#8070)
- chore: merge hotfix 7.12.2 (#8069)
- chore: cherry pick translations (#8027)
- Cherry pick: feat: Content update for Swaps (#8008)
- chore: update header key (#8007)
- chore: build bump 1214 RC4 (#7939)
- chore: cherry pick #7607 (#7945)
- chore: cherry pick 7935 (#7944)
- chore: cherry pick 7881 (#7883)
- chore: build bump to 1197 (#7779)
- chore: Cherry pick - bump axios (#7758) (#7758)
- chore: Update change log 7.10.0 (#7686)
- chore: build version 1186 (#7685)
- chore: Cherry pick (#7651) into 7.10.0 (#7651)
- chore: cherry pick 7667 (#7676)
- chore: Disable failing tests for CI smoke tests on release branch (#7675)
- chore: Build 1183 (#7638)
- chore: cherry pick 7614 (#7619)
- chore: cherry pick #7584 (#7588)
- chore: Cherry pick #7540 (#7580)
- chore: cherry pick #7574 (#7581)
- build bump for RC-3 (#7536)
- increase build on RC (#7478)
- chore: Cherry pick 7.9.0/7305 (#7466)
- chore: cherry pick Ramp copy updates (#7467)
- build_1174_RC2 (#7340)
- build 1171 RC2 (#7249)
- Handle etherscan rate limit errors (#7220)
- build 1169 RC2 (#7071)
- build 1167 RC4 (#7020)
- build 1164 RC3 (#7003)
- Revert "fix(browser): added remaining fields in WebSourceResponse patch (#6479)" (#6479)
...
- accept current merge changes (#6803)
- build 1144 (#6793)
...
- chore: Linea translations (#6649) (#6649)
...
- chore: pending review feedback for token details related changes (#6530) (#6530)
- build 1127 RC2 (#6572)
- resolve merge conflicts between 7.0.1 and 7.1.0 (#6565)
- bugfix: fix for swaps button displaying on unsupported networks (#6473) (#6473)
- Fix bug domain not shown on signature (#6464)
- upgrade to cocoapods 1.12.0 (#6512) (#6512)
...
- Fix ENS name displayed on confirm send page (#6350) (#6350)
- RC2 build 1113 (#6448)
...
- Revert "[FEAT] wallet connect v2 (#6355)" (#6355)
...
- Fix/6.4 main merge (#6222)
- build number bump to 1100 for RC2 (#6204)
- Appium/fixes cleanup 6.4.0 (#6198)
- fix token image size (#6197)
- [FIX] [6.4.0] Token rate undefined handled properly (#6195)
- [UPDATE] VM2 version (#6196)
- detox: close what's new modal (#6151)
...
- Fix broken SDK init call (#6045) (#6045)
- Bump 6.3.0 to build 1090 RC3 (#6074)
- Upgrade xcode version (#6006) (#6006)
...
- Upgrade on-ramp-sdk to 1.9.0 (#5782) (#5782)
- Release 6.1.2 Hotfix (#5921)
- Fix/update branch pod lock checksum (#5909)
- [FIX] Add try-catch to recreateVault (#5906)
- Hotfix remove eth sign (#5848)
- Bump version to 1078 (#5858)
- [FIX] Fix scanning Unity QR code for MM SDK (#5856)
- Bump/6.1.0 rc2 1077 (#5852)
- Bug/674 network search crash (#5851)
- [FIX] Fix regression bugs on 6.1.0 bug report (#5834)
- [HOTFIX] Browser: handle unsupported URLs (#5799)
- [VERSION] Bump 6.0.0 RC2 to #1068 (#5774)
- [FIX] Migrate dapps access into permission controller state (#5724)
- [FIX] UI bugs from 6.0.0 bug report (#5765)
- [FIX] Keystone transaction with account balance empty (#5761)
- [FIX] ENS Resolves to Wrong Address when DeepLink (#5742)
- Reset to 5.14.0 tag (#5734)
- Fix/release/5.14.1 (#5727)
- [FIX] Importing private key via QR code redirects to browser (#5714)
- [FIX] Settings networks icons were missing (#5709)
- Update change logs and bump build number to 1055 (#5633)
- Modal confirmation refactoring (#5631)
- Fix currency display (#5624)
- Fix analytics events (#5615)
- build 1049 (#5606)
- Token Detection not persisting (#5585)
- [UPDATE] yarn audit resolutions (#5596)
- Swaps disabled on fresh install on some networks (#5556)
- On-ramp: Fix order link in details screen (#5550)
- build 1042 (#5510)
- Fix styles of recovery of SRP (#5490)
- network persisting when re launching the app (#5482)
- build version 1039 (#5463)
- remove conversion rate and exchange rate for condition (#5439)
- send nft on IOS disabled (#5394)
...
- Update change log (#5285)
- [UPDATE] android SDK 31 (#5257)
- Revert "Refactor Approve Component (#5064)" (#5064)
- build version bump for RC2 (#5234)
- On-ramp: add order type property and analytics (#5233)
- bump version to 1004 (#5222)
- [FIX] Send to the wrong address (#5217)
- On-ramp: Fix multiple redirection handling (#5209)
- avoid using Rinkeby in wallet & import network test (#5113) (#5113)
- fix ens race error and disable confirm button when no address is valid (#5172)
- hotfix for the race of resolving the ens (#5159)
- 5.8.1 (#5097)
- Fix account switch after importing via private key and creation of ne… (#5104)
- Update "Usability enhancement" template (#4939)
- Detox version bump from 19.6.5 to 19.7.1 (#4782)
- removes `metamask://dapp/` schema support until stable on Android (#4412)
- Remove canOpenUrl from onramp linking (#4391)
- Additional fixes for double tab opened with metamask://dapp/ schema (#4396)
...
- Fixes double tab opening when using `metamask://dapp/` deep link schema (#4383)
- Update Release Notes (#5020)
- Prevent add account from auto switching accounts (#5005)
- Add patch and version bump (#5007)
- bumped xcode version down to the 13.4 (#5003)
- version code bump for RC 2 of 5.7.0 (#5001)
- Fix 384 (5.7 Regression) (#4963)
- on boarding wizard fixed when we complete the 3 steps of creating new wallet (#4996)
- bump version 14 xcode for release signing (#4988)
- 5.6.1 (#4965)
- [FIX] Prevent import account from auto switching accounts (5.7 Regression) (#4989)
- Update Bitrise Git version (#4969)
- Update Release 5.6.1 (#4968)
- Add http and https protocol to webview origin whitelist (#4966)
- url-parse implemented (#4967)
- detox update (#4952)
- Update git version and Revert "ENS CCIP Wildcard Support" (#4950)
- Bump build number (#4948)
- Upgrade On-Ramp SDK to v1.2.1 (#4944)
- function is testnetwork now its being called (#4924)
- Change swaps default slippage to 2% (#4838)
- 5.5.1 (#4872)
- Add testnets condition (#4878) (#4878)
- Add 5.5.1 change log (#4877)
- Upgrade on-ramp-sdk to 1.1.2 (#4837)
- Marge main (#4732)
- Update snapshots (#4713)
- Cherry pick c99a10f (#4712)
- pin nvm to @1.3.0 (#4700)
- Cal/5.4.0 rc fixes 2nd set (#4688)
- message error fixed (#4680)
- Fix CD1, CD3, CD3B, CD4, CD5 (#4682)
- Remove duplicated properties from trackEvent objects (#4686)
- Update/5.4.0 change log (#4664)
- Fix/5.3.0 conflicts (#4632)
- Merge main into 5.3.0 (#4630)
- [Detox] revert browser test back to uniswap (#4616)
- Bump build number (#4608)
- "Add Network" screen UI adjustments (#4590)
- [CD3] Add custom clipboard copy instead of relying on native select text (#4579)
- Fix audit advisory (#4592)
- Update address validation logic (#4562)
- Apply checksum when adding recents (#4557)
- [Detox] Add coverage for whats new modal (#4581)
- Just being able to navigate to on ramp if the networks are supported (#4564)
- fix duplicate networks when adding to the addToFrequentRPClist (#4556)
...
- fix crash when changing password (#4098)
- Keystone Integration: fix - keystone android camera permission wrongly appeared in iOS devices (#4071)
- Add getTicker to Gas Carousel (#4053)
...
- Added new `selectMoneyHubEnabledFlag` selector to control conditional rendering of the new Money hub screen. (#28934)
- Null (#28710)
- Create unfunded state on CardHome (#28891)
- Updated multichain private key list to open as a full screen instead of a bottom sheet (#28703)
- Closed positions now show realized PnL % (#28875)
- New reward campaign deeplinks + musd (#28802)
- Updated Token Details sticky footer buttons with green success styling and A/B test for swap label (#28729)
- Improved unified buy and ramp order screens so headers are shown once and match the rest of the in-app flow. (#28883)
- Add native token send in transaction activity for gas fees sponsored (#28876)
- Add new add wallet screen. (#28018)
- Fixed candlestick chart 429 rate limiting during rapid market navigation by routing historical candle fetches over HTTP (#28865)
- Hide zero balance tokens native exempt (#28721)
- Added trader position view (#28848)
- Add gas fees sponsored message in the transaction activity tab (#28822)
- Fixed KYC flow to automatically close the verification webview after document submission and return the user to the processing (#28595)
  screen
- Added a Benefits summary in Reward page, displaying top 3 (#27515)
  added a FullView to list available benefits for a
  subscription
  added a FullView to display the detail of the benefit
  added a claim button that navigate the user to a third
  party website through the in-app browser
- Added Leaderboard profile page (#28583)
- Fixed MetaMask Card authentication, unauthenticated cardholder actions, and spending limit/delegation refresh flows after (#28564)
  the CardController migration.
- Added persistent disk-backed caching for Perps so the trading screen opens instantly without loading skeletons (#27898)
- Added Money account activity preview on the Money home screen and a full activity list with filters when enabled by feature (#28632)
  flags
- Added Positions and Outcomes tab bar to sports game detail screens (#28668)
- Add gas-included metrics properties (#28571)
- Added "Convert your stablecoins" module to Money Home with eligible asset states and convert entry point (#28536)
- Adds Tempo support (using 7702/gasless) with absence of native token on Mobile. (#27142)
  adds Tempo transactions (partial) support on Mobile.
- Fixed inconsistent Secret Recovery Phrase reveal flow for seedless accounts (#28081)
- Hide zero-balance tokens on homepage and migrate setting for all users (#28527)
- Update transaction transactions metrics to add details on smart transactions and submission method (#28501)
- Added optional blocking of Google Sign-In on iOS versions below 17.4 when enabled by remote configuration, with clearer (#28402)
  error messaging for new and existing wallet flows.
- Updated the Tron token overview to show claimable and estimated staking rewards with improved unavailable-data handling. (#28052)
- Add campaign tour before use opts into a new campaign (#28495)
- Added fiat loss amount to the bridge/swap price impact warning modal so users see the real-money value of a high price-impact (#28378)
  trade.
- Fixed pull-to-refresh on the DeFi full view opened from the homepage (#28514)
...
- Pin changes added in login and create password screen (#21261)
- feat: release-7.24.0 RC-2 cut build increment (#9907)
- feat: Bump Build Number to 1315 (#9359)
- feat: Cherry pick controller utils v5 (#9222)
- feat: migrate to latest Token rates controller to release 7.12.4 (#8156)
- feat: build 1162 RC2 (#6993)
- feat: trigger qrsigning modal using approval controller (#6212) (#6212)
...
- Display correct amount in swap native in transaction display for gas fees sponsored trx (#28930)
- Fixed a bug that was causing reverse position orders in Perps to fail when stale entry pricing was used during order placement (#28897)
- fix: changed location prop name for cash account event (#28882)
- UseHasInsufficientBalance to skip native balance checks on Tempo (#28817)
...
- Fixed the mUSD estimated annual bonus so it reflects the user's combined mUSD balance across Ethereum mainnet and Linea (#28663)
  instead of only the chain currently being viewed.
- Fixed the Swap Max quick-pick button overflowing on smaller screens (#28858)
- Polish token selector for Buy, Swap and Send (#28711)
- Fixed missing recent perpetuals funding payments — `getFunding` now fetches the most recent 30-day window by default (1 API (#28671)
  ...
  500-record cap.
- Fixed a bug where "Paid by MetaMask" was incorrectly shown in transaction details for failed hardware wallet swaps on MON (#28584)
  network
- Fixed a bug that showed erc20 approvals as nft approvals (#28732)
- Fixed a bug where out-of-bounds amounts on the V2 Buy screen showed a generic error instead of the provider's minimum/maximum (#28174)
  amount message. Added client-side limit validation to skip unnecessary
  quote API calls.
...
- Fixed a bug where the swap confirm button remained active after changing tokens while a stale quote was still loading (#28759)
...
- Fixed a bug where tapping the confirmation overlay during its close animation could navigate the user to the home screen (#27974)
- Fixed a bug where sport-related prediction markets were incorrectly sorted using game-specific ordering instead of standard (#28760)
  sorting
...
- Fixed Buy amount screen sometimes showing a generic error when quotes returned for the selected provider but provider id (#28337)
  strings differed in format.
- Fixed swap deeplinks on supported disabled networks so the requested chain opens without an extra network-added toast. (#28670)
- fix: remove animation config from learn more import srp pop up (#28629)
- Fixed an issue where the Swap button was hidden on asset detail pages for tokens on unsupported networks; tapping Swap now (#28623)
  opens with a default ETH pair instead.
- Fixed perps withdraw transactions not appearing in the Perps activity Deposits tab (#28659)
- Fix AC interactions in token details. (#28653)
- Fixed transaction fee, estimated time, and total rows not appearing for same-chain Predict deposits/withdrawals (#28652)
- Fixed Tron staking and unstaking pages not displaying fee estimates (#28240)
- Fixed a bug where the Activity page showed incorrect PnL and order size for trades executed via multiple partial fills (e.g. (#28593)
  Stop Loss).
- fix: forward build outputs to Slack and PR comment to prevent stale build numbers (#28615)
- Updated the bridge screen to use a back chevron instead of a close icon (#28605)
- Fixed mUSD row on Home navigating to a single-network detail page instead of the network breakdown screen (#28594)
- Fixed perps withdraw zero-balance token selection reverting to mUSD and insufficient funds error when typing full balance (#28599)
- Fix assetId format for pol (#28578)
- Update volume bar transparency (#28577)
- On Gas-Sponsored networks, allow sending full native balance using `Max`. (#28055)
- Fixed perps withdraw metrics tracking, hide rows when no quotes are available, and fixed blue title in transaction details (#28588)
- Persist chart type upon switch in user state (#28580)
- Fixed advanced chart timeframe switching (1H/1D/1W/1M/1Y) showing identical charts for different time periods (#28542)
- Fixed a bug where placing a market order with TP/SL would incorrectly cancel TP/SL orders belonging to existing pending (#28073)
  limit orders, and fixed position TP/SL display showing limit order
  values instead of position-bound values.
- Fixed Turkish percentage strings that could render missing placeholder text on the homepage and related flows. (#28469)
- Include clientId and clientVersion in bridge token api requests (#28554)
- Remove unused logs (#27925)
- Fixed long titles overflowing on the Predict buy preview header (#28446)
- Fixed Android custom slippage values being clipped in the swap slippage modal (#28464)
- Fixed perps "pay with any token" order flow to show the standard "Order submitted" toast instead of a different "Submitting your (#28511)
  trade" toast
...
- Null (#28290)
- Replace password tp pin changes in case of rehyration and on onboarding success screen for ios platform and social login flow. (#21340)
- fix: update attribution (#12009)
...
- fix: stx on ramps missing origin (#10099) (#10099)
- fix: synchronize accounts name (#9997)
- fix: Engine does not exist, network controller is missing ids (#9978)
- fix(ramp): memoize asset before passing it to balance hook (#9968) (#9968)
- fix: Release/7.24.0 cherry missing chain (#9872)
- fix: cherry pick migration 23 fix (#9325)
...
- fix: Tokens disappearing (#8892)
- fix: update PPOM to v1.4.4 (#8863) (#8863)
- fix: update PPOM to v1.4.4 (#8863) (#8863)
- fix: Cherry pick translations (#8773)
- fix: Fix/1539 patch root file with controller data (#8578)
- fix: Revert/8081 engine slice (#8576)
- fix: cherry pick migrations fix on 7.14.0 (#8295)
- fix: add RN patch for boost (#8221) (#8221)
- fix: Fix `eth_signTypedData` signatures containing `0x` (#7886)
- fix: OpenSea supply -> total_supply (#8175)
- fix: OpenSea V1 -> V2 patch (#8155)
- fix: Disable SES on iOS (#8057)
- fix: Cherry pick revert javascript disable on webview (#7898)
- fix: revert nonce logic in transaction controller [HOTFIX] (#7653)
- fix: audit issues (#7656)
- fix: transactions stuck in submitted status [Release Branch] (#7532)
- fix: invalid destructuring of undefined object (#7200) (#7200)
- fix: safeguard utill/address functions for undefined arguments (#7056) (#7056)
- fix: keystone signatures (#7166) (#7166)
- fix: sdk connection issues (#7102) (#7102)
- fix: approval modal showing after submit swap (#7142) (#7142)
- fix: [7.6.0] - Token quotes on token details screen (#7064) (#7064)
...
- fix: vault recovery & invalid password error (#6957) (#6957)
- fix: invalid transaction data used for approve transaction (#6833) (#6833)
...
- fix(bitrise): bump project bitrise version (#6689) (#6689)
