...
- chore: update release pr approval trigger
- [skip ci] Bump version number to 3047
- Add Monad as supported network in Rewards Ways to Earn (#22662)
- Removed Sei from default networks and added QuickNode fallback RPC. (#22450)
- chore: enable EAS updates on preview channel (#21838)
- chore: segment events for QR scanner (#22287)
- No functional changes, this is still under a feature flag. (#22400)
- Removed `MM_REMOVE_GLOBAL_NETWORK_SELECTOR` feature flag from asset polling hooks. Polling now uses (#22463)
  `NetworkEnablementController` state to determine which networks to poll.
- Update earn and stake view title with the correct wording. (#21771)
- Include client version and platform version in `snap_getClientStatus` response. (#22317)
- Updated assets-controllers to version ^87.1.1 (#22396)
- No functionality changes expected (#22237)
- chore: Remove MM_PER_DAPP_SELECTED_NETWORK feature flag (#21963)
- Update Tutorial Perps Intro to redirect to the markets home screen view (#22131)
- Show tracked/untracked in reward settings view (#22298)
- Tron accounts controlled by feature flags (#21910)
- chore: sync stable to main for version 7.59.0 (#22222)
- remove v7.57.3
- keep main
- take main corrections
- Bugfix to cancel all order flow to ensure position TP/SL persists (#22215)
- No changes to user functionality (#22186)
- NA (#22157)
- Cleaned up Perps codebase by removing unused code and improving documentation (#22101)
- Null - ui fix (#21875)
- Fetch currency rates using price api and fallback to crypto compare (#21523)
- NA (#22085)
- Improve quote streaming UX and prevent premature tx submission (#21685)
- chore: sync stable to main for version 7.57.1 (#21899)
- chore: remove PORTFOLIO_VIEW feature flag (#21806)
- Default perps controller to mainnet (#21650)
- Update default bridge slippage to 2% (#21882)
- Removal of network selector in settings (#21614)
- Introduces pure UI component for Perps homescreen redesign (#21804)
- Persists candle period selection in Perps chart (#21593)
- Adds a button for max leverage when the max leverage is 3 such that there are 2 buttons to choose from (#21645)
- NA (#21630)
- chore: sync stable to main for version 7.57.0 (#21538)
- Updated order labels in the perps transaction view to have more readable titles (#21596)
- Improved "import token: flow (#21472)
- Bump bridge controller versions (#21392)
- Added a feature flag for the homepage redesign (#21526)
- Removes the earn token selector. (#21514)
