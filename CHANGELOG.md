...
- Merge branch 'main' into stable-main-7.59.0
- Merge branch 'release/7.61.0' into release/7.61.0-Changelog
- chore(runway): cherry-pick chore(metro bundler): allow metro bundler to spawn worker ([#23443](https://github.com/MetaMask/metamask-mobile/pull/23443))
- update changelog for 7.61.0 (hotfix - no test plan)
- chore(runway): cherry-pick chore(release pr validation): remove unnecessary pull_request trigger ([#23438](https://github.com/MetaMask/metamask-mobile/pull/23438))
- update changelog for 7.61.0 (hotfix - no test plan)
- chore(runway): cherry-pick feat: convert onboarding page to tsx ([#23420](https://github.com/MetaMask/metamask-mobile/pull/23420))
- [skip ci] Bump version number to 3183
- update changelog for 7.61.0
- update changelog for 7.61.0 (hotfix - no test plan)
- Merge main into stable-sync
...
- [skip ci] Bump version number to 3046
- release v7.58.3
- feat(predict): add skeleton loaders and error handling for order preview (#23340)
- feat(perps): visualize order book (#23327)
- feat(perps): usdh support for hip-3 (#23301)
- fix(perps): home using crossmargin instead of isolated margin (#23357)
- test: disables temporarily the popular network test (#23366)
- feat(perps): support hyperliquid growth mode (#23308)
- fix(perps): charting issues and incorrect decimals (#23315)
- feat(predict): navigate to transaction details from deposit toast (#23283)
- refactor(Predict): migrate Text component to design system (#23344)
- feat(predict): implement share market button (#23330)
- chore: updated job to increase memory 12 GB to address flaky run issue (#23345)
- refactor(predict): improve deposit toast UX and empty state component (#23282)
...
- chore: Remove MM_REMOVE_GLOBAL_NETWORK_SELECTOR feature flag from component level (#22067)
- chore: add activity item for shield and holding m usd (#23231)
- fix(ramp): cp-7.60.0 fix phone already registered error detection in BasicInfo form (#23299)
- feat(perps): design v2 for perps asset screen (#23230)
- feat(analytics): Add rpc_domain property to custom RPC analytics events (#23322)
- fix(predict): Resolves issue when selecting MAX on market details chart few new-ish markets (#23077)
- chore: bump `eth-snap-keyring` (to enable `:accountCreated` idempotency) cp-7.60.0 (#23310)
- refactor: update AccountSelector animations to use screen width instead of height (#23313)
- chore: re-organize trending and bug fixes (#23280)
- refactor: Remove all external references to legacy Swaps routes (#23108)
- fix(perps): segment violations and event simplification cp-7.60.0 (#23189)
- docs(perps): update hyperliquid references (#23236)
- chore: fix signature verification sorting issue cp-7.60.0 (#23220)
- chore: Updated ButtonFilters on activity page (#23285)
- test: add e2e to open predict position (#23081)
- chore: condense market data disclaimer copy (#23229)
- feat(predict): cp-7.60.0 append utm_source to entryPoint in predict deeplinks (#23275)
- chore: cp-7.60.0 bump tron snap and keyring-api package (#23196)
- refactor: Migrate swap utilities to global scope (#23234)
- chore: Update 'Daily resource' to 'Daily resources' (#22679)
- refactor(ramp): change network filter to single-select in token selection (#23256)
- refactor(ramp): add horizontal padding to ScreenLayout content (#23254)
- feat(transactions): enhance collectible transfer handling and add mint method support (#23043)
- chore: rewards add account require explicit internal account (#23044)
- refactor: enhance NFT details tracking with source parameter (#23110)
- fix(perps): normalize price formatting in order and position views (#22931)
- fix(perps): Prevent duplicate day markers on TradingView chart (#23179)
- chore: New Crowdin translations by Github Action (#22073)
- refactor: move ShapesBackgroundAnimation to ramps directory (#23175)
- chore: Re-organize link-handling files / folders (#23079)
- feat(Predict): cp-7.60.0 add side-specific errors for unfilled orders (#23209)
- fix(predict): cp-7.60.0 improve spacing and styling in Predict components (#23207)
- chore(predict): add env var to skip geoblock (#23204)
- feat(ramps): unified buy analytics (#23072)
- chore: EAS updates key signing (#22684)
- chore: switch to uat rewards for local/dev (#23202)
- chore: sync stable to main for version 7.61.0 (#23104)
- chore: shards do not block each other for unit tests (#22559)
- chore: swaps controller remove constants 2 (#23125)
- ci: Migrates some GH workflows to reusable actions (#23178)
- feat(segment): add isFullView prop to TokenList and TokenListItem components (#23109)
- feat(perps): chart improvements with volume and fullscreen view (#22843)
- fix(card): cp-7.60.0 Card Onboarding flow refactor (#22976)
- chore: add app metadata controller enabled on sentry app start (#23127)
- docs: update README branding and logo sizing (#23123)
- refactor(ramp): sell menu button and build quote title (#23061)
- refactor(ramp): deposit title to buy (#23070)
- fix(perps): use static filter tab values to match FilterTab type cp-7.60.0 (#23102)
- feat(ramps): adds unsupported and error modals to ramp entrypoint (#23057)
- fix(perps): increase bottom padding in PerpsTabView for navigation cl… (#23105)
- perf: cp-7.60.0 reduce loading time of metamask pay confirmations (#23064)
- Merge main into stable-sync
- fix(perps): calculate weighted ROE percentage for aggregated account states cp-7.60.0 (#23090)
...
- feat(perps): Add A/B testing framework for button color experiment (#22231)
- feat(predict): add auto-refresh for optimistic positions (#23051)
- chore: tron snap update cp-7.60.0 (#23059)
- fix(ramps): fixes array mutation in ramp routing hook (#23058)
- chore: remove primitive imports from swaps controller (#23040)
- chore: timeout build android apk for e2e 30 minutes (#23056)
- chore: remove MM_REMOVE_GLOBAL_NETWORK_SELECTOR from hooks, lists, and control bars (#22574)
...
- refactor(perps): decompose PerpsController into specialized services (#22844)
...
- fix(perps): add missing returnOnEquity calculation in HyperLiquidSubscriptionService cp-7.60.0 (#22983)
- release: 7.59.0 (#22226)
- test: updates e2e-testing.md to reflect the current status (#22990)
- ci: Enable flask tests on regular CI (#22924)
- feat(ramps): Refactor Ramp Navigation and Deep Linking (#22578)
- test: fix cash out activity mock (#22970)
- chore(predict): cp-7.60.0 updates predict low liquidity error message(s) (#22978)
- chore(ci): add e2e guidelines to Bugbot rules (#22915)
- fix(predict): cp-7.60.0 improve price formatting and position display (#22882)
- fix(predict): cp-7.60.0 claimable positions logic (#22963)
- fix(predict): cp-7.60.0 refresh balance after claim (#22910)
- Merge branch 'stable' into release/7.59.0
- chore: improve AI prompt and loging (#22930)
- Release 7.58.3 (#22811)
- chore: fix tron image in tokens list cp-7.60.0 (#22860)
- fix(tests): disable auto-sync to reduce test flakiness (#22914)
- fix(snaps): Refactor `SnapBridge` to use `SelectedNetworkController` (#22873)
- fix(card): cp-7.60.0 card assets UI issues (#22901)
- test: Fix Snaps E2E after settings changes (#22933)
- test: skip cash out test for open position in Predictions (#22935)
- feat(perps): use universal price display on chart (#22767)
- fix(predict): order calculations (#22900)
- chore(predict): update confirmation toast icon (#22877)
- refactor: trending carousel number styles (#22859)
- refactor(predict): move lost redeems filtering from client to API (#22698)
- chore: Update text for Rewards user flows (#22881)
- fix(card): cp-7.60.0 fix OTP inputs frozen screens (#22894)
- feat(ramp): implement dynamic token fetching for token selection screen (#22892)
- feat(ramps): adds unsupported modal for ramps entrypoints (#22580)
- fix(card): cp-7.60.0 debounced inputs on onboarding flow (#22747)
- fix(card): cp-7.60.0 fix false positives on card delegation failed metrics (#22822)
- test: add relayer mocks for cashing out (#22750)
- chore: fix unit test from main
- release: release/7.59.0-Changelog (#22494)
- refactor(ramp): standardize TokenSelection screen to use shared patterns (#22874)
- chore(release): Bump main version to 7.61.0 (#22828)
- fix(predict): Improving copy on positions that have resolved early (#22832)
- chore: fix AI tests tag action (#22855)
- fix(predict): Ensures buy preview button always has the same value as header (#22834)
- perf(perps): improved navigation time on low/middle range android devices (#22701)
- chore: cp-7.60.0 bump core-backend to 4.1.0 (#22796)
- refactor: Remove unused notification code (#22833)
- chore: update seedless controller 6.1.0 (#21991)
- feat(ramps): add unsupported token modal and disabled tooltip to token view (#22595)
- refactor(ramp): remove splash screens from ramps (#22739)
- chore: Fix NPMGateError for mobile (#22824)
- feat(notifications): create onChainAnalyticProperties util (#22801)
- fix(ramp): sell navigation (#22743)
- update changelog
- chore: cp-7.60.0 bump tron to 1.8.0 (#22795)
- fix(perps): use centralized ROE calculation in live positions cp-7.59.0 (#22791)
- chore: rename test suite for the test report (#22798)
- chore: Reenable Autocreate Release PR workflow (#22330)
- chore: remove rewards feature flag (#22318)
- style: Update NetworkVerificationInfo styles and tests (#22644)
- refactor: streamline trade action handling in PerpsMarketDetailsView (#22716)
- chore: Add more info about custom schemes to deeplink readme (#22732)
- chore: improve swaps performance (#22744)
- [skip ci] Bump version number to 3055
- chore(runway): cherry-pick fix(card): cp-7.58.3 physical address consent issue + undefined balances (#22737)
- chore(runway): cherry-pick chore: Update Spanish strings for Card onboarding flow cp-7.58.3 (#22740)
- chore: Update Spanish strings for Card onboarding flow cp-7.58.3 (#22733)
...
- feat(ramps): use goToRamps for Aggregator and Deposit entry points (#22196)
...
- fix(predict): Reverts PR that caused chart to hide when selecting certain timeframes (#22674)
...
- fix(perps): race condition sometime preventing loading hip-3 positions cp-7.59.0 (#22646)
- fix(card): cp-7.59.0 wrong zero balances on SelectAsset BottomSheet (#22658)
...
- fix(e2e): replace KDF delays with explicit wallet visibility checks (#22627)
- fix(bridge): cp-7.59.0 prevent crash when fetching icons for unsupported chains (#22631)
- chore: Consolidate Predict trade events into single event (#22622)
- chore(predict): standardize decimal formatting for percentages and price (#22573)
...
- chore: prefer side effect acc group for opt in & link active acc group (#22550)
- fix(predict): sell order error messages (#22596)
- fix(predict): Resolves issue with details chart incorrectly hiding (#22594)
...
- feat(predict): calculate net deposit amount after deducting fees (#22587)
...
- chore: bump multichain accounts deps (and other related peers) cp-7.59.0 (#22521)
- fix(card): cp-7.59.0 delegation refresh issue (#22549)
- fix(predict): update pending deposits to store batch IDs instead (#22554)
- chore: update BottomSheetHeader close and back buttons to size LG (#22170)
- fix(Predict): improve button layout and error messages (#22560)
- refactor(predict): extract account tree logic into accounts utility (#22503)
- fix(predict): Resolves scrolling issue on tabs (outcomes, etc) on market details due to loading skeletons (#22505)
- fix(perps): optimize read operations and prevent builder fee blocking cp-7.59.0 (#22552)
- chore: cp-7.59.0 input fixes (#22508)
- test: Check geo restriction for add funds (#22490)
- fix(predict): optimistic updates when querying claimable positions (#22542)
...
- fix(perps): rerender tabs when the amount of tabs changes cp-7.59.0 (#22517)
...
- fix(predict): Ensures both active and claimable positions are visible on market details (#22495)
...
- feat(perps): add cross margin warning modal and validation handling (#22293)
...
- fix(perps): exclude P&L from total margin calculation in close all positions (#22391)
...
- refactor: transaction pay controller (#21086)
- test: Mmqa fix perf flakiness (#22192)
- fix(predict): Market details outcomes tab now displays correctly when market is resolved (#22358)
- fix(card): UI issues on Authentication/Delegation (#22352)
- fix(predict): cap slippage to avoid sharePrice > 1 (#22354)
- feat(predict): Adds CLOB pricing refresh to details view (#22261)
- fix(predict): improve error handling when placing orders (#22253)
- chore(INFRA-3041): Stable Sync workflow update github-tools (#22197)
- chore: update tutorial to redirect to the home markets list on last page (#22131)
- chore: rewards bip 44 tracked indicators (#22298)
- feat(ds): accept listItemProps in ListItemSelect (#22277)
- fix(perps): prevent infinite loop in usePerpsPositionData cp-7.59.0 (#22257)
- fix(predict): Resolves search issue (removes spurious querystring param) (#22271)
- chore(predict): cash out screen changes (#22272)
- feat(predict): relay sell orders (#22290)
- fix(predict): Various chart UX fixes / improvements (#22220)
- chore(predict): change polymarket links to use webview (#22255)
...
- Merge branch 'main' into stable-main-7.59.0
- feat(perps): add skeleton loading states and fix rewards points display (#22248)
- chore(predict): fix eslint warnings (#22228)
- refactor(card): sonarcloud maintainability issues (#22221)
- chore: tron feature flag control (#21910)
- fix(perps): display live funding rate data in the asset list (#22243)
- chore: rewards optimize usage of get opt in status (#22247)
- feat(ramps): implement useRampNavigation hook (#22091)
- chore: remove BIP-44 flag from intro modal (#22227)
- refactor(perps): optimize selectors and improve utility functions (#22246)
