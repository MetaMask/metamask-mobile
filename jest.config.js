...
const config = {
  ...
  transformIgnorePatterns: [
    'node_modules/(?!((@metamask/)?(@react-native|react-native|@react-navigation|@react-native-community|@react-native-masked-view|react-navigation|d3-color|d3-shape|d3-path|d3-scale|d3-array|d3-time|d3-format|d3-interpolate|d3-selection|d3-axis|d3-transition|internmap|@notifee|expo-file-system|expo-modules-core|expo(nent)?|@expo(nent)?/.*)|@metamask/design-system-twrnc-preset|@metamask/design-system-react-native|@metamask/smart-transactions-controller))',
  ],
  transform: {
  ...
  moduleNameMapper: {
    ...
    '^@tommasini/react-native-scrollable-tab-view$':
      '<rootDir>/app/__mocks__/@tommasini/react-native-scrollable-tab-view.js',
    '^@tommasini/react-native-scrollable-tab-view/DefaultTabBar$':
      '<rootDir>/app/__mocks__/@tommasini/react-native-scrollable-tab-view-DefaultTabBar.js',
    '^redux-persist-filesystem-storage$':
      '<rootDir>/app/__mocks__/redux-persist-filesystem-storage.js',
