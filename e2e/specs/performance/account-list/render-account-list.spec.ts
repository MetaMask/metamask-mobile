    ...
    createUserProfileTests(
      ...
      async (userState) => {
        ...
        const PERFORMANCE_THRESHOLDS = isAndroid
          ? {
              TOTAL_TIME: 100, // 5.9 seconds max for Android
            }
          : {
              TOTAL_TIME: 100, // 4 seconds max for iOS
            };
    ...
    createUserProfileTests(
      ...
      async (userState) => {
        ...
        const HEAVY_LOAD_THRESHOLDS = isAndroid
          ? {
              TOTAL_TIME: 100, // 4.2 seconds max for Android
            }
          : {
              TOTAL_TIME: 100, // 4.2 seconds max for iOS
            };
    ...
    createUserProfileTests(
      ...
      async (_userState) => {
        ...
        const BASELINE_THRESHOLDS = isAndroid
          ? {
              TOTAL_TIME: 100, // 3.8 seconds max for Android
            }
          : {
              TOTAL_TIME: 100, // 3.8 seconds max for iOS
            };
