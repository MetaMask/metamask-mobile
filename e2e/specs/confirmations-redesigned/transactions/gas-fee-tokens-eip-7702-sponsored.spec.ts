...
import { setupMockRequest, setupMockPostRequest } from '../../../api-mocking/helpers/mockHelpers';
...
const setupCommonMocks = async (mockServer: Mockttp) => {
  ...
  // Mock infura_simulateTransactions using setupMockPostRequest
  await setupMockPostRequest(
    ...
    {
      statusCode: 200,
      // Ignore dynamic fields that change between requests
      ignoreFields: ['id', 'params.0.blockOverrides', 'params.0.transactions', 'params.0.suggestFees'],
      priority: 1000,
    },
  );
      ...
      await withFixtures(
        {
          ...
          testSpecificMock: async (mockServer: Mockttp) => {
            ...
            // Mock eth_sendRelayTransaction using setupMockPostRequest
            await setupMockPostRequest(
              mockServer,
              LOCALHOST_SENTINEL_URL,
              {
              ...
              {
                statusCode: 200,
                ignoreFields: ['id', 'params'], // Ignore these fields during matching
                priority: 999,
              },
            );
            ...
            await setupMockRequest(mockServer, {
              requestMethod: 'GET',
              url: `${LOCALHOST_SENTINEL_URL}/smart-transactions/1234-5678`,
              response: {
                transactions: [
                  {
            ...
            // await setupMockRequest(mockServer, {
            //   requestMethod: 'GET',
            //   url: `https://tx-sentinel-127.0.0.1.api.cx.metamask.io/smart-transactions/1234-5678`,
            //   response: {
            //     transactions: [
            //       {
            //         hash: TRANSACTION_RELAY_STATUS_NETWORKS_MOCK.response
