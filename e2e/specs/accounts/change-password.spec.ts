...
describe(Regression('change password'), () => {
  ...
  it('updates password', async () => {
    ...
    await Matchers.getElementByText('Account 1');
    await Matchers.getElementByText('Account 2');
    await Matchers.getElementByText('Account 3');
    await Matchers.getElementByText('Account 4');
    await Matchers.getElementByText('QR 1');
