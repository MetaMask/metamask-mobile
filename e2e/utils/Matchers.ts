...
export default class Matchers {
  ...
  static async getElementByText(
    ...
    return element(by.text(text)).atIndex(index) as Detox.IndexableNativeElement;
  }
  ...
  static async getElementByIDAndLabel(
    ...
    return element(by.id(id).and(by.label(label))).atIndex(index) as Detox.IndexableNativeElement;
  }
  ...
  static async getElementByLabel(
    ...
    return element(by.label(label)).atIndex(index) as Detox.IndexableNativeElement;
  }
  ...
  static async getElementByCSS(
    ...
    return myWebView.element(by.web.cssSelector(selector)).atIndex(0) as unknown as Detox.IndexableWebElement;
  }
  ...
  static async getElementByHref(
    ...
    const myWebView = web(by.id(webviewID));
    return myWebView.element(by.web.href(url)).atIndex(0) as unknown as Detox.IndexableWebElement;
  }
   ...
   */
  static async getSystemElementByText(text: string): Promise<Detox.IndexableSystemElement> {
