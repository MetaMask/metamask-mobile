...
export const OnboardingSelectorIDs = {
  ...
  */
  ...
  SOCIAL_LOGIN_SUCCESS_EXISTING_USER_TITLE:
    'social-login-success-existing-user-title-id',
  SOCIAL_LOGIN_SUCCESS_EXISTING_USER_BUTTON:
    'social-login-success-existing-user-button-id',
};
