export const SendActionViewSelectorsIDs = {
  ...
  CONTINUE_BUTTON: 'snap-footer-button-send-submit-button',
  CANCEL_BUTTON: 'snap-footer-button-send-cancel-button',
  CLOSE_BUTTON: 'snap-confirmation-Modal-close-button'
};