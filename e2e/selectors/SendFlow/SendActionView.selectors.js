export const SendActionViewSelectorsIDs = {
  ...
  SEND_TRANSACTION_BUTTON: 'transaction-confirmation-submit-button-snap-footer-button',
  CANCEL_SEND_TRANSACTION_BUTTON: 'transaction-confirmation-cancel-button-snap-footer-button',
