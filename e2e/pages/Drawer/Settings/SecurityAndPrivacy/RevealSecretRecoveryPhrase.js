...
const REVEAL_SECRET_RECOVERY_PHRASE_TOUCHABLE_BOX_ID = 'private-credential-touchable';
...
export default class RevealSecretRecoveryPhrase {
	...
	static async isSecretRecoveryPhraseTouchableBoxVisible() {
		await TestHelpers.checkIfVisible(REVEAL_SECRET_RECOVERY_PHRASE_TOUCHABLE_BOX_ID);
	}
	static async isSecretRecoveryPhraseTextCorrect(Correct_Seed_Words) {
		await TestHelpers.checkIfHasText(SECRET_RECOVERY_PHRASE_TEXT, Correct_Seed_Words);
	}
}
