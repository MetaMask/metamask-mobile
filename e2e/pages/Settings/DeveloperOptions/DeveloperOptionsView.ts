...
import {
  DeveloperOptionsSelectorsText,
} from '../../../selectors/Settings/DeveloperOptions.selectors';

class DeveloperOptionsView {
  get sampleFeatureButton() {
    return Matchers.getElementByText(DeveloperOptionsSelectorsText.NAVIGATE_TO_SAMPLE_FEATURE);
  }
