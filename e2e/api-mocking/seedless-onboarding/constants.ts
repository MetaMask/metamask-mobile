 ...
 * Using dev environment for E2E tests
 */
...
/**
 * Regex to match all 5 SSS nodes
 */
export const SSSBaseUrlRgx =
  /https:\/\/node-[1-5]\.dev-node\.web3auth\.io\/sss\/jrpc/u;

/**
 * Metadata Service endpoints for encrypted seed phrase storage
 */
...
/**
 * SSS Node Key Pairs for each of the 5 nodes
