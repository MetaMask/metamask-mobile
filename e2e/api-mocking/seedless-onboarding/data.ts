/**
 * Seedless Onboarding E2E Test Mock Data
 * Contains cryptographic keys and encrypted data matching Extension implementation
 */

import { ToprfStoreKeyShareRequestParams } from './types';

/**
 * Mock JWT private key for signing test tokens
 */
...
/**
 * Mock authentication public keys
 */
...
/**
 * Initial mock encryption key for encrypting/decrypting seed phrase
 */
...
/**
 * New mock password encryption key after password change
 */
...
/**
 * Mock key share data for the 5 SSS nodes
 * Contains encrypted shares and auth tokens for each node
 */
export const MockKeyShareData: ToprfStoreKeyShareRequestParams = {
