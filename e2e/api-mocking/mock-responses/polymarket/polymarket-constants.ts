...
// Post-open-position USDC balance (18.11 USDC = 18,110,000 = 0x1145c60)
// Base balance (28.16) - investment (10.00) - fees (~0.05) = 18.11 USDC
export const POST_OPEN_POSITION_USDC_BALANCE_WEI =
  '0x0000000000000000000000000000000000000000000000000000000001145c60'; // 18,110,000 in hex
