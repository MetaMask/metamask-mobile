...
- **skip-sonar-cloud**: The PR will be merged without running SonarCloud checks. Adding this label re-runs failed CI jobs so the quality-gate job does not have to be retried by hand.
