...
export const FEATURE_FLAG_REGISTRY: Record<string, FeatureFlagRegistryEntry> = {
  ...
  confirmations_relay_fixed_spread: {
    ...
    productionDefault: {
      routes: [
        ...
        {
          sourceChain: '0x1',
          sourceToken: '0x23878914efe38d27c4d67ab83ed1b93a74d4086a',
          targetChain: '0x1',
          targetToken: '0xaca92e438df0b2401ff60da7e4337b687a2435da',
        },
        {
          sourceChain: '0x1',
          sourceToken: '0x018008bfb33d285247a21d44e50697654f754e63',
          targetChain: '0x1',
          targetToken: '0xaca92e438df0b2401ff60da7e4337b687a2435da',
        },
        {
        ...
        },
        {
          ...
          sourceToken: '0xaca92e438df0b2401ff60da7e4337b687a2435da',
          targetChain: '0xe708',
          targetToken: '0x176211869ca2b568f2a7d4ee941e073a821ee1ff',
        },
        {
          sourceChain: '0xe708',
          sourceToken: '0x374d7860c4f2f604de0191298dd393703cce84f3',
          targetChain: '0xe708',
          targetToken: '0xaca92e438df0b2401ff60da7e4337b687a2435da',
        },
        {
          sourceChain: '0xe708',
          sourceToken: '0x88231dfec71d4ff5c1e466d08c321944a7adc673',
          targetChain: '0xe708',
          targetToken: '0xaca92e438df0b2401ff60da7e4337b687a2435da',
        },
        {
          sourceChain: '0x8f',
          sourceToken: '0x754704bc059f8c67012fed69bc8a327a5aafb603',
          targetChain: '0x8f',
          targetToken: '0xaca92e438df0b2401ff60da7e4337b687a2435da',
        },
        {
          ...
          sourceToken: '0xaca92e438df0b2401ff60da7e4337b687a2435da',
          targetChain: '0x8f',
          targetToken: '0x754704bc059f8c67012fed69bc8a327a5aafb603',
        },
        {
          sourceChain: '0xa4b1',
  ...
  moneyShowMoneyAccountAddress: {
    name: 'moneyShowMoneyAccountAddress',
    type: FeatureFlagType.Remote,
    inProd: true,
    productionDefault: {
      minimumVersion: '0.0.0',
  ...
  predictClobV2UseLegacyClobHost: {
    name: 'predictClobV2UseLegacyClobHost',
    type: FeatureFlagType.Remote,
    inProd: true,
    productionDefault: {
      enabled: false,
