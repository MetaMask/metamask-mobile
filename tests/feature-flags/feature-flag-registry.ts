 ...
 *
 * Production defaults last synced: 2026-08-04
...
export const FEATURE_FLAG_REGISTRY: Record<string, FeatureFlagRegistryEntry> = {
  ...
  earnMoneyEarningsSectionEnabled: {
    name: 'earnMoneyEarningsSectionEnabled',
    type: FeatureFlagType.Remote,
    inProd: true,
    productionDefault: {
      enabled: false,
  ...
  socialAiTSA905AbtestQuickBuyKeyboard: {
    name: 'socialAiTSA905AbtestQuickBuyKeyboard',
    type: FeatureFlagType.Remote,
    inProd: true,
    productionDefault: {
      versions: {
        '8.5.0': [
          {
            ...
            thresholdName: 'control — full rollout',
            thresholdVersion: 2,
            value: 'control',
          },
        ],
