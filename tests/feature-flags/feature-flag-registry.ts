 ...
 *
 * Production defaults last synced: 2026-07-14
        ...
        '8.3.0': [
          {
            ...
            thresholdName: 'disabled — control (white) for everyone',
            thresholdVersion: 2,
            value: 'control',
          },
        ],
  ...
  predictWorldCup: {
    ...
    productionDefault: {
      ...
      stages: [
        ...
        {
          eventIds: ['669233', '676288', '672628', '679992'],
          key: 'quarterfinals',
        },
        {
          eventIds: ['691040', '694581'],
          key: 'semifinals',
        },
      ],
    },
