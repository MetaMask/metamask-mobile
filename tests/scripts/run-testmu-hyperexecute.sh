...
env:
  ...
  LT_USERNAME: "$(yaml_escape "$LT_USERNAME")"
  LT_ACCESS_KEY: "$(yaml_escape "$LT_ACCESS_KEY")"
  ...
  MM_TEST_ACCOUNT_SRP: "$(yaml_escape "${MM_TEST_ACCOUNT_SRP:-}")"
  TEST_SRP_1: "$(yaml_escape "${TEST_SRP_1:-}")"
  TEST_SRP_2: "$(yaml_escape "${TEST_SRP_2:-}")"
  TEST_SRP_3: "$(yaml_escape "${TEST_SRP_3:-}")"
  TEST_SRP_4: "$(yaml_escape "${TEST_SRP_4:-}")"
  E2E_PASSWORD: "$(yaml_escape "${E2E_PASSWORD:-}")"
  E2E_PERFORMANCE_SENTRY_DSN: "$(yaml_escape "${E2E_PERFORMANCE_SENTRY_DSN:-}")"
  ...
  TESTMU_ANDROID_APP_URL: "$(yaml_escape "${TESTMU_ANDROID_APP_URL:-}")"
  TESTMU_ANDROID_CLEAN_APP_URL: "$(yaml_escape "${TESTMU_ANDROID_CLEAN_APP_URL:-${TESTMU_ANDROID_APP_URL:-}}")"
  TESTMU_ANDROID_ONBOARDING_PERF_APP_URL: "$(yaml_escape "${TESTMU_ANDROID_ONBOARDING_PERF_APP_URL:-${TESTMU_ANDROID_CLEAN_APP_URL:-}}")"
