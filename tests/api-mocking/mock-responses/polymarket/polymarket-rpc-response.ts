...
export const MOCK_RPC_RESPONSES = {
  ...
  // pUSD contract call - return mock balance
  PUSD_BALANCE_RESULT: MOCK_PUSD_BALANCE_WEI,

  // Post-claim pUSD balance
  POST_CLAIM_PUSD_BALANCE_RESULT: POST_CLAIM_PUSD_BALANCE_WEI,

  // Backward-compatible aliases while remaining callers migrate naming.
  USDC_BALANCE_RESULT: MOCK_PUSD_BALANCE_WEI,
  POST_CLAIM_USDC_BALANCE_RESULT: POST_CLAIM_PUSD_BALANCE_WEI,
