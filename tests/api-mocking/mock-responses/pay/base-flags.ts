const BASE_ASSETS_FLAGS = [
  {
    additionalNetworksBlacklist: ['0x1079', '0x13b2'],
  },
  {
...
const BASE_CONFIRMATIONS_FLAGS = [
  {
...
const BASE_MONEY_ACCOUNT_FLAGS = [
  {
    moneyAccount: {
...
export const BASE_FLAGS_DATA = [
  ...BASE_ASSETS_FLAGS,
  ...BASE_CONFIRMATIONS_FLAGS,
  ...BASE_MISC_FLAGS,
  ...BASE_HOME_FLAGS,
  ...BASE_MOBILE_UX_FLAGS,
  ...BASE_MONEY_ACCOUNT_FLAGS,
  ...BASE_PERPS_FLAGS,
  ...BASE_PREDICT_FLAGS,
  ...BASE_SEND_FLAGS,
  ...BASE_STX_FLAGS,
