const BRIDGE_TOP_ASSETS_CHAIN_1 = [
  {
...
const BRIDGE_TOKEN_DETAILS_CHAIN_1 = [
  {
    address: '0x0000000000000000000000000000000000000000',
    chainId: 1,
...
export const DEFAULT_BRIDGE_API_MOCKS = {
  GET: [
    {
      urlEndpoint: 'https://bridge.api.cx.metamask.io/networks/1/topAssets',
      response: BRIDGE_TOP_ASSETS_CHAIN_1,
      responseCode: 200,
    },
    {
