...
### Networks — [`harnesses/networks.ts`](harnesses/networks.ts)
...
- **Use when:** proving NC add/remove, TokensController wipe on network remove, or sibling controller wiring with mocked I/O. Smoke: [`harnesses/networks.integration.test.ts`](harnesses/networks.integration.test.ts)
- **Use cases:** see [`core-ux-use-cases.md`](core-ux-use-cases.md) (`UX-NET-HARNESS`, `UX-NET-TOKEN-WIPE`)

### Networks Flow — [`harnesses/networks-flow.ts`](harnesses/networks-flow.ts)
...
- [`core-ux-use-cases.md`](core-ux-use-cases.md) — Core UX network-management flows mapped to Integration Shape A/B / Unit.
