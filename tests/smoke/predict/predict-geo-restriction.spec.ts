...
import {
  predictGeoBlockedFeedExpectations,
  predictGeoBlockedCashoutExpectations,
  predictGeoBlockedDepositExpectations,
      ...
      await withFixtures(
        {
          ...
          analyticsExpectations: predictGeoBlockedFeedExpectations,
        },
        async () => {
          await loginToApp();
      ...
      await withFixtures(
        {
          ...
          analyticsExpectations: predictGeoBlockedCashoutExpectations,
        },
        async () => {
          await loginToApp();
      ...
      await withFixtures(
        {
          ...
          restartDevice: true,
          testSpecificMock: PredictionGeoBlockedFeature,
          analyticsExpectations: predictGeoBlockedDepositExpectations,
        },
        async () => {
          await loginToApp();
          await TabBarComponent.tapActions();
