...
import { predictClaimPositionsExpectations } from '../../helpers/analytics/expectations/predict-claim-positions.analytics';
    ...
    await withFixtures(
      {
        ...
        analyticsExpectations: predictClaimPositionsExpectations,
      },
      async ({ mockServer }) => {
