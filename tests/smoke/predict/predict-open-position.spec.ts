...
import { predictOpenPositionExpectations } from '../../helpers/analytics/expectations/predict-open-position.analytics';
    ...
    await withFixtures(
      {
        ...
        analyticsExpectations: predictOpenPositionExpectations,
      },
      async ({ mockServer }) => {
        await loginToApp();
