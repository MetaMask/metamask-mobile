...
import Browser from '../../../page-objects/Browser/BrowserView.ts';
import ConfirmationFooterActions from '../../../page-objects/Browser/Confirmations/FooterActions.ts';
import ConfirmationUITypes from '../../../page-objects/Browser/Confirmations/ConfirmationUITypes.ts';
import TestDApp from '../../../page-objects/Browser/TestDApp.ts';
import NetworkListModal from '../../../page-objects/Network/NetworkListModal.ts';
import TabBarComponent from '../../../page-objects/wallet/TabBarComponent.ts';
import WalletView from '../../../page-objects/wallet/WalletView.ts';
