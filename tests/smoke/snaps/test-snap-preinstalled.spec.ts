...
import { snapPreinstalledTrackEventExpectations } from '../../helpers/analytics/expectations/snap-preinstalled.analytics';
    ...
    await withFixtures(
      {
        ...
        analyticsExpectations: snapPreinstalledTrackEventExpectations,
      },
      async () => {
        await loginToApp();
