    ...
    await withFixtures(
      ...
      async () => {
        ...
        await Assertions.expectElementToBeVisible(
          ConnectedAccountsModal.accountSummaryHeader,
        );

        await ConnectedAccountsModal.tapCancelButton();
        await CommonView.tapBackButton();
        await Assertions.expectElementToBeVisible(BrowserView.backButton);
        await BrowserView.tapBackButton();
