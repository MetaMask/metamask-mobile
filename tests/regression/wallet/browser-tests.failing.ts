...
import EnsWebsite from '../../page-objects/Browser/ExternalWebsites/EnsWebsite.ts';
import Assertions from '../../framework/Assertions.ts';
import ConnectBottomSheet from '../../page-objects/Browser/ConnectBottomSheet.ts';
import RedirectWebsite from '../../page-objects/Browser/ExternalWebsites/RedirectWebsite.ts';
import UniswapWebsite from '../../page-objects/Browser/ExternalWebsites/UniswapWebsite.ts';
import OpenseaWebsite from '../../page-objects/Browser/ExternalWebsites/OpenseaWebsite.ts';
import PancakeSwapWebsite from '../../page-objects/Browser/ExternalWebsites/PancakeSwapWebsite.ts';
import DownloadFile from '../../page-objects/Browser/DownloadFile.ts';
import DownloadFileWebsite from '../../page-objects/Browser/ExternalWebsites/DownloadFileWebsite.ts';
import TestHelpers from '../../helpers.js';
import CameraWebsite from '../../page-objects/Browser/ExternalWebsites/Security/CameraWebsite.ts';
import HistoryDisclosureWebsite from '../../page-objects/Browser/ExternalWebsites/Security/HistoryDisclosureWebsite.ts';
...
describe.skip(SmokeWalletPlatform('Browser Tests'), () => {
  beforeEach(() => {
