...
import { startRedesignedNativeSendFiveEthToReview } from '../../../flows/confirmations.flow.js';
...
import GasFeeTokenModal from '../../../page-objects/Confirmation/GasFeeTokenModal.js';
...
appiumTest.describe.skip(
  ...
  () => {
    ...
    appiumTest(
      'Send ETH via EIP-7702 paying gas with USDC',
        ...
        await withFixtures(
          ...
          async () => {
            ...
            await GasFeeTokenModal.checkAmountToken(
              'DAI',
              daiValues.tokenAmount,
            );
            await GasFeeTokenModal.checkBalance('DAI', daiValues.balance);

            await GasFeeTokenModal.checkAmountFiat(
              'USDC',
              usdcValues.fiatAmount,
            );
            await GasFeeTokenModal.checkAmountToken(
              'USDC',
            ...
            await Assertions.expectTextDisplayed(usdcValues.fiatAmount, {
              description: 'USDC gas fee fiat amount on confirmation',
            });
