...
export const SET_APPROVAL_FOR_ALL_ACTIVITY = 'Set approval for all';

export function buildSetApprovalFixture({
  localNodes,
}: {
...
export const setApprovalTestSpecificMock = async (mockServer: Mockttp) => {
