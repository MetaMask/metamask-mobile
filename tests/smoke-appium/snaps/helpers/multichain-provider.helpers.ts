...
export const ethereumChain: MultichainChain = {
  name: 'Ethereum',
  chainId: '0x1',
  genesisHash:
...
export const sepoliaChain: MultichainChain = {
  name: 'Sepolia',
  chainId: '0xaa36a7',
  genesisHash:
...
export const solanaChain: MultichainChain = {
  name: 'Solana',
...
export async function runMultichainProviderTest(
