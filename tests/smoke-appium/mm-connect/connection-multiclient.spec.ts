...
appiumTest.describe.skip(SmokeMMConnect('Multiclient connect'), () => {
  ...
  appiumTest(
    '@metamask/connect-multichain (multiple clients) - Connect multiple clients via Multichain API to Local Browser Playground',
