...
import { mmConnectTestingWalletFixture } from './mm-connect-fixtures.js';
...
appiumTest.describe(SmokeMMConnect('EVM sign and cancel'), () => {
  ...
  appiumTest.skip(
    ...
    async ({ driver: _driver, currentDeviceDetails }) => {
      await withFixtures(
        {
          fixture: mmConnectTestingWalletFixture(),
          restartDevice: true,
