...
import { setupGoogleExistingUserOAuthMock } from './helpers/seedless-helpers.js';

appiumTest.describe(
  SmokeSeedlessOnboarding('Google Login - Existing User'),
  () => {
    appiumTest(
      'shows Account Already Exists screen for existing Google user',
        ...
        await withFixtures(
          {
            ...
            testSpecificMock: setupGoogleExistingUserOAuthMock,
          },
          async () => {
