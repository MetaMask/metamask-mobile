...
const SECTION = TrendingViewSelectorsText.SECTION_SITES;
const SECTION_HEADER = 'Popular';

appiumTest.describe(SmokeWalletPlatform('Trending Feed - Sites'), () => {
  appiumTest(
    'Sites: view all',
    async ({ driver: _driver, currentDeviceDetails }) => {
      await withFixtures(
        ...
        async () => {
          ...
          await TrendingView.navigateToSectionTab(SECTION);
          await TrendingView.verifySiteVisible('Uniswap');
        },
      );
    },
  );
