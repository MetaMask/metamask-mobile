 ...
 * @param {boolean | 'newInstance'} [restartDevice=false] - If true, restarts the app to apply the loaded fixture. If 'newInstance', relaunches without reinstalling (preserves Detox connection).
