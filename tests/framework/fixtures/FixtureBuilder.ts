...
class FixtureBuilder {
   ...
   */
  withNoAutoLock() {
    // FixtureState.types.settings is typed loosely (unknown) in the merged
    // fixture schema; narrow it for the LockManagerService magic value.
    (this.fixture.state.settings as { lockTime: number }).lockTime = -1;
    return this;
  }
