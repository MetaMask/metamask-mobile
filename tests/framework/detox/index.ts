// Detox-world framework exports for easy importing
// Mirrors the branch's original tests/framework/index.ts, but Gestures/Assertions
// resolve to the detox-namespace copies while all shared framework files are
// imported from the canonical parent directory.
...
// Example usage:
// import { Assertions, Gestures, Matchers, sleep, PortManager, ResourceType } from '../framework/detox';
