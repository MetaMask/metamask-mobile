...
- For CI/workflow/infrastructure changes (.github/workflows/, tests/framework/fixtures/, tests/page-objects/, tests/framework/, build configs), consider whether tests should run to validate the pipeline still works
