...
// Tab testIDs — generated by TabsBar as `${TabsList testID}-bar-tab-${index}`
// TabsList testID is "explore-tabs" (set in TrendingView.tsx)
export const TrendingTabTestIDs = {
  NOW: 'explore-tabs-bar-tab-0',
  MACRO: 'explore-tabs-bar-tab-1',
  RWAS: 'explore-tabs-bar-tab-2',
  CRYPTO: 'explore-tabs-bar-tab-3',
  SPORTS: 'explore-tabs-bar-tab-4',
