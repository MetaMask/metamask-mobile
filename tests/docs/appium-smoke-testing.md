...
`tests/smoke-appium/api-specs/` is **iOS-only**, colocated under smoke-appium but **not** part of Appium smoke tag suites (`testIgnore` unless `APPIUM_RUN_API_SPECS=1`). Use the dedicated script:
