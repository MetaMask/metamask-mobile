...
| -------------------- | ----------------- | -------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Detox                | Grey box testing  | E2E                                                | - When we want to test user flows <br> - Run on PR basis                                                     | - High cost <br> - Low tool (detox) maintenance <br> - JS/TS based test files <br> - Handles deeply nested elements better (easier to find and locate elements) <br> - Uses emulators/simulators <br> - Allows runs with local Builds |
| Component View Tests | White box testing | Individual view testing without implied user flows | - When we need to perform mutation tests <br> - When we want to test individual component and view rendering | - Low cost <br> - Fast feedback loop                                                                                                                                                                                                  |
...
| Maestro              | Grey box testing  | TBD                                                | TBD                                                                                                          | - Struggles with deeply nested elements <br> - YAML based spec files <br> - Allows runs with local builds                                                                                                                             |
