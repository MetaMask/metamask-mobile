...
- **Appium smoke (`tests/smoke-appium/`)** — Playwright + Appium. See [appium-smoke-testing.md](./appium-smoke-testing.md)
...
| Appium smoke (Playwright) | Black box testing | E2E                  | - Smoke / user-flow coverage <br> - PR and CI smoke (`tests/smoke-appium/`)                                         | - Uses `main-e2e` builds and Playwright fixture <br> - See [appium-smoke-testing.md](./appium-smoke-testing.md) <br> - Page objects use `Gestures` / `Assertions` / `Matchers`                                    |
