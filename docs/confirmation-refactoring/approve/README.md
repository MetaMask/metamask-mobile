...
This confirmation page allows the user to give approval to their assets:
...
2. The component has few methods that are quite generic and should be fully or partially converted to reusable functions in utils or hooks:
   - For gas polling it's proposed to create a re-usable hook [here](https://github.com/MetaMask/metamask-mobile/pull/6003/files#diff-7c74af67b37335b69af34b0dc466c46bc3a08e37832414f7eba12984bcbf5abfR119), the hook can be used in this component also.
