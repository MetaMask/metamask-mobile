...
| `perpsLighterProviderEnabled`                      | `perps-lighter-provider-enabled`                         | `MM_PERPS_LIGHTER_PROVIDER_ENABLED`            | false   | Lighter provider POC; local development builds enable the infrastructure automatically, while production builds require the environment gate                                       |
