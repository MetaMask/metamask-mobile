...
| `perpsTAT3938AbtestBottomSheets` | `perpsTAT3938AbtestBottomSheets`    | `control`, `treatment` | Shared full-page vs bottom-sheet rollout (TAT-3938) |
...
`perpsTAT3938AbtestBottomSheets` defaults to `control` (full-page flows). Consume it only through `usePerpsBottomSheetAbTest()` — see [`docs/perps/perps-ab-testing.md`](./perps-ab-testing.md).
