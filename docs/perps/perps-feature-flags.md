...
| `perpsAdvancedChartEnabledV2`                      | `perps-advanced-chart-enabled-v2`                        | `MM_PERPS_ADVANCED_CHART_ENABLED`              | false   | Perps market detail / fullscreen TradingView AdvancedChart                              |
