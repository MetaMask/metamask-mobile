...
| `perpsRelatedMarkets`                              | `perps-related-markets`                                  | `MM_PERPS_RELATED_MARKETS_ENABLED`             | true    | Related markets rail on market details (min version 7.68.0)                                              |
| `perpsMarketAboutEnabled`                          | `perps-market-about-enabled`                             | `MM_PERPS_MARKET_ABOUT_ENABLED`                | false   | About section (asset description) on market details (TAT-2308)                                           |
