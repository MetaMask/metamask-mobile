...
| `perpsPayWithAnyTokenAllowListAssets`   | `perps-pay-with-any-token-allow-list-assets`  | `PERPS_PAY_WITH_ANY_TOKEN_ALLOW_LIST_ASSETS` | Pay-with modal token allowlist (`chainId.address`, comma-separated; env overrides remote) |
