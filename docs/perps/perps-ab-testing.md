...
- [ ] `HAS_TEST_OVERRIDES` is NOT set to `true` in `.js.env` (events won't send if true)
...
| ------------------------------- | ------------------------- | ----------------------------------------------------------------------------------------------------- |
| Events not in console           | `HAS_TEST_OVERRIDES=true` | Set `IS_HAS_TEST_OVERRIDESTEST=false` in `.js.env`                                                    |
