...
storiesOf('Getting Started', module).add('Introduction', () => {
	...
	return (
		<View style={styles.wrapper}>
			...
			<Text>
				If you are looking to get a local build of Metamask Mobile up and running or contribute to the mobile
				app codebase please read the Metamask{' '}
			...
			<Text>
				If you&apos;re here to improve our storybook documentation you&apos;re in the right place! Please head
				over to the{' '}
