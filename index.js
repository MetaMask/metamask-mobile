...
LogBox.ignoreLogs([
  ...
  "ViewStyle will be removed from React Native, along with all other PropTypes. We recommend that you migrate away from PropTypes and switch to a type system like TypeScript. If you need to continue using ViewStyle, migrate to the 'deprecated-react-native-prop-types' package.",
