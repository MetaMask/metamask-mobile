  ...
  plugins: [
    ...
    [
      'expo-font',
      {
        ...
        // font family based on its filename (e.g., Oswald-Medium.ttf → 'Oswald-Medium').
        // This means the fontWeight property won't automatically switch fonts - you must use
        // explicit font families like 'Oswald-Medium' or use fontStyles.* from common.ts.
        //
