  ...
  plugins: [
    ...
    [
      'expo-font',
      {
        ...
        // font family based on its filename (e.g., Inter-Medium.otf → 'Inter-Medium').
        // This means the fontWeight property won't automatically switch fonts - you must use
        // explicit font families like 'Inter-Medium' or use fontStyles.* from common.ts.
        //
        ...
        fonts: [
          ...
          './app/fonts/Inter-Medium.otf',
          './app/fonts/Inter-SemiBold.otf',
          './app/fonts/Inter-RegularItalic.otf',
          './app/fonts/Inter-MediumItalic.otf',
