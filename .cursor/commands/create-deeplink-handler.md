...
**After collecting all information, proceed with generation.**
...
After generating handler and test files, provide **exact code snippets** for manual integration:
...
- [ ] All user information collected interactively
- [ ] Handler file created with proper structure
- [ ] Test file created with all test cases
- [ ] Integration snippets provided for all 6 steps
