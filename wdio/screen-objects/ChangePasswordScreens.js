...
class ChangePasswordScreens {
  get passwordInput() {
    return Selectors.getElementByPlatform(ManualBackUpSelectorsIDs.CONFIRM_PASSWORD_INPUT);
  }

  get confirmButton() {
    return Selectors.getElementByPlatform(ManualBackUpSelectorsIDs.SUBMIT_BUTTON);
  }
