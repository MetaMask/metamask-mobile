...
Feature: Address
  ...
  Scenario: A user enters an invalid address & valid address and proceed to send flow
    ...
    And I enter a contract address "<invalidAddress>" in the sender's input box
    ...
    Examples:
      | correctAddress                             | invalidAddress                             |
      | 0xdac17f958d2ee523a2206206994597c13d831ec7 | 0xB8B4EE5B1b693971eB60bDa15211570df2dB221L |
