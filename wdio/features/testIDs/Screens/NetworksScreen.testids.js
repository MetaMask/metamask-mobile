...
export const INPUT_CHAIN_ID_FIELD =
  'input-chain-id';

export const INPUT_RPC_URL_FIELD =
  'input-rpc-url';

export const ADD_NETWORK_BUTTON =
  'add-network-button';

export const INPUT_NETWORK_NAME =
  'input-network-name';

export const NETWORKS_SYMBOL_INPUT_FIELD =
  'input-network-symbol';

export const NEW_NETWORK_ADDED_SWITCH_TO_NETWORK_BUTTON =
  'switch-to-network-button';

export const NEW_NETWORK_ADDED_CLOSE_BUTTON =
  'close-network-button';

export const APPROVE_NETWORK_APPROVE_BUTTON =
  'approve-network-approve-button';

export const APPROVE_NETWORK_MODAL =
...
export const NAV_ANDROID_BACK_BUTTON =
  ...
  export const NETWORK_SCREEN_CLOSE_ICON =
  'close-network-icon';
